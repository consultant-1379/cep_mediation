...
/**
 * Define the ASN1 Type DL_DCCH_Message from ASN1 Module Class_definitions.
 * @see Sequence
 */

public class DL_DCCH_Message extends Sequence {
     ...
     */
    public DL_DCCH_Message(rrc.informationelements.IntegrityCheckInfo integrityCheckInfo, 
     ...
     */
    public DL_DCCH_Message(DL_DCCH_MessageType message)
    {
	setMessage(message);
    }
	...
	mComponents[1] = new DL_DCCH_MessageType();
    }
	...
	switch (index) {
	    ...
	    case 1:
		return new DL_DCCH_MessageType();
	    default:
    ...
    public DL_DCCH_MessageType getMessage()
    {
	return (DL_DCCH_MessageType)mComponents[1];
    }
    
    public void setMessage(DL_DCCH_MessageType message)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_DCCH_Message object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_DCCH_Message object.
     */
...
} // End class definition for DL_DCCH_Message
