...
/**
 * Define the ASN1 Type DL_CCCH_Message from ASN1 Module Class_definitions.
 * @see Sequence
 */

public class DL_CCCH_Message extends Sequence {
     ...
     */
    public DL_CCCH_Message(rrc.informationelements.IntegrityCheckInfo integrityCheckInfo, 
     ...
     */
    public DL_CCCH_Message(DL_CCCH_MessageType message)
    {
	setMessage(message);
    }
	...
	mComponents[1] = new DL_CCCH_MessageType();
    }
	...
	switch (index) {
	    ...
	    case 1:
		return new DL_CCCH_MessageType();
	    default:
    ...
    public DL_CCCH_MessageType getMessage()
    {
	return (DL_CCCH_MessageType)mComponents[1];
    }
    
    public void setMessage(DL_CCCH_MessageType message)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_CCCH_Message object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_CCCH_Message object.
     */
...
} // End class definition for DL_CCCH_Message
