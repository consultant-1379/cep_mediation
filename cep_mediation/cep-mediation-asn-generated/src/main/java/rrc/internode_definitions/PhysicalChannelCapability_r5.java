...
/**
 * Define the ASN1 Type PhysicalChannelCapability_r5 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class PhysicalChannelCapability_r5 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PhysicalChannelCapability_r5()
    {
    }
     ...
     */
    public PhysicalChannelCapability_r5(FddPhysChCapability fddPhysChCapability, 
	 ...
	 * Construct with AbstractData components.
	 */
	public FddPhysChCapability(DL_PhysChCapabilityFDD_r5 downlinkPhysChCapability, 
	...
	public void initComponents()
	{
	    mComponents[0] = new DL_PhysChCapabilityFDD_r5();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new DL_PhysChCapabilityFDD_r5();
		case 1:
	...
	public DL_PhysChCapabilityFDD_r5 getDownlinkPhysChCapability()
	{
	    return (DL_PhysChCapabilityFDD_r5)mComponents[0];
	}
	
	public void setDownlinkPhysChCapability(DL_PhysChCapabilityFDD_r5 downlinkPhysChCapability)
	{
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
		...
		"PhysicalChannelCapability_r5$FddPhysChCapability"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
	 ...
	 * Construct with AbstractData components.
	 */
	public Tdd384_PhysChCapability(DL_PhysChCapabilityTDD_r5 downlinkPhysChCapability, 
	...
	public void initComponents()
	{
	    mComponents[0] = new DL_PhysChCapabilityTDD_r5();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new DL_PhysChCapabilityTDD_r5();
		case 1:
	...
	// Methods for field "downlinkPhysChCapability"
	public DL_PhysChCapabilityTDD_r5 getDownlinkPhysChCapability()
	{
	    return (DL_PhysChCapabilityTDD_r5)mComponents[0];
	}
	
	public void setDownlinkPhysChCapability(DL_PhysChCapabilityTDD_r5 downlinkPhysChCapability)
	{
	    mComponents[0] = downlinkPhysChCapability;
	}
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"PhysicalChannelCapability_r5$Tdd384_PhysChCapability"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
	 ...
	 * Construct with AbstractData components.
	 */
	public Tdd128_PhysChCapability(DL_PhysChCapabilityTDD_LCR_r5 downlinkPhysChCapability, 
	...
	public void initComponents()
	{
	    mComponents[0] = new DL_PhysChCapabilityTDD_LCR_r5();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new DL_PhysChCapabilityTDD_LCR_r5();
		case 1:
	...
	// Methods for field "downlinkPhysChCapability"
	public DL_PhysChCapabilityTDD_LCR_r5 getDownlinkPhysChCapability()
	{
	    return (DL_PhysChCapabilityTDD_LCR_r5)mComponents[0];
	}
	
	public void setDownlinkPhysChCapability(DL_PhysChCapabilityTDD_LCR_r5 downlinkPhysChCapability)
	{
	    mComponents[0] = downlinkPhysChCapability;
	}
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"PhysicalChannelCapability_r5$Tdd128_PhysChCapability"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PhysicalChannelCapability_r5 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PhysicalChannelCapability_r5 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PhysicalChannelCapability_r5
