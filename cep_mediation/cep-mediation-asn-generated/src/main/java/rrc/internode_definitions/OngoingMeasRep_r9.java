...
/**
 * Define the ASN1 Type OngoingMeasRep_r9 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class OngoingMeasRep_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public OngoingMeasRep_r9()
    {
    }
     ...
     */
    public OngoingMeasRep_r9(rrc.informationelements.MeasurementIdentity measurementIdentity, 
		    MeasurementCommandWithType_r9 measurementCommandWithType, 
	...
	mComponents[1] = new MeasurementCommandWithType_r9();
	...
	switch (index) {
	    ...
	    case 1:
		return new MeasurementCommandWithType_r9();
	    case 2:
    ...
    public MeasurementCommandWithType_r9 getMeasurementCommandWithType()
    {
	return (MeasurementCommandWithType_r9)mComponents[1];
    }
    
    public void setMeasurementCommandWithType(MeasurementCommandWithType_r9 measurementCommandWithType)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' OngoingMeasRep_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' OngoingMeasRep_r9 object.
     */
...
} // End class definition for OngoingMeasRep_r9
