...
/**
 * Define the ASN1 Type SRNC_RelocationInfo_r9_IEs from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class SRNC_RelocationInfo_r9_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public SRNC_RelocationInfo_r9_IEs()
    {
    }
     ...
     */
    public SRNC_RelocationInfo_r9_IEs(rrc.informationelements.RB_Identity rb_IdentityForHOMessage, 
		    ...
		    OngoingMeasRepList_r9 ongoingMeasRepList, 
     ...
     */
    public SRNC_RelocationInfo_r9_IEs(StateOfRRC stateOfRRC, 
		    StateOfRRC_Procedure stateOfRRC_Procedure, 
		    CipheringStatusList_r4 cipheringStatusList, 
		    rrc.informationelements.CN_DomainIdentity latestConfiguredCN_Domain, 
		    IntegrityProtectionStatus integrityProtectionStatus, 
	...
	mComponents[26] = new OngoingMeasRepList_r9();
	...
	mComponents[32] = new rrc.informationelements.UL_AddReconfTransChInfoList_r8();
	mComponents[33] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[34] = new rrc.informationelements.DL_AddReconfTransChInfoList_r9();
	mComponents[35] = new TPC_CombinationInfoList();
	mComponents[36] = new E_RGCH_CombinationInfoList();
	mComponents[37] = new StoredCompressedModeInfo_r8();
	mComponents[38] = new TPC_CombinationInfoList_r9();
	mComponents[39] = new E_RGCH_CombinationInfoList_r9();
	mComponents[40] = new MeasurementReport();
	mComponents[41] = new rrc.informationelements.FailureCauseWithProtErr();
	mComponents[42] = new rrc.informationelements.UE_HistoryInformation();
	mComponents[43] = new rrc.informationelements.MBMS_JoinedInformation_r6();
	mComponents[44] = new rrc.informationelements.MBMS_SelectedServiceInfo();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[45];
    }
	...
	switch (index) {
	    ...
	    case 26:
		return new OngoingMeasRepList_r9();
	    case 27:
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
		...
		"SRNC_RelocationInfo_r9_IEs$UeCapabilityContainer"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r9_IEs$UeCapabilityContainer_RSC"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r9_IEs$UeCapabilityContainer_UCI"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    public OngoingMeasRepList_r9 getOngoingMeasRepList()
    {
	return (OngoingMeasRepList_r9)mComponents[26];
    }
    
    public void setOngoingMeasRepList(OngoingMeasRepList_r9 ongoingMeasRepList)
    {
    ...
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList_r8)mComponents[32];
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r9)mComponents[34];
    }
    ...
    {
	return (MeasurementReport)mComponents[40];
    }
    
    public void setMeasurementReport(MeasurementReport measurementReport)
    {
	mComponents[40] = measurementReport;
    }
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r9_IEs$MeasurementReport"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    {
	return (rrc.informationelements.FailureCauseWithProtErr)mComponents[41];
    }
    
    public void setFailureCause(rrc.informationelements.FailureCauseWithProtErr failureCause)
    {
	mComponents[41] = failureCause;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r9_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r9_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SRNC_RelocationInfo_r9_IEs
