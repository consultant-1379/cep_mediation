...
/**
 * Define the ASN1 Type SRNC_RelocationInfo_r5_IEs from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class SRNC_RelocationInfo_r5_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public SRNC_RelocationInfo_r5_IEs()
    {
    }
     ...
     */
    public SRNC_RelocationInfo_r5_IEs(rrc.informationelements.RB_Identity rb_IdentityForHOMessage, 
		    ...
		    UE_RadioAccessCapability_r5 ue_RadioAccessCapability, 
		    ...
		    OngoingMeasRepList_r5 ongoingMeasRepList, 
		    rrc.informationelements.PredefinedConfigStatusList predefinedConfigStatusList, 
		    rrc.informationelements.SRB_InformationSetupList_r5 srb_InformationList, 
		    rrc.informationelements.RAB_InformationSetupList_r5 rab_InformationList, 
     ...
     */
    public SRNC_RelocationInfo_r5_IEs(StateOfRRC stateOfRRC, 
		    StateOfRRC_Procedure stateOfRRC_Procedure, 
		    CipheringStatusList_r4 cipheringStatusList, 
		    rrc.informationelements.CN_DomainIdentity latestConfiguredCN_Domain, 
		    IntegrityProtectionStatus integrityProtectionStatus, 
	...
	mComponents[13] = new UE_RadioAccessCapability_r5();
	...
	mComponents[18] = new InterRAT_UE_RadioAccessCapabilityList_r5();
	...
	mComponents[22] = new OngoingMeasRepList_r5();
	mComponents[23] = new rrc.informationelements.PredefinedConfigStatusList();
	mComponents[24] = new rrc.informationelements.SRB_InformationSetupList_r5();
	mComponents[25] = new rrc.informationelements.RAB_InformationSetupList_r5();
	...
	mComponents[30] = new rrc.informationelements.DL_AddReconfTransChInfoList_r5();
	mComponents[31] = new TPC_CombinationInfoList();
	mComponents[32] = new rrc.pdu_definitions.MeasurementReport();
	mComponents[33] = new rrc.informationelements.FailureCauseWithProtErr();
    }
	...
	switch (index) {
	    ...
	    case 13:
		return new UE_RadioAccessCapability_r5();
	    case 14:
	    ...
	    case 22:
		return new OngoingMeasRepList_r5();
	    case 23:
    ...
    public UE_RadioAccessCapability_r5 getUe_RadioAccessCapability()
    {
	return (UE_RadioAccessCapability_r5)mComponents[13];
    }
    
    public void setUe_RadioAccessCapability(UE_RadioAccessCapability_r5 ue_RadioAccessCapability)
    {
    ...
    {
	return (InterRAT_UE_RadioAccessCapabilityList_r5)mComponents[18];
    }
    ...
    public OngoingMeasRepList_r5 getOngoingMeasRepList()
    {
	return (OngoingMeasRepList_r5)mComponents[22];
    }
    
    public void setOngoingMeasRepList(OngoingMeasRepList_r5 ongoingMeasRepList)
    {
    ...
    public rrc.informationelements.SRB_InformationSetupList_r5 getSrb_InformationList()
    {
	return (rrc.informationelements.SRB_InformationSetupList_r5)mComponents[24];
    }
    
    public void setSrb_InformationList(rrc.informationelements.SRB_InformationSetupList_r5 srb_InformationList)
    {
    ...
    public rrc.informationelements.RAB_InformationSetupList_r5 getRab_InformationList()
    {
	return (rrc.informationelements.RAB_InformationSetupList_r5)mComponents[25];
    }
    
    public void setRab_InformationList(rrc.informationelements.RAB_InformationSetupList_r5 rab_InformationList)
    {
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "SRNC_RelocationInfo_r5_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r5_IEs$Dummy"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r5)mComponents[30];
    }
    ...
    {
	return (rrc.pdu_definitions.MeasurementReport)mComponents[32];
    }
    
    public void setMeasurementReport(rrc.pdu_definitions.MeasurementReport measurementReport)
    {
	mComponents[32] = measurementReport;
    }
    ...
    {
	return (rrc.informationelements.FailureCauseWithProtErr)mComponents[33];
    }
    
    public void setFailureCause(rrc.informationelements.FailureCauseWithProtErr failureCause)
    {
	mComponents[33] = failureCause;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r5_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r5_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SRNC_RelocationInfo_r5_IEs
