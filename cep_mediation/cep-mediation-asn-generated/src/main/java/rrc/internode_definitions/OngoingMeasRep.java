...
/**
 * Define the ASN1 Type OngoingMeasRep from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class OngoingMeasRep extends Sequence {
    
    /**
     * The default constructor.
     */
    public OngoingMeasRep()
    {
    }
     ...
     */
    public OngoingMeasRep(rrc.informationelements.MeasurementIdentity measurementIdentity, 
	...
	mComponents[1] = new MeasurementCommandWithType();
	...
	switch (index) {
	    ...
	    case 1:
		return new MeasurementCommandWithType();
	    case 2:
    ...
    public MeasurementCommandWithType getMeasurementCommandWithType()
    {
	return (MeasurementCommandWithType)mComponents[1];
    }
    
    public void setMeasurementCommandWithType(MeasurementCommandWithType measurementCommandWithType)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' OngoingMeasRep object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' OngoingMeasRep object.
     */
...
} // End class definition for OngoingMeasRep
