...
/**
 * Define the ASN1 Type StoredTGP_Sequence_r8 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class StoredTGP_Sequence_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public StoredTGP_Sequence_r8()
    {
    }
     ...
     */
    public StoredTGP_Sequence_r8(rrc.informationelements.TGPSI tgpsi, 
		    Current_tgps_Status current_tgps_Status, 
		    rrc.informationelements.TGPS_ConfigurationParams_r8 tgps_ConfigurationParams)
    {
	setTgpsi(tgpsi);
	...
	mComponents[2] = new rrc.informationelements.TGPS_ConfigurationParams_r8();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new rrc.informationelements.TGPS_ConfigurationParams_r8();
	    default:
	...
	public static class Active extends Sequence {
		...
		new QName (
		    ...
		    "StoredTGP_Sequence_r8$Current_tgps_Status$Active"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"StoredTGP_Sequence_r8$Current_tgps_Status"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public rrc.informationelements.TGPS_ConfigurationParams_r8 getTgps_ConfigurationParams()
    {
	return (rrc.informationelements.TGPS_ConfigurationParams_r8)mComponents[2];
    }
    
    public void setTgps_ConfigurationParams(rrc.informationelements.TGPS_ConfigurationParams_r8 tgps_ConfigurationParams)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' StoredTGP_Sequence_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' StoredTGP_Sequence_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for StoredTGP_Sequence_r8
