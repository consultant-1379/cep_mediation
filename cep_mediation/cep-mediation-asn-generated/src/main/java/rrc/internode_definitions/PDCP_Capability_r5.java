...
/**
 * Define the ASN1 Type PDCP_Capability_r5 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class PDCP_Capability_r5 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDCP_Capability_r5()
    {
    }
     ...
     */
    public PDCP_Capability_r5(BOOLEAN losslessSRNS_RelocationSupport, 
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"PDCP_Capability_r5$SupportForRfc2507"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	public static class Supported extends Sequence {
		...
		new QName (
		    "rrc.internode_definitions",
		    "PDCP_Capability_r5$SupportForRfc3095$Supported"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"PDCP_Capability_r5$SupportForRfc3095"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDCP_Capability_r5 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDCP_Capability_r5 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDCP_Capability_r5
