...
/**
 * Define the ASN1 Type SRNC_RelocationInfo_r8_IEs from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class SRNC_RelocationInfo_r8_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public SRNC_RelocationInfo_r8_IEs()
    {
    }
     ...
     */
    public SRNC_RelocationInfo_r8_IEs(rrc.informationelements.RB_Identity rb_IdentityForHOMessage, 
		    ...
		    OngoingMeasRepList_r8 ongoingMeasRepList, 
     ...
     */
    public SRNC_RelocationInfo_r8_IEs(StateOfRRC stateOfRRC, 
		    StateOfRRC_Procedure stateOfRRC_Procedure, 
		    CipheringStatusList_r4 cipheringStatusList, 
		    rrc.informationelements.CN_DomainIdentity latestConfiguredCN_Domain, 
		    IntegrityProtectionStatus integrityProtectionStatus, 
	...
	mComponents[26] = new OngoingMeasRepList_r8();
	...
	mComponents[38] = new MeasurementReport();
	mComponents[39] = new rrc.informationelements.FailureCauseWithProtErr();
	mComponents[40] = new rrc.informationelements.UE_HistoryInformation();
	mComponents[41] = new rrc.informationelements.MBMS_JoinedInformation_r6();
	mComponents[42] = new rrc.informationelements.MBMS_SelectedServiceInfo();
    }
	...
	switch (index) {
	    ...
	    case 26:
		return new OngoingMeasRepList_r8();
	    case 27:
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
		...
		"SRNC_RelocationInfo_r8_IEs$UeCapabilityContainer"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r8_IEs$UeCapabilityContainer_RSC"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r8_IEs$UeCapabilityContainer_UCI"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    public OngoingMeasRepList_r8 getOngoingMeasRepList()
    {
	return (OngoingMeasRepList_r8)mComponents[26];
    }
    
    public void setOngoingMeasRepList(OngoingMeasRepList_r8 ongoingMeasRepList)
    {
    ...
    {
	return (MeasurementReport)mComponents[38];
    }
    
    public void setMeasurementReport(MeasurementReport measurementReport)
    {
	mComponents[38] = measurementReport;
    }
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r8_IEs$MeasurementReport"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    {
	return (rrc.informationelements.FailureCauseWithProtErr)mComponents[39];
    }
    
    public void setFailureCause(rrc.informationelements.FailureCauseWithProtErr failureCause)
    {
	mComponents[39] = failureCause;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r8_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r8_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SRNC_RelocationInfo_r8_IEs
