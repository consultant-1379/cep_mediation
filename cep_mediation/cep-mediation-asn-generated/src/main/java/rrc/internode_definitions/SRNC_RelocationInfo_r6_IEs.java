...
/**
 * Define the ASN1 Type SRNC_RelocationInfo_r6_IEs from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class SRNC_RelocationInfo_r6_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public SRNC_RelocationInfo_r6_IEs()
    {
    }
     ...
     */
    public SRNC_RelocationInfo_r6_IEs(rrc.informationelements.RB_Identity rb_IdentityForHOMessage, 
		    ...
		    OngoingMeasRepList_r6 ongoingMeasRepList, 
		    ...
		    rrc.informationelements.SRB_InformationSetupList_r6 srb_InformationList, 
		    rrc.informationelements.RAB_InformationSetupList_r6 rab_InformationList, 
		    rrc.informationelements.UL_CommonTransChInfo_r4 ul_CommonTransChInfo, 
		    rrc.informationelements.UL_AddReconfTransChInfoList_r6 ul_TransChInfoList, 
		    rrc.informationelements.DL_CommonTransChInfo_r4 dl_CommonTransChInfo, 
		    rrc.informationelements.DL_AddReconfTransChInfoList_r5 dl_TransChInfoList, 
		    TPC_CombinationInfoList tpc_CombinationInfoList, 
		    StoredCompressedModeInfo storedCompressedModeInfo, 
     ...
     */
    public SRNC_RelocationInfo_r6_IEs(StateOfRRC stateOfRRC, 
		    StateOfRRC_Procedure stateOfRRC_Procedure, 
		    CipheringStatusList_r4 cipheringStatusList, 
		    rrc.informationelements.CN_DomainIdentity latestConfiguredCN_Domain, 
		    IntegrityProtectionStatus integrityProtectionStatus, 
	...
	mComponents[23] = new rrc.informationelements.NAS_SystemInformationGSM_MAP();
	mComponents[24] = new rrc.informationelements.CN_DomainInformationListFull();
	mComponents[25] = new OngoingMeasRepList_r6();
	mComponents[26] = new rrc.informationelements.InterRATCellInfoIndication();
	mComponents[27] = new rrc.informationelements.PredefinedConfigStatusList();
	mComponents[28] = new rrc.informationelements.SRB_InformationSetupList_r6();
	mComponents[29] = new rrc.informationelements.RAB_InformationSetupList_r6();
	mComponents[30] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	mComponents[31] = new rrc.informationelements.UL_AddReconfTransChInfoList_r6();
	mComponents[32] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[33] = new rrc.informationelements.DL_AddReconfTransChInfoList_r5();
	mComponents[34] = new TPC_CombinationInfoList();
	mComponents[35] = new StoredCompressedModeInfo();
	mComponents[36] = new MeasurementReport();
	mComponents[37] = new rrc.informationelements.FailureCauseWithProtErr();
	mComponents[38] = new rrc.informationelements.MBMS_JoinedInformation_r6();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[39];
    }
	...
	switch (index) {
	    ...
	    case 25:
		return new OngoingMeasRepList_r6();
	    case 26:
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
		...
		"SRNC_RelocationInfo_r6_IEs$UeCapabilityContainer"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r6_IEs$UeCapabilityContainer_RSC"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r6_IEs$UeCapabilityContainer_UCI"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    {
	return (rrc.informationelements.NAS_SystemInformationGSM_MAP)mComponents[23];
    }
    ...
    {
	mComponents[23] = cn_CommonGSM_MAP_NAS_SysInfo;
    }
    ...
    public OngoingMeasRepList_r6 getOngoingMeasRepList()
    {
	return (OngoingMeasRepList_r6)mComponents[25];
    }
    
    public void setOngoingMeasRepList(OngoingMeasRepList_r6 ongoingMeasRepList)
    {
	mComponents[25] = ongoingMeasRepList;
    }
    ...
    {
	return (rrc.informationelements.PredefinedConfigStatusList)mComponents[27];
    }
    
    public void setPredefinedConfigStatusList(rrc.informationelements.PredefinedConfigStatusList predefinedConfigStatusList)
    {
	mComponents[27] = predefinedConfigStatusList;
    }
    
    
    // Methods for field "srb_InformationList"
    public rrc.informationelements.SRB_InformationSetupList_r6 getSrb_InformationList()
    {
	return (rrc.informationelements.SRB_InformationSetupList_r6)mComponents[28];
    }
    
    public void setSrb_InformationList(rrc.informationelements.SRB_InformationSetupList_r6 srb_InformationList)
    {
	mComponents[28] = srb_InformationList;
    }
    
    
    // Methods for field "rab_InformationList"
    public rrc.informationelements.RAB_InformationSetupList_r6 getRab_InformationList()
    {
	return (rrc.informationelements.RAB_InformationSetupList_r6)mComponents[29];
    }
    
    public void setRab_InformationList(rrc.informationelements.RAB_InformationSetupList_r6 rab_InformationList)
    {
	mComponents[29] = rab_InformationList;
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[30];
    }
    
    public void setUl_CommonTransChInfo(rrc.informationelements.UL_CommonTransChInfo_r4 ul_CommonTransChInfo)
    {
	mComponents[30] = ul_CommonTransChInfo;
    }
    ...
    public rrc.informationelements.UL_AddReconfTransChInfoList_r6 getUl_TransChInfoList()
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList_r6)mComponents[31];
    }
    
    public void setUl_TransChInfoList(rrc.informationelements.UL_AddReconfTransChInfoList_r6 ul_TransChInfoList)
    {
	mComponents[31] = ul_TransChInfoList;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo_r4)mComponents[32];
    }
    
    public void setDl_CommonTransChInfo(rrc.informationelements.DL_CommonTransChInfo_r4 dl_CommonTransChInfo)
    {
	mComponents[32] = dl_CommonTransChInfo;
    }
    ...
    public rrc.informationelements.DL_AddReconfTransChInfoList_r5 getDl_TransChInfoList()
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r5)mComponents[33];
    }
    
    public void setDl_TransChInfoList(rrc.informationelements.DL_AddReconfTransChInfoList_r5 dl_TransChInfoList)
    {
	mComponents[33] = dl_TransChInfoList;
    }
    ...
    {
	return (MeasurementReport)mComponents[36];
    }
    
    public void setMeasurementReport(MeasurementReport measurementReport)
    {
	mComponents[36] = measurementReport;
    }
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r6_IEs$MeasurementReport"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    {
	return (rrc.informationelements.FailureCauseWithProtErr)mComponents[37];
    }
    
    public void setFailureCause(rrc.informationelements.FailureCauseWithProtErr failureCause)
    {
	mComponents[37] = failureCause;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r6_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r6_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SRNC_RelocationInfo_r6_IEs
