...
/**
 * Define the ASN1 Type OngoingMeasRep_r8 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class OngoingMeasRep_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public OngoingMeasRep_r8()
    {
    }
     ...
     */
    public OngoingMeasRep_r8(rrc.informationelements.MeasurementIdentity measurementIdentity, 
		    MeasurementCommandWithType_r8 measurementCommandWithType, 
	...
	mComponents[1] = new MeasurementCommandWithType_r8();
	...
	switch (index) {
	    ...
	    case 1:
		return new MeasurementCommandWithType_r8();
	    case 2:
    ...
    public MeasurementCommandWithType_r8 getMeasurementCommandWithType()
    {
	return (MeasurementCommandWithType_r8)mComponents[1];
    }
    
    public void setMeasurementCommandWithType(MeasurementCommandWithType_r8 measurementCommandWithType)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' OngoingMeasRep_r8 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' OngoingMeasRep_r8 object.
     */
...
} // End class definition for OngoingMeasRep_r8
