...
/**
 * Define the ASN1 Type OngoingMeasRep_r6 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class OngoingMeasRep_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public OngoingMeasRep_r6()
    {
    }
     ...
     */
    public OngoingMeasRep_r6(rrc.informationelements.MeasurementIdentity measurementIdentity, 
		    MeasurementCommandWithType_r6 measurementCommandWithType, 
	...
	mComponents[1] = new MeasurementCommandWithType_r6();
	...
	switch (index) {
	    ...
	    case 1:
		return new MeasurementCommandWithType_r6();
	    case 2:
    ...
    public MeasurementCommandWithType_r6 getMeasurementCommandWithType()
    {
	return (MeasurementCommandWithType_r6)mComponents[1];
    }
    
    public void setMeasurementCommandWithType(MeasurementCommandWithType_r6 measurementCommandWithType)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' OngoingMeasRep_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' OngoingMeasRep_r6 object.
     */
...
} // End class definition for OngoingMeasRep_r6
