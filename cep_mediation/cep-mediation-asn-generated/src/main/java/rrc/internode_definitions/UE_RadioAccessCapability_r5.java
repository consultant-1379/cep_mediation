...
/**
 * Define the ASN1 Type UE_RadioAccessCapability_r5 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class UE_RadioAccessCapability_r5 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_RadioAccessCapability_r5()
    {
    }
     ...
     */
    public UE_RadioAccessCapability_r5(rrc.informationelements.AccessStratumReleaseIndicator accessStratumReleaseIndicator, 
		    rrc.informationelements.DL_CapabilityWithSimultaneousHS_DSCHConfig dl_CapabilityWithSimultaneousHS_DSCHConfig, 
		    PDCP_Capability_r5 pdcp_Capability, 
	...
	mComponents[2] = new PDCP_Capability_r5();
    ...
    public PDCP_Capability_r5 getPdcp_Capability()
    {
	return (PDCP_Capability_r5)mComponents[2];
    }
    
    public void setPdcp_Capability(PDCP_Capability_r5 pdcp_Capability)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_RadioAccessCapability_r5 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_RadioAccessCapability_r5 object.
     */
...
} // End class definition for UE_RadioAccessCapability_r5
