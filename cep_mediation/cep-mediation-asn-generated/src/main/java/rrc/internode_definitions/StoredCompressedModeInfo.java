...
/**
 * Define the ASN1 Type StoredCompressedModeInfo from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class StoredCompressedModeInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public StoredCompressedModeInfo()
    {
    }
     ...
     */
    public StoredCompressedModeInfo(StoredTGP_SequenceList storedTGP_SequenceList, 
    ...
    {
	mComponents[0] = new StoredTGP_SequenceList();
	...
	switch (index) {
	    case 0:
		return new StoredTGP_SequenceList();
	    case 1:
    ...
    public StoredTGP_SequenceList getStoredTGP_SequenceList()
    {
	return (StoredTGP_SequenceList)mComponents[0];
    }
    
    public void setStoredTGP_SequenceList(StoredTGP_SequenceList storedTGP_SequenceList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' StoredCompressedModeInfo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' StoredCompressedModeInfo object.
     */
...
} // End class definition for StoredCompressedModeInfo
