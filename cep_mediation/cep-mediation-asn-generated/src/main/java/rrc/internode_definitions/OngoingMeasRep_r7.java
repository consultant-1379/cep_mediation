...
/**
 * Define the ASN1 Type OngoingMeasRep_r7 from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class OngoingMeasRep_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public OngoingMeasRep_r7()
    {
    }
     ...
     */
    public OngoingMeasRep_r7(rrc.informationelements.MeasurementIdentity measurementIdentity, 
		    MeasurementCommandWithType_r7 measurementCommandWithType, 
	...
	mComponents[1] = new MeasurementCommandWithType_r7();
	...
	switch (index) {
	    ...
	    case 1:
		return new MeasurementCommandWithType_r7();
	    case 2:
    ...
    public MeasurementCommandWithType_r7 getMeasurementCommandWithType()
    {
	return (MeasurementCommandWithType_r7)mComponents[1];
    }
    
    public void setMeasurementCommandWithType(MeasurementCommandWithType_r7 measurementCommandWithType)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' OngoingMeasRep_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' OngoingMeasRep_r7 object.
     */
...
} // End class definition for OngoingMeasRep_r7
