...
/**
 * Define the ASN1 Type SRNC_RelocationInfo_r7_IEs from ASN1 Module Internode_definitions.
 * @see Sequence
 */

public class SRNC_RelocationInfo_r7_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public SRNC_RelocationInfo_r7_IEs()
    {
    }
     ...
     */
    public SRNC_RelocationInfo_r7_IEs(rrc.informationelements.RB_Identity rb_IdentityForHOMessage, 
		    ...
		    OngoingMeasRepList_r7 ongoingMeasRepList, 
		    ...
		    rrc.informationelements.SRB_InformationSetupList_r7 srb_InformationList, 
		    rrc.informationelements.RAB_InformationSetupList_r7 rab_InformationList, 
		    rrc.informationelements.UL_CommonTransChInfo_r4 ul_CommonTransChInfo, 
		    rrc.informationelements.UL_AddReconfTransChInfoList_r7 ul_TransChInfoList, 
		    rrc.informationelements.DL_CommonTransChInfo_r4 dl_CommonTransChInfo, 
		    rrc.informationelements.DL_AddReconfTransChInfoList_r7 dl_TransChInfoList, 
     ...
     */
    public SRNC_RelocationInfo_r7_IEs(StateOfRRC stateOfRRC, 
		    StateOfRRC_Procedure stateOfRRC_Procedure, 
		    CipheringStatusList_r4 cipheringStatusList, 
		    rrc.informationelements.CN_DomainIdentity latestConfiguredCN_Domain, 
		    IntegrityProtectionStatus integrityProtectionStatus, 
	...
	mComponents[26] = new OngoingMeasRepList_r7();
	...
	mComponents[29] = new rrc.informationelements.SRB_InformationSetupList_r7();
	mComponents[30] = new rrc.informationelements.RAB_InformationSetupList_r7();
	mComponents[31] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	mComponents[32] = new rrc.informationelements.UL_AddReconfTransChInfoList_r7();
	mComponents[33] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[34] = new rrc.informationelements.DL_AddReconfTransChInfoList_r7();
	mComponents[35] = new TPC_CombinationInfoList();
	mComponents[36] = new StoredCompressedModeInfo();
	mComponents[37] = new MeasurementReport();
	mComponents[38] = new rrc.informationelements.FailureCauseWithProtErr();
	mComponents[39] = new rrc.informationelements.MBMS_JoinedInformation_r6();
	mComponents[40] = new rrc.informationelements.MBMS_SelectedServiceInfo();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[41];
    }
	...
	switch (index) {
	    ...
	    case 26:
		return new OngoingMeasRepList_r7();
	    case 27:
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
		...
		"SRNC_RelocationInfo_r7_IEs$UeCapabilityContainer"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r7_IEs$UeCapabilityContainer_RSC"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r7_IEs$UeCapabilityContainer_UCI"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    public OngoingMeasRepList_r7 getOngoingMeasRepList()
    {
	return (OngoingMeasRepList_r7)mComponents[26];
    }
    
    public void setOngoingMeasRepList(OngoingMeasRepList_r7 ongoingMeasRepList)
    {
    ...
    public rrc.informationelements.SRB_InformationSetupList_r7 getSrb_InformationList()
    {
	return (rrc.informationelements.SRB_InformationSetupList_r7)mComponents[29];
    }
    
    public void setSrb_InformationList(rrc.informationelements.SRB_InformationSetupList_r7 srb_InformationList)
    {
    ...
    public rrc.informationelements.RAB_InformationSetupList_r7 getRab_InformationList()
    {
	return (rrc.informationelements.RAB_InformationSetupList_r7)mComponents[30];
    }
    
    public void setRab_InformationList(rrc.informationelements.RAB_InformationSetupList_r7 rab_InformationList)
    {
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[31];
    }
    
    public void setUl_CommonTransChInfo(rrc.informationelements.UL_CommonTransChInfo_r4 ul_CommonTransChInfo)
    {
	mComponents[31] = ul_CommonTransChInfo;
    }
    ...
    public rrc.informationelements.UL_AddReconfTransChInfoList_r7 getUl_TransChInfoList()
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList_r7)mComponents[32];
    }
    
    public void setUl_TransChInfoList(rrc.informationelements.UL_AddReconfTransChInfoList_r7 ul_TransChInfoList)
    {
	mComponents[32] = ul_TransChInfoList;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo_r4)mComponents[33];
    }
    
    public void setDl_CommonTransChInfo(rrc.informationelements.DL_CommonTransChInfo_r4 dl_CommonTransChInfo)
    {
	mComponents[33] = dl_CommonTransChInfo;
    }
    ...
    public rrc.informationelements.DL_AddReconfTransChInfoList_r7 getDl_TransChInfoList()
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r7)mComponents[34];
    }
    
    public void setDl_TransChInfoList(rrc.informationelements.DL_AddReconfTransChInfoList_r7 dl_TransChInfoList)
    {
	mComponents[34] = dl_TransChInfoList;
    }
    ...
    {
	return (MeasurementReport)mComponents[37];
    }
    
    public void setMeasurementReport(MeasurementReport measurementReport)
    {
	mComponents[37] = measurementReport;
    }
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.internode_definitions",
		"SRNC_RelocationInfo_r7_IEs$MeasurementReport"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    {
	return (rrc.informationelements.FailureCauseWithProtErr)mComponents[38];
    }
    
    public void setFailureCause(rrc.informationelements.FailureCauseWithProtErr failureCause)
    {
	mComponents[38] = failureCause;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r7_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SRNC_RelocationInfo_r7_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SRNC_RelocationInfo_r7_IEs
