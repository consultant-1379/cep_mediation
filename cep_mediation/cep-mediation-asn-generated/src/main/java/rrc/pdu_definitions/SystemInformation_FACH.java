...
/**
 * Define the ASN1 Type SystemInformation_FACH from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class SystemInformation_FACH extends Sequence {
    
    /**
     * The default constructor.
     */
    public SystemInformation_FACH()
    {
    }
     ...
     */
    public SystemInformation_FACH(Payload payload)
    {
	setPayload(payload);
    }
    ...
    {
	return (Payload)mComponents[0];
    }
    
    public void setPayload(Payload payload)
    {
	mComponents[0] = payload;
    }
	...
	public static class LastAndFirst extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "SystemInformation_FACH$Payload$LastAndFirst"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class LastAndComplete extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "SystemInformation_FACH$Payload$LastAndComplete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class LastAndCompleteAndFirst extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "SystemInformation_FACH$Payload$LastAndCompleteAndFirst"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class CompleteAndFirst extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "SystemInformation_FACH$Payload$CompleteAndFirst"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"SystemInformation_FACH$Payload"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SystemInformation_FACH object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SystemInformation_FACH object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SystemInformation_FACH
