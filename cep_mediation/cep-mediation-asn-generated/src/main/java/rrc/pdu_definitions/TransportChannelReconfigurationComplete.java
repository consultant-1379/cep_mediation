...
/**
 * Define the ASN1 Type TransportChannelReconfigurationComplete from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class TransportChannelReconfigurationComplete extends Sequence {
    
    /**
     * The default constructor.
     */
    public TransportChannelReconfigurationComplete()
    {
    }
     ...
     */
    public TransportChannelReconfigurationComplete(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString transportChannelReconfigurationComplete_r3_add_ext, 
			V770NCEs v770NCEs)
	{
	    setTransportChannelReconfigurationComplete_r3_add_ext(transportChannelReconfigurationComplete_r3_add_ext);
	...
	// Methods for field "transportChannelReconfigurationComplete_r3_add_ext"
	public BitString getTransportChannelReconfigurationComplete_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setTransportChannelReconfigurationComplete_r3_add_ext(BitString transportChannelReconfigurationComplete_r3_add_ext)
	{
	    mComponents[0] = transportChannelReconfigurationComplete_r3_add_ext;
	}
	
	public boolean hasTransportChannelReconfigurationComplete_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteTransportChannelReconfigurationComplete_r3_add_ext()
	{
	...
	public static class V770NCEs extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public V770NCEs(TransportChannelReconfigurationComplete_v770ext_IEs transportChannelReconfigurationComplete_v770ext, 
			    NonCriticalExtensions nonCriticalExtensions)
	    {
		setTransportChannelReconfigurationComplete_v770ext(transportChannelReconfigurationComplete_v770ext);
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new TransportChannelReconfigurationComplete_v770ext_IEs();
		...
		switch (index) {
		    case 0:
			return new TransportChannelReconfigurationComplete_v770ext_IEs();
		    case 1:
	    ...
	    // Methods for field "transportChannelReconfigurationComplete_v770ext"
	    public TransportChannelReconfigurationComplete_v770ext_IEs getTransportChannelReconfigurationComplete_v770ext()
	    {
		return (TransportChannelReconfigurationComplete_v770ext_IEs)mComponents[0];
	    }
	    
	    public void setTransportChannelReconfigurationComplete_v770ext(TransportChannelReconfigurationComplete_v770ext_IEs transportChannelReconfigurationComplete_v770ext)
	    {
		mComponents[0] = transportChannelReconfigurationComplete_v770ext;
	    }
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"TransportChannelReconfigurationComplete$LaterNCEs$V770NCEs$NonCriticalExtensions"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "TransportChannelReconfigurationComplete$LaterNCEs$V770NCEs"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfigurationComplete$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TransportChannelReconfigurationComplete object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TransportChannelReconfigurationComplete object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TransportChannelReconfigurationComplete
