...
/**
 * Define the ASN1 Type RadioBearerReconfigurationFailure from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerReconfigurationFailure extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerReconfigurationFailure()
    {
    }
     ...
     */
    public RadioBearerReconfigurationFailure(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString radioBearerReconfigurationFailure_r3_add_ext, 
			NonCriticalExtensions nonCriticalExtensions)
	{
	    setRadioBearerReconfigurationFailure_r3_add_ext(radioBearerReconfigurationFailure_r3_add_ext);
	...
	// Methods for field "radioBearerReconfigurationFailure_r3_add_ext"
	public BitString getRadioBearerReconfigurationFailure_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setRadioBearerReconfigurationFailure_r3_add_ext(BitString radioBearerReconfigurationFailure_r3_add_ext)
	{
	    mComponents[0] = radioBearerReconfigurationFailure_r3_add_ext;
	}
	
	public boolean hasRadioBearerReconfigurationFailure_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteRadioBearerReconfigurationFailure_r3_add_ext()
	{
	...
	public static class NonCriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReconfigurationFailure$LaterNCEs$NonCriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfigurationFailure$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerReconfigurationFailure object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerReconfigurationFailure object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerReconfigurationFailure
