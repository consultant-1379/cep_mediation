...
/**
 * Define the ASN1 Type HandoverToUTRANCommand_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class HandoverToUTRANCommand_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public HandoverToUTRANCommand_r4_IEs()
    {
    }
     ...
     */
    public HandoverToUTRANCommand_r4_IEs(rrc.informationelements.U_RNTI_Short new_U_RNTI, 
	...
	public static class Complete extends Sequence {
	    ...
	    public Complete(rrc.informationelements.SRB_InformationSetupList srb_InformationSetupList, 
			    rrc.informationelements.RAB_InformationSetupList_r4 rab_InformationSetupList, 
			    ...
			    rrc.informationelements.UL_DPCH_Info_r4 ul_DPCH_Info, 
		...
		mComponents[1] = new rrc.informationelements.RAB_InformationSetupList_r4();
		...
		mComponents[5] = new rrc.informationelements.DL_AddReconfTransChInfoList_r4();
		mComponents[6] = new rrc.informationelements.UL_DPCH_Info_r4();
		mComponents[7] = new ModeSpecificInfo();
		mComponents[8] = new rrc.informationelements.DL_CommonInformation_r4();
		mComponents[9] = new rrc.informationelements.DL_InformationPerRL_List_r4();
		...
		switch (index) {
		    ...
		    case 6:
			return new rrc.informationelements.UL_DPCH_Info_r4();
		    case 7:
	    ...
	    public rrc.informationelements.RAB_InformationSetupList_r4 getRab_InformationSetupList()
	    {
		return (rrc.informationelements.RAB_InformationSetupList_r4)mComponents[1];
	    }
	    
	    public void setRab_InformationSetupList(rrc.informationelements.RAB_InformationSetupList_r4 rab_InformationSetupList)
	    {
	    ...
	    {
		return (rrc.informationelements.DL_AddReconfTransChInfoList_r4)mComponents[5];
	    }
	    ...
	    public rrc.informationelements.UL_DPCH_Info_r4 getUl_DPCH_Info()
	    {
		return (rrc.informationelements.UL_DPCH_Info_r4)mComponents[6];
	    }
	    
	    public void setUl_DPCH_Info(rrc.informationelements.UL_DPCH_Info_r4 ul_DPCH_Info)
	    {
		...
		public static class Fdd extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r4_IEs$SpecificationMode$Complete$ModeSpecificInfo$Fdd"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"HandoverToUTRANCommand_r4_IEs$SpecificationMode$Complete$ModeSpecificInfo"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
	    ...
	    {
		return (rrc.informationelements.DL_InformationPerRL_List_r4)mComponents[9];
	    }
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverToUTRANCommand_r4_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
		    ...
		    public DefaultConfig(rrc.informationelements.DefaultConfigMode defaultConfigMode, 
				    rrc.informationelements.DefaultConfigIdentity_r4 defaultConfigIdentity)
		    {
			...
			mComponents[1] = new rrc.informationelements.DefaultConfigIdentity_r4();
		    }
			...
			switch (index) {
			    ...
			    case 1:
				return new rrc.informationelements.DefaultConfigIdentity_r4();
			    default:
				throw new InternalError("AbstractCollection.createInstance()");
			}
		    ...
		    public rrc.informationelements.DefaultConfigIdentity_r4 getDefaultConfigIdentity()
		    {
			return (rrc.informationelements.DefaultConfigIdentity_r4)mComponents[1];
		    }
		    
		    public void setDefaultConfigIdentity(rrc.informationelements.DefaultConfigIdentity_r4 defaultConfigIdentity)
		    {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
			...
			new Fields (
				...
				new SequenceFieldInfo (
					...
					new IntegerInfo (
					    ...
					    new ValueRangeConstraint (
						new AbstractBounds(
						    new rrc.informationelements.DefaultConfigIdentity_r4(0), 
						    new rrc.informationelements.DefaultConfigIdentity_r4(12),
						    0
						)
					    ),
					    new Bounds (
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		public static class Fdd extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Fdd"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class Tdd extends Choice {
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd$Tdd384"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd$Tdd128"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd"
			),
			new QName (
			    "builtin",
			    "CHOICE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverToUTRANCommand_r4_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"HandoverToUTRANCommand_r4_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HandoverToUTRANCommand_r4_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HandoverToUTRANCommand_r4_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HandoverToUTRANCommand_r4_IEs
