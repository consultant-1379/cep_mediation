...
/**
 * Define the ASN1 Type RRCConnectionSetup_r9_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RRCConnectionSetup_r9_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RRCConnectionSetup_r9_IEs()
    {
    }
     ...
     */
    public RRCConnectionSetup_r9_IEs(rrc.informationelements.ActivationTime activationTime, 
	...
	this(activationTime, new_U_RNTI, new_c_RNTI, new_H_RNTI, 
	     ...
	     dl_SecondaryCellInfoFDD, sps_Information_TDD128);
    }
    
    /**
     * Construct with required components.
     */
    public RRCConnectionSetup_r9_IEs(rrc.informationelements.U_RNTI new_U_RNTI, 
		    rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    rrc.informationelements.UTRAN_DRX_CycleLengthCoefficient_r7 utran_DRX_CycleLengthCoeff, 
		    boolean supportForChangeOfUE_Capability, 
		    SpecificationMode specificationMode)
	...
	mComponents[21] = new rrc.informationelements.DL_CommonInformation_r8();
	mComponents[22] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[23] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r9();
	mComponents[24] = new rrc.informationelements.SPS_Information_TDD128_r8();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[25];
    }
	...
	public static class Complete extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RRCConnectionSetup_r9_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "RRCConnectionSetup_r9_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"RRCConnectionSetup_r9_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RRCConnectionSetup_r9_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionSetup_r9_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r8)mComponents[21];
    }
    ...
    {
	return (rrc.informationelements.DL_SecondaryCellInfoFDD_r9)mComponents[23];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RRCConnectionSetup_r9_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RRCConnectionSetup_r9_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RRCConnectionSetup_r9_IEs
