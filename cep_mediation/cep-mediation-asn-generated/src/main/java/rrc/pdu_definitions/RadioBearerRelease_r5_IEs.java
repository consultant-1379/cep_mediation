...
/**
 * Define the ASN1 Type RadioBearerRelease_r5_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerRelease_r5_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerRelease_r5_IEs()
    {
    }
     ...
     */
    public RadioBearerRelease_r5_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerRelease_r5_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    rrc.informationelements.RB_InformationReleaseList rb_InformationReleaseList, 
		    ModeSpecificPhysChInfo modeSpecificPhysChInfo)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	...
	mComponents[10] = rrc.informationelements.CN_DomainIdentity.cs_domain;
	mComponents[11] = new rrc.informationelements.URA_Identity();
	mComponents[12] = new rrc.informationelements.RAB_InformationReconfigList();
	mComponents[13] = new rrc.informationelements.RB_InformationReleaseList();
	mComponents[14] = new rrc.informationelements.RB_InformationAffectedList_r5();
	mComponents[15] = new rrc.informationelements.DL_CounterSynchronisationInfo_r5();
	mComponents[16] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	...
	mComponents[19] = new Dummy();
	mComponents[20] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[21] = new rrc.informationelements.DL_DeletedTransChInfoList_r5();
	mComponents[22] = new rrc.informationelements.DL_AddReconfTransChInfoList_r5();
	mComponents[23] = new rrc.informationelements.FrequencyInfo();
	mComponents[24] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[25] = new rrc.informationelements.UL_ChannelRequirement_r5();
	mComponents[26] = new ModeSpecificPhysChInfo();
	mComponents[27] = new rrc.informationelements.DL_HSPDSCH_Information();
	mComponents[28] = new rrc.informationelements.DL_CommonInformation_r5();
	mComponents[29] = new rrc.informationelements.DL_InformationPerRL_List_r5();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[30];
    }
    ...
    {
	return (rrc.informationelements.CN_DomainIdentity)mComponents[10];
    }
    ...
    {
	mComponents[10] = signallingConnectionRelIndication;
    }
    ...
    {
	return (rrc.informationelements.RAB_InformationReconfigList)mComponents[12];
    }
    ...
    {
	mComponents[12] = rab_InformationReconfigList;
    }
    ...
    {
	return (rrc.informationelements.RB_InformationAffectedList_r5)mComponents[14];
    }
    ...
    {
	return (rrc.informationelements.DL_CounterSynchronisationInfo_r5)mComponents[15];
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[16];
    }
    ...
    {
	return (Dummy)mComponents[19];
    }
    
    public void setDummy(Dummy dummy)
    {
	mComponents[19] = dummy;
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerRelease_r5_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerRelease_r5_IEs$Dummy"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_DeletedTransChInfoList_r5)mComponents[21];
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r5)mComponents[22];
    }
    ...
    {
	return (rrc.informationelements.UL_ChannelRequirement_r5)mComponents[25];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerRelease_r5_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerRelease_r5_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information)mComponents[27];
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r5)mComponents[28];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r5)mComponents[29];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerRelease_r5_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerRelease_r5_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerRelease_r5_IEs
