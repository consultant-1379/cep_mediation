...
/**
 * Define the ASN1 Type LastSegment from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class LastSegment extends Sequence {
     ...
     */
    public LastSegment(rrc.informationelements.SIB_Type sib_Type, 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' LastSegment object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' LastSegment object.
     */
...
} // End class definition for LastSegment
