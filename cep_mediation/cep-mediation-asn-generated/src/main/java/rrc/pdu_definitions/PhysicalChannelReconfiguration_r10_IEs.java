...
/**
 * Define the ASN1 Type PhysicalChannelReconfiguration_r10_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class PhysicalChannelReconfiguration_r10_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public PhysicalChannelReconfiguration_r10_IEs()
    {
    }
     ...
     */
    public PhysicalChannelReconfiguration_r10_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
		    ...
		    rrc.informationelements.HARQ_Info_r7 harqInfo, 
	...
	this(integrityProtectionModeInfo, cipheringModeInfo, 
	     ...
	     harqInfo, frequencyInfo, multi_frequencyInfo, 
	     dtx_drx_TimingInfo, dtx_drx_Info, hs_scch_LessInfo, 
	     mimoParameters, controlChannelDRXInfo_TDD128, 
	     sps_Information_TDD128, maxAllowedUL_TX_Power, ul_DPCH_Info, 
     ...
     */
    public PhysicalChannelReconfiguration_r10_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
    }
	...
	mComponents[18] = new rrc.informationelements.HARQ_Info_r7();
	...
	mComponents[25] = new rrc.informationelements.ControlChannelDRXInfo_TDD128_r8();
	mComponents[26] = new rrc.informationelements.SPS_Information_TDD128_r8();
	mComponents[27] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[28] = new rrc.informationelements.UL_DPCH_Info_r7();
	mComponents[29] = new rrc.informationelements.UL_EDCH_Information_r9();
	mComponents[30] = new rrc.informationelements.UL_SecondaryCellInfoFDD();
	mComponents[31] = new rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128();
	mComponents[32] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
	mComponents[33] = new rrc.informationelements.DL_CommonInformation_r10();
	mComponents[34] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[35] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r10();
	mComponents[36] = new rrc.informationelements.AdditionalDLSecCellInfoListFDD();
	mComponents[37] = new rrc.informationelements.MU_MIMO_Info_TDD128();
	mComponents[38] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
	mComponents[39] = new rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[40];
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"PhysicalChannelReconfiguration_r10_IEs$ResponseToChangeOfUE_Capability"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    {
	return (rrc.informationelements.HARQ_Info_r7)mComponents[18];
    }
    
    public void setHarqInfo(rrc.informationelements.HARQ_Info_r7 harqInfo)
    {
	mComponents[18] = harqInfo;
    }
    ...
    {
	return (rrc.informationelements.ControlChannelDRXInfo_TDD128_r8)mComponents[25];
    }
    ...
    {
	mComponents[25] = controlChannelDRXInfo_TDD128;
    }
    ...
    {
	return (rrc.informationelements.UL_DPCH_Info_r7)mComponents[28];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r9)mComponents[29];
    }
    ...
    {
	return (rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128)mComponents[31];
    }
    ...
    {
	mComponents[31] = ul_MulticarrierEDCHInfo_TDD128;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r10)mComponents[33];
    }
    
    public void setDl_CommonInformation(rrc.informationelements.DL_CommonInformation_r10 dl_CommonInformation)
    {
	mComponents[33] = dl_CommonInformation;
    }
    ...
    {
	return (rrc.informationelements.AdditionalDLSecCellInfoListFDD)mComponents[36];
    }
    ...
    {
	mComponents[36] = additionalDLSecCellInfoListFDD;
    }
    ...
    {
	return (rrc.informationelements.MU_MIMO_Info_TDD128)mComponents[37];
    }
    
    public void setMu_MIMO_Info_TDD128(rrc.informationelements.MU_MIMO_Info_TDD128 mu_MIMO_Info_TDD128)
    {
	mComponents[37] = mu_MIMO_Info_TDD128;
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[38];
    }
    ...
    {
	mComponents[38] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    {
	return (rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9)mComponents[39];
    }
    ...
    {
	mComponents[39] = cellDCHMeasOccasionInfo_TDD128;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r10_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r10_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PhysicalChannelReconfiguration_r10_IEs
