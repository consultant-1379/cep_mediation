...
/**
 * Define the ASN1 Type CellUpdateConfirm_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class CellUpdateConfirm_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellUpdateConfirm_r4_IEs()
    {
    }
     ...
     */
    public CellUpdateConfirm_r4_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
     ...
     */
    public CellUpdateConfirm_r4_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    boolean rlc_Re_establishIndicatorRb2_3or4, 
		    boolean rlc_Re_establishIndicatorRb5orAbove, 
		    ModeSpecificTransChInfo modeSpecificTransChInfo, 
		    ModeSpecificPhysChInfo modeSpecificPhysChInfo)
	...
	mComponents[13] = new rrc.informationelements.RB_InformationReconfigList_r4();
	...
	mComponents[22] = new rrc.informationelements.DL_AddReconfTransChInfoList_r4();
	mComponents[23] = new rrc.informationelements.FrequencyInfo();
	mComponents[24] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[25] = new rrc.informationelements.UL_ChannelRequirement_r4();
	mComponents[26] = new ModeSpecificPhysChInfo();
	mComponents[27] = new rrc.informationelements.DL_CommonInformation_r4();
	mComponents[28] = new rrc.informationelements.DL_InformationPerRL_List_r4();
    }
    ...
    {
	return (rrc.informationelements.RB_InformationReconfigList_r4)mComponents[13];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "CellUpdateConfirm_r4_IEs$ModeSpecificTransChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"CellUpdateConfirm_r4_IEs$ModeSpecificTransChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r4)mComponents[22];
    }
    ...
    {
	return (rrc.informationelements.UL_ChannelRequirement_r4)mComponents[25];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "CellUpdateConfirm_r4_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"CellUpdateConfirm_r4_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r4)mComponents[27];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r4)mComponents[28];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellUpdateConfirm_r4_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellUpdateConfirm_r4_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellUpdateConfirm_r4_IEs
