...
/**
 * Define the ASN1 Type RadioBearerReconfiguration_r7_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerReconfiguration_r7_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerReconfiguration_r7_IEs()
    {
    }
     ...
     */
    public RadioBearerReconfiguration_r7_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
	...
	this(integrityProtectionModeInfo, cipheringModeInfo, 
	     ...
	     responseToChangeOfUE_Capability, specificationMode, 
     ...
     */
    public RadioBearerReconfiguration_r7_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    SpecificationMode specificationMode)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setSpecificationMode(specificationMode);
	...
	mComponents[17] = new SpecificationMode();
	mComponents[18] = new rrc.informationelements.FrequencyInfo();
	mComponents[19] = new rrc.informationelements.Multi_frequencyInfo_LCR_r7();
	mComponents[20] = new rrc.informationelements.DTX_DRX_TimingInfo_r7();
	mComponents[21] = new rrc.informationelements.DTX_DRX_Info_r7();
	mComponents[22] = new rrc.informationelements.HS_SCCH_LessInfo_r7();
	mComponents[23] = new rrc.informationelements.MIMO_Parameters_r7();
	mComponents[24] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[25] = new rrc.informationelements.UL_DPCH_Info_r7();
	mComponents[26] = new rrc.informationelements.UL_EDCH_Information_r7();
	mComponents[27] = new rrc.informationelements.DL_HSPDSCH_Information_r7();
	mComponents[28] = new rrc.informationelements.DL_CommonInformation_r7();
	mComponents[29] = new rrc.informationelements.DL_InformationPerRL_List_r7();
	mComponents[30] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfiguration_r7_IEs$ResponseToChangeOfUE_Capability"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    {
	return (SpecificationMode)mComponents[17];
    }
    
    public void setSpecificationMode(SpecificationMode specificationMode)
    {
	mComponents[17] = specificationMode;
    }
	...
	public static class Complete extends Sequence {
		...
		mComponents[2] = new rrc.informationelements.RB_InformationReconfigList_r7();
		mComponents[3] = new rrc.informationelements.RB_InformationAffectedList_r7();
		...
		mComponents[8] = new rrc.informationelements.UL_AddReconfTransChInfoList_r7();
		...
		mComponents[11] = new rrc.informationelements.DL_AddReconfTransChInfoList_r7();
	    }
	    ...
	    {
		return (rrc.informationelements.RB_InformationReconfigList_r7)mComponents[2];
	    }
	    ...
	    {
		return (rrc.informationelements.RB_InformationAffectedList_r7)mComponents[3];
	    }
	    ...
	    {
		return (rrc.informationelements.UL_AddReconfTransChInfoList_r7)mComponents[8];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_AddReconfTransChInfoList_r7)mComponents[11];
	    }
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReconfiguration_r7_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "RadioBearerReconfiguration_r7_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"RadioBearerReconfiguration_r7_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReconfiguration_r7_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfiguration_r7_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.FrequencyInfo)mComponents[18];
    }
    
    public void setFrequencyInfo(rrc.informationelements.FrequencyInfo frequencyInfo)
    {
	mComponents[18] = frequencyInfo;
    }
    ...
    {
	return (rrc.informationelements.Multi_frequencyInfo_LCR_r7)mComponents[19];
    }
    
    public void setMulti_frequencyInfo(rrc.informationelements.Multi_frequencyInfo_LCR_r7 multi_frequencyInfo)
    {
	mComponents[19] = multi_frequencyInfo;
    }
    ...
    {
	return (rrc.informationelements.DTX_DRX_TimingInfo_r7)mComponents[20];
    }
    
    public void setDtx_drx_TimingInfo(rrc.informationelements.DTX_DRX_TimingInfo_r7 dtx_drx_TimingInfo)
    {
	mComponents[20] = dtx_drx_TimingInfo;
    }
    ...
    {
	return (rrc.informationelements.DTX_DRX_Info_r7)mComponents[21];
    }
    
    public void setDtx_drx_Info(rrc.informationelements.DTX_DRX_Info_r7 dtx_drx_Info)
    {
	mComponents[21] = dtx_drx_Info;
    }
    ...
    {
	return (rrc.informationelements.HS_SCCH_LessInfo_r7)mComponents[22];
    }
    
    public void setHs_scch_LessInfo(rrc.informationelements.HS_SCCH_LessInfo_r7 hs_scch_LessInfo)
    {
	mComponents[22] = hs_scch_LessInfo;
    }
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r7)mComponents[23];
    }
    
    public void setMimoParameters(rrc.informationelements.MIMO_Parameters_r7 mimoParameters)
    {
	mComponents[23] = mimoParameters;
    }
    ...
    {
	return (rrc.informationelements.UL_DPCH_Info_r7)mComponents[25];
    }
    
    public void setUl_DPCH_Info(rrc.informationelements.UL_DPCH_Info_r7 ul_DPCH_Info)
    {
	mComponents[25] = ul_DPCH_Info;
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r7)mComponents[26];
    }
    
    public void setUl_EDCH_Information(rrc.informationelements.UL_EDCH_Information_r7 ul_EDCH_Information)
    {
	mComponents[26] = ul_EDCH_Information;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r7)mComponents[28];
    }
    
    public void setDl_CommonInformation(rrc.informationelements.DL_CommonInformation_r7 dl_CommonInformation)
    {
	mComponents[28] = dl_CommonInformation;
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[30];
    }
    ...
    {
	mComponents[30] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerReconfiguration_r7_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerReconfiguration_r7_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerReconfiguration_r7_IEs
