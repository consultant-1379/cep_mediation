...
/**
 * Define the ASN1 Type RRCConnectionSetupComplete_v690ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RRCConnectionSetupComplete_v690ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RRCConnectionSetupComplete_v690ext_IEs()
    {
    }
     ...
     */
    public RRCConnectionSetupComplete_v690ext_IEs(UeCapabilityContainer ueCapabilityContainer)
    {
	...
	private static final ContainingBitStringInfo c_typeinfo = new ContainingBitStringInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionSetupComplete_v690ext_IEs$UeCapabilityContainer"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RRCConnectionSetupComplete_v690ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RRCConnectionSetupComplete_v690ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RRCConnectionSetupComplete_v690ext_IEs
