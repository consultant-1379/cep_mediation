...
/**
 * Define the ASN1 Type RRCConnectionRequest_v860ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RRCConnectionRequest_v860ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RRCConnectionRequest_v860ext_IEs()
    {
    }
     ...
     */
    public RRCConnectionRequest_v860ext_IEs(SupportOfCommonEDCH supportOfCommonEDCH, 
		    MultiCellSupport multiCellSupport, 
		    rrc.informationelements.Pre_RedirectionInfo pre_redirectionInfo, 
		    SupportOfMACiis supportOfMACiis, 
		    SupportOfSPSOperation supportOfSPSOperation)
    {
	setSupportOfCommonEDCH(supportOfCommonEDCH);
	setMultiCellSupport(multiCellSupport);
	setPre_redirectionInfo(pre_redirectionInfo);
	...
	mComponents[1] = MultiCellSupport._true;
	mComponents[2] = new rrc.informationelements.Pre_RedirectionInfo();
	...
	switch (index) {
	    ...
	    case 1:
		return MultiCellSupport._true;
	    case 2:
		return new rrc.informationelements.Pre_RedirectionInfo();
	    case 3:
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionRequest_v860ext_IEs$SupportOfCommonEDCH"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    // Methods for field "multiCellSupport"
    public MultiCellSupport getMultiCellSupport()
    {
	return (MultiCellSupport)mComponents[1];
    }
    
    public void setMultiCellSupport(MultiCellSupport multiCellSupport)
    {
	mComponents[1] = multiCellSupport;
    }
    
    public boolean hasMultiCellSupport()
    {
	return componentIsPresent(1);
    }
    
    public void deleteMultiCellSupport()
    {
    ...
    /**
     * Define the ASN1 Type MultiCellSupport from ASN1 Module PDU_definitions.
     * @see Enumerated
     */
    public static final class MultiCellSupport extends Enumerated {
	
	/**
	 * The default constructor.
	 */
	private MultiCellSupport()
	{
	    super(cFirstNumber);
	}
	
	protected MultiCellSupport(long value)
	{
	    super(value);
	}
	
	// Named list definitions.
	public static final MultiCellSupport _true =
	    new MultiCellSupport(0);
	private final static MultiCellSupport cNamedNumbers[] = {
	     _true
	};
	protected final static long cFirstNumber = 0;
	protected final static boolean cLinearNumbers = false;
	...
	public static MultiCellSupport valueOf(long value)
	{
	    return (MultiCellSupport)_true.lookupValue(value);
	}
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionRequest_v860ext_IEs$MultiCellSupport"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	/**
	 * Get the type descriptor (TypeInfo) of 'this' MultiCellSupport object.
	 */
	public TypeInfo getTypeInfo()
	{
	    return c_typeinfo;
	...
	/**
	 * Get the static type descriptor (TypeInfo) of 'this' MultiCellSupport object.
	 */
	public static TypeInfo getStaticTypeInfo()
	{
	    return c_typeinfo;
    ...
    } // End class definition for MultiCellSupport

    // Methods for field "pre_redirectionInfo"
    public rrc.informationelements.Pre_RedirectionInfo getPre_redirectionInfo()
    {
	return (rrc.informationelements.Pre_RedirectionInfo)mComponents[2];
    }
    
    public void setPre_redirectionInfo(rrc.informationelements.Pre_RedirectionInfo pre_redirectionInfo)
    {
	mComponents[2] = pre_redirectionInfo;
    }
    
    public boolean hasPre_redirectionInfo()
    {
	return componentIsPresent(2);
    }
    
    public void deletePre_redirectionInfo()
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionRequest_v860ext_IEs$SupportOfMACiis"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionRequest_v860ext_IEs$SupportOfSPSOperation"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RRCConnectionRequest_v860ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RRCConnectionRequest_v860ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RRCConnectionRequest_v860ext_IEs
