...
/**
 * Define the ASN1 Type PhysicalChannelReconfigurationComplete from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class PhysicalChannelReconfigurationComplete extends Sequence {
    
    /**
     * The default constructor.
     */
    public PhysicalChannelReconfigurationComplete()
    {
    }
     ...
     */
    public PhysicalChannelReconfigurationComplete(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString physicalChannelReconfigurationComplete_r3_add_ext, 
			V770NCEs v770NCEs)
	{
	    setPhysicalChannelReconfigurationComplete_r3_add_ext(physicalChannelReconfigurationComplete_r3_add_ext);
	...
	// Methods for field "physicalChannelReconfigurationComplete_r3_add_ext"
	public BitString getPhysicalChannelReconfigurationComplete_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setPhysicalChannelReconfigurationComplete_r3_add_ext(BitString physicalChannelReconfigurationComplete_r3_add_ext)
	{
	    mComponents[0] = physicalChannelReconfigurationComplete_r3_add_ext;
	}
	
	public boolean hasPhysicalChannelReconfigurationComplete_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deletePhysicalChannelReconfigurationComplete_r3_add_ext()
	{
	...
	public static class V770NCEs extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public V770NCEs(PhysicalChannelReconfigurationComplete_v770ext_IEs physicalChannelReconfigurationComplete_v770ext, 
			    NonCriticalExtensions nonCriticalExtensions)
	    {
		setPhysicalChannelReconfigurationComplete_v770ext(physicalChannelReconfigurationComplete_v770ext);
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new PhysicalChannelReconfigurationComplete_v770ext_IEs();
		...
		switch (index) {
		    case 0:
			return new PhysicalChannelReconfigurationComplete_v770ext_IEs();
		    case 1:
	    ...
	    // Methods for field "physicalChannelReconfigurationComplete_v770ext"
	    public PhysicalChannelReconfigurationComplete_v770ext_IEs getPhysicalChannelReconfigurationComplete_v770ext()
	    {
		return (PhysicalChannelReconfigurationComplete_v770ext_IEs)mComponents[0];
	    }
	    
	    public void setPhysicalChannelReconfigurationComplete_v770ext(PhysicalChannelReconfigurationComplete_v770ext_IEs physicalChannelReconfigurationComplete_v770ext)
	    {
		mComponents[0] = physicalChannelReconfigurationComplete_v770ext;
	    }
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"PhysicalChannelReconfigurationComplete$LaterNCEs$V770NCEs$NonCriticalExtensions"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "PhysicalChannelReconfigurationComplete$LaterNCEs$V770NCEs"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"PhysicalChannelReconfigurationComplete$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PhysicalChannelReconfigurationComplete object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PhysicalChannelReconfigurationComplete object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PhysicalChannelReconfigurationComplete
