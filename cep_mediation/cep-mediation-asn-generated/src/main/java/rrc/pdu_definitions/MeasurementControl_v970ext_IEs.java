...
/**
 * Define the ASN1 Type MeasurementControl_v970ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class MeasurementControl_v970ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public MeasurementControl_v970ext_IEs()
    {
    }
     ...
     */
    public MeasurementControl_v970ext_IEs(rrc.informationelements.MeasurementIdentity_r9 measurementIdentity, 
		    rrc.informationelements.AdditionalMeasurementID_List_r9 additionalMeasurementList)
    {
    ...
    public rrc.informationelements.AdditionalMeasurementID_List_r9 getAdditionalMeasurementList()
    {
	return (rrc.informationelements.AdditionalMeasurementID_List_r9)mComponents[1];
    }
    
    public void setAdditionalMeasurementList(rrc.informationelements.AdditionalMeasurementID_List_r9 additionalMeasurementList)
    {
	mComponents[1] = additionalMeasurementList;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementControl_v970ext_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementControl_v970ext_IEs object.
     */
...
} // End class definition for MeasurementControl_v970ext_IEs
