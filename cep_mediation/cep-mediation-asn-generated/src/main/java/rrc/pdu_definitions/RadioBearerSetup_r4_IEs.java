...
/**
 * Define the ASN1 Type RadioBearerSetup_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerSetup_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerSetup_r4_IEs()
    {
    }
     ...
     */
    public RadioBearerSetup_r4_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerSetup_r4_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    ModeSpecificPhysChInfo modeSpecificPhysChInfo)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setModeSpecificPhysChInfo(modeSpecificPhysChInfo);
	...
	mComponents[11] = new rrc.informationelements.RAB_InformationSetupList_r4();
	...
	mComponents[14] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	...
	mComponents[18] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[19] = new rrc.informationelements.DL_DeletedTransChInfoList();
	mComponents[20] = new rrc.informationelements.DL_AddReconfTransChInfoList_r4();
	mComponents[21] = new rrc.informationelements.FrequencyInfo();
	mComponents[22] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[23] = new rrc.informationelements.UL_ChannelRequirement_r4();
	mComponents[24] = new ModeSpecificPhysChInfo();
	mComponents[25] = new rrc.informationelements.DL_CommonInformation_r4();
	mComponents[26] = new rrc.informationelements.DL_InformationPerRL_List_r4();
    }
    ...
    {
	return (rrc.informationelements.RAB_InformationSetupList_r4)mComponents[11];
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[14];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerSetup_r4_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo_r4)mComponents[18];
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r4)mComponents[20];
    }
    ...
    {
	return (rrc.informationelements.UL_ChannelRequirement_r4)mComponents[23];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerSetup_r4_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerSetup_r4_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r4)mComponents[25];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r4)mComponents[26];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerSetup_r4_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerSetup_r4_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerSetup_r4_IEs
