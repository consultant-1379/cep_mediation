...
/**
 * Define the ASN1 Type RadioBearerRelease_v690ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerRelease_v690ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerRelease_v690ext_IEs()
    {
    }
     ...
     */
    public RadioBearerRelease_v690ext_IEs(rrc.informationelements.PLMN_Identity primary_plmn_Identity, 
	...
	mComponents[5] = rrc.informationelements.TimingMaintainedSynchInd._false;
	mComponents[6] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
	mComponents[7] = new rrc.informationelements.RB_InformationReleaseList();
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerRelease_v690ext_IEs$PostVerificationPeriod"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[6];
    }
    ...
    {
	mComponents[6] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    {
	return (rrc.informationelements.RB_InformationReleaseList)mComponents[7];
    }
    ...
    {
	mComponents[7] = mbms_RB_ListReleasedToChangeTransferMode;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerRelease_v690ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerRelease_v690ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerRelease_v690ext_IEs
