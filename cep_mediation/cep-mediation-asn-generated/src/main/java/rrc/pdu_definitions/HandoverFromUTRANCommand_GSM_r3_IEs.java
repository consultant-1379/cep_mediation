...
/**
 * Define the ASN1 Type HandoverFromUTRANCommand_GSM_r3_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class HandoverFromUTRANCommand_GSM_r3_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public HandoverFromUTRANCommand_GSM_r3_IEs()
    {
    }
     ...
     */
    public HandoverFromUTRANCommand_GSM_r3_IEs(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	...
	mComponents[3] = rrc.informationelements.Frequency_Band.dcs1800BandUsed;
	mComponents[4] = new Gsm_message();
    }
    ...
    {
	return (rrc.informationelements.Frequency_Band)mComponents[3];
    }
    ...
    {
	return (Gsm_message)mComponents[4];
    }
    
    public void setGsm_message(Gsm_message gsm_message)
    {
	mComponents[4] = gsm_message;
    }
	...
	public static class Single_GSM_Message extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverFromUTRANCommand_GSM_r3_IEs$Gsm_message$Single_GSM_Message"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Gsm_MessageList extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverFromUTRANCommand_GSM_r3_IEs$Gsm_message$Gsm_MessageList"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"HandoverFromUTRANCommand_GSM_r3_IEs$Gsm_message"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HandoverFromUTRANCommand_GSM_r3_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HandoverFromUTRANCommand_GSM_r3_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HandoverFromUTRANCommand_GSM_r3_IEs
