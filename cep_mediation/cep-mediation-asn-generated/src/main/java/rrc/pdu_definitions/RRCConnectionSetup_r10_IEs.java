...
/**
 * Define the ASN1 Type RRCConnectionSetup_r10_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RRCConnectionSetup_r10_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RRCConnectionSetup_r10_IEs()
    {
    }
     ...
     */
    public RRCConnectionSetup_r10_IEs(rrc.informationelements.ActivationTime activationTime, 
		    ...
		    rrc.informationelements.CapabilityUpdateRequirement_r8 capabilityUpdateRequirement, 
	...
	this(activationTime, new_U_RNTI, new_c_RNTI, new_H_RNTI, 
	     ...
	     defaultConfigForCellFACH, specificationMode, frequencyInfo, 
	     multi_frequencyInfo, dtx_drx_TimingInfo, dtx_drx_Info, 
	     hs_scch_LessInfo, maxAllowedUL_TX_Power, ul_DPCH_Info, 
	     ...
	     sps_Information_TDD128, mu_MIMO_Info_TDD128);
    }
    
    /**
     * Construct with required components.
     */
    public RRCConnectionSetup_r10_IEs(rrc.informationelements.U_RNTI new_U_RNTI, 
		    rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    rrc.informationelements.UTRAN_DRX_CycleLengthCoefficient_r7 utran_DRX_CycleLengthCoeff, 
		    boolean supportForChangeOfUE_Capability, 
		    SpecificationMode specificationMode)
	...
	mComponents[8] = new rrc.informationelements.CapabilityUpdateRequirement_r8();
	mComponents[9] = new BOOLEAN();
	mComponents[10] = new rrc.informationelements.DefaultConfigForCellFACH();
	mComponents[11] = new SpecificationMode();
	mComponents[12] = new rrc.informationelements.FrequencyInfo();
	mComponents[13] = new rrc.informationelements.Multi_frequencyInfo_LCR_r7();
	mComponents[14] = new rrc.informationelements.DTX_DRX_TimingInfo_r7();
	mComponents[15] = new rrc.informationelements.DTX_DRX_Info_r7();
	mComponents[16] = new rrc.informationelements.HS_SCCH_LessInfo_r7();
	mComponents[17] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[18] = new rrc.informationelements.UL_DPCH_Info_r7();
	mComponents[19] = new rrc.informationelements.UL_EDCH_Information_r9();
	mComponents[20] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
	mComponents[21] = new rrc.informationelements.DL_CommonInformation_r10();
	mComponents[22] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[23] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r10();
	mComponents[24] = new rrc.informationelements.AdditionalDLSecCellInfoListFDD();
	mComponents[25] = new rrc.informationelements.SPS_Information_TDD128_r8();
	mComponents[26] = new rrc.informationelements.MU_MIMO_Info_TDD128();
    }
	...
	switch (index) {
	    ...
	    case 8:
		return new rrc.informationelements.CapabilityUpdateRequirement_r8();
	    case 9:
		return new BOOLEAN();
	    case 10:
    ...
    public rrc.informationelements.CapabilityUpdateRequirement_r8 getCapabilityUpdateRequirement()
    {
	return (rrc.informationelements.CapabilityUpdateRequirement_r8)mComponents[8];
    }
    
    public void setCapabilityUpdateRequirement(rrc.informationelements.CapabilityUpdateRequirement_r8 capabilityUpdateRequirement)
    {
	...
	public static class Complete extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Complete(rrc.informationelements.SRB_InformationSetupList2_r8 srb_InformationSetupList, 
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new rrc.informationelements.SRB_InformationSetupList2_r8();
		mComponents[1] = new rrc.informationelements.UL_CommonTransChInfo_r4();
		mComponents[2] = new rrc.informationelements.UL_AddReconfTransChInfoList_r8();
		mComponents[3] = new rrc.informationelements.DL_CommonTransChInfo_r4();
		mComponents[4] = new rrc.informationelements.DL_AddReconfTransChInfoList_r9();
	    }
		...
		switch (index) {
		    case 0:
			return new rrc.informationelements.SRB_InformationSetupList2_r8();
		    case 1:
	    ...
	    public rrc.informationelements.SRB_InformationSetupList2_r8 getSrb_InformationSetupList()
	    {
		return (rrc.informationelements.SRB_InformationSetupList2_r8)mComponents[0];
	    }
	    
	    public void setSrb_InformationSetupList(rrc.informationelements.SRB_InformationSetupList2_r8 srb_InformationSetupList)
	    {
	    ...
	    {
		return (rrc.informationelements.UL_AddReconfTransChInfoList_r8)mComponents[2];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_AddReconfTransChInfoList_r9)mComponents[4];
	    }
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RRCConnectionSetup_r10_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "RRCConnectionSetup_r10_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"RRCConnectionSetup_r10_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RRCConnectionSetup_r10_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionSetup_r10_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.Multi_frequencyInfo_LCR_r7)mComponents[13];
    }
    
    public void setMulti_frequencyInfo(rrc.informationelements.Multi_frequencyInfo_LCR_r7 multi_frequencyInfo)
    {
	mComponents[13] = multi_frequencyInfo;
    }
    ...
    {
	return (rrc.informationelements.DTX_DRX_TimingInfo_r7)mComponents[14];
    }
    
    public void setDtx_drx_TimingInfo(rrc.informationelements.DTX_DRX_TimingInfo_r7 dtx_drx_TimingInfo)
    {
	mComponents[14] = dtx_drx_TimingInfo;
    }
    ...
    {
	return (rrc.informationelements.DTX_DRX_Info_r7)mComponents[15];
    }
    
    public void setDtx_drx_Info(rrc.informationelements.DTX_DRX_Info_r7 dtx_drx_Info)
    {
	mComponents[15] = dtx_drx_Info;
    }
    ...
    {
	return (rrc.informationelements.HS_SCCH_LessInfo_r7)mComponents[16];
    }
    
    public void setHs_scch_LessInfo(rrc.informationelements.HS_SCCH_LessInfo_r7 hs_scch_LessInfo)
    {
	mComponents[16] = hs_scch_LessInfo;
    }
    ...
    {
	return (rrc.informationelements.UL_DPCH_Info_r7)mComponents[18];
    }
    
    public void setUl_DPCH_Info(rrc.informationelements.UL_DPCH_Info_r7 ul_DPCH_Info)
    {
	mComponents[18] = ul_DPCH_Info;
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r9)mComponents[19];
    }
    
    public void setUl_EDCH_Information(rrc.informationelements.UL_EDCH_Information_r9 ul_EDCH_Information)
    {
	mComponents[19] = ul_EDCH_Information;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r10)mComponents[21];
    }
    
    public void setDl_CommonInformation(rrc.informationelements.DL_CommonInformation_r10 dl_CommonInformation)
    {
	mComponents[21] = dl_CommonInformation;
    }
    ...
    {
	return (rrc.informationelements.AdditionalDLSecCellInfoListFDD)mComponents[24];
    }
    ...
    {
	mComponents[24] = additionalDLSecCellInfoListFDD;
    }
    ...
    {
	return (rrc.informationelements.MU_MIMO_Info_TDD128)mComponents[26];
    }
    
    public void setMu_MIMO_Info_TDD128(rrc.informationelements.MU_MIMO_Info_TDD128 mu_MIMO_Info_TDD128)
    {
	mComponents[26] = mu_MIMO_Info_TDD128;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RRCConnectionSetup_r10_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RRCConnectionSetup_r10_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RRCConnectionSetup_r10_IEs
