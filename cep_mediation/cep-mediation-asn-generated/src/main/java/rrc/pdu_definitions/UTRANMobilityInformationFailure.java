...
/**
 * Define the ASN1 Type UTRANMobilityInformationFailure from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class UTRANMobilityInformationFailure extends Sequence {
    
    /**
     * The default constructor.
     */
    public UTRANMobilityInformationFailure()
    {
    }
     ...
     */
    public UTRANMobilityInformationFailure(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString utranMobilityInformationFailure_r3_add_ext, 
			NonCriticalExtensions nonCriticalExtensions)
	{
	    setUtranMobilityInformationFailure_r3_add_ext(utranMobilityInformationFailure_r3_add_ext);
	...
	// Methods for field "utranMobilityInformationFailure_r3_add_ext"
	public BitString getUtranMobilityInformationFailure_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setUtranMobilityInformationFailure_r3_add_ext(BitString utranMobilityInformationFailure_r3_add_ext)
	{
	    mComponents[0] = utranMobilityInformationFailure_r3_add_ext;
	}
	
	public boolean hasUtranMobilityInformationFailure_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteUtranMobilityInformationFailure_r3_add_ext()
	{
	...
	public static class NonCriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "UTRANMobilityInformationFailure$LaterNCEs$NonCriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"UTRANMobilityInformationFailure$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UTRANMobilityInformationFailure object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UTRANMobilityInformationFailure object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UTRANMobilityInformationFailure
