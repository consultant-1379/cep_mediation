...
/**
 * Define the ASN1 Type PhysicalChannelReconfigurationFailure from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class PhysicalChannelReconfigurationFailure extends Sequence {
    
    /**
     * The default constructor.
     */
    public PhysicalChannelReconfigurationFailure()
    {
    }
     ...
     */
    public PhysicalChannelReconfigurationFailure(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
     ...
     */
    public PhysicalChannelReconfigurationFailure(rrc.informationelements.FailureCauseWithProtErr failureCause)
    {
	setFailureCause(failureCause);
    }
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString physicalChannelReconfigurationFailure_r3_add_ext, 
			NonCriticalExtensions nonCriticalExtensions)
	{
	    setPhysicalChannelReconfigurationFailure_r3_add_ext(physicalChannelReconfigurationFailure_r3_add_ext);
	...
	// Methods for field "physicalChannelReconfigurationFailure_r3_add_ext"
	public BitString getPhysicalChannelReconfigurationFailure_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setPhysicalChannelReconfigurationFailure_r3_add_ext(BitString physicalChannelReconfigurationFailure_r3_add_ext)
	{
	    mComponents[0] = physicalChannelReconfigurationFailure_r3_add_ext;
	}
	
	public boolean hasPhysicalChannelReconfigurationFailure_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deletePhysicalChannelReconfigurationFailure_r3_add_ext()
	{
	    setComponentAbsent(0);
	}
	...
	public static class NonCriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "PhysicalChannelReconfigurationFailure$LaterNCEs$NonCriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"PhysicalChannelReconfigurationFailure$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PhysicalChannelReconfigurationFailure object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PhysicalChannelReconfigurationFailure object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PhysicalChannelReconfigurationFailure
