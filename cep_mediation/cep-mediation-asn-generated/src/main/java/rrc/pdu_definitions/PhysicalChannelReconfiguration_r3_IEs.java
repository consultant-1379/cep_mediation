...
/**
 * Define the ASN1 Type PhysicalChannelReconfiguration_r3_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class PhysicalChannelReconfiguration_r3_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public PhysicalChannelReconfiguration_r3_IEs()
    {
    }
     ...
     */
    public PhysicalChannelReconfiguration_r3_IEs(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
		    ...
		    rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID ul_ChannelRequirement, 
	...
	mComponents[13] = new rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID();
	mComponents[14] = new ModeSpecificInfo();
	mComponents[15] = new rrc.informationelements.DL_CommonInformation();
	mComponents[16] = new rrc.informationelements.DL_InformationPerRL_List();
    }
	...
	switch (index) {
	    ...
	    case 13:
		return new rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID();
	    case 14:
    ...
    public rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID getUl_ChannelRequirement()
    {
	return (rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID)mComponents[13];
    }
    
    public void setUl_ChannelRequirement(rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID ul_ChannelRequirement)
    {
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "PhysicalChannelReconfiguration_r3_IEs$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"PhysicalChannelReconfiguration_r3_IEs$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation)mComponents[15];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List)mComponents[16];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r3_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r3_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PhysicalChannelReconfiguration_r3_IEs
