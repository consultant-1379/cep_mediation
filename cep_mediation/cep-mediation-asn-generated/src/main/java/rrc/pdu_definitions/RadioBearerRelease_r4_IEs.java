...
/**
 * Define the ASN1 Type RadioBearerRelease_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerRelease_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerRelease_r4_IEs()
    {
    }
     ...
     */
    public RadioBearerRelease_r4_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerRelease_r4_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    rrc.informationelements.RB_InformationReleaseList rb_InformationReleaseList, 
		    ModeSpecificPhysChInfo modeSpecificPhysChInfo)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	...
	mComponents[21] = new rrc.informationelements.DL_AddReconfTransChInfoList_r4();
	mComponents[22] = new rrc.informationelements.FrequencyInfo();
	mComponents[23] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[24] = new rrc.informationelements.UL_ChannelRequirement_r4();
	mComponents[25] = new ModeSpecificPhysChInfo();
	mComponents[26] = new rrc.informationelements.DL_CommonInformation_r4();
	mComponents[27] = new rrc.informationelements.DL_InformationPerRL_List_r4();
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerRelease_r4_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerRelease_r4_IEs$Dummy"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r4)mComponents[21];
    }
    ...
    {
	return (rrc.informationelements.UL_ChannelRequirement_r4)mComponents[24];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerRelease_r4_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerRelease_r4_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r4)mComponents[26];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r4)mComponents[27];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerRelease_r4_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerRelease_r4_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerRelease_r4_IEs
