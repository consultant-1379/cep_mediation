...
/**
 * Define the ASN1 Type URAUpdate_va40ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class URAUpdate_va40ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public URAUpdate_va40ext_IEs()
    {
    }
     ...
     */
    public URAUpdate_va40ext_IEs(LoggedMeasAvailable loggedMeasAvailable, 
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"URAUpdate_va40ext_IEs$LoggedMeasAvailable"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"URAUpdate_va40ext_IEs$LoggedANRResultsAvailable"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' URAUpdate_va40ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' URAUpdate_va40ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for URAUpdate_va40ext_IEs
