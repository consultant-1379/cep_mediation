...
/**
 * Define the ASN1 Type MeasurementControl_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class MeasurementControl_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public MeasurementControl_r4_IEs()
    {
    }
     ...
     */
    public MeasurementControl_r4_IEs(rrc.informationelements.MeasurementIdentity measurementIdentity, 
		    rrc.informationelements.MeasurementCommand_r4 measurementCommand, 
	...
	mComponents[1] = new rrc.informationelements.MeasurementCommand_r4();
	...
	switch (index) {
	    ...
	    case 1:
		return new rrc.informationelements.MeasurementCommand_r4();
	    case 2:
    ...
    public rrc.informationelements.MeasurementCommand_r4 getMeasurementCommand()
    {
	return (rrc.informationelements.MeasurementCommand_r4)mComponents[1];
    }
    
    public void setMeasurementCommand(rrc.informationelements.MeasurementCommand_r4 measurementCommand)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementControl_r4_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementControl_r4_IEs object.
     */
...
} // End class definition for MeasurementControl_r4_IEs
