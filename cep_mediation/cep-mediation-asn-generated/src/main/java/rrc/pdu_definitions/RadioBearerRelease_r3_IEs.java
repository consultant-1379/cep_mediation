...
/**
 * Define the ASN1 Type RadioBearerRelease_r3_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerRelease_r3_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerRelease_r3_IEs()
    {
    }
     ...
     */
    public RadioBearerRelease_r3_IEs(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
		    ...
		    rrc.informationelements.DL_AddReconfTransChInfo2List dl_AddReconfTransChInfoList, 
	...
	mComponents[9] = rrc.informationelements.CN_DomainIdentity.cs_domain;
	mComponents[10] = new rrc.informationelements.URA_Identity();
	mComponents[11] = new rrc.informationelements.RAB_InformationReconfigList();
	mComponents[12] = new rrc.informationelements.RB_InformationReleaseList();
	mComponents[13] = new rrc.informationelements.RB_InformationAffectedList();
	mComponents[14] = new rrc.informationelements.DL_CounterSynchronisationInfo();
	mComponents[15] = new rrc.informationelements.UL_CommonTransChInfo();
	...
	mComponents[19] = new rrc.informationelements.DL_CommonTransChInfo();
	mComponents[20] = new rrc.informationelements.DL_DeletedTransChInfoList();
	mComponents[21] = new rrc.informationelements.DL_AddReconfTransChInfo2List();
	mComponents[22] = new rrc.informationelements.FrequencyInfo();
	mComponents[23] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[24] = new rrc.informationelements.UL_ChannelRequirement();
	mComponents[25] = new ModeSpecificPhysChInfo();
	mComponents[26] = new rrc.informationelements.DL_CommonInformation();
	mComponents[27] = new rrc.informationelements.DL_InformationPerRL_List();
    }
	...
	switch (index) {
	    ...
	    case 21:
		return new rrc.informationelements.DL_AddReconfTransChInfo2List();
	    case 22:
    ...
    {
	return (rrc.informationelements.CN_DomainIdentity)mComponents[9];
    }
    ...
    {
	mComponents[9] = signallingConnectionRelIndication;
    }
    ...
    {
	return (rrc.informationelements.RAB_InformationReconfigList)mComponents[11];
    }
    ...
    {
	mComponents[11] = rab_InformationReconfigList;
    }
    ...
    {
	return (rrc.informationelements.RB_InformationAffectedList)mComponents[13];
    }
    ...
    {
	return (rrc.informationelements.DL_CounterSynchronisationInfo)mComponents[14];
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo)mComponents[15];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerRelease_r3_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerRelease_r3_IEs$Dummy"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo)mComponents[19];
    }
    ...
    {
	return (rrc.informationelements.DL_DeletedTransChInfoList)mComponents[20];
    }
    ...
    public rrc.informationelements.DL_AddReconfTransChInfo2List getDl_AddReconfTransChInfoList()
    {
	return (rrc.informationelements.DL_AddReconfTransChInfo2List)mComponents[21];
    }
    
    public void setDl_AddReconfTransChInfoList(rrc.informationelements.DL_AddReconfTransChInfo2List dl_AddReconfTransChInfoList)
    {
    ...
    {
	return (rrc.informationelements.UL_ChannelRequirement)mComponents[24];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerRelease_r3_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerRelease_r3_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation)mComponents[26];
    }
    
    public void setDl_CommonInformation(rrc.informationelements.DL_CommonInformation dl_CommonInformation)
    {
	mComponents[26] = dl_CommonInformation;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerRelease_r3_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerRelease_r3_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerRelease_r3_IEs
