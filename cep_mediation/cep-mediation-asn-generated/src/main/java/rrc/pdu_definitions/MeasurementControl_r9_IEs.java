...
/**
 * Define the ASN1 Type MeasurementControl_r9_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class MeasurementControl_r9_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public MeasurementControl_r9_IEs()
    {
    }
     ...
     */
    public MeasurementControl_r9_IEs(rrc.informationelements.MeasurementIdentity measurementIdentity, 
		    rrc.informationelements.MeasurementCommand_r9 measurementCommand, 
	...
	mComponents[1] = new rrc.informationelements.MeasurementCommand_r9();
	...
	switch (index) {
	    ...
	    case 1:
		return new rrc.informationelements.MeasurementCommand_r9();
	    case 2:
    ...
    public rrc.informationelements.MeasurementCommand_r9 getMeasurementCommand()
    {
	return (rrc.informationelements.MeasurementCommand_r9)mComponents[1];
    }
    
    public void setMeasurementCommand(rrc.informationelements.MeasurementCommand_r9 measurementCommand)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementControl_r9_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementControl_r9_IEs object.
     */
...
} // End class definition for MeasurementControl_r9_IEs
