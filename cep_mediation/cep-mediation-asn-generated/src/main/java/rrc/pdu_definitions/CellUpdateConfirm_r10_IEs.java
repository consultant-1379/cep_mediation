...
/**
 * Define the ASN1 Type CellUpdateConfirm_r10_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class CellUpdateConfirm_r10_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellUpdateConfirm_r10_IEs()
    {
    }
     ...
     */
    public CellUpdateConfirm_r10_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
		    ...
		    rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128 ul_MulticarrierEDCHInfo_TDD128, 
		    rrc.informationelements.DL_HSPDSCH_Information_r9 dl_HSPDSCH_Information, 
		    rrc.informationelements.DL_CommonInformation_r10 dl_CommonInformation, 
		    ...
		    rrc.informationelements.MU_MIMO_Info_TDD128 mu_MIMO_Info_TDD128, 
	...
	setUl_MulticarrierEDCHInfo_TDD128(ul_MulticarrierEDCHInfo_TDD128);
	...
	setMu_MIMO_Info_TDD128(mu_MIMO_Info_TDD128);
	...
	this(integrityProtectionModeInfo, cipheringModeInfo, sr_vcc_Info, 
	     ...
	     ul_DPCH_Info, ul_EDCH_Information, ul_SecondaryCellInfoFDD, 
	     ul_MulticarrierEDCHInfo_TDD128, dl_HSPDSCH_Information, 
	     dl_CommonInformation, dl_InformationPerRL_List, 
	     dl_SecondaryCellInfoFDD, additionalDLSecCellInfoListFDD, 
	     controlChannelDRXInfo_TDD128, sps_Information_TDD128, 
	     mu_MIMO_Info_TDD128, mbms_PL_ServiceRestrictInfo, 
     ...
     */
    public CellUpdateConfirm_r10_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    boolean rlc_Re_establishIndicatorRb2_3or4, 
		    boolean rlc_Re_establishIndicatorRb5orAbove)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	...
	mComponents[12] = new rrc.informationelements.WaitTime();
	mComponents[13] = new BOOLEAN();
	mComponents[14] = new BOOLEAN();
	mComponents[15] = new rrc.informationelements.CN_InformationInfo_r6();
	mComponents[16] = new rrc.informationelements.URA_Identity();
	mComponents[17] = new BOOLEAN();
	mComponents[18] = new rrc.informationelements.DefaultConfigForCellFACH();
	mComponents[19] = new rrc.informationelements.RAB_InformationSetup_r8();
	mComponents[20] = new rrc.informationelements.RB_InformationReleaseList();
	mComponents[21] = new rrc.informationelements.RB_InformationReconfigList_r8();
	mComponents[22] = new rrc.informationelements.RB_InformationAffectedList_r8();
	mComponents[23] = new rrc.informationelements.DL_CounterSynchronisationInfo_r5();
	mComponents[24] = rrc.informationelements.PDCP_ROHC_TargetMode.o_Mode;
	mComponents[25] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	mComponents[26] = new rrc.informationelements.UL_DeletedTransChInfoList_r6();
	mComponents[27] = new rrc.informationelements.UL_AddReconfTransChInfoList_r8();
	mComponents[28] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[29] = new rrc.informationelements.DL_DeletedTransChInfoList_r7();
	mComponents[30] = new rrc.informationelements.DL_AddReconfTransChInfoList_r9();
	mComponents[31] = new rrc.informationelements.FrequencyInfo();
	mComponents[32] = new rrc.informationelements.Multi_frequencyInfo_LCR_r7();
	mComponents[33] = new rrc.informationelements.DTX_DRX_TimingInfo_r7();
	mComponents[34] = new rrc.informationelements.DTX_DRX_Info_r7();
	mComponents[35] = new rrc.informationelements.HS_SCCH_LessInfo_r7();
	mComponents[36] = new rrc.informationelements.MIMO_Parameters_r9();
	mComponents[37] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[38] = new rrc.informationelements.UL_DPCH_Info_r7();
	mComponents[39] = new rrc.informationelements.UL_EDCH_Information_r9();
	mComponents[40] = new rrc.informationelements.UL_SecondaryCellInfoFDD();
	mComponents[41] = new rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128();
	mComponents[42] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
	mComponents[43] = new rrc.informationelements.DL_CommonInformation_r10();
	mComponents[44] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[45] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r10();
	mComponents[46] = new rrc.informationelements.AdditionalDLSecCellInfoListFDD();
	mComponents[47] = new rrc.informationelements.ControlChannelDRXInfo_TDD128_r8();
	mComponents[48] = new rrc.informationelements.SPS_Information_TDD128_r8();
	mComponents[49] = new rrc.informationelements.MU_MIMO_Info_TDD128();
	mComponents[50] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
	mComponents[51] = new rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[52];
    }
	...
	switch (index) {
	    ...
	    case 41:
		return new rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128();
	    case 42:
		return new rrc.informationelements.DL_HSPDSCH_Information_r9();
	    case 43:
		return new rrc.informationelements.DL_CommonInformation_r10();
	    case 44:
	    ...
	    case 49:
		return new rrc.informationelements.MU_MIMO_Info_TDD128();
	    case 50:
    ...
    {
	return (rrc.informationelements.WaitTime)mComponents[12];
    }
    
    public void setWaitTime(rrc.informationelements.WaitTime waitTime)
    {
	mComponents[12] = waitTime;
    }
    ...
    public void setRlc_Re_establishIndicatorRb2_3or4(BOOLEAN rlc_Re_establishIndicatorRb2_3or4)
    {
	mComponents[13] = rlc_Re_establishIndicatorRb2_3or4;
    }
    ...
    public void setRlc_Re_establishIndicatorRb5orAbove(BOOLEAN rlc_Re_establishIndicatorRb5orAbove)
    {
	mComponents[14] = rlc_Re_establishIndicatorRb5orAbove;
    }
    ...
    {
	return (rrc.informationelements.CN_InformationInfo_r6)mComponents[15];
    }
    
    public void setCn_InformationInfo(rrc.informationelements.CN_InformationInfo_r6 cn_InformationInfo)
    {
	mComponents[15] = cn_InformationInfo;
    }
    ...
    {
	return (rrc.informationelements.URA_Identity)mComponents[16];
    }
    
    public void setUra_Identity(rrc.informationelements.URA_Identity ura_Identity)
    {
	mComponents[16] = ura_Identity;
    }
    ...
    {
	return ((BOOLEAN)mComponents[17]).booleanValue();
    }
    ...
    public void setSupportForChangeOfUE_Capability(BOOLEAN supportForChangeOfUE_Capability)
    {
	mComponents[17] = supportForChangeOfUE_Capability;
    }
    ...
    {
	return (rrc.informationelements.RAB_InformationSetup_r8)mComponents[19];
    }
    
    public void setRab_InformationSetup(rrc.informationelements.RAB_InformationSetup_r8 rab_InformationSetup)
    {
	mComponents[19] = rab_InformationSetup;
    }
    ...
    {
	return (rrc.informationelements.RB_InformationReconfigList_r8)mComponents[21];
    }
    ...
    {
	mComponents[21] = rb_InformationReconfigList;
    }
    ...
    {
	return (rrc.informationelements.RB_InformationAffectedList_r8)mComponents[22];
    }
    ...
    {
	mComponents[22] = rb_InformationAffectedList;
    }
    ...
    {
	return (rrc.informationelements.DL_CounterSynchronisationInfo_r5)mComponents[23];
    }
    ...
    {
	mComponents[23] = dl_CounterSynchronisationInfo;
    }
    ...
    {
	return (rrc.informationelements.PDCP_ROHC_TargetMode)mComponents[24];
    }
    
    public void setPdcp_ROHC_TargetMode(rrc.informationelements.PDCP_ROHC_TargetMode pdcp_ROHC_TargetMode)
    {
	mComponents[24] = pdcp_ROHC_TargetMode;
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[25];
    }
    
    public void setUl_CommonTransChInfo(rrc.informationelements.UL_CommonTransChInfo_r4 ul_CommonTransChInfo)
    {
	mComponents[25] = ul_CommonTransChInfo;
    }
    ...
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList_r8)mComponents[27];
    }
    ...
    {
	mComponents[27] = ul_AddReconfTransChInfoList;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo_r4)mComponents[28];
    }
    
    public void setDl_CommonTransChInfo(rrc.informationelements.DL_CommonTransChInfo_r4 dl_CommonTransChInfo)
    {
	mComponents[28] = dl_CommonTransChInfo;
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r9)mComponents[30];
    }
    ...
    {
	mComponents[30] = dl_AddReconfTransChInfoList;
    }
    ...
    {
	return (rrc.informationelements.FrequencyInfo)mComponents[31];
    }
    
    public void setFrequencyInfo(rrc.informationelements.FrequencyInfo frequencyInfo)
    {
	mComponents[31] = frequencyInfo;
    }
    ...
    {
	return (rrc.informationelements.Multi_frequencyInfo_LCR_r7)mComponents[32];
    }
    
    public void setMulti_frequencyInfo(rrc.informationelements.Multi_frequencyInfo_LCR_r7 multi_frequencyInfo)
    {
	mComponents[32] = multi_frequencyInfo;
    }
    ...
    {
	return (rrc.informationelements.DTX_DRX_TimingInfo_r7)mComponents[33];
    }
    
    public void setDtx_drx_TimingInfo(rrc.informationelements.DTX_DRX_TimingInfo_r7 dtx_drx_TimingInfo)
    {
	mComponents[33] = dtx_drx_TimingInfo;
    }
    ...
    {
	return (rrc.informationelements.DTX_DRX_Info_r7)mComponents[34];
    }
    
    public void setDtx_drx_Info(rrc.informationelements.DTX_DRX_Info_r7 dtx_drx_Info)
    {
	mComponents[34] = dtx_drx_Info;
    }
    ...
    {
	return (rrc.informationelements.HS_SCCH_LessInfo_r7)mComponents[35];
    }
    
    public void setHs_scch_LessInfo(rrc.informationelements.HS_SCCH_LessInfo_r7 hs_scch_LessInfo)
    {
	mComponents[35] = hs_scch_LessInfo;
    }
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r9)mComponents[36];
    }
    
    public void setMimoParameters(rrc.informationelements.MIMO_Parameters_r9 mimoParameters)
    {
	mComponents[36] = mimoParameters;
    }
    ...
    {
	return (rrc.informationelements.UL_DPCH_Info_r7)mComponents[38];
    }
    
    public void setUl_DPCH_Info(rrc.informationelements.UL_DPCH_Info_r7 ul_DPCH_Info)
    {
	mComponents[38] = ul_DPCH_Info;
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r9)mComponents[39];
    }
    
    public void setUl_EDCH_Information(rrc.informationelements.UL_EDCH_Information_r9 ul_EDCH_Information)
    {
	mComponents[39] = ul_EDCH_Information;
    }
    ...
    // Methods for field "ul_MulticarrierEDCHInfo_TDD128"
    public rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128 getUl_MulticarrierEDCHInfo_TDD128()
    {
	return (rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128)mComponents[41];
    }
    
    public void setUl_MulticarrierEDCHInfo_TDD128(rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128 ul_MulticarrierEDCHInfo_TDD128)
    {
	mComponents[41] = ul_MulticarrierEDCHInfo_TDD128;
    }
    
    public boolean hasUl_MulticarrierEDCHInfo_TDD128()
    {
	return componentIsPresent(41);
    }
    
    public void deleteUl_MulticarrierEDCHInfo_TDD128()
    {
    ...
    public rrc.informationelements.DL_CommonInformation_r10 getDl_CommonInformation()
    {
	return (rrc.informationelements.DL_CommonInformation_r10)mComponents[43];
    }
    
    public void setDl_CommonInformation(rrc.informationelements.DL_CommonInformation_r10 dl_CommonInformation)
    {
	mComponents[43] = dl_CommonInformation;
    }
    ...
    {
	return (rrc.informationelements.AdditionalDLSecCellInfoListFDD)mComponents[46];
    }
    ...
    {
	mComponents[46] = additionalDLSecCellInfoListFDD;
    }
    ...
    {
	return (rrc.informationelements.ControlChannelDRXInfo_TDD128_r8)mComponents[47];
    }
    ...
    {
	mComponents[47] = controlChannelDRXInfo_TDD128;
    }
    ...
    // Methods for field "mu_MIMO_Info_TDD128"
    public rrc.informationelements.MU_MIMO_Info_TDD128 getMu_MIMO_Info_TDD128()
    {
	return (rrc.informationelements.MU_MIMO_Info_TDD128)mComponents[49];
    }
    
    public void setMu_MIMO_Info_TDD128(rrc.informationelements.MU_MIMO_Info_TDD128 mu_MIMO_Info_TDD128)
    {
	mComponents[49] = mu_MIMO_Info_TDD128;
    }
    
    public boolean hasMu_MIMO_Info_TDD128()
    {
	return componentIsPresent(49);
    }
    
    public void deleteMu_MIMO_Info_TDD128()
    {
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[50];
    }
    ...
    {
	mComponents[50] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    {
	return (rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9)mComponents[51];
    }
    ...
    {
	mComponents[51] = cellDCHMeasOccasionInfo_TDD128;
    }
	...
	new TagDecoders (
		...
		new TagDecoder (
			...
			new TagDecoderElement((short)0x802e, 46),
			new TagDecoderElement((short)0x802f, 47),
			new TagDecoderElement((short)0x8030, 48),
			new TagDecoderElement((short)0x8031, 49),
			new TagDecoderElement((short)0x8032, 50),
			new TagDecoderElement((short)0x8033, 51)
		    }
		),
		new TagDecoder (
		    new TagDecoderElement[] {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellUpdateConfirm_r10_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellUpdateConfirm_r10_IEs object.
     */
...
} // End class definition for CellUpdateConfirm_r10_IEs
