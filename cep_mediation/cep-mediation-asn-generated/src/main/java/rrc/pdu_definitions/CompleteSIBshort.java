...
/**
 * Define the ASN1 Type CompleteSIBshort from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class CompleteSIBshort extends Sequence {
    
    /**
     * The default constructor.
     */
    public CompleteSIBshort()
    {
    }
     ...
     */
    public CompleteSIBshort(rrc.informationelements.SIB_Type sib_Type, 
	...
	mComponents[1] = new rrc.informationelements.SIB_Data_variable();
    }
    ...
    {
	return (rrc.informationelements.SIB_Data_variable)mComponents[1];
    }
    
    public void setSib_Data_variable(rrc.informationelements.SIB_Data_variable sib_Data_variable)
    {
	mComponents[1] = sib_Data_variable;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CompleteSIBshort object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CompleteSIBshort object.
     */
...
} // End class definition for CompleteSIBshort
