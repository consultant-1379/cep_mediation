...
/**
 * Define the ASN1 Type RadioBearerRelease_r7_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerRelease_r7_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerRelease_r7_IEs()
    {
    }
     ...
     */
    public RadioBearerRelease_r7_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerRelease_r7_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    rrc.informationelements.RB_InformationReleaseList rb_InformationReleaseList)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setRb_InformationReleaseList(rb_InformationReleaseList);
	...
	mComponents[16] = new rrc.informationelements.RAB_InformationReconfigList();
	mComponents[17] = new rrc.informationelements.RB_InformationReleaseList();
	mComponents[18] = new rrc.informationelements.RB_InformationReconfigList_r7();
	mComponents[19] = new rrc.informationelements.RB_InformationAffectedList_r7();
	...
	mComponents[23] = new rrc.informationelements.UL_AddReconfTransChInfoList_r7();
	...
	mComponents[32] = new rrc.informationelements.MIMO_Parameters_r7();
	...
	mComponents[35] = new rrc.informationelements.UL_EDCH_Information_r7();
	mComponents[36] = new rrc.informationelements.DL_HSPDSCH_Information_r7();
	mComponents[37] = new rrc.informationelements.DL_CommonInformation_r7();
	mComponents[38] = new rrc.informationelements.DL_InformationPerRL_List_r7();
	mComponents[39] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
	mComponents[40] = new rrc.informationelements.RB_InformationReleaseList();
    }
    ...
    {
	return (rrc.informationelements.RAB_InformationReconfigList)mComponents[16];
    }
    ...
    {
	return (rrc.informationelements.RB_InformationReconfigList_r7)mComponents[18];
    }
    ...
    {
	return (rrc.informationelements.RB_InformationAffectedList_r7)mComponents[19];
    }
    ...
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList_r7)mComponents[23];
    }
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r7)mComponents[32];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r7)mComponents[35];
    }
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r7)mComponents[36];
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r7)mComponents[37];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r7)mComponents[38];
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[39];
    }
    ...
    {
	mComponents[39] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    {
	return (rrc.informationelements.RB_InformationReleaseList)mComponents[40];
    }
    ...
    {
	mComponents[40] = mbms_RB_ListReleasedToChangeTransferMode;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerRelease_r7_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerRelease_r7_IEs object.
     */
...
} // End class definition for RadioBearerRelease_r7_IEs
