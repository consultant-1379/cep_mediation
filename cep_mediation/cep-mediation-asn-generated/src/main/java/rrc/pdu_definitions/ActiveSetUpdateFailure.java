...
/**
 * Define the ASN1 Type ActiveSetUpdateFailure from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class ActiveSetUpdateFailure extends Sequence {
    
    /**
     * The default constructor.
     */
    public ActiveSetUpdateFailure()
    {
    }
     ...
     */
    public ActiveSetUpdateFailure(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString activeSetUpdateFailure_r3_add_ext, 
			NonCriticalExtensions nonCriticalExtensions)
	{
	    setActiveSetUpdateFailure_r3_add_ext(activeSetUpdateFailure_r3_add_ext);
	...
	// Methods for field "activeSetUpdateFailure_r3_add_ext"
	public BitString getActiveSetUpdateFailure_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setActiveSetUpdateFailure_r3_add_ext(BitString activeSetUpdateFailure_r3_add_ext)
	{
	    mComponents[0] = activeSetUpdateFailure_r3_add_ext;
	}
	
	public boolean hasActiveSetUpdateFailure_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteActiveSetUpdateFailure_r3_add_ext()
	{
	...
	public static class NonCriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "ActiveSetUpdateFailure$LaterNCEs$NonCriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"ActiveSetUpdateFailure$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' ActiveSetUpdateFailure object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' ActiveSetUpdateFailure object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for ActiveSetUpdateFailure
