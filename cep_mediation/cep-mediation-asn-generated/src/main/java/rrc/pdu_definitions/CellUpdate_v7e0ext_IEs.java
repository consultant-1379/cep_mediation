...
/**
 * Define the ASN1 Type CellUpdate_v7e0ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class CellUpdate_v7e0ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellUpdate_v7e0ext_IEs()
    {
    }
     ...
     */
    public CellUpdate_v7e0ext_IEs(SupportForTwoDRXSchemesInPCH supportForTwoDRXSchemesInPCH)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"CellUpdate_v7e0ext_IEs$SupportForTwoDRXSchemesInPCH"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellUpdate_v7e0ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellUpdate_v7e0ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellUpdate_v7e0ext_IEs
