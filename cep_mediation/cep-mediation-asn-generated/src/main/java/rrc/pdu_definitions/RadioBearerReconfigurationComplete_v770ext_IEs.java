...
/**
 * Define the ASN1 Type RadioBearerReconfigurationComplete_v770ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerReconfigurationComplete_v770ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerReconfigurationComplete_v770ext_IEs()
    {
    }
     ...
     */
    public RadioBearerReconfigurationComplete_v770ext_IEs(rrc.informationelements.EXT_UL_TimingAdvance ext_UL_TimingAdvance, 
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfigurationComplete_v770ext_IEs$DeferredMeasurementControlReading"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerReconfigurationComplete_v770ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerReconfigurationComplete_v770ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerReconfigurationComplete_v770ext_IEs
