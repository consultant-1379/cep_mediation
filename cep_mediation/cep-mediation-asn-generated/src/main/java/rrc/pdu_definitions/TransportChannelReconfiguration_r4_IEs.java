...
/**
 * Define the ASN1 Type TransportChannelReconfiguration_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class TransportChannelReconfiguration_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public TransportChannelReconfiguration_r4_IEs()
    {
    }
     ...
     */
    public TransportChannelReconfiguration_r4_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
     ...
     */
    public TransportChannelReconfiguration_r4_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    ModeSpecificPhysChInfo modeSpecificPhysChInfo)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setModeSpecificPhysChInfo(modeSpecificPhysChInfo);
	...
	mComponents[11] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	mComponents[12] = new rrc.informationelements.UL_AddReconfTransChInfoList();
	mComponents[13] = new Dummy();
	mComponents[14] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[15] = new rrc.informationelements.DL_AddReconfTransChInfoList_r4();
	mComponents[16] = new rrc.informationelements.FrequencyInfo();
	mComponents[17] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[18] = new rrc.informationelements.UL_ChannelRequirement_r4();
	mComponents[19] = new ModeSpecificPhysChInfo();
	mComponents[20] = new rrc.informationelements.DL_CommonInformation_r4();
	mComponents[21] = new rrc.informationelements.DL_InformationPerRL_List_r4();
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[11];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "TransportChannelReconfiguration_r4_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfiguration_r4_IEs$Dummy"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo_r4)mComponents[14];
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r4)mComponents[15];
    }
    ...
    {
	return (rrc.informationelements.UL_ChannelRequirement_r4)mComponents[18];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "TransportChannelReconfiguration_r4_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfiguration_r4_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r4)mComponents[20];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r4)mComponents[21];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r4_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r4_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TransportChannelReconfiguration_r4_IEs
