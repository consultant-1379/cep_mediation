...
/**
 * Define the ASN1 Type URAUpdateConfirm_CCCH from ASN1 Module PDU_definitions.
 * @see Choice
 */

public class URAUpdateConfirm_CCCH extends Choice {
    
    /**
     * The default constructor.
     */
    public URAUpdateConfirm_CCCH()
    {
    }
    ...
    public static URAUpdateConfirm_CCCH createURAUpdateConfirm_CCCHWithR3(R3 r3)
    {
	URAUpdateConfirm_CCCH __object = new URAUpdateConfirm_CCCH();
	 ...
	 */
	public R3(URAUpdateConfirm_CCCH_r3_IEs uraUpdateConfirm_CCCH_r3, 
			LaterNCEs laterNCEs)
	{
	    setUraUpdateConfirm_CCCH_r3(uraUpdateConfirm_CCCH_r3);
	...
	{
	    mComponents[0] = new URAUpdateConfirm_CCCH_r3_IEs();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new URAUpdateConfirm_CCCH_r3_IEs();
		case 1:
	...
	// Methods for field "uraUpdateConfirm_CCCH_r3"
	public URAUpdateConfirm_CCCH_r3_IEs getUraUpdateConfirm_CCCH_r3()
	{
	    return (URAUpdateConfirm_CCCH_r3_IEs)mComponents[0];
	}
	
	public void setUraUpdateConfirm_CCCH_r3(URAUpdateConfirm_CCCH_r3_IEs uraUpdateConfirm_CCCH_r3)
	{
	    mComponents[0] = uraUpdateConfirm_CCCH_r3;
	}
	...
	public static class LaterNCEs extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public LaterNCEs(BitString uraUpdateConfirm_CCCH_r3_add_ext, 
			    V690NCEs v690NCEs)
	    {
		setUraUpdateConfirm_CCCH_r3_add_ext(uraUpdateConfirm_CCCH_r3_add_ext);
	    ...
	    // Methods for field "uraUpdateConfirm_CCCH_r3_add_ext"
	    public BitString getUraUpdateConfirm_CCCH_r3_add_ext()
	    {
		return (BitString)mComponents[0];
	    }
	    
	    public void setUraUpdateConfirm_CCCH_r3_add_ext(BitString uraUpdateConfirm_CCCH_r3_add_ext)
	    {
		mComponents[0] = uraUpdateConfirm_CCCH_r3_add_ext;
	    }
	    
	    public boolean hasUraUpdateConfirm_CCCH_r3_add_ext()
	    {
		return componentIsPresent(0);
	    }
	    
	    public void deleteUraUpdateConfirm_CCCH_r3_add_ext()
	    {
		...
		public static class V860NCEs extends Sequence {
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"URAUpdateConfirm_CCCH$R3$LaterNCEs$V690NCEs$V860NCEs$NonCriticalExtensions"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			new QName (
			    "rrc.pdu_definitions",
			    "URAUpdateConfirm_CCCH$R3$LaterNCEs$V690NCEs$V860NCEs"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"URAUpdateConfirm_CCCH$R3$LaterNCEs$V690NCEs"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "URAUpdateConfirm_CCCH$R3$LaterNCEs"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    public static URAUpdateConfirm_CCCH createURAUpdateConfirm_CCCHWithLater_than_r3(Later_than_r3 later_than_r3)
    {
	URAUpdateConfirm_CCCH __object = new URAUpdateConfirm_CCCH();
	...
	public static class CriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "URAUpdateConfirm_CCCH$Later_than_r3$CriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"URAUpdateConfirm_CCCH$Later_than_r3"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' URAUpdateConfirm_CCCH object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' URAUpdateConfirm_CCCH object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for URAUpdateConfirm_CCCH
