...
/**
 * Define the ASN1 Type PhysicalChannelReconfiguration_r9_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class PhysicalChannelReconfiguration_r9_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public PhysicalChannelReconfiguration_r9_IEs()
    {
    }
     ...
     */
    public PhysicalChannelReconfiguration_r9_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public PhysicalChannelReconfiguration_r9_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
    }
	...
	mComponents[31] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
	mComponents[32] = new rrc.informationelements.DL_CommonInformation_r8();
	mComponents[33] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[34] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r9();
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"PhysicalChannelReconfiguration_r9_IEs$ResponseToChangeOfUE_Capability"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r9)mComponents[31];
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r8)mComponents[32];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r8)mComponents[33];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r9_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r9_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PhysicalChannelReconfiguration_r9_IEs
