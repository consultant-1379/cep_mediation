...
/**
 * Define the ASN1 Type URAUpdateConfirm_r5_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class URAUpdateConfirm_r5_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public URAUpdateConfirm_r5_IEs()
    {
    }
     ...
     */
    public URAUpdateConfirm_r5_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
     ...
     */
    public URAUpdateConfirm_r5_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
    }
	...
	mComponents[5] = new rrc.informationelements.UTRAN_DRX_CycleLengthCoefficient();
	mComponents[6] = new rrc.informationelements.CN_InformationInfo();
	mComponents[7] = new rrc.informationelements.URA_Identity();
	mComponents[8] = new rrc.informationelements.DL_CounterSynchronisationInfo_r5();
    }
    ...
    {
	return (rrc.informationelements.UTRAN_DRX_CycleLengthCoefficient)mComponents[5];
    }
    ...
    {
	return (rrc.informationelements.DL_CounterSynchronisationInfo_r5)mComponents[8];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' URAUpdateConfirm_r5_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' URAUpdateConfirm_r5_IEs object.
     */
...
} // End class definition for URAUpdateConfirm_r5_IEs
