...
/**
 * Define the ASN1 Type RadioBearerSetup_r7_add_ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerSetup_r7_add_ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerSetup_r7_add_ext_IEs()
    {
    }
     ...
     */
    public RadioBearerSetup_r7_add_ext_IEs(RadioBearerSetup_v7d0ext_IEs radioBearerSetup_v7d0ext, 
		    V7f0NCEs v7f0NCEs)
    {
    ...
    public boolean hasRadioBearerSetup_v7d0ext()
    {
	return componentIsPresent(0);
    }
    
    public void deleteRadioBearerSetup_v7d0ext()
    {
	...
	public static class V7g0NCEs extends Sequence {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"RadioBearerSetup_r7_add_ext_IEs$V7f0NCEs$V7g0NCEs$NonCriticalExtensions"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerSetup_r7_add_ext_IEs$V7f0NCEs$V7g0NCEs"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerSetup_r7_add_ext_IEs$V7f0NCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerSetup_r7_add_ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerSetup_r7_add_ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerSetup_r7_add_ext_IEs
