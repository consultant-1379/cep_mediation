...
/**
 * Define the ASN1 Type RRCConnectionRequest_v6e0ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RRCConnectionRequest_v6e0ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RRCConnectionRequest_v6e0ext_IEs()
    {
    }
     ...
     */
    public RRCConnectionRequest_v6e0ext_IEs(SupportForFDPCH supportForFDPCH)
    {
    ...
    /**
     * Define the ASN1 Type SupportForFDPCH from ASN1 Module PDU_definitions.
     * @see Enumerated
     */
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionRequest_v6e0ext_IEs$SupportForFDPCH"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RRCConnectionRequest_v6e0ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RRCConnectionRequest_v6e0ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RRCConnectionRequest_v6e0ext_IEs
