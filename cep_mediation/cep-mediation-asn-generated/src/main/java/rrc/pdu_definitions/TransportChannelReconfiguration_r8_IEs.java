...
/**
 * Define the ASN1 Type TransportChannelReconfiguration_r8_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class TransportChannelReconfiguration_r8_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public TransportChannelReconfiguration_r8_IEs()
    {
    }
     ...
     */
    public TransportChannelReconfiguration_r8_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public TransportChannelReconfiguration_r8_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
    }
	...
	mComponents[27] = new rrc.informationelements.MIMO_Parameters_r8();
	...
	mComponents[30] = new rrc.informationelements.UL_EDCH_Information_r8();
	mComponents[31] = new rrc.informationelements.DL_HSPDSCH_Information_r8();
	...
	mComponents[34] = new rrc.informationelements.DL_SecondaryCellInfoFDD();
	...
	mComponents[37] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[38];
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfiguration_r8_IEs$ResponseToChangeOfUE_Capability"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r8)mComponents[27];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r8)mComponents[30];
    }
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r8)mComponents[31];
    }
    ...
    {
	return (rrc.informationelements.DL_SecondaryCellInfoFDD)mComponents[34];
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[37];
    }
    ...
    {
	mComponents[37] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r8_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r8_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TransportChannelReconfiguration_r8_IEs
