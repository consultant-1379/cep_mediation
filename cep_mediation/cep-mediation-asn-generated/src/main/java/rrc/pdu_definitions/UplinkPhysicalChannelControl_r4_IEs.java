...
/**
 * Define the ASN1 Type UplinkPhysicalChannelControl_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class UplinkPhysicalChannelControl_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public UplinkPhysicalChannelControl_r4_IEs()
    {
    }
     ...
     */
    public UplinkPhysicalChannelControl_r4_IEs(rrc.informationelements.CCTrCH_PowerControlInfo_r4 ccTrCH_PowerControlInfo, 
     ...
     */
    public UplinkPhysicalChannelControl_r4_IEs(TddOption tddOption)
    {
	setTddOption(tddOption);
    }
    ...
    {
	mComponents[0] = new rrc.informationelements.CCTrCH_PowerControlInfo_r4();
	...
	switch (index) {
	    case 0:
		return new rrc.informationelements.CCTrCH_PowerControlInfo_r4();
	    case 1:
    ...
    public rrc.informationelements.CCTrCH_PowerControlInfo_r4 getCcTrCH_PowerControlInfo()
    {
	return (rrc.informationelements.CCTrCH_PowerControlInfo_r4)mComponents[0];
    }
    
    public void setCcTrCH_PowerControlInfo(rrc.informationelements.CCTrCH_PowerControlInfo_r4 ccTrCH_PowerControlInfo)
    {
	...
	public static class Tdd384 extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "UplinkPhysicalChannelControl_r4_IEs$TddOption$Tdd384"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd128 extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "UplinkPhysicalChannelControl_r4_IEs$TddOption$Tdd128"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"UplinkPhysicalChannelControl_r4_IEs$TddOption"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UplinkPhysicalChannelControl_r4_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UplinkPhysicalChannelControl_r4_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UplinkPhysicalChannelControl_r4_IEs
