...
/**
 * Define the ASN1 Type UTRANMobilityInformationConfirm_va40ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class UTRANMobilityInformationConfirm_va40ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public UTRANMobilityInformationConfirm_va40ext_IEs()
    {
    }
     ...
     */
    public UTRANMobilityInformationConfirm_va40ext_IEs(LoggedMeasAvailable loggedMeasAvailable)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"UTRANMobilityInformationConfirm_va40ext_IEs$LoggedMeasAvailable"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UTRANMobilityInformationConfirm_va40ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UTRANMobilityInformationConfirm_va40ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UTRANMobilityInformationConfirm_va40ext_IEs
