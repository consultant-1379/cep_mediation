...
/**
 * Define the ASN1 Type DownlinkDirectTransfer from ASN1 Module PDU_definitions.
 * @see Choice
 */

public class DownlinkDirectTransfer extends Choice {
    
    /**
     * The default constructor.
     */
    public DownlinkDirectTransfer()
    {
    }
    ...
    public static DownlinkDirectTransfer createDownlinkDirectTransferWithR3(R3 r3)
    {
	DownlinkDirectTransfer __object = new DownlinkDirectTransfer();
	 ...
	 */
	public R3(DownlinkDirectTransfer_r3_IEs downlinkDirectTransfer_r3, 
			LaterNCEs laterNCEs)
	{
	    setDownlinkDirectTransfer_r3(downlinkDirectTransfer_r3);
	...
	{
	    mComponents[0] = new DownlinkDirectTransfer_r3_IEs();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new DownlinkDirectTransfer_r3_IEs();
		case 1:
	...
	// Methods for field "downlinkDirectTransfer_r3"
	public DownlinkDirectTransfer_r3_IEs getDownlinkDirectTransfer_r3()
	{
	    return (DownlinkDirectTransfer_r3_IEs)mComponents[0];
	}
	
	public void setDownlinkDirectTransfer_r3(DownlinkDirectTransfer_r3_IEs downlinkDirectTransfer_r3)
	{
	    mComponents[0] = downlinkDirectTransfer_r3;
	}
	...
	public static class LaterNCEs extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public LaterNCEs(BitString downlinkDirectTransfer_r3_add_ext, 
			    NonCriticalExtensions nonCriticalExtensions)
	    {
		setDownlinkDirectTransfer_r3_add_ext(downlinkDirectTransfer_r3_add_ext);
	    ...
	    // Methods for field "downlinkDirectTransfer_r3_add_ext"
	    public BitString getDownlinkDirectTransfer_r3_add_ext()
	    {
		return (BitString)mComponents[0];
	    }
	    
	    public void setDownlinkDirectTransfer_r3_add_ext(BitString downlinkDirectTransfer_r3_add_ext)
	    {
		mComponents[0] = downlinkDirectTransfer_r3_add_ext;
	    }
	    
	    public boolean hasDownlinkDirectTransfer_r3_add_ext()
	    {
		return componentIsPresent(0);
	    }
	    
	    public void deleteDownlinkDirectTransfer_r3_add_ext()
	    {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"DownlinkDirectTransfer$R3$LaterNCEs$NonCriticalExtensions"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "DownlinkDirectTransfer$R3$LaterNCEs"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    public static DownlinkDirectTransfer createDownlinkDirectTransferWithLater_than_r3(Later_than_r3 later_than_r3)
    {
	DownlinkDirectTransfer __object = new DownlinkDirectTransfer();
	...
	public static class CriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "DownlinkDirectTransfer$Later_than_r3$CriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"DownlinkDirectTransfer$Later_than_r3"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DownlinkDirectTransfer object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DownlinkDirectTransfer object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DownlinkDirectTransfer
