...
/**
 * Define the ASN1 Type HandoverFromUTRANCommand_GSM_v690ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class HandoverFromUTRANCommand_GSM_v690ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public HandoverFromUTRANCommand_GSM_v690ext_IEs()
    {
    }
     ...
     */
    public HandoverFromUTRANCommand_GSM_v690ext_IEs(Geran_SystemInfoType geran_SystemInfoType)
    {
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"HandoverFromUTRANCommand_GSM_v690ext_IEs$Geran_SystemInfoType"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HandoverFromUTRANCommand_GSM_v690ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HandoverFromUTRANCommand_GSM_v690ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HandoverFromUTRANCommand_GSM_v690ext_IEs
