...
/**
 * Define the ASN1 Type RadioBearerRelease_r10_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerRelease_r10_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerRelease_r10_IEs()
    {
    }
     ...
     */
    public RadioBearerRelease_r10_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerRelease_r10_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    rrc.informationelements.RB_InformationReleaseList rb_InformationReleaseList)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setRb_InformationReleaseList(rb_InformationReleaseList);
	...
	mComponents[26] = new rrc.informationelements.DL_AddReconfTransChInfoList_r9();
	...
	mComponents[32] = new rrc.informationelements.MIMO_Parameters_r9();
	...
	mComponents[35] = new rrc.informationelements.UL_EDCH_Information_r9();
	mComponents[36] = new rrc.informationelements.UL_SecondaryCellInfoFDD();
	mComponents[37] = new rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128();
	mComponents[38] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
	mComponents[39] = new rrc.informationelements.DL_CommonInformation_r10();
	mComponents[40] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[41] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r10();
	mComponents[42] = new rrc.informationelements.AdditionalDLSecCellInfoListFDD();
	...
	mComponents[45] = new rrc.informationelements.MU_MIMO_Info_TDD128();
	mComponents[46] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
	mComponents[47] = new rrc.informationelements.RB_InformationReleaseList();
	mComponents[48] = new rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[49];
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r9)mComponents[26];
    }
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r9)mComponents[32];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r9)mComponents[35];
    }
    ...
    {
	return (rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128)mComponents[37];
    }
    ...
    {
	mComponents[37] = ul_MulticarrierEDCHInfo_TDD128;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r10)mComponents[39];
    }
    ...
    {
	return (rrc.informationelements.DL_SecondaryCellInfoFDD_r10)mComponents[41];
    }
    ...
    {
	return (rrc.informationelements.AdditionalDLSecCellInfoListFDD)mComponents[42];
    }
    ...
    {
	mComponents[42] = additionalDLSecCellInfoListFDD;
    }
    ...
    {
	return (rrc.informationelements.MU_MIMO_Info_TDD128)mComponents[45];
    }
    
    public void setMu_MIMO_Info_TDD128(rrc.informationelements.MU_MIMO_Info_TDD128 mu_MIMO_Info_TDD128)
    {
	mComponents[45] = mu_MIMO_Info_TDD128;
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[46];
    }
    ...
    {
	mComponents[46] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    {
	return (rrc.informationelements.RB_InformationReleaseList)mComponents[47];
    }
    ...
    {
	mComponents[47] = mbms_RB_ListReleasedToChangeTransferMode;
    }
    ...
    {
	return (rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9)mComponents[48];
    }
    ...
    {
	mComponents[48] = cellDCHMeasOccasionInfo_TDD128;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerRelease_r10_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerRelease_r10_IEs object.
     */
...
} // End class definition for RadioBearerRelease_r10_IEs
