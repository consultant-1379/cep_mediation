...
/**
 * Define the ASN1 Type ActiveSetUpdate_r7_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class ActiveSetUpdate_r7_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public ActiveSetUpdate_r7_IEs()
    {
    }
     ...
     */
    public ActiveSetUpdate_r7_IEs(rrc.informationelements.ActivationTime activationTime, 
		    ...
		    rrc.informationelements.RL_AdditionInformationList_r7 rl_AdditionInformationList, 
		    ...
		    rrc.informationelements.Serving_HSDSCH_CellInformation_r7 serving_HSDSCH_CellInformation, 
	...
	mComponents[9] = new rrc.informationelements.MIMO_Parameters_r7();
	mComponents[10] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[11] = new rrc.informationelements.RL_AdditionInformationList_r7();
	mComponents[12] = new rrc.informationelements.RL_RemovalInformationList();
	mComponents[13] = rrc.informationelements.TX_DiversityMode.noDiversity;
	mComponents[14] = rrc.informationelements.DPC_Mode.singleTPC;
	mComponents[15] = new rrc.informationelements.Serving_HSDSCH_CellInformation_r7();
	mComponents[16] = new rrc.informationelements.E_DCH_ReconfigurationInfo_r7();
	mComponents[17] = new rrc.informationelements.UL_16QAM_Config();
	mComponents[18] = new rrc.informationelements.E_DCH_RL_InfoSameServingCell();
	mComponents[19] = new rrc.informationelements.E_TFC_Boost_Info_r7();
	mComponents[20] = new rrc.informationelements.E_DPDCH_PowerInterpolation();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[21];
    }
	...
	switch (index) {
	    ...
	    case 11:
		return new rrc.informationelements.RL_AdditionInformationList_r7();
	    case 12:
	    ...
	    case 15:
		return new rrc.informationelements.Serving_HSDSCH_CellInformation_r7();
	    case 16:
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r7)mComponents[9];
    }
    ...
    public rrc.informationelements.RL_AdditionInformationList_r7 getRl_AdditionInformationList()
    {
	return (rrc.informationelements.RL_AdditionInformationList_r7)mComponents[11];
    }
    
    public void setRl_AdditionInformationList(rrc.informationelements.RL_AdditionInformationList_r7 rl_AdditionInformationList)
    {
    ...
    {
	return (rrc.informationelements.TX_DiversityMode)mComponents[13];
    }
    
    public void setTx_DiversityMode(rrc.informationelements.TX_DiversityMode tx_DiversityMode)
    {
	mComponents[13] = tx_DiversityMode;
    }
    ...
    {
	return (rrc.informationelements.DPC_Mode)mComponents[14];
    }
    
    public void setDpc_Mode(rrc.informationelements.DPC_Mode dpc_Mode)
    {
	mComponents[14] = dpc_Mode;
    }
    ...
    public rrc.informationelements.Serving_HSDSCH_CellInformation_r7 getServing_HSDSCH_CellInformation()
    {
	return (rrc.informationelements.Serving_HSDSCH_CellInformation_r7)mComponents[15];
    }
    
    public void setServing_HSDSCH_CellInformation(rrc.informationelements.Serving_HSDSCH_CellInformation_r7 serving_HSDSCH_CellInformation)
    {
	mComponents[15] = serving_HSDSCH_CellInformation;
    }
    ...
    {
	return (rrc.informationelements.UL_16QAM_Config)mComponents[17];
    }
    
    public void setUl_16QAM_Config(rrc.informationelements.UL_16QAM_Config ul_16QAM_Config)
    {
	mComponents[17] = ul_16QAM_Config;
    }
    ...
    {
	return (rrc.informationelements.E_TFC_Boost_Info_r7)mComponents[19];
    }
    
    public void setE_TFC_Boost_Info(rrc.informationelements.E_TFC_Boost_Info_r7 e_TFC_Boost_Info)
    {
	mComponents[19] = e_TFC_Boost_Info;
    }
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"Serving_HSDSCH_CellInformation_r7"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' ActiveSetUpdate_r7_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' ActiveSetUpdate_r7_IEs object.
     */
...
} // End class definition for ActiveSetUpdate_r7_IEs
