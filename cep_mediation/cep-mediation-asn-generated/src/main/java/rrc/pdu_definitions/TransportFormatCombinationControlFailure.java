...
/**
 * Define the ASN1 Type TransportFormatCombinationControlFailure from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class TransportFormatCombinationControlFailure extends Sequence {
    
    /**
     * The default constructor.
     */
    public TransportFormatCombinationControlFailure()
    {
    }
     ...
     */
    public TransportFormatCombinationControlFailure(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString transportFormatCombinationControlFailure_r3_add_ext, 
			NonCriticalExtensions nonCriticalExtensions)
	{
	    setTransportFormatCombinationControlFailure_r3_add_ext(transportFormatCombinationControlFailure_r3_add_ext);
	...
	// Methods for field "transportFormatCombinationControlFailure_r3_add_ext"
	public BitString getTransportFormatCombinationControlFailure_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setTransportFormatCombinationControlFailure_r3_add_ext(BitString transportFormatCombinationControlFailure_r3_add_ext)
	{
	    mComponents[0] = transportFormatCombinationControlFailure_r3_add_ext;
	}
	
	public boolean hasTransportFormatCombinationControlFailure_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteTransportFormatCombinationControlFailure_r3_add_ext()
	{
	...
	public static class NonCriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "TransportFormatCombinationControlFailure$LaterNCEs$NonCriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportFormatCombinationControlFailure$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TransportFormatCombinationControlFailure object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TransportFormatCombinationControlFailure object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TransportFormatCombinationControlFailure
