...
/**
 * Define the ASN1 Type RadioBearerSetup_r5_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerSetup_r5_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerSetup_r5_IEs()
    {
    }
     ...
     */
    public RadioBearerSetup_r5_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
		    ...
		    rrc.informationelements.SRB_InformationSetupList_r5 srb_InformationSetupList, 
     ...
     */
    public RadioBearerSetup_r5_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    ModeSpecificPhysChInfo modeSpecificPhysChInfo)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setModeSpecificPhysChInfo(modeSpecificPhysChInfo);
	...
	mComponents[11] = new rrc.informationelements.SRB_InformationSetupList_r5();
	mComponents[12] = new rrc.informationelements.RAB_InformationSetupList_r5();
	mComponents[13] = new rrc.informationelements.RB_InformationAffectedList_r5();
	mComponents[14] = new rrc.informationelements.DL_CounterSynchronisationInfo_r5();
	mComponents[15] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	mComponents[16] = new rrc.informationelements.UL_DeletedTransChInfoList();
	mComponents[17] = new rrc.informationelements.UL_AddReconfTransChInfoList();
	mComponents[18] = new Dummy();
	mComponents[19] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[20] = new rrc.informationelements.DL_DeletedTransChInfoList_r5();
	mComponents[21] = new rrc.informationelements.DL_AddReconfTransChInfoList_r5();
	mComponents[22] = new rrc.informationelements.FrequencyInfo();
	mComponents[23] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[24] = new rrc.informationelements.UL_ChannelRequirement_r5();
	mComponents[25] = new ModeSpecificPhysChInfo();
	mComponents[26] = new rrc.informationelements.DL_HSPDSCH_Information();
	mComponents[27] = new rrc.informationelements.DL_CommonInformation_r5();
	mComponents[28] = new rrc.informationelements.DL_InformationPerRL_List_r5();
    }
    ...
    {
	return (rrc.informationelements.RB_InformationAffectedList_r5)mComponents[13];
    }
    ...
    {
	mComponents[13] = rb_InformationAffectedList;
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[15];
    }
    
    public void setUl_CommonTransChInfo(rrc.informationelements.UL_CommonTransChInfo_r4 ul_CommonTransChInfo)
    {
	mComponents[15] = ul_CommonTransChInfo;
    }
    ...
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList)mComponents[17];
    }
    ...
    {
	mComponents[17] = ul_AddReconfTransChInfoList;
    }
    ...
    {
	return (Dummy)mComponents[18];
    }
    
    public void setDummy(Dummy dummy)
    {
	mComponents[18] = dummy;
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerSetup_r5_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo_r4)mComponents[19];
    }
    
    public void setDl_CommonTransChInfo(rrc.informationelements.DL_CommonTransChInfo_r4 dl_CommonTransChInfo)
    {
	mComponents[19] = dl_CommonTransChInfo;
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r5)mComponents[21];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerSetup_r5_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerSetup_r5_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r5)mComponents[27];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r5)mComponents[28];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerSetup_r5_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerSetup_r5_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerSetup_r5_IEs
