...
/**
 * Define the ASN1 Type TransportChannelReconfigurationFailure from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class TransportChannelReconfigurationFailure extends Sequence {
    
    /**
     * The default constructor.
     */
    public TransportChannelReconfigurationFailure()
    {
    }
     ...
     */
    public TransportChannelReconfigurationFailure(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString transportChannelReconfigurationFailure_r3_add_ext, 
			NonCriticalExtensions nonCriticalExtensions)
	{
	    setTransportChannelReconfigurationFailure_r3_add_ext(transportChannelReconfigurationFailure_r3_add_ext);
	...
	// Methods for field "transportChannelReconfigurationFailure_r3_add_ext"
	public BitString getTransportChannelReconfigurationFailure_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setTransportChannelReconfigurationFailure_r3_add_ext(BitString transportChannelReconfigurationFailure_r3_add_ext)
	{
	    mComponents[0] = transportChannelReconfigurationFailure_r3_add_ext;
	}
	
	public boolean hasTransportChannelReconfigurationFailure_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteTransportChannelReconfigurationFailure_r3_add_ext()
	{
	...
	public static class NonCriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "TransportChannelReconfigurationFailure$LaterNCEs$NonCriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfigurationFailure$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TransportChannelReconfigurationFailure object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TransportChannelReconfigurationFailure object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TransportChannelReconfigurationFailure
