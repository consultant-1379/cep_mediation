...
/**
 * Define the ASN1 Type TransportChannelReconfiguration_r10_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class TransportChannelReconfiguration_r10_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public TransportChannelReconfiguration_r10_IEs()
    {
    }
     ...
     */
    public TransportChannelReconfiguration_r10_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
	...
	this(integrityProtectionModeInfo, cipheringModeInfo, 
	     ...
	     ul_SecondaryCellInfoFDD, ul_MulticarrierEDCHInfo_TDD128, 
	     dl_HSPDSCH_Information, dl_CommonInformation, 
	     dl_InformationPerRL_List, dl_SecondaryCellInfoFDD, 
	     additionalDLSecCellInfoListFDD, controlChannelDRXInfo_TDD128, 
     ...
     */
    public TransportChannelReconfiguration_r10_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
    }
	...
	mComponents[19] = new rrc.informationelements.UL_AddReconfTransChInfoList_r8();
	mComponents[20] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[21] = new rrc.informationelements.DL_AddReconfTransChInfoList_r9();
	...
	mComponents[27] = new rrc.informationelements.MIMO_Parameters_r9();
	...
	mComponents[30] = new rrc.informationelements.UL_EDCH_Information_r9();
	mComponents[31] = new rrc.informationelements.UL_SecondaryCellInfoFDD();
	mComponents[32] = new rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128();
	mComponents[33] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
	mComponents[34] = new rrc.informationelements.DL_CommonInformation_r10();
	mComponents[35] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[36] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r10();
	mComponents[37] = new rrc.informationelements.AdditionalDLSecCellInfoListFDD();
	mComponents[38] = new rrc.informationelements.ControlChannelDRXInfo_TDD128_r8();
	mComponents[39] = new rrc.informationelements.SPS_Information_TDD128_r8();
	mComponents[40] = new rrc.informationelements.MU_MIMO_Info_TDD128();
	mComponents[41] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
	mComponents[42] = new rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9();
    }
    
    // Instance initializer
    {
	mComponents = new AbstractData[43];
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfiguration_r10_IEs$ResponseToChangeOfUE_Capability"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList_r8)mComponents[19];
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r9)mComponents[21];
    }
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r9)mComponents[27];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r9)mComponents[30];
    }
    ...
    {
	return (rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128)mComponents[32];
    }
    ...
    {
	mComponents[32] = ul_MulticarrierEDCHInfo_TDD128;
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r10)mComponents[34];
    }
    
    public void setDl_CommonInformation(rrc.informationelements.DL_CommonInformation_r10 dl_CommonInformation)
    {
	mComponents[34] = dl_CommonInformation;
    }
    ...
    {
	return (rrc.informationelements.AdditionalDLSecCellInfoListFDD)mComponents[37];
    }
    ...
    {
	mComponents[37] = additionalDLSecCellInfoListFDD;
    }
    ...
    {
	return (rrc.informationelements.ControlChannelDRXInfo_TDD128_r8)mComponents[38];
    }
    ...
    {
	mComponents[38] = controlChannelDRXInfo_TDD128;
    }
    ...
    {
	return (rrc.informationelements.MU_MIMO_Info_TDD128)mComponents[40];
    }
    
    public void setMu_MIMO_Info_TDD128(rrc.informationelements.MU_MIMO_Info_TDD128 mu_MIMO_Info_TDD128)
    {
	mComponents[40] = mu_MIMO_Info_TDD128;
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[41];
    }
    ...
    {
	mComponents[41] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    {
	return (rrc.informationelements.CellDCHMeasOccasionInfo_TDD128_r9)mComponents[42];
    }
    ...
    {
	mComponents[42] = cellDCHMeasOccasionInfo_TDD128;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r10_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r10_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TransportChannelReconfiguration_r10_IEs
