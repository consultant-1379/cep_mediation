...
/**
 * Define the ASN1 Type RadioBearerSetup_r10_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerSetup_r10_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerSetup_r10_IEs()
    {
    }
     ...
     */
    public RadioBearerSetup_r10_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerSetup_r10_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
    }
	...
	mComponents[38] = new rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128();
	mComponents[39] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
	mComponents[40] = new rrc.informationelements.DL_CommonInformation_r10();
	mComponents[41] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[42] = new rrc.informationelements.DL_SecondaryCellInfoFDD_r10();
	mComponents[43] = new rrc.informationelements.AdditionalDLSecCellInfoListFDD();
	mComponents[44] = new rrc.informationelements.ControlChannelDRXInfo_TDD128_r8();
	mComponents[45] = new rrc.informationelements.SPS_Information_TDD128_r8();
	mComponents[46] = new rrc.informationelements.MU_MIMO_Info_TDD128();
	mComponents[47] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
    ...
    {
	return (rrc.informationelements.UL_MulticarrierEDCHInfo_TDD128)mComponents[38];
    }
    ...
    {
	mComponents[38] = ul_MulticarrierEDCHInfo_TDD128;
    }
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r9)mComponents[39];
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r10)mComponents[40];
    }
    ...
    {
	return (rrc.informationelements.DL_SecondaryCellInfoFDD_r10)mComponents[42];
    }
    ...
    {
	return (rrc.informationelements.AdditionalDLSecCellInfoListFDD)mComponents[43];
    }
    ...
    {
	mComponents[43] = additionalDLSecCellInfoListFDD;
    }
    ...
    {
	return (rrc.informationelements.ControlChannelDRXInfo_TDD128_r8)mComponents[44];
    }
    ...
    {
	mComponents[44] = controlChannelDRXInfo_TDD128;
    }
    ...
    {
	return (rrc.informationelements.MU_MIMO_Info_TDD128)mComponents[46];
    }
    
    public void setMu_MIMO_Info_TDD128(rrc.informationelements.MU_MIMO_Info_TDD128 mu_MIMO_Info_TDD128)
    {
	mComponents[46] = mu_MIMO_Info_TDD128;
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[47];
    }
    ...
    {
	mComponents[47] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerSetup_r10_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerSetup_r10_IEs object.
     */
...
} // End class definition for RadioBearerSetup_r10_IEs
