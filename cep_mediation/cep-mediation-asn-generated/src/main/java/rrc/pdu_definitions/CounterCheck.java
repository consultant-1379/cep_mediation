...
/**
 * Define the ASN1 Type CounterCheck from ASN1 Module PDU_definitions.
 * @see Choice
 */

public class CounterCheck extends Choice {
    ...
    public static CounterCheck createCounterCheckWithR3(R3 r3)
    {
	CounterCheck __object = new CounterCheck();
	 ...
	 */
	public R3(CounterCheck_r3_IEs counterCheck_r3, LaterNCEs laterNCEs)
	{
	    setCounterCheck_r3(counterCheck_r3);
	 ...
	 */
	public R3(CounterCheck_r3_IEs counterCheck_r3)
	{
	    setCounterCheck_r3(counterCheck_r3);
	}
	...
	{
	    mComponents[0] = new CounterCheck_r3_IEs();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new CounterCheck_r3_IEs();
		case 1:
	...
	// Methods for field "counterCheck_r3"
	public CounterCheck_r3_IEs getCounterCheck_r3()
	{
	    return (CounterCheck_r3_IEs)mComponents[0];
	}
	
	public void setCounterCheck_r3(CounterCheck_r3_IEs counterCheck_r3)
	{
	    mComponents[0] = counterCheck_r3;
	}
	...
	public static class LaterNCEs extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public LaterNCEs(BitString counterCheck_r3_add_ext, 
			    NonCriticalExtensions nonCriticalExtensions)
	    {
		setCounterCheck_r3_add_ext(counterCheck_r3_add_ext);
	    ...
	    // Methods for field "counterCheck_r3_add_ext"
	    public BitString getCounterCheck_r3_add_ext()
	    {
		return (BitString)mComponents[0];
	    }
	    
	    public void setCounterCheck_r3_add_ext(BitString counterCheck_r3_add_ext)
	    {
		mComponents[0] = counterCheck_r3_add_ext;
	    }
	    
	    public boolean hasCounterCheck_r3_add_ext()
	    {
		return componentIsPresent(0);
	    }
	    
	    public void deleteCounterCheck_r3_add_ext()
	    {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"CounterCheck$R3$LaterNCEs$NonCriticalExtensions"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
    ...
    public static CounterCheck createCounterCheckWithLater_than_r3(Later_than_r3 later_than_r3)
    {
	CounterCheck __object = new CounterCheck();
	...
	public static class CriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "CounterCheck$Later_than_r3$CriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CounterCheck object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CounterCheck object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CounterCheck
