...
/**
 * Define the ASN1 Type CellUpdateConfirm_r7_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class CellUpdateConfirm_r7_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellUpdateConfirm_r7_IEs()
    {
    }
     ...
     */
    public CellUpdateConfirm_r7_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public CellUpdateConfirm_r7_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    boolean rlc_Re_establishIndicatorRb2_3or4, 
		    boolean rlc_Re_establishIndicatorRb5orAbove)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	...
	mComponents[24] = new rrc.informationelements.UL_AddReconfTransChInfoList_r7();
	...
	mComponents[33] = new rrc.informationelements.MIMO_Parameters_r7();
	...
	mComponents[36] = new rrc.informationelements.UL_EDCH_Information_r7();
	mComponents[37] = new rrc.informationelements.DL_HSPDSCH_Information_r7();
	mComponents[38] = new rrc.informationelements.DL_CommonInformation_r7();
	mComponents[39] = new rrc.informationelements.DL_InformationPerRL_List_r7();
	mComponents[40] = rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6._true;
    }
    ...
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList_r7)mComponents[24];
    }
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r7)mComponents[33];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r7)mComponents[36];
    }
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r7)mComponents[37];
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r7)mComponents[38];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r7)mComponents[39];
    }
    ...
    {
	return (rrc.informationelements.MBMS_PL_ServiceRestrictInfo_r6)mComponents[40];
    }
    ...
    {
	mComponents[40] = mbms_PL_ServiceRestrictInfo;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellUpdateConfirm_r7_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellUpdateConfirm_r7_IEs object.
     */
...
} // End class definition for CellUpdateConfirm_r7_IEs
