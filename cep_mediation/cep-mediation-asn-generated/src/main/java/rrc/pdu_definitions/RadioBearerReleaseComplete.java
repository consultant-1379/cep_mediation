...
/**
 * Define the ASN1 Type RadioBearerReleaseComplete from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerReleaseComplete extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerReleaseComplete()
    {
    }
     ...
     */
    public RadioBearerReleaseComplete(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString radioBearerReleaseComplete_r3_add_ext, 
			V770NCEs v770NCEs)
	{
	    setRadioBearerReleaseComplete_r3_add_ext(radioBearerReleaseComplete_r3_add_ext);
	...
	// Methods for field "radioBearerReleaseComplete_r3_add_ext"
	public BitString getRadioBearerReleaseComplete_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setRadioBearerReleaseComplete_r3_add_ext(BitString radioBearerReleaseComplete_r3_add_ext)
	{
	    mComponents[0] = radioBearerReleaseComplete_r3_add_ext;
	}
	
	public boolean hasRadioBearerReleaseComplete_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteRadioBearerReleaseComplete_r3_add_ext()
	{
	...
	public static class V770NCEs extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public V770NCEs(RadioBearerReleaseComplete_v770ext_IEs radioBearerReleaseComplete_v770ext, 
			    NonCriticalExtensions nonCriticalExtensions)
	    {
		setRadioBearerReleaseComplete_v770ext(radioBearerReleaseComplete_v770ext);
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new RadioBearerReleaseComplete_v770ext_IEs();
		...
		switch (index) {
		    case 0:
			return new RadioBearerReleaseComplete_v770ext_IEs();
		    case 1:
	    ...
	    // Methods for field "radioBearerReleaseComplete_v770ext"
	    public RadioBearerReleaseComplete_v770ext_IEs getRadioBearerReleaseComplete_v770ext()
	    {
		return (RadioBearerReleaseComplete_v770ext_IEs)mComponents[0];
	    }
	    
	    public void setRadioBearerReleaseComplete_v770ext(RadioBearerReleaseComplete_v770ext_IEs radioBearerReleaseComplete_v770ext)
	    {
		mComponents[0] = radioBearerReleaseComplete_v770ext;
	    }
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"RadioBearerReleaseComplete$LaterNCEs$V770NCEs$NonCriticalExtensions"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReleaseComplete$LaterNCEs$V770NCEs"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReleaseComplete$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerReleaseComplete object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerReleaseComplete object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerReleaseComplete
