...
/**
 * Define the ASN1 Type RadioBearerSetup_v690ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerSetup_v690ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerSetup_v690ext_IEs()
    {
    }
     ...
     */
    public RadioBearerSetup_v690ext_IEs(rrc.informationelements.PLMN_Identity primary_plmn_Identity, 
	...
	mComponents[6] = new rrc.informationelements.RAB_InformationSetupList_r6_ext();
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerSetup_v690ext_IEs$PostVerificationPeriod"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerSetup_v690ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerSetup_v690ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerSetup_v690ext_IEs
