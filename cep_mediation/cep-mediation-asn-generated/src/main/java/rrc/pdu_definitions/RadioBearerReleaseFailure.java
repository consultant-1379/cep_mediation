...
/**
 * Define the ASN1 Type RadioBearerReleaseFailure from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerReleaseFailure extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerReleaseFailure()
    {
    }
     ...
     */
    public RadioBearerReleaseFailure(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	 ...
	 * Construct with AbstractData components.
	 */
	public LaterNCEs(BitString radioBearerReleaseFailure_r3_add_ext, 
			NonCriticalExtensions nonCriticalExtensions)
	{
	    setRadioBearerReleaseFailure_r3_add_ext(radioBearerReleaseFailure_r3_add_ext);
	...
	// Methods for field "radioBearerReleaseFailure_r3_add_ext"
	public BitString getRadioBearerReleaseFailure_r3_add_ext()
	{
	    return (BitString)mComponents[0];
	}
	
	public void setRadioBearerReleaseFailure_r3_add_ext(BitString radioBearerReleaseFailure_r3_add_ext)
	{
	    mComponents[0] = radioBearerReleaseFailure_r3_add_ext;
	}
	
	public boolean hasRadioBearerReleaseFailure_r3_add_ext()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteRadioBearerReleaseFailure_r3_add_ext()
	{
	...
	public static class NonCriticalExtensions extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReleaseFailure$LaterNCEs$NonCriticalExtensions"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReleaseFailure$LaterNCEs"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerReleaseFailure object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerReleaseFailure object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerReleaseFailure
