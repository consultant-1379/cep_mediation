...
/**
 * Define the ASN1 Type RadioBearerReconfiguration_r8_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerReconfiguration_r8_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerReconfiguration_r8_IEs()
    {
    }
     ...
     */
    public RadioBearerReconfiguration_r8_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerReconfiguration_r8_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    SpecificationMode specificationMode)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setSpecificationMode(specificationMode);
	...
	mComponents[24] = new rrc.informationelements.MIMO_Parameters_r8();
	...
	mComponents[27] = new rrc.informationelements.UL_EDCH_Information_r8();
	mComponents[28] = new rrc.informationelements.DL_HSPDSCH_Information_r8();
	mComponents[29] = new rrc.informationelements.DL_CommonInformation_r8();
	mComponents[30] = new rrc.informationelements.DL_InformationPerRL_List_r8();
	mComponents[31] = new rrc.informationelements.DL_SecondaryCellInfoFDD();
	mComponents[32] = new rrc.informationelements.ControlChannelDRXInfo_TDD128_r8();
	mComponents[33] = new rrc.informationelements.SPS_Information_TDD128_r8();
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfiguration_r8_IEs$ResponseToChangeOfUE_Capability"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	public static class Complete extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReconfiguration_r8_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "RadioBearerReconfiguration_r8_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"RadioBearerReconfiguration_r8_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReconfiguration_r8_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfiguration_r8_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r8)mComponents[24];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r8)mComponents[27];
    }
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r8)mComponents[28];
    }
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r8)mComponents[29];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r8)mComponents[30];
    }
    ...
    {
	return (rrc.informationelements.ControlChannelDRXInfo_TDD128_r8)mComponents[32];
    }
    ...
    {
	mComponents[32] = controlChannelDRXInfo_TDD128;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerReconfiguration_r8_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerReconfiguration_r8_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerReconfiguration_r8_IEs
