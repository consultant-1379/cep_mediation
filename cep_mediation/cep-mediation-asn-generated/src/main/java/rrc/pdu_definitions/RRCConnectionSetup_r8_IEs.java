...
/**
 * Define the ASN1 Type RRCConnectionSetup_r8_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RRCConnectionSetup_r8_IEs extends Sequence {
     ...
     */
    public RRCConnectionSetup_r8_IEs(rrc.informationelements.ActivationTime activationTime, 
     ...
     */
    public RRCConnectionSetup_r8_IEs(rrc.informationelements.U_RNTI new_U_RNTI, 
		    rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    rrc.informationelements.UTRAN_DRX_CycleLengthCoefficient_r7 utran_DRX_CycleLengthCoeff, 
		    boolean supportForChangeOfUE_Capability, 
		    SpecificationMode specificationMode)
	...
	mComponents[19] = new rrc.informationelements.UL_EDCH_Information_r8();
	mComponents[20] = new rrc.informationelements.DL_HSPDSCH_Information_r8();
	...
	mComponents[23] = new rrc.informationelements.DL_SecondaryCellInfoFDD();
	...
	public static class Complete extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RRCConnectionSetup_r8_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "RRCConnectionSetup_r8_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"RRCConnectionSetup_r8_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RRCConnectionSetup_r8_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RRCConnectionSetup_r8_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r8)mComponents[19];
    }
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r8)mComponents[20];
    }
    ...
    {
	return (rrc.informationelements.DL_SecondaryCellInfoFDD)mComponents[23];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RRCConnectionSetup_r8_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RRCConnectionSetup_r8_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RRCConnectionSetup_r8_IEs
