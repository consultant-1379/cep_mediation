...
/**
 * Define the ASN1 Type PhysicalChannelReconfiguration_r4_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class PhysicalChannelReconfiguration_r4_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public PhysicalChannelReconfiguration_r4_IEs()
    {
    }
     ...
     */
    public PhysicalChannelReconfiguration_r4_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
		    ...
		    rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID_r4 ul_ChannelRequirement, 
     ...
     */
    public PhysicalChannelReconfiguration_r4_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    ModeSpecificInfo modeSpecificInfo)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setModeSpecificInfo(modeSpecificInfo);
	...
	mComponents[13] = new rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID_r4();
	mComponents[14] = new ModeSpecificInfo();
	mComponents[15] = new rrc.informationelements.DL_CommonInformation_r4();
	mComponents[16] = new rrc.informationelements.DL_InformationPerRL_List_r4();
    }
	...
	switch (index) {
	    ...
	    case 13:
		return new rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID_r4();
	    case 14:
    ...
    public rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID_r4 getUl_ChannelRequirement()
    {
	return (rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID_r4)mComponents[13];
    }
    
    public void setUl_ChannelRequirement(rrc.informationelements.UL_ChannelRequirementWithCPCH_SetID_r4 ul_ChannelRequirement)
    {
    ...
    {
	return (ModeSpecificInfo)mComponents[14];
    }
    
    public void setModeSpecificInfo(ModeSpecificInfo modeSpecificInfo)
    {
	mComponents[14] = modeSpecificInfo;
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "PhysicalChannelReconfiguration_r4_IEs$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"PhysicalChannelReconfiguration_r4_IEs$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r4)mComponents[15];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List_r4)mComponents[16];
    }
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new ChoiceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"UL_ChannelRequirementWithCPCH_SetID_r4"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r4_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PhysicalChannelReconfiguration_r4_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PhysicalChannelReconfiguration_r4_IEs
