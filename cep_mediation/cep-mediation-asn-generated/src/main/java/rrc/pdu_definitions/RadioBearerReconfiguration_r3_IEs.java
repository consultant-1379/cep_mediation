...
/**
 * Define the ASN1 Type RadioBearerReconfiguration_r3_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerReconfiguration_r3_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerReconfiguration_r3_IEs()
    {
    }
     ...
     */
    public RadioBearerReconfiguration_r3_IEs(rrc.informationelements.RRC_TransactionIdentifier rrc_TransactionIdentifier, 
	...
	mComponents[11] = new rrc.informationelements.RB_InformationReconfigList();
	mComponents[12] = new rrc.informationelements.RB_InformationAffectedList();
	mComponents[13] = new rrc.informationelements.UL_CommonTransChInfo();
	...
	mComponents[17] = new rrc.informationelements.DL_CommonTransChInfo();
	mComponents[18] = new rrc.informationelements.DL_DeletedTransChInfoList();
	mComponents[19] = new rrc.informationelements.DL_AddReconfTransChInfo2List();
	mComponents[20] = new rrc.informationelements.FrequencyInfo();
	mComponents[21] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[22] = new rrc.informationelements.UL_ChannelRequirement();
	mComponents[23] = new ModeSpecificPhysChInfo();
	mComponents[24] = new rrc.informationelements.DL_CommonInformation();
	mComponents[25] = new rrc.informationelements.DL_InformationPerRL_List();
    }
    ...
    {
	return (rrc.informationelements.RB_InformationReconfigList)mComponents[11];
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo)mComponents[13];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReconfiguration_r3_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfiguration_r3_IEs$Dummy"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo)mComponents[17];
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfo2List)mComponents[19];
    }
    ...
    {
	return (rrc.informationelements.UL_ChannelRequirement)mComponents[22];
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "RadioBearerReconfiguration_r3_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"RadioBearerReconfiguration_r3_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation)mComponents[24];
    }
    ...
    {
	return (rrc.informationelements.DL_InformationPerRL_List)mComponents[25];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerReconfiguration_r3_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerReconfiguration_r3_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RadioBearerReconfiguration_r3_IEs
