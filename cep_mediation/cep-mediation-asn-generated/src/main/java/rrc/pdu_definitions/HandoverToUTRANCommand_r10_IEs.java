...
/**
 * Define the ASN1 Type HandoverToUTRANCommand_r10_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class HandoverToUTRANCommand_r10_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public HandoverToUTRANCommand_r10_IEs()
    {
    }
     ...
     */
    public HandoverToUTRANCommand_r10_IEs(rrc.informationelements.U_RNTI_Short new_U_RNTI, 
	...
	this(new_U_RNTI, cipheringAlgorithm, 
	     ...
	     newPrimary_E_RNTI, newSecondary_E_RNTI, 
	     defaultConfigForCellFACH, specificationMode, 
	...
	mComponents[6] = new rrc.informationelements.DefaultConfigForCellFACH();
	mComponents[7] = new SpecificationMode();
    ...
    {
	return (SpecificationMode)mComponents[7];
    }
    
    public void setSpecificationMode(SpecificationMode specificationMode)
    {
	mComponents[7] = specificationMode;
    }
	...
	public static class Complete extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Complete(rrc.informationelements.SRB_InformationSetupList_r8 srb_InformationSetupList, 
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new rrc.informationelements.SRB_InformationSetupList_r8();
		mComponents[1] = new rrc.informationelements.RAB_InformationSetupList_r8();
		mComponents[2] = new rrc.informationelements.UL_CommonTransChInfo_r4();
		mComponents[3] = new rrc.informationelements.UL_AddReconfTransChInfoList_r8();
		mComponents[4] = new rrc.informationelements.DL_CommonTransChInfo_r4();
		mComponents[5] = new rrc.informationelements.DL_AddReconfTransChInfoList_r9();
		mComponents[6] = new rrc.informationelements.UL_DPCH_Info_r7();
		mComponents[7] = new rrc.informationelements.UL_EDCH_Information_r9();
		mComponents[8] = new rrc.informationelements.DL_HSPDSCH_Information_r9();
		mComponents[9] = new rrc.informationelements.DL_CommonInformation_r10();
	    ...
	    {
		return (rrc.informationelements.SRB_InformationSetupList_r8)mComponents[0];
	    }
	    ...
	    {
		return (rrc.informationelements.RAB_InformationSetupList_r8)mComponents[1];
	    }
	    ...
	    {
		return (rrc.informationelements.UL_AddReconfTransChInfoList_r8)mComponents[3];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_AddReconfTransChInfoList_r9)mComponents[5];
	    }
	    ...
	    {
		return (rrc.informationelements.UL_EDCH_Information_r9)mComponents[7];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_HSPDSCH_Information_r9)mComponents[8];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_CommonInformation_r10)mComponents[9];
	    }
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverToUTRANCommand_r10_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
		    ...
		    public DefaultConfig(rrc.informationelements.DefaultConfigMode defaultConfigMode, 
				    ...
				    rrc.informationelements.DLUL_HSPA_Information_r10 dummy)
		    {
			...
			mComponents[2] = new rrc.informationelements.DLUL_HSPA_Information_r10();
		    }
			...
			switch (index) {
			    ...
			    case 2:
				return new rrc.informationelements.DLUL_HSPA_Information_r10();
			    default:
				throw new InternalError("AbstractCollection.createInstance()");
			}
		    ...
		    public rrc.informationelements.DLUL_HSPA_Information_r10 getDummy()
		    {
			return (rrc.informationelements.DLUL_HSPA_Information_r10)mComponents[2];
		    }
		    
		    public void setDummy(rrc.informationelements.DLUL_HSPA_Information_r10 dummy)
		    {
			mComponents[2] = dummy;
		    }
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		public static class Fdd extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Fdd"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class Tdd extends Choice {
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd$Tdd384"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd$Tdd128"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd$Tdd768"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd"
			),
			new QName (
			    "builtin",
			    "CHOICE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverToUTRANCommand_r10_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"HandoverToUTRANCommand_r10_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HandoverToUTRANCommand_r10_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HandoverToUTRANCommand_r10_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HandoverToUTRANCommand_r10_IEs
