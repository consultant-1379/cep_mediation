...
/**
 * Define the ASN1 Type RadioBearerSetup_r8_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class RadioBearerSetup_r8_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public RadioBearerSetup_r8_IEs()
    {
    }
     ...
     */
    public RadioBearerSetup_r8_IEs(rrc.informationelements.IntegrityProtectionModeInfo_r7 integrityProtectionModeInfo, 
     ...
     */
    public RadioBearerSetup_r8_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
    }
	...
	mComponents[27] = new rrc.informationelements.DL_AddReconfTransChInfoList_r7();
	...
	mComponents[33] = new rrc.informationelements.MIMO_Parameters_r8();
	...
	mComponents[36] = new rrc.informationelements.UL_EDCH_Information_r8();
	mComponents[37] = new rrc.informationelements.DL_HSPDSCH_Information_r8();
	...
	mComponents[40] = new rrc.informationelements.DL_SecondaryCellInfoFDD();
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r7)mComponents[27];
    }
    ...
    {
	return (rrc.informationelements.MIMO_Parameters_r8)mComponents[33];
    }
    ...
    {
	return (rrc.informationelements.UL_EDCH_Information_r8)mComponents[36];
    }
    ...
    {
	return (rrc.informationelements.DL_HSPDSCH_Information_r8)mComponents[37];
    }
    ...
    {
	return (rrc.informationelements.DL_SecondaryCellInfoFDD)mComponents[40];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RadioBearerSetup_r8_IEs object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RadioBearerSetup_r8_IEs object.
     */
...
} // End class definition for RadioBearerSetup_r8_IEs
