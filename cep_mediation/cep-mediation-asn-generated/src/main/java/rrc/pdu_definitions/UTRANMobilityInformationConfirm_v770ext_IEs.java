...
/**
 * Define the ASN1 Type UTRANMobilityInformationConfirm_v770ext_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class UTRANMobilityInformationConfirm_v770ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public UTRANMobilityInformationConfirm_v770ext_IEs()
    {
    }
     ...
     */
    public UTRANMobilityInformationConfirm_v770ext_IEs(DeferredMeasurementControlReading deferredMeasurementControlReading)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"UTRANMobilityInformationConfirm_v770ext_IEs$DeferredMeasurementControlReading"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UTRANMobilityInformationConfirm_v770ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UTRANMobilityInformationConfirm_v770ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UTRANMobilityInformationConfirm_v770ext_IEs
