...
/**
 * Define the ASN1 Type TransportChannelReconfiguration_r5_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class TransportChannelReconfiguration_r5_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public TransportChannelReconfiguration_r5_IEs()
    {
    }
     ...
     */
    public TransportChannelReconfiguration_r5_IEs(rrc.informationelements.IntegrityProtectionModeInfo integrityProtectionModeInfo, 
     ...
     */
    public TransportChannelReconfiguration_r5_IEs(rrc.informationelements.RRC_StateIndicator rrc_StateIndicator, 
		    ModeSpecificPhysChInfo modeSpecificPhysChInfo)
    {
	setRrc_StateIndicator(rrc_StateIndicator);
	setModeSpecificPhysChInfo(modeSpecificPhysChInfo);
	...
	mComponents[12] = new rrc.informationelements.UL_CommonTransChInfo_r4();
	mComponents[13] = new rrc.informationelements.UL_AddReconfTransChInfoList();
	mComponents[14] = new Dummy();
	mComponents[15] = new rrc.informationelements.DL_CommonTransChInfo_r4();
	mComponents[16] = new rrc.informationelements.DL_AddReconfTransChInfoList_r5();
	mComponents[17] = new rrc.informationelements.FrequencyInfo();
	mComponents[18] = new rrc.informationelements.MaxAllowedUL_TX_Power();
	mComponents[19] = new rrc.informationelements.UL_ChannelRequirement_r5();
	mComponents[20] = new ModeSpecificPhysChInfo();
	mComponents[21] = new rrc.informationelements.DL_HSPDSCH_Information();
	mComponents[22] = new rrc.informationelements.DL_CommonInformation_r5();
	mComponents[23] = new rrc.informationelements.DL_InformationPerRL_List_r5();
    }
    ...
    {
	return (rrc.informationelements.UL_CommonTransChInfo_r4)mComponents[12];
    }
    
    public void setUl_CommonTransChInfo(rrc.informationelements.UL_CommonTransChInfo_r4 ul_CommonTransChInfo)
    {
	mComponents[12] = ul_CommonTransChInfo;
    }
    ...
    {
	return (rrc.informationelements.UL_AddReconfTransChInfoList)mComponents[13];
    }
    ...
    {
	mComponents[13] = ul_AddReconfTransChInfoList;
    }
    ...
    {
	return (Dummy)mComponents[14];
    }
    
    public void setDummy(Dummy dummy)
    {
	mComponents[14] = dummy;
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "TransportChannelReconfiguration_r5_IEs$Dummy$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfiguration_r5_IEs$Dummy"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonTransChInfo_r4)mComponents[15];
    }
    
    public void setDl_CommonTransChInfo(rrc.informationelements.DL_CommonTransChInfo_r4 dl_CommonTransChInfo)
    {
	mComponents[15] = dl_CommonTransChInfo;
    }
    ...
    {
	return (rrc.informationelements.DL_AddReconfTransChInfoList_r5)mComponents[16];
    }
    ...
    {
	mComponents[16] = dl_AddReconfTransChInfoList;
    }
    ...
    {
	return (rrc.informationelements.FrequencyInfo)mComponents[17];
    }
    
    public void setFrequencyInfo(rrc.informationelements.FrequencyInfo frequencyInfo)
    {
	mComponents[17] = frequencyInfo;
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.pdu_definitions",
		    "TransportChannelReconfiguration_r5_IEs$ModeSpecificPhysChInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"TransportChannelReconfiguration_r5_IEs$ModeSpecificPhysChInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (rrc.informationelements.DL_CommonInformation_r5)mComponents[22];
    }
    
    public void setDl_CommonInformation(rrc.informationelements.DL_CommonInformation_r5 dl_CommonInformation)
    {
	mComponents[22] = dl_CommonInformation;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r5_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TransportChannelReconfiguration_r5_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TransportChannelReconfiguration_r5_IEs
