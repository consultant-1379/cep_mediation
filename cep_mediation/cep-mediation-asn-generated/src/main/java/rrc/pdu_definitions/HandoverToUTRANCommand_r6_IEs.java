...
/**
 * Define the ASN1 Type HandoverToUTRANCommand_r6_IEs from ASN1 Module PDU_definitions.
 * @see Sequence
 */

public class HandoverToUTRANCommand_r6_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public HandoverToUTRANCommand_r6_IEs()
    {
    }
     ...
     */
    public HandoverToUTRANCommand_r6_IEs(rrc.informationelements.U_RNTI_Short new_U_RNTI, 
	...
	public static class Complete extends Sequence {
		...
		mComponents[3] = new rrc.informationelements.UL_AddReconfTransChInfoList_r6();
		...
		mComponents[6] = new rrc.informationelements.UL_DPCH_Info_r6();
		mComponents[7] = new rrc.informationelements.UL_EDCH_Information_r6();
		mComponents[8] = new rrc.informationelements.DL_HSPDSCH_Information_r6();
		mComponents[9] = new rrc.informationelements.DL_CommonInformation_r6();
		mComponents[10] = new rrc.informationelements.DL_InformationPerRL_List_r6();
	    ...
	    {
		return (rrc.informationelements.UL_AddReconfTransChInfoList_r6)mComponents[3];
	    }
	    ...
	    {
		return (rrc.informationelements.UL_DPCH_Info_r6)mComponents[6];
	    }
	    ...
	    {
		return (rrc.informationelements.UL_EDCH_Information_r6)mComponents[7];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_HSPDSCH_Information_r6)mComponents[8];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_CommonInformation_r6)mComponents[9];
	    }
	    ...
	    {
		return (rrc.informationelements.DL_InformationPerRL_List_r6)mComponents[10];
	    }
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverToUTRANCommand_r6_IEs$SpecificationMode$Complete"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Preconfiguration extends Sequence {
		...
		public static class DefaultConfig extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration$PreConfigMode$DefaultConfig"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration$PreConfigMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		public static class Fdd extends Sequence {
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Fdd"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class Tdd extends Choice {
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd$Tdd384"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			private static final SequenceInfo c_typeinfo = new SequenceInfo (
			    ...
			    new QName (
				"rrc.pdu_definitions",
				"HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd$Tdd128"
			    ),
			    new QName (
				"builtin",
				"SEQUENCE"
			...
			new QName (
			    "rrc.pdu_definitions",
			    "HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo$Tdd"
			),
			new QName (
			    "builtin",
			    "CHOICE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.pdu_definitions",
			"HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration$ModeSpecificInfo"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.pdu_definitions",
		    "HandoverToUTRANCommand_r6_IEs$SpecificationMode$Preconfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.pdu_definitions",
		"HandoverToUTRANCommand_r6_IEs$SpecificationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HandoverToUTRANCommand_r6_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HandoverToUTRANCommand_r6_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HandoverToUTRANCommand_r6_IEs
