...
/**
 * Define the ASN1 Type PUSCH_SysInfoList_SFN_LCR_r4 from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PUSCH_SysInfoList_SFN_LCR_r4 extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PUSCH_SysInfoList_SFN_LCR_r4()
    {
    }
     ...
     */
    public PUSCH_SysInfoList_SFN_LCR_r4(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(PUSCH_SysInfo_LCR_r4 pusch_SysInfo, 
			SFN_TimeInfo sfn_TimeInfo)
	{
	    setPusch_SysInfo(pusch_SysInfo);
	...
	{
	    mComponents[0] = new PUSCH_SysInfo_LCR_r4();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new PUSCH_SysInfo_LCR_r4();
		case 1:
	...
	// Methods for field "pusch_SysInfo"
	public PUSCH_SysInfo_LCR_r4 getPusch_SysInfo()
	{
	    return (PUSCH_SysInfo_LCR_r4)mComponents[0];
	}
	
	public void setPusch_SysInfo(PUSCH_SysInfo_LCR_r4 pusch_SysInfo)
	{
	    mComponents[0] = pusch_SysInfo;
	}
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN_LCR_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN_LCR_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PUSCH_SysInfoList_SFN_LCR_r4
