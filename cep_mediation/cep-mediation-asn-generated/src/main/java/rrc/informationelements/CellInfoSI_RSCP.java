...
/**
 * Define the ASN1 Type CellInfoSI_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellInfoSI_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellInfoSI_RSCP()
    {
    }
     ...
     */
    public CellInfoSI_RSCP(CellIndividualOffset cellIndividualOffset, 
		    ReferenceTimeDifferenceToCell referenceTimeDifferenceToCell, 
		    ModeSpecificInfo modeSpecificInfo, 
		    CellSelectReselectInfoSIB_11_12_RSCP cellSelectionReselectionInfo)
    {
     ...
     */
    public CellInfoSI_RSCP(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	mComponents[3] = new CellSelectReselectInfoSIB_11_12_RSCP();
    }
	...
	switch (index) {
	    ...
	    case 3:
		return new CellSelectReselectInfoSIB_11_12_RSCP();
	    default:
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellInfoSI_RSCP$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellInfoSI_RSCP$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CellInfoSI_RSCP$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public CellSelectReselectInfoSIB_11_12_RSCP getCellSelectionReselectionInfo()
    {
	return (CellSelectReselectInfoSIB_11_12_RSCP)mComponents[3];
    }
    
    public void setCellSelectionReselectionInfo(CellSelectReselectInfoSIB_11_12_RSCP cellSelectionReselectionInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellInfoSI_RSCP object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellInfoSI_RSCP object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellInfoSI_RSCP
