...
/**
 * Define the ASN1 Type UplinkAdditionalTimeslots_LCR_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UplinkAdditionalTimeslots_LCR_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UplinkAdditionalTimeslots_LCR_r7()
    {
    }
     ...
     */
    public UplinkAdditionalTimeslots_LCR_r7(Parameters parameters)
    {
	...
	public static class SameAsLast extends Sequence {
		...
		new QName (
		    ...
		    "UplinkAdditionalTimeslots_LCR_r7$Parameters$SameAsLast"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class NewParameters extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public NewParameters(IndividualTimeslotInfo_LCR_r4 individualTimeslotInfo, 
		...
		mComponents[1] = new UL_TS_ChannelisationCodeList_r7();
	    }
	    ...
	    {
		return (UL_TS_ChannelisationCodeList_r7)mComponents[1];
	    }
		...
		new QName (
		    "rrc.informationelements",
		    "UplinkAdditionalTimeslots_LCR_r7$Parameters$NewParameters"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UplinkAdditionalTimeslots_LCR_r7$Parameters"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UplinkAdditionalTimeslots_LCR_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UplinkAdditionalTimeslots_LCR_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UplinkAdditionalTimeslots_LCR_r7
