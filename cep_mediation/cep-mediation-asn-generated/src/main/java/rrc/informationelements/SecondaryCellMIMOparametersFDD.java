...
/**
 * Define the ASN1 Type SecondaryCellMIMOparametersFDD from ASN1 Module InformationElements.
 * @see Choice
 */

public class SecondaryCellMIMOparametersFDD extends Choice {
    
    /**
     * The default constructor.
     */
    public SecondaryCellMIMOparametersFDD()
    {
    }
    ...
    public static SecondaryCellMIMOparametersFDD createSecondaryCellMIMOparametersFDDWith_continue(Null _continue)
    {
	SecondaryCellMIMOparametersFDD __object = new SecondaryCellMIMOparametersFDD();
    ...
    public static SecondaryCellMIMOparametersFDD createSecondaryCellMIMOparametersFDDWithNewConfiguration(NewConfiguration newConfiguration)
    {
	SecondaryCellMIMOparametersFDD __object = new SecondaryCellMIMOparametersFDD();
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
		...
		"SecondaryCellMIMOparametersFDD$NewConfiguration"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SecondaryCellMIMOparametersFDD object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SecondaryCellMIMOparametersFDD object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SecondaryCellMIMOparametersFDD
