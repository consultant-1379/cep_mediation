...
/**
 * Define the ASN1 Type UE_Positioning_Measurement_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_Measurement_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_Measurement_r4()
    {
    }
     ...
     */
    public UE_Positioning_Measurement_r4(UE_Positioning_ReportingQuantity_r4 ue_positioning_ReportingQuantity, 
		    MeasurementValidity measurementValidity, 
		    UE_Positioning_ReportCriteria reportCriteria, 
		    UE_Positioning_OTDOA_AssistanceData_r4 ue_positioning_OTDOA_AssistanceData, 
    ...
    {
	mComponents[0] = new UE_Positioning_ReportingQuantity_r4();
	mComponents[1] = new MeasurementValidity();
	mComponents[2] = new UE_Positioning_ReportCriteria();
	mComponents[3] = new UE_Positioning_OTDOA_AssistanceData_r4();
	mComponents[4] = new UE_Positioning_GPS_AssistanceData();
    }
	...
	switch (index) {
	    case 0:
		return new UE_Positioning_ReportingQuantity_r4();
	    case 1:
		return new MeasurementValidity();
	    case 2:
		return new UE_Positioning_ReportCriteria();
	    case 3:
		return new UE_Positioning_OTDOA_AssistanceData_r4();
	    case 4:
    ...
    public UE_Positioning_ReportingQuantity_r4 getUe_positioning_ReportingQuantity()
    {
	return (UE_Positioning_ReportingQuantity_r4)mComponents[0];
    }
    
    public void setUe_positioning_ReportingQuantity(UE_Positioning_ReportingQuantity_r4 ue_positioning_ReportingQuantity)
    {
    ...
    {
	return (UE_Positioning_ReportCriteria)mComponents[2];
    }
    ...
    public UE_Positioning_OTDOA_AssistanceData_r4 getUe_positioning_OTDOA_AssistanceData()
    {
	return (UE_Positioning_OTDOA_AssistanceData_r4)mComponents[3];
    }
    
    public void setUe_positioning_OTDOA_AssistanceData(UE_Positioning_OTDOA_AssistanceData_r4 ue_positioning_OTDOA_AssistanceData)
    {
    ...
    {
	return (UE_Positioning_GPS_AssistanceData)mComponents[4];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r4 object.
     */
...
} // End class definition for UE_Positioning_Measurement_r4
