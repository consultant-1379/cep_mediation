...
/**
 * Define the ASN1 Type DL_CommonTransChInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_CommonTransChInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_CommonTransChInfo()
    {
    }
     ...
     */
    public DL_CommonTransChInfo(TFCS sccpch_TFCS, 
     ...
     */
    public DL_CommonTransChInfo(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	public static class Fdd extends Sequence {
		...
		public static Dl_Parameters createDl_ParametersWithDl_DCH_TFCS(TFCS dl_DCH_TFCS)
		{
		...
		public void setDl_DCH_TFCS(TFCS dl_DCH_TFCS)
		{
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
			...
			"DL_CommonTransChInfo$ModeSpecificInfo$Fdd$Dl_Parameters"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_CommonTransChInfo$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "DL_CommonTransChInfo$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_CommonTransChInfo$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_CommonTransChInfo object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_CommonTransChInfo object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_CommonTransChInfo
