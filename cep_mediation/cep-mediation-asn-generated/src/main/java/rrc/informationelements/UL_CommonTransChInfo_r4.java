...
/**
 * Define the ASN1 Type UL_CommonTransChInfo_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_CommonTransChInfo_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UL_CommonTransChInfo_r4()
    {
    }
     ...
     */
    public UL_CommonTransChInfo_r4(TFC_Subset tfc_Subset, TFCS prach_TFCS, 
		    ModeSpecificInfo modeSpecificInfo, 
		    TFC_SubsetList tfc_SubsetList)
    {
	setTfc_Subset(tfc_Subset);
	setPrach_TFCS(prach_TFCS);
	setModeSpecificInfo(modeSpecificInfo);
	setTfc_SubsetList(tfc_SubsetList);
    }
	...
	mComponents[3] = new TFC_SubsetList();
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "UL_CommonTransChInfo_r4$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UL_CommonTransChInfo_r4$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UL_CommonTransChInfo_r4$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    // Methods for field "tfc_SubsetList"
    public TFC_SubsetList getTfc_SubsetList()
    {
	return (TFC_SubsetList)mComponents[3];
    }
    
    public void setTfc_SubsetList(TFC_SubsetList tfc_SubsetList)
    {
	mComponents[3] = tfc_SubsetList;
    }
    
    public boolean hasTfc_SubsetList()
    {
	return componentIsPresent(3);
    }
    
    public void deleteTfc_SubsetList()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_CommonTransChInfo_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_CommonTransChInfo_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_CommonTransChInfo_r4
