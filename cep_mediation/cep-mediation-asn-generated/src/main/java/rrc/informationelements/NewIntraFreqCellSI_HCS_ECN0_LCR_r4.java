...
/**
 * Define the ASN1 Type NewIntraFreqCellSI_HCS_ECN0_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewIntraFreqCellSI_HCS_ECN0_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewIntraFreqCellSI_HCS_ECN0_LCR_r4()
    {
    }
     ...
     */
    public NewIntraFreqCellSI_HCS_ECN0_LCR_r4(IntraFreqCellID intraFreqCellID, 
     ...
     */
    public NewIntraFreqCellSI_HCS_ECN0_LCR_r4(CellInfoSI_HCS_ECN0_LCR_r4 cellInfo)
    {
	setCellInfo(cellInfo);
    }
	...
	mComponents[1] = new CellInfoSI_HCS_ECN0_LCR_r4();
    }
    ...
    {
	return (CellInfoSI_HCS_ECN0_LCR_r4)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewIntraFreqCellSI_HCS_ECN0_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewIntraFreqCellSI_HCS_ECN0_LCR_r4 object.
     */
...
} // End class definition for NewIntraFreqCellSI_HCS_ECN0_LCR_r4
