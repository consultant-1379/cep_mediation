...
/**
 * Define the ASN1 Type SIB_ReferenceList from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class SIB_ReferenceList extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public SIB_ReferenceList()
    {
    }
     ...
     */
    public SIB_ReferenceList(SchedulingInformationSIB[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SIB_ReferenceList object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SIB_ReferenceList object.
     */
...
} // End class definition for SIB_ReferenceList
