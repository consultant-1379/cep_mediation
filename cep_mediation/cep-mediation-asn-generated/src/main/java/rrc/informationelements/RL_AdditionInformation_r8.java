...
/**
 * Define the ASN1 Type RL_AdditionInformation_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RL_AdditionInformation_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public RL_AdditionInformation_r8()
    {
    }
	...
	mComponents[5] = new TargetCellPreconfigInfo();
    }
	...
	switch (index) {
	    ...
	    case 5:
		return new TargetCellPreconfigInfo();
	    default:
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"RL_AdditionInformation_r8$Dl_dpchInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public TargetCellPreconfigInfo getTargetCellPreconfigInfo()
    {
	return (TargetCellPreconfigInfo)mComponents[5];
    }
    
    public void setTargetCellPreconfigInfo(TargetCellPreconfigInfo targetCellPreconfigInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RL_AdditionInformation_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RL_AdditionInformation_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RL_AdditionInformation_r8
