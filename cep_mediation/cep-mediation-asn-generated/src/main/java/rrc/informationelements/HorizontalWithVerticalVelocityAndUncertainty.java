...
/**
 * Define the ASN1 Type HorizontalWithVerticalVelocityAndUncertainty from ASN1 Module InformationElements.
 * @see Sequence
 */

public class HorizontalWithVerticalVelocityAndUncertainty extends Sequence {
     ...
     */
    public HorizontalWithVerticalVelocityAndUncertainty(VerticalSpeedDirection verticalSpeedDirection, 
		    INTEGER bearing, INTEGER horizontalSpeed, 
		    INTEGER verticalSpeed, INTEGER horizontalUncertaintySpeed, 
		    INTEGER verticalUncertaintySpeed)
    {
	setVerticalSpeedDirection(verticalSpeedDirection);
	setBearing(bearing);
	setHorizontalSpeed(horizontalSpeed);
	setVerticalSpeed(verticalSpeed);
	setHorizontalUncertaintySpeed(horizontalUncertaintySpeed);
	setVerticalUncertaintySpeed(verticalUncertaintySpeed);
    }
	...
	this(verticalSpeedDirection, new INTEGER(bearing), 
	     ...
	     new INTEGER(horizontalUncertaintySpeed), 
	     new INTEGER(verticalUncertaintySpeed));
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"HorizontalWithVerticalVelocityAndUncertainty$VerticalSpeedDirection"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    // Methods for field "horizontalUncertaintySpeed"
    public long getHorizontalUncertaintySpeed()
    {
	return ((INTEGER)mComponents[4]).longValue();
    }
    
    public void setHorizontalUncertaintySpeed(long horizontalUncertaintySpeed)
    {
	setHorizontalUncertaintySpeed(new INTEGER(horizontalUncertaintySpeed));
    }
    
    public void setHorizontalUncertaintySpeed(INTEGER horizontalUncertaintySpeed)
    {
	mComponents[4] = horizontalUncertaintySpeed;
    }
    
    
    // Methods for field "verticalUncertaintySpeed"
    public long getVerticalUncertaintySpeed()
    {
	return ((INTEGER)mComponents[5]).longValue();
    }
    
    public void setVerticalUncertaintySpeed(long verticalUncertaintySpeed)
    {
	setVerticalUncertaintySpeed(new INTEGER(verticalUncertaintySpeed));
    }
    
    public void setVerticalUncertaintySpeed(INTEGER verticalUncertaintySpeed)
    {
	mComponents[5] = verticalUncertaintySpeed;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HorizontalWithVerticalVelocityAndUncertainty object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HorizontalWithVerticalVelocityAndUncertainty object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HorizontalWithVerticalVelocityAndUncertainty
