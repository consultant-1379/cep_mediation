...
/**
 * Define the ASN1 Type InterFreqReportCriteria_r9 from ASN1 Module InformationElements.
 * @see Choice
 */

public class InterFreqReportCriteria_r9 extends Choice {
    
    /**
     * The default constructor.
     */
    public InterFreqReportCriteria_r9()
    {
    }
    ...
    public static InterFreqReportCriteria_r9 createInterFreqReportCriteria_r9WithIntraFreqReportingCriteria(IntraFreqReportingCriteria_r9 intraFreqReportingCriteria)
    {
	InterFreqReportCriteria_r9 __object = new InterFreqReportCriteria_r9();
    ...
    public static InterFreqReportCriteria_r9 createInterFreqReportCriteria_r9WithInterFreqReportingCriteria(InterFreqReportingCriteria_r6 interFreqReportingCriteria)
    {
	InterFreqReportCriteria_r9 __object = new InterFreqReportCriteria_r9();
    ...
    public static InterFreqReportCriteria_r9 createInterFreqReportCriteria_r9WithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	InterFreqReportCriteria_r9 __object = new InterFreqReportCriteria_r9();
    ...
    public static InterFreqReportCriteria_r9 createInterFreqReportCriteria_r9WithNoReporting(ReportingCellStatusOpt noReporting)
    {
	InterFreqReportCriteria_r9 __object = new InterFreqReportCriteria_r9();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFreqReportCriteria_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFreqReportCriteria_r9 object.
     */
...
} // End class definition for InterFreqReportCriteria_r9
