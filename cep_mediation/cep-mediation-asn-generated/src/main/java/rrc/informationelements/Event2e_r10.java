...
/**
 * Define the ASN1 Type Event2e_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2e_r10 extends Sequence {
     ...
     */
    public Event2e_r10(HysteresisInterFreq hysteresis, 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2e_r10 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2e_r10 object.
     */
...
} // End class definition for Event2e_r10
