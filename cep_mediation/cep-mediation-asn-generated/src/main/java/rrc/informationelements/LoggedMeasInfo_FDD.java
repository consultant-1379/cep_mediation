...
/**
 * Define the ASN1 Type LoggedMeasInfo_FDD from ASN1 Module InformationElements.
 * @see Sequence
 */

public class LoggedMeasInfo_FDD extends Sequence {
    
    /**
     * The default constructor.
     */
    public LoggedMeasInfo_FDD()
    {
    }
     ...
     */
    public LoggedMeasInfo_FDD(INTEGER relativeTimeStamp, 
		    LoggedMeasServingCellMeas_FDD loggedMeasServingCellMeas, 
		    LoggedMeasIntrafreqNeighbourList_FDD loggedMeasIntrafreqNeighbourList, 
		    LoggedMeasInterfreqList_FDD loggedMeasInterfreqList, 
     ...
     */
    public LoggedMeasInfo_FDD(long relativeTimeStamp, 
		    LoggedMeasServingCellMeas_FDD loggedMeasServingCellMeas, 
		    LoggedMeasIntrafreqNeighbourList_FDD loggedMeasIntrafreqNeighbourList, 
		    LoggedMeasInterfreqList_FDD loggedMeasInterfreqList, 
		    LoggedMeasInterRATNeighbourMeas loggedMeasInterRATNeighbourMeas, 
	...
	mComponents[1] = new LoggedMeasServingCellMeas_FDD();
	mComponents[2] = new LoggedMeasIntrafreqNeighbourList_FDD();
	mComponents[3] = new LoggedMeasInterfreqList_FDD();
	...
	switch (index) {
		...
		return new INTEGER();
	    case 1:
		return new LoggedMeasServingCellMeas_FDD();
	    case 2:
		return new LoggedMeasIntrafreqNeighbourList_FDD();
	    case 3:
		return new LoggedMeasInterfreqList_FDD();
	    case 4:
    ...
    public LoggedMeasServingCellMeas_FDD getLoggedMeasServingCellMeas()
    {
	return (LoggedMeasServingCellMeas_FDD)mComponents[1];
    }
    
    public void setLoggedMeasServingCellMeas(LoggedMeasServingCellMeas_FDD loggedMeasServingCellMeas)
    {
    ...
    public LoggedMeasIntrafreqNeighbourList_FDD getLoggedMeasIntrafreqNeighbourList()
    {
	return (LoggedMeasIntrafreqNeighbourList_FDD)mComponents[2];
    }
    
    public void setLoggedMeasIntrafreqNeighbourList(LoggedMeasIntrafreqNeighbourList_FDD loggedMeasIntrafreqNeighbourList)
    {
    ...
    public LoggedMeasInterfreqList_FDD getLoggedMeasInterfreqList()
    {
	return (LoggedMeasInterfreqList_FDD)mComponents[3];
    }
    
    public void setLoggedMeasInterfreqList(LoggedMeasInterfreqList_FDD loggedMeasInterfreqList)
    {
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new ContainerInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"LoggedMeasIntrafreqNeighbourList_FDD"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' LoggedMeasInfo_FDD object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' LoggedMeasInfo_FDD object.
     */
...
} // End class definition for LoggedMeasInfo_FDD
