...
/**
 * Define the ASN1 Type TGPS_ConfigurationParams from ASN1 Module InformationElements.
 * @see Sequence
 */

public class TGPS_ConfigurationParams extends Sequence {
    
    /**
     * The default constructor.
     */
    public TGPS_ConfigurationParams()
    {
    }
     ...
     */
    public TGPS_ConfigurationParams(TGMP tgmp, TGPRC tgprc, TGSN tgsn, 
		    TGL tgl1, TGL tgl2, TGD tgd, TGPL tgpl1, TGPL dummy, 
		    RPP rpp, ITP itp, UL_DL_Mode ul_DL_Mode, 
    ...
    {
	mComponents[0] = TGMP.tdd_Measurement;
    ...
    public TGMP getTgmp()
    {
	return (TGMP)mComponents[0];
    }
    
    public void setTgmp(TGMP tgmp)
    {
	mComponents[0] = tgmp;
    }
    ...
    public TGPL getDummy()
    {
	return (TGPL)mComponents[7];
    }
    
    public void setDummy(TGPL dummy)
    {
	mComponents[7] = dummy;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TGPS_ConfigurationParams object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TGPS_ConfigurationParams object.
     */
...
} // End class definition for TGPS_ConfigurationParams
