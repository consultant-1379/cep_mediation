...
/**
 * Define the ASN1 Type IntraFreqEventCriteriaOnSecULFreq from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqEventCriteriaOnSecULFreq extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqEventCriteriaOnSecULFreq()
    {
    }
     ...
     */
    public IntraFreqEventCriteriaOnSecULFreq(IntraFreqEventOnSecULFreq event, 
    ...
    {
	mComponents[0] = new IntraFreqEventOnSecULFreq();
	...
	switch (index) {
	    case 0:
		return new IntraFreqEventOnSecULFreq();
	    case 1:
    ...
    public IntraFreqEventOnSecULFreq getEvent()
    {
	return (IntraFreqEventOnSecULFreq)mComponents[0];
    }
    
    public void setEvent(IntraFreqEventOnSecULFreq event)
    {
	mComponents[0] = event;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEventCriteriaOnSecULFreq object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEventCriteriaOnSecULFreq object.
     */
...
} // End class definition for IntraFreqEventCriteriaOnSecULFreq
