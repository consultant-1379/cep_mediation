...
/**
 * Define the ASN1 Type MeasurementType_r7 from ASN1 Module InformationElements.
 * @see Choice
 */

public class MeasurementType_r7 extends Choice {
    
    /**
     * The default constructor.
     */
    public MeasurementType_r7()
    {
    }
    ...
    public static MeasurementType_r7 createMeasurementType_r7WithIntraFrequencyMeasurement(IntraFrequencyMeasurement_r7 intraFrequencyMeasurement)
    {
	MeasurementType_r7 __object = new MeasurementType_r7();
    ...
    public void setIntraFrequencyMeasurement(IntraFrequencyMeasurement_r7 intraFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r7 createMeasurementType_r7WithInterFrequencyMeasurement(InterFrequencyMeasurement_r7 interFrequencyMeasurement)
    {
	MeasurementType_r7 __object = new MeasurementType_r7();
    ...
    public void setInterFrequencyMeasurement(InterFrequencyMeasurement_r7 interFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r7 createMeasurementType_r7WithInterRATMeasurement(InterRATMeasurement_r6 interRATMeasurement)
    {
	MeasurementType_r7 __object = new MeasurementType_r7();
    ...
    public void setInterRATMeasurement(InterRATMeasurement_r6 interRATMeasurement)
    {
    ...
    public static MeasurementType_r7 createMeasurementType_r7WithUp_Measurement(UE_Positioning_Measurement_r7 up_Measurement)
    {
	MeasurementType_r7 __object = new MeasurementType_r7();
    ...
    public void setUp_Measurement(UE_Positioning_Measurement_r7 up_Measurement)
    {
    ...
    public static MeasurementType_r7 createMeasurementType_r7WithTrafficVolumeMeasurement(TrafficVolumeMeasurement trafficVolumeMeasurement)
    {
	MeasurementType_r7 __object = new MeasurementType_r7();
    ...
    public static MeasurementType_r7 createMeasurementType_r7WithQualityMeasurement(QualityMeasurement qualityMeasurement)
    {
	MeasurementType_r7 __object = new MeasurementType_r7();
    ...
    public static MeasurementType_r7 createMeasurementType_r7WithUe_InternalMeasurement(UE_InternalMeasurement_r4 ue_InternalMeasurement)
    {
	MeasurementType_r7 __object = new MeasurementType_r7();
	...
	switch (chosen) {
		...
		return new IntraFrequencyMeasurement_r7();
	    case interFrequencyMeasurement_chosen:
		return new InterFrequencyMeasurement_r7();
	    case interRATMeasurement_chosen:
		return new InterRATMeasurement_r6();
	    case up_Measurement_chosen:
		return new UE_Positioning_Measurement_r7();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementType_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementType_r7 object.
     */
...
} // End class definition for MeasurementType_r7
