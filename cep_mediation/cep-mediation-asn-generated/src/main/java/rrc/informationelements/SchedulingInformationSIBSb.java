...
/**
 * Define the ASN1 Type SchedulingInformationSIBSb from ASN1 Module InformationElements.
 * @see Sequence
 */

public class SchedulingInformationSIBSb extends Sequence {
    
    /**
     * The default constructor.
     */
    public SchedulingInformationSIBSb()
    {
    }
     ...
     */
    public SchedulingInformationSIBSb(SIBSb_TypeAndTag sibSb_Type, 
		    SchedulingInformation scheduling)
    {
	setSibSb_Type(sibSb_Type);
	setScheduling(scheduling);
    }
    
    public void initComponents()
    {
	mComponents[0] = new SIBSb_TypeAndTag();
    ...
    // Methods for field "sibSb_Type"
    public SIBSb_TypeAndTag getSibSb_Type()
    {
	return (SIBSb_TypeAndTag)mComponents[0];
    }
    
    public void setSibSb_Type(SIBSb_TypeAndTag sibSb_Type)
    {
	mComponents[0] = sibSb_Type;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SchedulingInformationSIBSb object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SchedulingInformationSIBSb object.
     */
...
} // End class definition for SchedulingInformationSIBSb
