...
/**
 * Define the ASN1 Type Serving_HSDSCH_CellInformation from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Serving_HSDSCH_CellInformation extends Sequence {
    
    /**
     * The default constructor.
     */
    public Serving_HSDSCH_CellInformation()
    {
    }
     ...
     */
    public Serving_HSDSCH_CellInformation(DeltaACK deltaACK, 
		    DeltaNACK deltaNACK, 
		    HARQ_Preamble_Mode harq_Preamble_Mode, 
		    PrimaryCPICH_Info primaryCPICH_Info, 
		    DL_HSPDSCH_Information dl_hspdsch_Information, 
		    HARQ_Info harqInfo, 
     ...
     */
    public Serving_HSDSCH_CellInformation(HARQ_Preamble_Mode harq_Preamble_Mode)
    {
	setHarq_Preamble_Mode(harq_Preamble_Mode);
    }
	...
	mComponents[4] = new DL_HSPDSCH_Information();
	mComponents[5] = new HARQ_Info();
	...
	switch (index) {
	    ...
	    case 4:
		return new DL_HSPDSCH_Information();
	    case 5:
    ...
    public DL_HSPDSCH_Information getDl_hspdsch_Information()
    {
	return (DL_HSPDSCH_Information)mComponents[4];
    }
    
    public void setDl_hspdsch_Information(DL_HSPDSCH_Information dl_hspdsch_Information)
    {
    ...
    {
	return (HARQ_Info)mComponents[5];
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"Serving_HSDSCH_CellInformation$Mac_hsResetIndicator"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Serving_HSDSCH_CellInformation object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Serving_HSDSCH_CellInformation object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for Serving_HSDSCH_CellInformation
