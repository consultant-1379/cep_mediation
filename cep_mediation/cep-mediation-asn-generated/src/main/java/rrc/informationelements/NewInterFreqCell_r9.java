...
/**
 * Define the ASN1 Type NewInterFreqCell_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterFreqCell_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterFreqCell_r9()
    {
    }
     ...
     */
    public NewInterFreqCell_r9(InterFreqCellID interFreqCellID, 
     ...
     */
    public NewInterFreqCell_r9(CellInfo_r9 cellInfo, 
		    ModeSpecificInfo modeSpecificInfo)
    {
	setCellInfo(cellInfo);
	setModeSpecificInfo(modeSpecificInfo);
	...
	public static class Tdd128 extends Sequence {
		...
		new QName (
		    ...
		    "NewInterFreqCell_r9$ModeSpecificInfo$Tdd128"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"NewInterFreqCell_r9$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterFreqCell_r9 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterFreqCell_r9 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for NewInterFreqCell_r9
