...
/**
 * Define the ASN1 Type IntraFreqEvent_r7 from ASN1 Module InformationElements.
 * @see Choice
 */

public class IntraFreqEvent_r7 extends Choice {
    
    /**
     * The default constructor.
     */
    public IntraFreqEvent_r7()
    {
    }
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1a(Event1a_r4 e1a)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1b(Event1b_r7 e1b)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public void setE1b(Event1b_r7 e1b)
    {
	setChosenValue(e1b);
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1c(Event1c e1c)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1d(Event1d e1d)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1e(Event1e_r6 e1e)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1f(Event1f_r6 e1f)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1g(Null e1g)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1h(long e1h)
    {
	return createIntraFreqEvent_r7WithE1h(new ThresholdUsedFrequency_r6(e1h));
    }
    
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1h(ThresholdUsedFrequency_r6 e1h)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1i(long e1i)
    {
	return createIntraFreqEvent_r7WithE1i(new ThresholdUsedFrequency_r6(e1i));
    }
    
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1i(ThresholdUsedFrequency_r6 e1i)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    public static IntraFreqEvent_r7 createIntraFreqEvent_r7WithE1j(Event1j_r6 e1j)
    {
	IntraFreqEvent_r7 __object = new IntraFreqEvent_r7();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEvent_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEvent_r7 object.
     */
...
} // End class definition for IntraFreqEvent_r7
