...
/**
 * Define the ASN1 Type IntraFreqEvent_LCR_r4 from ASN1 Module InformationElements.
 * @see Choice
 */

public class IntraFreqEvent_LCR_r4 extends Choice {
    
    /**
     * The default constructor.
     */
    public IntraFreqEvent_LCR_r4()
    {
    }
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1a(Event1a_LCR_r4 e1a)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public void setE1a(Event1a_LCR_r4 e1a)
    {
	setChosenValue(e1a);
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1b(Event1b_LCR_r4 e1b)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public void setE1b(Event1b_LCR_r4 e1b)
    {
	setChosenValue(e1b);
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1c(Event1c e1c)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1d(Null e1d)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1e(Event1e e1e)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1f(Event1f e1f)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1g(Null e1g)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1h(long e1h)
    {
	return createIntraFreqEvent_LCR_r4WithE1h(new ThresholdUsedFrequency(e1h));
    }
    
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1h(ThresholdUsedFrequency e1h)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
    ...
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1i(long e1i)
    {
	return createIntraFreqEvent_LCR_r4WithE1i(new ThresholdUsedFrequency(e1i));
    }
    
    public static IntraFreqEvent_LCR_r4 createIntraFreqEvent_LCR_r4WithE1i(ThresholdUsedFrequency e1i)
    {
	IntraFreqEvent_LCR_r4 __object = new IntraFreqEvent_LCR_r4();
	...
	switch (chosen) {
	    case e1a_chosen:
		return new Event1a_LCR_r4();
	    case e1b_chosen:
		return new Event1b_LCR_r4();
	    case e1c_chosen:
		return new Event1c();
	    case e1d_chosen:
		return new Null();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEvent_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEvent_LCR_r4 object.
     */
...
} // End class definition for IntraFreqEvent_LCR_r4
