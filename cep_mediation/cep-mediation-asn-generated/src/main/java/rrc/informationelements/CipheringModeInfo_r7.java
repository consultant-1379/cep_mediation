...
/**
 * Define the ASN1 Type CipheringModeInfo_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CipheringModeInfo_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public CipheringModeInfo_r7()
    {
    }
     ...
     */
    public CipheringModeInfo_r7(CipheringModeCommand_r7 cipheringModeCommand, 
    ...
    {
	mComponents[0] = new CipheringModeCommand_r7();
	...
	switch (index) {
	    case 0:
		return new CipheringModeCommand_r7();
	    case 1:
    ...
    public CipheringModeCommand_r7 getCipheringModeCommand()
    {
	return (CipheringModeCommand_r7)mComponents[0];
    }
    
    public void setCipheringModeCommand(CipheringModeCommand_r7 cipheringModeCommand)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CipheringModeInfo_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CipheringModeInfo_r7 object.
     */
...
} // End class definition for CipheringModeInfo_r7
