...
/**
 * Define the ASN1 Type Event1e_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event1e_r6 extends Sequence {
     ...
     */
    public Event1e_r6(TriggeringCondition2 triggeringCondition, 
		    ThresholdUsedFrequency_r6 thresholdUsedFrequency)
    {
	...
	mComponents[1] = new ThresholdUsedFrequency_r6();
    }
    ...
    public ThresholdUsedFrequency_r6 getThresholdUsedFrequency()
    {
	return (ThresholdUsedFrequency_r6)mComponents[1];
    }
    
    public void setThresholdUsedFrequency(ThresholdUsedFrequency_r6 thresholdUsedFrequency)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event1e_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event1e_r6 object.
     */
...
} // End class definition for Event1e_r6
