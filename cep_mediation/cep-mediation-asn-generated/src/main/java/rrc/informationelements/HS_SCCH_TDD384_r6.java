...
/**
 * Define the ASN1 Type HS_SCCH_TDD384_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class HS_SCCH_TDD384_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public HS_SCCH_TDD384_r6()
    {
    }
     ...
     */
    public HS_SCCH_TDD384_r6(TimeslotNumber timeslotNumber, 
		    ...
		    HS_SICH_Configuration_TDD384 hs_sich_configuration)
    {
	...
	mComponents[4] = new HS_SICH_Configuration_TDD384();
    }
	...
	switch (index) {
	    ...
	    case 4:
		return new HS_SICH_Configuration_TDD384();
	    default:
	...
	public static class UeSpecificMidamble extends Sequence {
		...
		new QName (
		    ...
		    "HS_SCCH_TDD384_r6$MidambleAllocationMode$UeSpecificMidamble"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"HS_SCCH_TDD384_r6$MidambleAllocationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public HS_SICH_Configuration_TDD384 getHs_sich_configuration()
    {
	return (HS_SICH_Configuration_TDD384)mComponents[4];
    }
    
    public void setHs_sich_configuration(HS_SICH_Configuration_TDD384 hs_sich_configuration)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HS_SCCH_TDD384_r6 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HS_SCCH_TDD384_r6 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HS_SCCH_TDD384_r6
