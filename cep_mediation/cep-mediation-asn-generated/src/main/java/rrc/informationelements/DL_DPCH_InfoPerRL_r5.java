...
/**
 * Define the ASN1 Type DL_DPCH_InfoPerRL_r5 from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_DPCH_InfoPerRL_r5 extends Choice {
    
    /**
     * The default constructor.
     */
    public DL_DPCH_InfoPerRL_r5()
    {
    }
    ...
    public static DL_DPCH_InfoPerRL_r5 createDL_DPCH_InfoPerRL_r5WithFdd(Fdd fdd)
    {
	DL_DPCH_InfoPerRL_r5 __object = new DL_DPCH_InfoPerRL_r5();
	...
	public void initComponents()
	{
	    ...
	    mComponents[6] = SSDT_CellIdentity.ssdt_id_a;
	    mComponents[7] = ClosedLoopTimingAdjMode.slot1;
	}
	...
	public AbstractData createInstance(int index)
	{
		...
		case 6:
		    return SSDT_CellIdentity.ssdt_id_a;
		case 7:
	...
	public SSDT_CellIdentity getDummy()
	{
	    return (SSDT_CellIdentity)mComponents[6];
	}
	
	public void setDummy(SSDT_CellIdentity dummy)
	{
	    mComponents[6] = dummy;
	}
    ...
    public static DL_DPCH_InfoPerRL_r5 createDL_DPCH_InfoPerRL_r5WithTdd(Tdd tdd)
    {
	DL_DPCH_InfoPerRL_r5 __object = new DL_DPCH_InfoPerRL_r5();
	 ...
	 * Construct with AbstractData components.
	 */
	public Tdd(DL_CCTrChList_r4 dl_CCTrChListToEstablish, 
	...
	public void initComponents()
	{
	    mComponents[0] = new DL_CCTrChList_r4();
	...
	public DL_CCTrChList_r4 getDl_CCTrChListToEstablish()
	{
	    return (DL_CCTrChList_r4)mComponents[0];
	}
	
	public void setDl_CCTrChListToEstablish(DL_CCTrChList_r4 dl_CCTrChListToEstablish)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL_r5 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL_r5 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_DPCH_InfoPerRL_r5
