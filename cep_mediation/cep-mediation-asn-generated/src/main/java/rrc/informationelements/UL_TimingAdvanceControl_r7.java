...
/**
 * Define the ASN1 Type UL_TimingAdvanceControl_r7 from ASN1 Module InformationElements.
 * @see Choice
 */

public class UL_TimingAdvanceControl_r7 extends Choice {
    
    /**
     * The default constructor.
     */
    public UL_TimingAdvanceControl_r7()
    {
    }
    ...
    public static UL_TimingAdvanceControl_r7 createUL_TimingAdvanceControl_r7WithDisabled(Null disabled)
    {
	UL_TimingAdvanceControl_r7 __object = new UL_TimingAdvanceControl_r7();
    ...
    public static UL_TimingAdvanceControl_r7 createUL_TimingAdvanceControl_r7WithEnabled(Enabled enabled)
    {
	UL_TimingAdvanceControl_r7 __object = new UL_TimingAdvanceControl_r7();
	...
	public static class TddOption extends Choice {
		...
		public Tdd384(UL_TimingAdvance ul_TimingAdvance, 
				EXT_UL_TimingAdvance ext_UL_TimingAdvance, 
		...
		public void initComponents()
		{
		    ...
		    mComponents[1] = new EXT_UL_TimingAdvance();
		...
		public EXT_UL_TimingAdvance getExt_UL_TimingAdvance()
		{
		    return (EXT_UL_TimingAdvance)mComponents[1];
		}
		
		public void setExt_UL_TimingAdvance(EXT_UL_TimingAdvance ext_UL_TimingAdvance)
		{
		    mComponents[1] = ext_UL_TimingAdvance;
		}
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"UL_TimingAdvanceControl_r7$Enabled$TddOption$Tdd384"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		 ...
		 * Construct with AbstractData components.
		 */
		public Tdd768(EXT_UL_TimingAdvance ext_UL_TimingAdvance, 
				ActivationTime activationTime)
		{
		    setExt_UL_TimingAdvance(ext_UL_TimingAdvance);
		    setActivationTime(activationTime);
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UL_TimingAdvanceControl_r7$Enabled$TddOption$Tdd768"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UL_TimingAdvanceControl_r7$Enabled$TddOption$Tdd128"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "UL_TimingAdvanceControl_r7$Enabled$TddOption"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UL_TimingAdvanceControl_r7$Enabled"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_TimingAdvanceControl_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_TimingAdvanceControl_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_TimingAdvanceControl_r7
