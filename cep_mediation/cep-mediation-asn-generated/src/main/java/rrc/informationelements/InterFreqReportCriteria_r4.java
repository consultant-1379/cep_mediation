...
/**
 * Define the ASN1 Type InterFreqReportCriteria_r4 from ASN1 Module InformationElements.
 * @see Choice
 */

public class InterFreqReportCriteria_r4 extends Choice {
    
    /**
     * The default constructor.
     */
    public InterFreqReportCriteria_r4()
    {
    }
    ...
    public static InterFreqReportCriteria_r4 createInterFreqReportCriteria_r4WithIntraFreqReportingCriteria(IntraFreqReportingCriteria_r4 intraFreqReportingCriteria)
    {
	InterFreqReportCriteria_r4 __object = new InterFreqReportCriteria_r4();
    ...
    public void setIntraFreqReportingCriteria(IntraFreqReportingCriteria_r4 intraFreqReportingCriteria)
    {
    ...
    public static InterFreqReportCriteria_r4 createInterFreqReportCriteria_r4WithInterFreqReportingCriteria(InterFreqReportingCriteria interFreqReportingCriteria)
    {
	InterFreqReportCriteria_r4 __object = new InterFreqReportCriteria_r4();
    ...
    public static InterFreqReportCriteria_r4 createInterFreqReportCriteria_r4WithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	InterFreqReportCriteria_r4 __object = new InterFreqReportCriteria_r4();
    ...
    public static InterFreqReportCriteria_r4 createInterFreqReportCriteria_r4WithNoReporting(ReportingCellStatusOpt noReporting)
    {
	InterFreqReportCriteria_r4 __object = new InterFreqReportCriteria_r4();
	...
	switch (chosen) {
		...
		return new IntraFreqReportingCriteria_r4();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFreqReportCriteria_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFreqReportCriteria_r4 object.
     */
...
} // End class definition for InterFreqReportCriteria_r4
