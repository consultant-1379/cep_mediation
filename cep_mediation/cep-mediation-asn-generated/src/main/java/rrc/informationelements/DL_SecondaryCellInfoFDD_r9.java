...
/**
 * Define the ASN1 Type DL_SecondaryCellInfoFDD_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_SecondaryCellInfoFDD_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_SecondaryCellInfoFDD_r9()
    {
    }
     ...
     */
    public DL_SecondaryCellInfoFDD_r9(ConfigurationInfo configurationInfo, 
		    SecondaryCellMIMOparametersFDD secondaryCellMIMOparameters)
    {
	...
	mComponents[1] = new SecondaryCellMIMOparametersFDD();
    }
	...
	switch (index) {
	    ...
	    case 1:
		return new SecondaryCellMIMOparametersFDD();
	    default:
	...
	public static class NewConfiguration extends Sequence {
		...
		private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
			...
			"DL_SecondaryCellInfoFDD_r9$ConfigurationInfo$NewConfiguration$Dl_64QAM_Configured"
		    ),
		    new QName (
			"builtin",
			"ENUMERATED"
		...
		private static final ContainerInfo c_typeinfo = new ContainerInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_SecondaryCellInfoFDD_r9$ConfigurationInfo$NewConfiguration$HS_SCCHChannelisationCodeInfo"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE OF"
		...
		private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_SecondaryCellInfoFDD_r9$ConfigurationInfo$NewConfiguration$DifferentTxModeFromServingHS_DSCHCell"
		    ),
		    new QName (
			"builtin",
			"ENUMERATED"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_SecondaryCellInfoFDD_r9$ConfigurationInfo$NewConfiguration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_SecondaryCellInfoFDD_r9$ConfigurationInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public SecondaryCellMIMOparametersFDD getSecondaryCellMIMOparameters()
    {
	return (SecondaryCellMIMOparametersFDD)mComponents[1];
    }
    
    public void setSecondaryCellMIMOparameters(SecondaryCellMIMOparametersFDD secondaryCellMIMOparameters)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_SecondaryCellInfoFDD_r9 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_SecondaryCellInfoFDD_r9 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_SecondaryCellInfoFDD_r9
