...
/**
 * Define the ASN1 Type UplinkTimeslotsCodes_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UplinkTimeslotsCodes_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UplinkTimeslotsCodes_LCR_r4()
    {
    }
     ...
     */
    public UplinkTimeslotsCodes_LCR_r4(BOOLEAN dynamicSFusage, 
	...
	public static class AdditionalTimeslots extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"UplinkTimeslotsCodes_LCR_r4$MoreTimeslots$AdditionalTimeslots$Consecutive"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		 ...
		 */
		public TimeslotList(UplinkAdditionalTimeslots_LCR_r4[] elements)
		{
		    super(elements);
		}
		 ...
		 */
		public synchronized void add(UplinkAdditionalTimeslots_LCR_r4 element)
		{
		 ...
		 */
		public synchronized void set(UplinkAdditionalTimeslots_LCR_r4 element, int atIndex)
		{
		 ...
		 */
		public synchronized UplinkAdditionalTimeslots_LCR_r4 get(int atIndex)
		{
		    return (UplinkAdditionalTimeslots_LCR_r4)super.getElement(atIndex);
		}
		
		/**
		 * Insert an Element into the SEQUENCE OF/SET OF.
		 */
		public synchronized void insert(UplinkAdditionalTimeslots_LCR_r4 element, int atIndex)
		{
		 ...
		 */
		public synchronized void remove(UplinkAdditionalTimeslots_LCR_r4 element)
		{
		...
		{
		    return (AbstractData)new UplinkAdditionalTimeslots_LCR_r4();
		}
		...
		private static final ContainerInfo c_typeinfo = new ContainerInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UplinkTimeslotsCodes_LCR_r4$MoreTimeslots$AdditionalTimeslots$TimeslotList"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE OF"
			...
			new QName (
			    "rrc.informationelements",
			    "UplinkAdditionalTimeslots_LCR_r4"
			)
		    )
		);
		...
		new QName (
		    "rrc.informationelements",
		    "UplinkTimeslotsCodes_LCR_r4$MoreTimeslots$AdditionalTimeslots"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UplinkTimeslotsCodes_LCR_r4$MoreTimeslots"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UplinkTimeslotsCodes_LCR_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UplinkTimeslotsCodes_LCR_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UplinkTimeslotsCodes_LCR_r4
