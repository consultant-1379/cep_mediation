...
/**
 * Define the ASN1 Type UE_Positioning_GANSS_AssistanceData_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GANSS_AssistanceData_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GANSS_AssistanceData_r8()
    {
    }
     ...
     */
    public UE_Positioning_GANSS_AssistanceData_r8(UE_Positioning_GANSS_ReferenceTime ue_positioning_GANSS_ReferenceTime, 
		    ...
		    GANSSGenericDataList_r8 ganssGenericDataList)
    {
	...
	mComponents[5] = new GANSSGenericDataList_r8();
    }
	...
	switch (index) {
	    ...
	    case 5:
		return new GANSSGenericDataList_r8();
	    default:
    ...
    public GANSSGenericDataList_r8 getGanssGenericDataList()
    {
	return (GANSSGenericDataList_r8)mComponents[5];
    }
    
    public void setGanssGenericDataList(GANSSGenericDataList_r8 ganssGenericDataList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_AssistanceData_r8 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_AssistanceData_r8 object.
     */
...
} // End class definition for UE_Positioning_GANSS_AssistanceData_r8
