...
/**
 * Define the ASN1 Type UL_ChannelRequirement from ASN1 Module InformationElements.
 * @see Choice
 */

public class UL_ChannelRequirement extends Choice {
    
    /**
     * The default constructor.
     */
    public UL_ChannelRequirement()
    {
    }
    ...
    public static UL_ChannelRequirement createUL_ChannelRequirementWithUl_DPCH_Info(UL_DPCH_Info ul_DPCH_Info)
    {
	UL_ChannelRequirement __object = new UL_ChannelRequirement();
    ...
    public static UL_ChannelRequirement createUL_ChannelRequirementWithDummy(CPCH_SetInfo dummy)
    {
	UL_ChannelRequirement __object = new UL_ChannelRequirement();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_ChannelRequirement object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_ChannelRequirement object.
     */
...
} // End class definition for UL_ChannelRequirement
