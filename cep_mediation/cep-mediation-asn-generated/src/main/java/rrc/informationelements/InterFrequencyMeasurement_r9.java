...
/**
 * Define the ASN1 Type InterFrequencyMeasurement_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterFrequencyMeasurement_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterFrequencyMeasurement_r9()
    {
    }
     ...
     */
    public InterFrequencyMeasurement_r9(InterFreqCellInfoList_r9 interFreqCellInfoList, 
		    ...
		    InterFreqReportCriteria_r9 reportCriteria)
    {
	...
	this(interFreqCellInfoList, interFreqMeasQuantity, 
	     ...
	     new INTEGER(interBandFrequencyIndex), reportCriteria);
    }
    ...
    {
	mComponents[0] = new InterFreqCellInfoList_r9();
	...
	mComponents[7] = new InterFreqReportCriteria_r9();
    }
	...
	switch (index) {
	    case 0:
		return new InterFreqCellInfoList_r9();
	    case 1:
		...
		return new INTEGER();
	    case 7:
		return new InterFreqReportCriteria_r9();
	    default:
    ...
    public InterFreqCellInfoList_r9 getInterFreqCellInfoList()
    {
	return (InterFreqCellInfoList_r9)mComponents[0];
    }
    
    public void setInterFreqCellInfoList(InterFreqCellInfoList_r9 interFreqCellInfoList)
    {
    ...
    public InterFreqReportCriteria_r9 getReportCriteria()
    {
	return (InterFreqReportCriteria_r9)mComponents[7];
    }
    
    public void setReportCriteria(InterFreqReportCriteria_r9 reportCriteria)
    {
	mComponents[7] = reportCriteria;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement_r9 object.
     */
...
} // End class definition for InterFrequencyMeasurement_r9
