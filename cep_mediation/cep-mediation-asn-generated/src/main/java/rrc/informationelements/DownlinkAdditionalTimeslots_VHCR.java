...
/**
 * Define the ASN1 Type DownlinkAdditionalTimeslots_VHCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DownlinkAdditionalTimeslots_VHCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public DownlinkAdditionalTimeslots_VHCR()
    {
    }
     ...
     */
    public DownlinkAdditionalTimeslots_VHCR(Parameters parameters)
    {
	...
	public static class SameAsLast extends Sequence {
		...
		new QName (
		    ...
		    "DownlinkAdditionalTimeslots_VHCR$Parameters$SameAsLast"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class NewParameters extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public NewParameters(IndividualTimeslotInfo_VHCR individualTimeslotInfo, 
		...
		new QName (
		    "rrc.informationelements",
		    "DownlinkAdditionalTimeslots_VHCR$Parameters$NewParameters"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DownlinkAdditionalTimeslots_VHCR$Parameters"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DownlinkAdditionalTimeslots_VHCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DownlinkAdditionalTimeslots_VHCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DownlinkAdditionalTimeslots_VHCR
