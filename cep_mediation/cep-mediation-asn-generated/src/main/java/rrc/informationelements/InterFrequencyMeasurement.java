...
/**
 * Define the ASN1 Type InterFrequencyMeasurement from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterFrequencyMeasurement extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterFrequencyMeasurement()
    {
    }
     ...
     */
    public InterFrequencyMeasurement(InterFreqCellInfoList interFreqCellInfoList, 
		    ...
		    InterFreqReportCriteria reportCriteria)
    {
    ...
    {
	mComponents[0] = new InterFreqCellInfoList();
	...
	mComponents[5] = new InterFreqReportCriteria();
    }
	...
	switch (index) {
	    case 0:
		return new InterFreqCellInfoList();
	    case 1:
	    ...
	    case 5:
		return new InterFreqReportCriteria();
	    default:
    ...
    public InterFreqCellInfoList getInterFreqCellInfoList()
    {
	return (InterFreqCellInfoList)mComponents[0];
    }
    
    public void setInterFreqCellInfoList(InterFreqCellInfoList interFreqCellInfoList)
    {
    ...
    public InterFreqReportCriteria getReportCriteria()
    {
	return (InterFreqReportCriteria)mComponents[5];
    }
    
    public void setReportCriteria(InterFreqReportCriteria reportCriteria)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement object.
     */
...
} // End class definition for InterFrequencyMeasurement
