...
/**
 * Define the ASN1 Type UE_Positioning_GPS_AssistanceData from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GPS_AssistanceData extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GPS_AssistanceData()
    {
    }
     ...
     */
    public UE_Positioning_GPS_AssistanceData(UE_Positioning_GPS_ReferenceTime ue_positioning_GPS_ReferenceTime, 
		    ...
		    UE_Positioning_GPS_AcquisitionAssistance ue_positioning_GPS_AcquisitionAssistance, 
		    BadSatList ue_positioning_GPS_Real_timeIntegrity, 
		    UE_Positioning_GPS_ReferenceCellInfo dummy)
    {
    ...
    {
	mComponents[0] = new UE_Positioning_GPS_ReferenceTime();
	...
	mComponents[7] = new UE_Positioning_GPS_AcquisitionAssistance();
	mComponents[8] = new BadSatList();
	mComponents[9] = new UE_Positioning_GPS_ReferenceCellInfo();
    }
	...
	switch (index) {
	    ...
	    case 7:
		return new UE_Positioning_GPS_AcquisitionAssistance();
	    case 8:
		return new BadSatList();
	    case 9:
		return new UE_Positioning_GPS_ReferenceCellInfo();
	    default:
    ...
    {
	return (UE_Positioning_GPS_ReferenceTime)mComponents[0];
    }
    ...
    public UE_Positioning_GPS_AcquisitionAssistance getUe_positioning_GPS_AcquisitionAssistance()
    {
	return (UE_Positioning_GPS_AcquisitionAssistance)mComponents[7];
    }
    
    public void setUe_positioning_GPS_AcquisitionAssistance(UE_Positioning_GPS_AcquisitionAssistance ue_positioning_GPS_AcquisitionAssistance)
    {
    ...
    public UE_Positioning_GPS_ReferenceCellInfo getDummy()
    {
	return (UE_Positioning_GPS_ReferenceCellInfo)mComponents[9];
    }
    
    public void setDummy(UE_Positioning_GPS_ReferenceCellInfo dummy)
    {
	mComponents[9] = dummy;
    }
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"UE_Positioning_GPS_ReferenceCellInfo"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_AssistanceData object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_AssistanceData object.
     */
...
} // End class definition for UE_Positioning_GPS_AssistanceData
