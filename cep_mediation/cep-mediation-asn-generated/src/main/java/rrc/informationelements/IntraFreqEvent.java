...
/**
 * Define the ASN1 Type IntraFreqEvent from ASN1 Module InformationElements.
 * @see Choice
 */

public class IntraFreqEvent extends Choice {
    
    /**
     * The default constructor.
     */
    public IntraFreqEvent()
    {
    }
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1a(Event1a e1a)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public void setE1a(Event1a e1a)
    {
	setChosenValue(e1a);
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1b(Event1b e1b)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public void setE1b(Event1b e1b)
    {
	setChosenValue(e1b);
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1c(Event1c e1c)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1d(Null e1d)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1e(Event1e e1e)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1f(Event1f e1f)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1g(Null e1g)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1h(long e1h)
    {
	return createIntraFreqEventWithE1h(new ThresholdUsedFrequency(e1h));
    }
    
    public static IntraFreqEvent createIntraFreqEventWithE1h(ThresholdUsedFrequency e1h)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    public static IntraFreqEvent createIntraFreqEventWithE1i(long e1i)
    {
	return createIntraFreqEventWithE1i(new ThresholdUsedFrequency(e1i));
    }
    
    public static IntraFreqEvent createIntraFreqEventWithE1i(ThresholdUsedFrequency e1i)
    {
	IntraFreqEvent __object = new IntraFreqEvent();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEvent object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEvent object.
     */
...
} // End class definition for IntraFreqEvent
