...
/**
 * Define the ASN1 Type MeasurementType_r8 from ASN1 Module InformationElements.
 * @see Choice
 */

public class MeasurementType_r8 extends Choice {
    
    /**
     * The default constructor.
     */
    public MeasurementType_r8()
    {
    }
    ...
    public static MeasurementType_r8 createMeasurementType_r8WithIntraFrequencyMeasurement(IntraFrequencyMeasurement_r7 intraFrequencyMeasurement)
    {
	MeasurementType_r8 __object = new MeasurementType_r8();
    ...
    public static MeasurementType_r8 createMeasurementType_r8WithInterFrequencyMeasurement(InterFrequencyMeasurement_r8 interFrequencyMeasurement)
    {
	MeasurementType_r8 __object = new MeasurementType_r8();
    ...
    public void setInterFrequencyMeasurement(InterFrequencyMeasurement_r8 interFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r8 createMeasurementType_r8WithInterRATMeasurement(InterRATMeasurement_r8 interRATMeasurement)
    {
	MeasurementType_r8 __object = new MeasurementType_r8();
    ...
    public void setInterRATMeasurement(InterRATMeasurement_r8 interRATMeasurement)
    {
    ...
    public static MeasurementType_r8 createMeasurementType_r8WithUp_Measurement(UE_Positioning_Measurement_r8 up_Measurement)
    {
	MeasurementType_r8 __object = new MeasurementType_r8();
    ...
    public void setUp_Measurement(UE_Positioning_Measurement_r8 up_Measurement)
    {
    ...
    public static MeasurementType_r8 createMeasurementType_r8WithTrafficVolumeMeasurement(TrafficVolumeMeasurement trafficVolumeMeasurement)
    {
	MeasurementType_r8 __object = new MeasurementType_r8();
    ...
    public static MeasurementType_r8 createMeasurementType_r8WithQualityMeasurement(QualityMeasurement qualityMeasurement)
    {
	MeasurementType_r8 __object = new MeasurementType_r8();
    ...
    public static MeasurementType_r8 createMeasurementType_r8WithUe_InternalMeasurement(UE_InternalMeasurement_r4 ue_InternalMeasurement)
    {
	MeasurementType_r8 __object = new MeasurementType_r8();
	...
	switch (chosen) {
		...
		return new InterFrequencyMeasurement_r8();
	    case interRATMeasurement_chosen:
		return new InterRATMeasurement_r8();
	    case up_Measurement_chosen:
		return new UE_Positioning_Measurement_r8();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementType_r8 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementType_r8 object.
     */
...
} // End class definition for MeasurementType_r8
