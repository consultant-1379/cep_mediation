...
/**
 * Define the ASN1 Type UL_DPCH_Info_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_DPCH_Info_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UL_DPCH_Info_r6()
    {
    }
     ...
     */
    public UL_DPCH_Info_r6(UL_DPCH_PowerControlInfo_r6 ul_DPCH_PowerControlInfo, 
     ...
     */
    public UL_DPCH_Info_r6(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
    ...
    {
	mComponents[0] = new UL_DPCH_PowerControlInfo_r6();
	...
	switch (index) {
	    case 0:
		return new UL_DPCH_PowerControlInfo_r6();
	    case 1:
    ...
    public UL_DPCH_PowerControlInfo_r6 getUl_DPCH_PowerControlInfo()
    {
	return (UL_DPCH_PowerControlInfo_r6)mComponents[0];
    }
    
    public void setUl_DPCH_PowerControlInfo(UL_DPCH_PowerControlInfo_r6 ul_DPCH_PowerControlInfo)
    {
	...
	public static class Fdd extends Sequence {
		...
		public static class Present extends Sequence {
			...
			mComponents[4] = PuncturingLimit.pl0_40;
		    }
		    ...
		    {
			return (PuncturingLimit)mComponents[4];
		    }
		    
		    public void setPuncturingLimit(PuncturingLimit puncturingLimit)
		    {
			mComponents[4] = puncturingLimit;
		    }
			...
			new QName (
			    ...
			    "UL_DPCH_Info_r6$ModeSpecificInfo$Fdd$DpdchPresence$Present"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class NotPresent extends Sequence {
			...
			new QName (
			    "rrc.informationelements",
			    "UL_DPCH_Info_r6$ModeSpecificInfo$Fdd$DpdchPresence$NotPresent"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UL_DPCH_Info_r6$ModeSpecificInfo$Fdd$DpdchPresence"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "UL_DPCH_Info_r6$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd(UL_TimingAdvanceControl_r4 ul_TimingAdvance, 
			    UL_CCTrCHList_r4 ul_CCTrCHList, 
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new UL_TimingAdvanceControl_r4();
		mComponents[1] = new UL_CCTrCHList_r4();
		...
		switch (index) {
		    case 0:
			return new UL_TimingAdvanceControl_r4();
		    case 1:
			return new UL_CCTrCHList_r4();
		    case 2:
	    ...
	    public UL_TimingAdvanceControl_r4 getUl_TimingAdvance()
	    {
		return (UL_TimingAdvanceControl_r4)mComponents[0];
	    }
	    
	    public void setUl_TimingAdvance(UL_TimingAdvanceControl_r4 ul_TimingAdvance)
	    {
	    ...
	    public UL_CCTrCHList_r4 getUl_CCTrCHList()
	    {
		return (UL_CCTrCHList_r4)mComponents[1];
	    }
	    
	    public void setUl_CCTrCHList(UL_CCTrCHList_r4 ul_CCTrCHList)
	    {
		...
		new QName (
		    "rrc.informationelements",
		    "UL_DPCH_Info_r6$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UL_DPCH_Info_r6$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_DPCH_Info_r6 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_DPCH_Info_r6 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_DPCH_Info_r6
