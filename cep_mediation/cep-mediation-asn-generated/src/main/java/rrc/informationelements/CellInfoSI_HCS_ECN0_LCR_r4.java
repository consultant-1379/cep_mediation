...
/**
 * Define the ASN1 Type CellInfoSI_HCS_ECN0_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellInfoSI_HCS_ECN0_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellInfoSI_HCS_ECN0_LCR_r4()
    {
    }
     ...
     */
    public CellInfoSI_HCS_ECN0_LCR_r4(CellIndividualOffset cellIndividualOffset, 
     ...
     */
    public CellInfoSI_HCS_ECN0_LCR_r4(PrimaryCCPCH_Info_LCR_r4 primaryCCPCH_Info, 
		    boolean readSFN_Indicator)
    {
	setPrimaryCCPCH_Info(primaryCCPCH_Info);
	setReadSFN_Indicator(readSFN_Indicator);
	...
	mComponents[6] = new CellSelectReselectInfoSIB_11_12_HCS_ECN0();
    }
    ...
    {
	return (CellSelectReselectInfoSIB_11_12_HCS_ECN0)mComponents[6];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellInfoSI_HCS_ECN0_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellInfoSI_HCS_ECN0_LCR_r4 object.
     */
...
} // End class definition for CellInfoSI_HCS_ECN0_LCR_r4
