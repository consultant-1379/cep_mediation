...
/**
 * Define the ASN1 Type CommonDynamicTF_Info from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CommonDynamicTF_Info extends Sequence {
    
    /**
     * The default constructor.
     */
    public CommonDynamicTF_Info()
    {
    }
     ...
     */
    public CommonDynamicTF_Info(Rlc_Size rlc_Size, 
	...
	public static Rlc_Size createRlc_SizeWithFdd(Fdd fdd)
	{
	...
	public static class Fdd extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Fdd(OctetModeRLC_SizeInfoType2 octetModeRLC_SizeInfoType2)
	    {
		...
		new QName (
		    ...
		    "CommonDynamicTF_Info$Rlc_Size$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static Rlc_Size createRlc_SizeWithTdd(Tdd tdd)
	{
	    Rlc_Size __object = new Rlc_Size();
	...
	public static class Tdd extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd(CommonTDD_Choice commonTDD_Choice)
	    {
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"CommonDynamicTF_Info$Rlc_Size$Tdd$CommonTDD_Choice"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "CommonDynamicTF_Info$Rlc_Size$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CommonDynamicTF_Info$NumberOfTbSizeList"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CommonDynamicTF_Info object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CommonDynamicTF_Info object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CommonDynamicTF_Info
