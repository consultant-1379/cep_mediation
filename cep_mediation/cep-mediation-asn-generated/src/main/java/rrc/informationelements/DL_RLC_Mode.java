...
/**
 * Define the ASN1 Type DL_RLC_Mode from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_RLC_Mode extends Choice {
    ...
    public static DL_RLC_Mode createDL_RLC_ModeWithDl_AM_RLC_Mode(DL_AM_RLC_Mode dl_AM_RLC_Mode)
    {
	DL_RLC_Mode __object = new DL_RLC_Mode();
    ...
    public void setDl_AM_RLC_Mode(DL_AM_RLC_Mode dl_AM_RLC_Mode)
    {
    ...
    public static DL_RLC_Mode createDL_RLC_ModeWithDl_UM_RLC_Mode(Null dl_UM_RLC_Mode)
    {
	DL_RLC_Mode __object = new DL_RLC_Mode();
    ...
    public void setDl_UM_RLC_Mode(Null dl_UM_RLC_Mode)
    {
    ...
    public static DL_RLC_Mode createDL_RLC_ModeWithDl_TM_RLC_Mode(DL_TM_RLC_Mode dl_TM_RLC_Mode)
    {
	DL_RLC_Mode __object = new DL_RLC_Mode();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_RLC_Mode object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_RLC_Mode object.
     */
...
} // End class definition for DL_RLC_Mode
