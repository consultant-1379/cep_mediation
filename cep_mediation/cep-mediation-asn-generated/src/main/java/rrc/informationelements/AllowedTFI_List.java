...
/**
 * Define the ASN1 Type AllowedTFI_List from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class AllowedTFI_List extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public AllowedTFI_List()
    {
    }
     ...
     */
    public AllowedTFI_List(INTEGER[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' AllowedTFI_List object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' AllowedTFI_List object.
     */
...
} // End class definition for AllowedTFI_List
