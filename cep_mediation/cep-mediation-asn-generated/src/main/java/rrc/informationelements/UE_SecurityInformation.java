...
/**
 * Define the ASN1 Type UE_SecurityInformation from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_SecurityInformation extends Sequence {
     ...
     */
    public UE_SecurityInformation(START_Value start_CS)
    {
	setStart_CS(start_CS);
    }
    ...
    // Methods for field "start_CS"
    public START_Value getStart_CS()
    {
	return (START_Value)mComponents[0];
    }
    
    public void setStart_CS(START_Value start_CS)
    {
	mComponents[0] = start_CS;
    }
