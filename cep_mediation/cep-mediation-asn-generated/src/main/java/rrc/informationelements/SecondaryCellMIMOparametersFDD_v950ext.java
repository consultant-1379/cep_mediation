...
/**
 * Define the ASN1 Type SecondaryCellMIMOparametersFDD_v950ext from ASN1 Module InformationElements.
 * @see Sequence
 */

public class SecondaryCellMIMOparametersFDD_v950ext extends Sequence {
    
    /**
     * The default constructor.
     */
    public SecondaryCellMIMOparametersFDD_v950ext()
    {
    }
     ...
     */
    public SecondaryCellMIMOparametersFDD_v950ext(PrecodingWeightSetRestriction precodingWeightSetRestriction)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"SecondaryCellMIMOparametersFDD_v950ext$PrecodingWeightSetRestriction"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SecondaryCellMIMOparametersFDD_v950ext object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SecondaryCellMIMOparametersFDD_v950ext object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SecondaryCellMIMOparametersFDD_v950ext
