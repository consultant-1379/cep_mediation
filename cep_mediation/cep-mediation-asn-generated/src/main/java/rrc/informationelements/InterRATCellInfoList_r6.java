...
/**
 * Define the ASN1 Type InterRATCellInfoList_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterRATCellInfoList_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterRATCellInfoList_r6()
    {
    }
     ...
     */
    public InterRATCellInfoList_r6(RemovedInterRATCellList removedInterRATCellList, 
		    NewInterRATCellList newInterRATCellList, 
		    CellsForInterRATMeasList cellsForInterRATMeasList, 
		    InterRATCellInfoIndication interRATCellInfoIndication_r6)
    {
	...
	setInterRATCellInfoIndication_r6(interRATCellInfoIndication_r6);
    }
	...
	mComponents[3] = new InterRATCellInfoIndication();
    }
	...
	switch (index) {
	    ...
	    case 3:
		return new InterRATCellInfoIndication();
	    default:
    ...
    // Methods for field "interRATCellInfoIndication_r6"
    public InterRATCellInfoIndication getInterRATCellInfoIndication_r6()
    {
	return (InterRATCellInfoIndication)mComponents[3];
    }
    
    public void setInterRATCellInfoIndication_r6(InterRATCellInfoIndication interRATCellInfoIndication_r6)
    {
	mComponents[3] = interRATCellInfoIndication_r6;
    }
    
    public boolean hasInterRATCellInfoIndication_r6()
    {
	return componentIsPresent(3);
    }
    
    public void deleteInterRATCellInfoIndication_r6()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterRATCellInfoList_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterRATCellInfoList_r6 object.
     */
...
} // End class definition for InterRATCellInfoList_r6
