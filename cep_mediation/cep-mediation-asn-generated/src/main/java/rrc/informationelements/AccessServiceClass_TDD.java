...
/**
 * Define the ASN1 Type AccessServiceClass_TDD from ASN1 Module InformationElements.
 * @see Sequence
 */

public class AccessServiceClass_TDD extends Sequence {
    
    /**
     * The default constructor.
     */
    public AccessServiceClass_TDD()
    {
    }
     ...
     */
    public AccessServiceClass_TDD(ChannelisationCodeIndices channelisationCodeIndices, 
     ...
     */
    public AccessServiceClass_TDD(SubchannelSize subchannelSize)
    {
	setSubchannelSize(subchannelSize);
    }
	...
	public static final int chCodeIndex7 = 0;
	public static final int chCodeIndex6 = 1;
	public static final int chCodeIndex5 = 2;
	public static final int chCodeIndex4 = 3;
	public static final int chCodeIndex3 = 4;
	public static final int chCodeIndex2 = 5;
	public static final int chCodeIndex1 = 6;
	public static final int chCodeIndex0 = 7;
	...
	private static final BitStringInfo c_typeinfo = new BitStringInfo (
		...
		"AccessServiceClass_TDD$ChannelisationCodeIndices"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	public static class Size2 extends Sequence {
		...
		private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"AccessServiceClass_TDD$SubchannelSize$Size2$Subchannels"
		    ),
		    new QName (
			"builtin",
			"ENUMERATED"
		...
		new QName (
		    "rrc.informationelements",
		    "AccessServiceClass_TDD$SubchannelSize$Size2"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Size4 extends Sequence {
		...
		private static final BitStringInfo c_typeinfo = new BitStringInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"AccessServiceClass_TDD$SubchannelSize$Size4$Subchannels"
		    ),
		    new QName (
			"builtin",
			"BIT STRING"
		...
		new QName (
		    "rrc.informationelements",
		    "AccessServiceClass_TDD$SubchannelSize$Size4"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Size8 extends Sequence {
		...
		private static final BitStringInfo c_typeinfo = new BitStringInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"AccessServiceClass_TDD$SubchannelSize$Size8$Subchannels"
		    ),
		    new QName (
			"builtin",
			"BIT STRING"
		...
		new QName (
		    "rrc.informationelements",
		    "AccessServiceClass_TDD$SubchannelSize$Size8"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"AccessServiceClass_TDD$SubchannelSize"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' AccessServiceClass_TDD object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' AccessServiceClass_TDD object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for AccessServiceClass_TDD
