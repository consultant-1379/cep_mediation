...
/**
 * Define the ASN1 Type DPCH_CompressedModeStatusInfo_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DPCH_CompressedModeStatusInfo_r10 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DPCH_CompressedModeStatusInfo_r10()
    {
    }
     ...
     */
    public DPCH_CompressedModeStatusInfo_r10(TGPS_Reconfiguration_CFN tgps_Reconfiguration_CFN, 
	 ...
	 */
	public Tgp_SequenceShortList(TGP_SequenceShort_r10[] elements)
	{
	    super(elements);
	}
	 ...
	 */
	public synchronized void add(TGP_SequenceShort_r10 element)
	{
	 ...
	 */
	public synchronized void set(TGP_SequenceShort_r10 element, int atIndex)
	{
	 ...
	 */
	public synchronized TGP_SequenceShort_r10 get(int atIndex)
	{
	    return (TGP_SequenceShort_r10)super.getElement(atIndex);
	}
	
	/**
	 * Insert an Element into the SEQUENCE OF/SET OF.
	 */
	public synchronized void insert(TGP_SequenceShort_r10 element, int atIndex)
	{
	 ...
	 */
	public synchronized void remove(TGP_SequenceShort_r10 element)
	{
	...
	{
	    return (AbstractData)new TGP_SequenceShort_r10();
	}
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
		...
		"DPCH_CompressedModeStatusInfo_r10$Tgp_SequenceShortList"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DPCH_CompressedModeStatusInfo_r10 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DPCH_CompressedModeStatusInfo_r10 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DPCH_CompressedModeStatusInfo_r10
