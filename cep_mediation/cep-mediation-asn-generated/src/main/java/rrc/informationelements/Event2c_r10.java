...
/**
 * Define the ASN1 Type Event2c_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2c_r10 extends Sequence {
     ...
     */
    public Event2c_r10(HysteresisInterFreq hysteresis, 
	...
	mComponents[2] = new ReportingCellStatus_r10();
	mComponents[3] = new NonUsedFreqParameterList_r10();
    }
    ...
    {
	return (ReportingCellStatus_r10)mComponents[2];
    }
    ...
    {
	return (NonUsedFreqParameterList_r10)mComponents[3];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2c_r10 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2c_r10 object.
     */
...
} // End class definition for Event2c_r10
