...
/**
 * Define the ASN1 Type InterFreqCellInfoList from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterFreqCellInfoList extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterFreqCellInfoList()
    {
    }
     ...
     */
    public InterFreqCellInfoList(RemovedInterFreqCellList removedInterFreqCellList, 
		    NewInterFreqCellList newInterFreqCellList, 
	...
	mComponents[1] = new NewInterFreqCellList();
	...
	switch (index) {
	    ...
	    case 1:
		return new NewInterFreqCellList();
	    case 2:
    ...
    public NewInterFreqCellList getNewInterFreqCellList()
    {
	return (NewInterFreqCellList)mComponents[1];
    }
    
    public void setNewInterFreqCellList(NewInterFreqCellList newInterFreqCellList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFreqCellInfoList object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFreqCellInfoList object.
     */
...
} // End class definition for InterFreqCellInfoList
