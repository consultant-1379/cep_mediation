...
/**
 * Define the ASN1 Type MidambleShiftAndBurstType_DL_VHCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MidambleShiftAndBurstType_DL_VHCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public MidambleShiftAndBurstType_DL_VHCR()
    {
    }
     ...
     */
    public MidambleShiftAndBurstType_DL_VHCR(BurstType burstType)
    {
	...
	public static class Type1 extends Sequence {
		...
		public static class UeSpecificMidamble extends Sequence {
			...
			new QName (
			    ...
			    "MidambleShiftAndBurstType_DL_VHCR$BurstType$Type1$MidambleAllocationMode$UeSpecificMidamble"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MidambleShiftAndBurstType_DL_VHCR$BurstType$Type1$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MidambleShiftAndBurstType_DL_VHCR$BurstType$Type1"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Type2 extends Sequence {
		...
		public static class UeSpecificMidamble extends Sequence {
			...
			new QName (
			    "rrc.informationelements",
			    "MidambleShiftAndBurstType_DL_VHCR$BurstType$Type2$MidambleAllocationMode$UeSpecificMidamble"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MidambleShiftAndBurstType_DL_VHCR$BurstType$Type2$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MidambleShiftAndBurstType_DL_VHCR$BurstType$Type2"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"MidambleShiftAndBurstType_DL_VHCR$BurstType"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MidambleShiftAndBurstType_DL_VHCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MidambleShiftAndBurstType_DL_VHCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MidambleShiftAndBurstType_DL_VHCR
