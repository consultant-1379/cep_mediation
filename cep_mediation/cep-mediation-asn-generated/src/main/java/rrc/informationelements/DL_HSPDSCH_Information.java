...
/**
 * Define the ASN1 Type DL_HSPDSCH_Information from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_HSPDSCH_Information extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_HSPDSCH_Information()
    {
    }
     ...
     */
    public DL_HSPDSCH_Information(HS_SCCH_Info hs_scch_Info, 
     ...
     */
    public DL_HSPDSCH_Information(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
    ...
    {
	mComponents[0] = new HS_SCCH_Info();
    ...
    public HS_SCCH_Info getHs_scch_Info()
    {
	return (HS_SCCH_Info)mComponents[0];
    }
    
    public void setHs_scch_Info(HS_SCCH_Info hs_scch_Info)
    {
	...
	public static class Tdd extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"DL_HSPDSCH_Information$ModeSpecificInfo$Tdd$Tdd384"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_HSPDSCH_Information$ModeSpecificInfo$Tdd$Tdd128"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_HSPDSCH_Information$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_HSPDSCH_Information$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_HSPDSCH_Information object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_HSPDSCH_Information object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_HSPDSCH_Information
