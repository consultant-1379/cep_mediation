...
/**
 * Define the ASN1 Type Event1a_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event1a_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public Event1a_LCR_r4()
    {
    }
     ...
     */
    public Event1a_LCR_r4(TriggeringCondition2 triggeringCondition, 
		    ReportingRange reportingRange, 
		    ForbiddenAffectCellList_LCR_r4 forbiddenAffectCellList, 
		    W w, 
	...
	mComponents[2] = new ForbiddenAffectCellList_LCR_r4();
	mComponents[3] = new W();
	...
	switch (index) {
	    ...
	    case 2:
		return new ForbiddenAffectCellList_LCR_r4();
	    case 3:
		return new W();
	    case 4:
    ...
    public ForbiddenAffectCellList_LCR_r4 getForbiddenAffectCellList()
    {
	return (ForbiddenAffectCellList_LCR_r4)mComponents[2];
    }
    
    public void setForbiddenAffectCellList(ForbiddenAffectCellList_LCR_r4 forbiddenAffectCellList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event1a_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event1a_LCR_r4 object.
     */
...
} // End class definition for Event1a_LCR_r4
