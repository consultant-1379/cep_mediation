...
/**
 * Define the ASN1 Type IntraFreqMeasurementSysInfo_HCS_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqMeasurementSysInfo_HCS_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqMeasurementSysInfo_HCS_RSCP()
    {
    }
     ...
     */
    public IntraFreqMeasurementSysInfo_HCS_RSCP(MeasurementIdentity intraFreqMeasurementID, 
		    IntraFreqCellInfoSI_List_HCS_RSCP intraFreqCellInfoSI_List, 
		    ...
		    ReportingInfoForCellDCH reportingInfoForCellDCH)
    {
	...
	mComponents[1] = new IntraFreqCellInfoSI_List_HCS_RSCP();
	...
	mComponents[5] = new ReportingInfoForCellDCH();
    }
	...
	switch (index) {
	    ...
	    case 1:
		return new IntraFreqCellInfoSI_List_HCS_RSCP();
	    case 2:
	    ...
	    case 5:
		return new ReportingInfoForCellDCH();
	    default:
    ...
    public IntraFreqCellInfoSI_List_HCS_RSCP getIntraFreqCellInfoSI_List()
    {
	return (IntraFreqCellInfoSI_List_HCS_RSCP)mComponents[1];
    }
    
    public void setIntraFreqCellInfoSI_List(IntraFreqCellInfoSI_List_HCS_RSCP intraFreqCellInfoSI_List)
    {
    ...
    public ReportingInfoForCellDCH getReportingInfoForCellDCH()
    {
	return (ReportingInfoForCellDCH)mComponents[5];
    }
    
    public void setReportingInfoForCellDCH(ReportingInfoForCellDCH reportingInfoForCellDCH)
    {
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"IntraFreqCellInfoSI_List_HCS_RSCP"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_HCS_RSCP object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_HCS_RSCP object.
     */
...
} // End class definition for IntraFreqMeasurementSysInfo_HCS_RSCP
