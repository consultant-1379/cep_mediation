...
/**
 * Define the ASN1 Type UE_Positioning_ReportingQuantity_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_ReportingQuantity_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_ReportingQuantity_r7()
    {
    }
     ...
     */
    public UE_Positioning_ReportingQuantity_r7(UE_Positioning_MethodType methodType, 
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"UE_Positioning_ReportingQuantity_r7$VelocityRequested"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	new QName (
	    "rrc.informationelements",
	    "UE_Positioning_ReportingQuantity_r7"
	),
	new QName (
	    "InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_ReportingQuantity_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_ReportingQuantity_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_ReportingQuantity_r7
