...
/**
 * Define the ASN1 Type NewInterFreqCellSI_ECN0 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterFreqCellSI_ECN0 extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterFreqCellSI_ECN0()
    {
    }
     ...
     */
    public NewInterFreqCellSI_ECN0(InterFreqCellID interFreqCellID, 
		    FrequencyInfo frequencyInfo, CellInfoSI_ECN0 cellInfo)
    {
     ...
     */
    public NewInterFreqCellSI_ECN0(CellInfoSI_ECN0 cellInfo)
    {
	setCellInfo(cellInfo);
    }
	...
	mComponents[2] = new CellInfoSI_ECN0();
    }
    ...
    public CellInfoSI_ECN0 getCellInfo()
    {
	return (CellInfoSI_ECN0)mComponents[2];
    }
    
    public void setCellInfo(CellInfoSI_ECN0 cellInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_ECN0 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_ECN0 object.
     */
...
} // End class definition for NewInterFreqCellSI_ECN0
