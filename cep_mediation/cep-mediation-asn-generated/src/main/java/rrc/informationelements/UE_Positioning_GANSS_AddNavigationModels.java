...
/**
 * Define the ASN1 Type UE_Positioning_GANSS_AddNavigationModels from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GANSS_AddNavigationModels extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GANSS_AddNavigationModels()
    {
    }
     ...
     */
    public UE_Positioning_GANSS_AddNavigationModels(Non_broadcastIndication non_broadcastIndication, 
		    Ganss_Sat_Info_AddNavList ganssSatInfoNavList)
    {
     ...
     */
    public UE_Positioning_GANSS_AddNavigationModels(Ganss_Sat_Info_AddNavList ganssSatInfoNavList)
    {
	setGanssSatInfoNavList(ganssSatInfoNavList);
    }
	...
	mComponents[1] = new Ganss_Sat_Info_AddNavList();
    }
	...
	switch (index) {
	    ...
	    case 1:
		return new Ganss_Sat_Info_AddNavList();
	    default:
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"UE_Positioning_GANSS_AddNavigationModels$Non_broadcastIndication"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    public Ganss_Sat_Info_AddNavList getGanssSatInfoNavList()
    {
	return (Ganss_Sat_Info_AddNavList)mComponents[1];
    }
    
    public void setGanssSatInfoNavList(Ganss_Sat_Info_AddNavList ganssSatInfoNavList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_AddNavigationModels object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_AddNavigationModels object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_GANSS_AddNavigationModels
