...
/**
 * Define the ASN1 Type Measurement_Feedback_Info from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Measurement_Feedback_Info extends Sequence {
    
    /**
     * The default constructor.
     */
    public Measurement_Feedback_Info()
    {
    }
     ...
     */
    public Measurement_Feedback_Info(ModeSpecificInfo modeSpecificInfo)
    {
	...
	public static class Fdd extends Sequence {
		...
		mComponents[1] = Feedback_cycle.fc0;
	    ...
	    public Feedback_cycle getFeedback_cycle()
	    {
		return (Feedback_cycle)mComponents[1];
	    }
	    
	    public void setFeedback_cycle(Feedback_cycle feedback_cycle)
	    {
		...
		new QName (
		    ...
		    "Measurement_Feedback_Info$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"Measurement_Feedback_Info$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Measurement_Feedback_Info object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Measurement_Feedback_Info object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for Measurement_Feedback_Info
