...
/**
 * Define the ASN1 Type IntraFreqMeasurementSysInfo_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqMeasurementSysInfo_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqMeasurementSysInfo_RSCP()
    {
    }
     ...
     */
    public IntraFreqMeasurementSysInfo_RSCP(MeasurementIdentity intraFreqMeasurementID, 
		    IntraFreqCellInfoSI_List_RSCP intraFreqCellInfoSI_List, 
	...
	mComponents[1] = new IntraFreqCellInfoSI_List_RSCP();
	...
	switch (index) {
	    ...
	    case 1:
		return new IntraFreqCellInfoSI_List_RSCP();
	    case 2:
    ...
    public IntraFreqCellInfoSI_List_RSCP getIntraFreqCellInfoSI_List()
    {
	return (IntraFreqCellInfoSI_List_RSCP)mComponents[1];
    }
    
    public void setIntraFreqCellInfoSI_List(IntraFreqCellInfoSI_List_RSCP intraFreqCellInfoSI_List)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_RSCP object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_RSCP object.
     */
...
} // End class definition for IntraFreqMeasurementSysInfo_RSCP
