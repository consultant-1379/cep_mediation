...
/**
 * Define the ASN1 Type Event2e from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2e extends Sequence {
     ...
     */
    public Event2e(HysteresisInterFreq hysteresis, 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2e object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2e object.
     */
...
} // End class definition for Event2e
