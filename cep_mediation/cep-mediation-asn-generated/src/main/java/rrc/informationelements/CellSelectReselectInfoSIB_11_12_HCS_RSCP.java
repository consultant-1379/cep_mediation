...
/**
 * Define the ASN1 Type CellSelectReselectInfoSIB_11_12_HCS_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellSelectReselectInfoSIB_11_12_HCS_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellSelectReselectInfoSIB_11_12_HCS_RSCP()
    {
    }
     ...
     */
    public CellSelectReselectInfoSIB_11_12_HCS_RSCP(Q_OffsetS_N q_OffsetS_N, 
		    MaxAllowedUL_TX_Power maxAllowedUL_TX_Power, 
		    HCS_NeighbouringCellInformation_RSCP hcs_NeighbouringCellInformation_RSCP, 
		    ModeSpecificInfo modeSpecificInfo)
    {
	setQ_OffsetS_N(q_OffsetS_N);
	setMaxAllowedUL_TX_Power(maxAllowedUL_TX_Power);
	setHcs_NeighbouringCellInformation_RSCP(hcs_NeighbouringCellInformation_RSCP);
     ...
     */
    public CellSelectReselectInfoSIB_11_12_HCS_RSCP(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	mComponents[1] = new MaxAllowedUL_TX_Power();
	mComponents[2] = new HCS_NeighbouringCellInformation_RSCP();
	...
	switch (index) {
	    ...
	    case 2:
		return new HCS_NeighbouringCellInformation_RSCP();
	    case 3:
    ...
    // Default Values
    public static final Q_OffsetS_N q_OffsetS_N__default = 
	new Q_OffsetS_N(0);
    
    // Methods for field "q_OffsetS_N"
    public Q_OffsetS_N getQ_OffsetS_N()
    {
	if (hasQ_OffsetS_N())
	    return (Q_OffsetS_N)mComponents[0];
	else
	    return (Q_OffsetS_N)q_OffsetS_N__default.clone();
    }
    
    public void setQ_OffsetS_N(Q_OffsetS_N q_OffsetS_N)
    {
	mComponents[0] = q_OffsetS_N;
    }
    
    public void setQ_OffsetS_NToDefault()
    {
	setQ_OffsetS_N(q_OffsetS_N__default);
    }
    
    public boolean hasDefaultQ_OffsetS_N()
    {
	return true;
    }
    
    public boolean hasQ_OffsetS_N()
    {
	return componentIsPresent(0);
    }
    
    public void deleteQ_OffsetS_N()
    {
    ...
    // Methods for field "hcs_NeighbouringCellInformation_RSCP"
    public HCS_NeighbouringCellInformation_RSCP getHcs_NeighbouringCellInformation_RSCP()
    {
	return (HCS_NeighbouringCellInformation_RSCP)mComponents[2];
    }
    
    public void setHcs_NeighbouringCellInformation_RSCP(HCS_NeighbouringCellInformation_RSCP hcs_NeighbouringCellInformation_RSCP)
    {
	mComponents[2] = hcs_NeighbouringCellInformation_RSCP;
    }
    
    public boolean hasHcs_NeighbouringCellInformation_RSCP()
    {
	return componentIsPresent(2);
    }
    
    public void deleteHcs_NeighbouringCellInformation_RSCP()
    {
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellSelectReselectInfoSIB_11_12_HCS_RSCP$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellSelectReselectInfoSIB_11_12_HCS_RSCP$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Gsm extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellSelectReselectInfoSIB_11_12_HCS_RSCP$ModeSpecificInfo$Gsm"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CellSelectReselectInfoSIB_11_12_HCS_RSCP$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellSelectReselectInfoSIB_11_12_HCS_RSCP object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellSelectReselectInfoSIB_11_12_HCS_RSCP object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellSelectReselectInfoSIB_11_12_HCS_RSCP
