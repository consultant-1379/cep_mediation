...
/**
 * Define the ASN1 Type IntraFreqReportCriteria from ASN1 Module InformationElements.
 * @see Choice
 */

public class IntraFreqReportCriteria extends Choice {
    
    /**
     * The default constructor.
     */
    public IntraFreqReportCriteria()
    {
    }
    ...
    public static IntraFreqReportCriteria createIntraFreqReportCriteriaWithIntraFreqReportingCriteria(IntraFreqReportingCriteria intraFreqReportingCriteria)
    {
	IntraFreqReportCriteria __object = new IntraFreqReportCriteria();
    ...
    public static IntraFreqReportCriteria createIntraFreqReportCriteriaWithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	IntraFreqReportCriteria __object = new IntraFreqReportCriteria();
    ...
    public static IntraFreqReportCriteria createIntraFreqReportCriteriaWithNoReporting(ReportingCellStatusOpt noReporting)
    {
	IntraFreqReportCriteria __object = new IntraFreqReportCriteria();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria object.
     */
...
} // End class definition for IntraFreqReportCriteria
