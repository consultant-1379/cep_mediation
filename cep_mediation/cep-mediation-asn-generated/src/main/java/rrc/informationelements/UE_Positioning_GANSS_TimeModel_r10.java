...
/**
 * Define the ASN1 Type UE_Positioning_GANSS_TimeModel_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GANSS_TimeModel_r10 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GANSS_TimeModel_r10()
    {
    }
     ...
     */
    public UE_Positioning_GANSS_TimeModel_r10(INTEGER ganss_timeModelreferenceTime, 
		    INTEGER ganss_t_a0, INTEGER ganss_t_a1, 
		    INTEGER ganss_t_a2, Gnss_to_id gnss_to_id, 
		    INTEGER ganss_wk_number, INTEGER deltaT)
    {
     ...
     */
    public UE_Positioning_GANSS_TimeModel_r10(long ganss_timeModelreferenceTime, 
		    long ganss_t_a0, long ganss_t_a1, long ganss_t_a2, 
		    Gnss_to_id gnss_to_id, long ganss_wk_number, long deltaT)
    {
	this(new INTEGER(ganss_timeModelreferenceTime), 
	     ...
	     new INTEGER(ganss_wk_number), new INTEGER(deltaT));
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"UE_Positioning_GANSS_TimeModel_r10$Gnss_to_id"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    {
	setDeltaT(new INTEGER(deltaT));
    }
    
    public void setDeltaT(INTEGER deltaT)
    {
	mComponents[6] = deltaT;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_TimeModel_r10 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_TimeModel_r10 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_GANSS_TimeModel_r10
