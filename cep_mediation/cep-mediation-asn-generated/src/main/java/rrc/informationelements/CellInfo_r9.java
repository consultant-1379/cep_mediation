...
/**
 * Define the ASN1 Type CellInfo_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellInfo_r9 extends Sequence {
     ...
     */
    public CellInfo_r9(CellIndividualOffset cellIndividualOffset, 
		    ReferenceTimeDifferenceToCell referenceTimeDifferenceToCell, 
		    ModeSpecificInfo modeSpecificInfo, 
		    CellSelectReselectInfoMC_RSCP cellSelectionReselectionInfo)
    {
     ...
     */
    public CellInfo_r9(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	mComponents[3] = new CellSelectReselectInfoMC_RSCP();
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellInfo_r9$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellInfo_r9$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    {
	return (CellSelectReselectInfoMC_RSCP)mComponents[3];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellInfo_r9 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellInfo_r9 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellInfo_r9
