...
/**
 * Define the ASN1 Type DL_LogicalChannelMapping from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_LogicalChannelMapping extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_LogicalChannelMapping()
    {
    }
     ...
     */
    public DL_LogicalChannelMapping(DL_TransportChannelType dl_TransportChannelType, 
    ...
    {
	mComponents[0] = new DL_TransportChannelType();
	...
	switch (index) {
	    case 0:
		return new DL_TransportChannelType();
	    case 1:
    ...
    public DL_TransportChannelType getDl_TransportChannelType()
    {
	return (DL_TransportChannelType)mComponents[0];
    }
    
    public void setDl_TransportChannelType(DL_TransportChannelType dl_TransportChannelType)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_LogicalChannelMapping object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_LogicalChannelMapping object.
     */
...
} // End class definition for DL_LogicalChannelMapping
