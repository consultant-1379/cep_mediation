...
/**
 * Define the ASN1 Type SysInfoType6_v4b0ext_IEs from ASN1 Module InformationElements.
 * @see Sequence
 */

public class SysInfoType6_v4b0ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public SysInfoType6_v4b0ext_IEs()
    {
    }
     ...
     */
    public SysInfoType6_v4b0ext_IEs(OpenLoopPowerControl_IPDL_TDD_r4 openLoopPowerControl_IPDL_TDD, 
    ...
    {
	mComponents[0] = new OpenLoopPowerControl_IPDL_TDD_r4();
	mComponents[1] = new PRACH_SystemInformationList_LCR_r4();
	mComponents[2] = new Tdd128SpecificInfo();
	mComponents[3] = RadioFrequencyBandFDD.fdd2100;
    }
    ...
    {
	return (OpenLoopPowerControl_IPDL_TDD_r4)mComponents[0];
    }
    ...
    {
	return (Tdd128SpecificInfo)mComponents[2];
    }
    
    public void setTdd128SpecificInfo(Tdd128SpecificInfo tdd128SpecificInfo)
    {
	mComponents[2] = tdd128SpecificInfo;
    }
	...
	public boolean hasSCCPCH_LCR_ExtensionsList()
	{
	    return componentIsPresent(3);
	}
	
	public void deleteSCCPCH_LCR_ExtensionsList()
	{
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
		...
		"SysInfoType6_v4b0ext_IEs$Tdd128SpecificInfo"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SysInfoType6_v4b0ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SysInfoType6_v4b0ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SysInfoType6_v4b0ext_IEs
