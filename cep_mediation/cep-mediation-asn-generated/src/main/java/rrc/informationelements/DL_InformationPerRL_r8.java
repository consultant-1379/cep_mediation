...
/**
 * Define the ASN1 Type DL_InformationPerRL_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_InformationPerRL_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_InformationPerRL_r8()
    {
    }
     ...
     */
    public DL_InformationPerRL_r8(ModeSpecificInfo modeSpecificInfo, 
		    Dl_dpchInfo dl_dpchInfo, 
		    E_AGCH_Information_r8 e_AGCH_Information, 
	...
	mComponents[2] = new E_AGCH_Information_r8();
	...
	switch (index) {
	    ...
	    case 2:
		return new E_AGCH_Information_r8();
	    case 3:
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "DL_InformationPerRL_r8$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_InformationPerRL_r8$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_InformationPerRL_r8$Dl_dpchInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public E_AGCH_Information_r8 getE_AGCH_Information()
    {
	return (E_AGCH_Information_r8)mComponents[2];
    }
    
    public void setE_AGCH_Information(E_AGCH_Information_r8 e_AGCH_Information)
    {
	...
	public static class Fdd extends Sequence {
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_InformationPerRL_r8$ModeSpecificInfo2$Fdd$E_HICH_Info"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_InformationPerRL_r8$ModeSpecificInfo2$Fdd$E_RGCH_Info"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_InformationPerRL_r8$ModeSpecificInfo2$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_InformationPerRL_r8$ModeSpecificInfo2$Tdd$Tdd384_tdd768"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_InformationPerRL_r8$ModeSpecificInfo2$Tdd$Tdd128"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_InformationPerRL_r8$ModeSpecificInfo2$Tdd"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_InformationPerRL_r8$ModeSpecificInfo2"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_InformationPerRL_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_InformationPerRL_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_InformationPerRL_r8
