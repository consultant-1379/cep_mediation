...
/**
 * Define the ASN1 Type RL_IdentifierList from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class RL_IdentifierList extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public RL_IdentifierList()
    {
    }
     ...
     */
    public RL_IdentifierList(PrimaryCPICH_Info[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RL_IdentifierList object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RL_IdentifierList object.
     */
...
} // End class definition for RL_IdentifierList
