...
/**
 * Define the ASN1 Type RAB_InformationSetup from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RAB_InformationSetup extends Sequence {
     ...
     */
    public RAB_InformationSetup(RAB_Info rab_Info, 
	...
	mComponents[1] = new RB_InformationSetupList();
    }
    ...
    public RB_InformationSetupList getRb_InformationSetupList()
    {
	return (RB_InformationSetupList)mComponents[1];
    }
    
    public void setRb_InformationSetupList(RB_InformationSetupList rb_InformationSetupList)
    {
