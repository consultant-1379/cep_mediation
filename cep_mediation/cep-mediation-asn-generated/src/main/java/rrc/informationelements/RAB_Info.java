...
/**
 * Define the ASN1 Type RAB_Info from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RAB_Info extends Sequence {
     ...
     */
    public RAB_Info(RAB_Identity rab_Identity, 
	...
	mComponents[3] = Re_EstablishmentTimer.useT314;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RAB_Info object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RAB_Info object.
     */
...
} // End class definition for RAB_Info
