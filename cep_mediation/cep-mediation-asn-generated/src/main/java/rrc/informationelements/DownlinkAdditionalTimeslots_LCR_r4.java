...
/**
 * Define the ASN1 Type DownlinkAdditionalTimeslots_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DownlinkAdditionalTimeslots_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DownlinkAdditionalTimeslots_LCR_r4()
    {
    }
     ...
     */
    public DownlinkAdditionalTimeslots_LCR_r4(Parameters parameters)
    {
	...
	public static class SameAsLast extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public SameAsLast(TimeslotNumber_LCR_r4 timeslotNumber)
	    {
		...
		new QName (
		    ...
		    "DownlinkAdditionalTimeslots_LCR_r4$Parameters$SameAsLast"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class NewParameters extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "DownlinkAdditionalTimeslots_LCR_r4$Parameters$NewParameters"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DownlinkAdditionalTimeslots_LCR_r4$Parameters"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DownlinkAdditionalTimeslots_LCR_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DownlinkAdditionalTimeslots_LCR_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DownlinkAdditionalTimeslots_LCR_r4
