...
/**
 * Define the ASN1 Type UE_Positioning_GANSS_ReferenceTime from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GANSS_ReferenceTime extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GANSS_ReferenceTime()
    {
    }
     ...
     */
    public UE_Positioning_GANSS_ReferenceTime(INTEGER ganssDay, 
		    INTEGER ganssTod, INTEGER ganssTodUncertainty, 
		    INTEGER ganssTimeId, 
     ...
     */
    public UE_Positioning_GANSS_ReferenceTime(long ganssDay, long ganssTod, 
		    long ganssTodUncertainty, long ganssTimeId, 
		    Utran_ganssreferenceTime utran_ganssreferenceTime, 
		    Tutran_Ganss_DriftRate tutran_ganss_driftRate)
    {
	this(new INTEGER(ganssDay), new INTEGER(ganssTod), 
	     new INTEGER(ganssTodUncertainty), new INTEGER(ganssTimeId), 
	     utran_ganssreferenceTime, tutran_ganss_driftRate);
    }
    
    /**
     * Construct with required components.
     */
    public UE_Positioning_GANSS_ReferenceTime(long ganssTod)
    {
	setGanssTod(ganssTod);
    }
	...
	mComponents[4] = new Utran_ganssreferenceTime();
	mComponents[5] = Tutran_Ganss_DriftRate.ugdr0;
    }
    ...
    {
	mComponents[2] = ganssTodUncertainty;
    }
	...
	public static class Mode extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"UE_Positioning_GANSS_ReferenceTime$Utran_ganssreferenceTime$Mode$Fdd"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UE_Positioning_GANSS_ReferenceTime$Utran_ganssreferenceTime$Mode$Tdd"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_GANSS_ReferenceTime$Utran_ganssreferenceTime$Mode"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UE_Positioning_GANSS_ReferenceTime$Utran_ganssreferenceTime"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_ReferenceTime object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GANSS_ReferenceTime object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_GANSS_ReferenceTime
