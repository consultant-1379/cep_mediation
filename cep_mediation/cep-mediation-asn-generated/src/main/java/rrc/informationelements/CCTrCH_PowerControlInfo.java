...
/**
 * Define the ASN1 Type CCTrCH_PowerControlInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CCTrCH_PowerControlInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public CCTrCH_PowerControlInfo()
    {
    }
     ...
     */
    public CCTrCH_PowerControlInfo(TFCS_Identity tfcs_Identity, 
		    UL_DPCH_PowerControlInfo ul_DPCH_PowerControlInfo)
    {
     ...
     */
    public CCTrCH_PowerControlInfo(UL_DPCH_PowerControlInfo ul_DPCH_PowerControlInfo)
    {
	setUl_DPCH_PowerControlInfo(ul_DPCH_PowerControlInfo);
    }
	...
	mComponents[1] = new UL_DPCH_PowerControlInfo();
    }
    ...
    {
	return (UL_DPCH_PowerControlInfo)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CCTrCH_PowerControlInfo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CCTrCH_PowerControlInfo object.
     */
...
} // End class definition for CCTrCH_PowerControlInfo
