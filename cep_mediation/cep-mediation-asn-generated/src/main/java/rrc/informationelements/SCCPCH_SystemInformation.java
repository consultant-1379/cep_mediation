...
/**
 * Define the ASN1 Type SCCPCH_SystemInformation from ASN1 Module InformationElements.
 * @see Sequence
 */

public class SCCPCH_SystemInformation extends Sequence {
    
    /**
     * The default constructor.
     */
    public SCCPCH_SystemInformation()
    {
    }
     ...
     */
    public SCCPCH_SystemInformation(SecondaryCCPCH_Info secondaryCCPCH_Info, 
		    TFCS tfcs, 
    ...
    public PICH_Info getPich_Info()
    {
	return (PICH_Info)mComponents[3];
    }
    
    public void setPich_Info(PICH_Info pich_Info)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SCCPCH_SystemInformation object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SCCPCH_SystemInformation object.
     */
...
} // End class definition for SCCPCH_SystemInformation
