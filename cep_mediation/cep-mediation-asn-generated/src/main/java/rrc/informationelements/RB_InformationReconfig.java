...
/**
 * Define the ASN1 Type RB_InformationReconfig from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RB_InformationReconfig extends Sequence {
    
    /**
     * The default constructor.
     */
    public RB_InformationReconfig()
    {
    }
     ...
     */
    public RB_InformationReconfig(RB_Identity rb_Identity, 
		    PDCP_InfoReconfig pdcp_Info, PDCP_SN_Info pdcp_SN_Info, 
		    RLC_Info rlc_Info, RB_MappingInfo rb_MappingInfo, 
	...
	mComponents[1] = new PDCP_InfoReconfig();
	mComponents[2] = new PDCP_SN_Info();
	mComponents[3] = new RLC_Info();
	mComponents[4] = new RB_MappingInfo();
	...
	switch (index) {
	    ...
	    case 1:
		return new PDCP_InfoReconfig();
	    case 2:
		return new PDCP_SN_Info();
	    case 3:
		return new RLC_Info();
	    case 4:
		return new RB_MappingInfo();
	    case 5:
    ...
    public PDCP_InfoReconfig getPdcp_Info()
    {
	return (PDCP_InfoReconfig)mComponents[1];
    }
    
    public void setPdcp_Info(PDCP_InfoReconfig pdcp_Info)
    {
    ...
    public RLC_Info getRlc_Info()
    {
	return (RLC_Info)mComponents[3];
    }
    ...
    public RB_MappingInfo getRb_MappingInfo()
    {
	return (RB_MappingInfo)mComponents[4];
    }
    
    public void setRb_MappingInfo(RB_MappingInfo rb_MappingInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RB_InformationReconfig object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RB_InformationReconfig object.
     */
...
} // End class definition for RB_InformationReconfig
