...
/**
 * Define the ASN1 Type PUSCH_SysInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PUSCH_SysInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public PUSCH_SysInfo()
    {
    }
     ...
     */
    public PUSCH_SysInfo(PUSCH_Identity pusch_Identity, PUSCH_Info pusch_Info, 
		    TransportFormatSet usch_TFS, TFCS usch_TFCS)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_SysInfo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_SysInfo object.
     */
...
} // End class definition for PUSCH_SysInfo
