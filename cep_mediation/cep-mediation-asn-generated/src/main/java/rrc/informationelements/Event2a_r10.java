...
/**
 * Define the ASN1 Type Event2a_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2a_r10 extends Sequence {
     ...
     */
    public Event2a_r10(W usedFreqW, HysteresisInterFreq hysteresis, 
		    TimeToTrigger timeToTrigger, 
		    ReportingCellStatus_r10 reportingCellStatus, 
		    NonUsedFreq2aParameterList_r10 nonUsedFreqParameterList)
    {
	...
	mComponents[3] = new ReportingCellStatus_r10();
	mComponents[4] = new NonUsedFreq2aParameterList_r10();
    }
	...
	switch (index) {
	    ...
	    case 4:
		return new NonUsedFreq2aParameterList_r10();
	    default:
    ...
    {
	return (ReportingCellStatus_r10)mComponents[3];
    }
    ...
    public NonUsedFreq2aParameterList_r10 getNonUsedFreqParameterList()
    {
	return (NonUsedFreq2aParameterList_r10)mComponents[4];
    }
    
    public void setNonUsedFreqParameterList(NonUsedFreq2aParameterList_r10 nonUsedFreqParameterList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2a_r10 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2a_r10 object.
     */
...
} // End class definition for Event2a_r10
