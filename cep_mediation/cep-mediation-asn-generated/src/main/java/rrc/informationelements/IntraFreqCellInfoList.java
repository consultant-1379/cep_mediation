...
/**
 * Define the ASN1 Type IntraFreqCellInfoList from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqCellInfoList extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqCellInfoList()
    {
    }
     ...
     */
    public IntraFreqCellInfoList(RemovedIntraFreqCellList removedIntraFreqCellList, 
		    NewIntraFreqCellList newIntraFreqCellList, 
	...
	mComponents[1] = new NewIntraFreqCellList();
	...
	switch (index) {
	    ...
	    case 1:
		return new NewIntraFreqCellList();
	    case 2:
    ...
    public NewIntraFreqCellList getNewIntraFreqCellList()
    {
	return (NewIntraFreqCellList)mComponents[1];
    }
    
    public void setNewIntraFreqCellList(NewIntraFreqCellList newIntraFreqCellList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqCellInfoList object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqCellInfoList object.
     */
...
} // End class definition for IntraFreqCellInfoList
