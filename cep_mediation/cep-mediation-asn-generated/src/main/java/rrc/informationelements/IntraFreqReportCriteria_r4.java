...
/**
 * Define the ASN1 Type IntraFreqReportCriteria_r4 from ASN1 Module InformationElements.
 * @see Choice
 */

public class IntraFreqReportCriteria_r4 extends Choice {
    
    /**
     * The default constructor.
     */
    public IntraFreqReportCriteria_r4()
    {
    }
    ...
    public static IntraFreqReportCriteria_r4 createIntraFreqReportCriteria_r4WithIntraFreqReportingCriteria(IntraFreqReportingCriteria_r4 intraFreqReportingCriteria)
    {
	IntraFreqReportCriteria_r4 __object = new IntraFreqReportCriteria_r4();
    ...
    public static IntraFreqReportCriteria_r4 createIntraFreqReportCriteria_r4WithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	IntraFreqReportCriteria_r4 __object = new IntraFreqReportCriteria_r4();
    ...
    public static IntraFreqReportCriteria_r4 createIntraFreqReportCriteria_r4WithNoReporting(ReportingCellStatusOpt noReporting)
    {
	IntraFreqReportCriteria_r4 __object = new IntraFreqReportCriteria_r4();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria_r4 object.
     */
...
} // End class definition for IntraFreqReportCriteria_r4
