...
/**
 * Define the ASN1 Type DL_CCTrCh_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_CCTrCh_r7 extends Sequence {
     ...
     */
    public DL_CCTrCh_r7(TFCS_IdentityPlain tfcs_ID, TimeInfo timeInfo, 
     ...
     */
    public DL_CCTrCh_r7(TimeInfo timeInfo, TddOption tddOption)
    {
	setTimeInfo(timeInfo);
	setTddOption(tddOption);
    }
	...
	public static class Tdd384 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd384(DownlinkTimeslotsCodes_r7 dl_CCTrCH_TimeslotsCodes)
	    {
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new DownlinkTimeslotsCodes_r7();
	    }
	    ...
	    public DownlinkTimeslotsCodes_r7 getDl_CCTrCH_TimeslotsCodes()
	    {
		return (DownlinkTimeslotsCodes_r7)mComponents[0];
	    }
	    
	    public void setDl_CCTrCH_TimeslotsCodes(DownlinkTimeslotsCodes_r7 dl_CCTrCH_TimeslotsCodes)
	    {
	...
	public static class Tdd768 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd768(DownlinkTimeslotsCodes_VHCR dl_CCTrCH_TimeslotsCodes)
	    {
		setDl_CCTrCH_TimeslotsCodes(dl_CCTrCH_TimeslotsCodes);
	    }
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new DownlinkTimeslotsCodes_VHCR();
	    }
	    ...
	    // Methods for field "dl_CCTrCH_TimeslotsCodes"
	    public DownlinkTimeslotsCodes_VHCR getDl_CCTrCH_TimeslotsCodes()
	    {
		return (DownlinkTimeslotsCodes_VHCR)mComponents[0];
	    }
	    
	    public void setDl_CCTrCH_TimeslotsCodes(DownlinkTimeslotsCodes_VHCR dl_CCTrCH_TimeslotsCodes)
	    {
		mComponents[0] = dl_CCTrCH_TimeslotsCodes;
	    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_CCTrCh_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_CCTrCh_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_CCTrCh_r7
