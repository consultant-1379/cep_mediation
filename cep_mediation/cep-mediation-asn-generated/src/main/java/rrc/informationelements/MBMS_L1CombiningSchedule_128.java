...
/**
 * Define the ASN1 Type MBMS_L1CombiningSchedule_128 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MBMS_L1CombiningSchedule_128 extends Sequence {
    
    /**
     * The default constructor.
     */
    public MBMS_L1CombiningSchedule_128()
    {
    }
     ...
     */
    public MBMS_L1CombiningSchedule_128(INTEGER cycleOffset, 
     ...
     */
    public MBMS_L1CombiningSchedule_128(long cycleOffset, 
		    Mtch_L1CombiningPeriodList mtch_L1CombiningPeriodList)
    {
     ...
     */
    public MBMS_L1CombiningSchedule_128(Mtch_L1CombiningPeriodList mtch_L1CombiningPeriodList)
    {
	setMtch_L1CombiningPeriodList(mtch_L1CombiningPeriodList);
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    ...
		    "MBMS_L1CombiningSchedule_128$Mtch_L1CombiningPeriodList$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"MBMS_L1CombiningSchedule_128$Mtch_L1CombiningPeriodList"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MBMS_L1CombiningSchedule_128 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MBMS_L1CombiningSchedule_128 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MBMS_L1CombiningSchedule_128
