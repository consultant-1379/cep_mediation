...
/**
 * Define the ASN1 Type SysInfoTypeSB1 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class SysInfoTypeSB1 extends Sequence {
     ...
     */
    public SysInfoTypeSB1(SIB_ReferenceList sib_ReferenceList, 
		    V6b0NCEs v6b0NCEs)
    {
	 ...
	 * Construct with AbstractData components.
	 */
	public V6b0NCEs(SysInfoTypeSB1_v6b0ext sysInfoTypeSB1_v6b0ext, 
			V860NCEs v860NCEs)
	{
	    setSysInfoTypeSB1_v6b0ext(sysInfoTypeSB1_v6b0ext);
	...
	public void initComponents()
	{
	    mComponents[0] = new SysInfoTypeSB1_v6b0ext();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new SysInfoTypeSB1_v6b0ext();
		case 1:
		    return new V860NCEs();
		default:
		    throw new InternalError("AbstractCollection.createInstance()");
	...
	// Methods for field "sysInfoTypeSB1_v6b0ext"
	public SysInfoTypeSB1_v6b0ext getSysInfoTypeSB1_v6b0ext()
	{
	    return (SysInfoTypeSB1_v6b0ext)mComponents[0];
	}
	
	public void setSysInfoTypeSB1_v6b0ext(SysInfoTypeSB1_v6b0ext sysInfoTypeSB1_v6b0ext)
	{
	    mComponents[0] = sysInfoTypeSB1_v6b0ext;
	}
	...
	public static class V860NCEs extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public V860NCEs(SysInfoTypeSB1_v860ext sysInfoTypeSB1_v860ext, 
			    NonCriticalExtensions nonCriticalExtensions)
	    {
		setSysInfoTypeSB1_v860ext(sysInfoTypeSB1_v860ext);
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new SysInfoTypeSB1_v860ext();
		...
		switch (index) {
		    case 0:
			return new SysInfoTypeSB1_v860ext();
		    case 1:
	    ...
	    // Methods for field "sysInfoTypeSB1_v860ext"
	    public SysInfoTypeSB1_v860ext getSysInfoTypeSB1_v860ext()
	    {
		return (SysInfoTypeSB1_v860ext)mComponents[0];
	    }
	    
	    public void setSysInfoTypeSB1_v860ext(SysInfoTypeSB1_v860ext sysInfoTypeSB1_v860ext)
	    {
		mComponents[0] = sysInfoTypeSB1_v860ext;
	    }
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"SysInfoTypeSB1$V6b0NCEs$V860NCEs$NonCriticalExtensions"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "SysInfoTypeSB1$V6b0NCEs$V860NCEs"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
