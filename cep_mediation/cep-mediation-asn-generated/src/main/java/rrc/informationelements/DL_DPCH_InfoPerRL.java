...
/**
 * Define the ASN1 Type DL_DPCH_InfoPerRL from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_DPCH_InfoPerRL extends Choice {
    
    /**
     * The default constructor.
     */
    public DL_DPCH_InfoPerRL()
    {
    }
    ...
    public static DL_DPCH_InfoPerRL createDL_DPCH_InfoPerRLWithFdd(Fdd fdd)
    {
	DL_DPCH_InfoPerRL __object = new DL_DPCH_InfoPerRL();
    ...
    public static DL_DPCH_InfoPerRL createDL_DPCH_InfoPerRLWithTdd(Tdd tdd)
    {
	DL_DPCH_InfoPerRL __object = new DL_DPCH_InfoPerRL();
	 ...
	 * Construct with AbstractData components.
	 */
	public Tdd(DL_CCTrChList dl_CCTrChListToEstablish, 
	...
	public void initComponents()
	{
	    mComponents[0] = new DL_CCTrChList();
	...
	public DL_CCTrChList getDl_CCTrChListToEstablish()
	{
	    return (DL_CCTrChList)mComponents[0];
	}
	
	public void setDl_CCTrChListToEstablish(DL_CCTrChList dl_CCTrChListToEstablish)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_DPCH_InfoPerRL
