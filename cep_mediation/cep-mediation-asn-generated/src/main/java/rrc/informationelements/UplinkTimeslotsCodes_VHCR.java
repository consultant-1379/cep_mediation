...
/**
 * Define the ASN1 Type UplinkTimeslotsCodes_VHCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UplinkTimeslotsCodes_VHCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public UplinkTimeslotsCodes_VHCR()
    {
    }
     ...
     */
    public UplinkTimeslotsCodes_VHCR(BOOLEAN dynamicSFusage, 
		    IndividualTimeslotInfo_VHCR firstIndividualTimeslotInfo, 
		    UL_TS_ChannelisationCodeList_VHCR ul_TS_ChannelisationCodeList, 
	...
	mComponents[1] = new IndividualTimeslotInfo_VHCR();
	mComponents[2] = new UL_TS_ChannelisationCodeList_VHCR();
	...
	switch (index) {
	    ...
	    case 2:
		return new UL_TS_ChannelisationCodeList_VHCR();
	    case 3:
    ...
    public IndividualTimeslotInfo_VHCR getFirstIndividualTimeslotInfo()
    {
	return (IndividualTimeslotInfo_VHCR)mComponents[1];
    }
    
    public void setFirstIndividualTimeslotInfo(IndividualTimeslotInfo_VHCR firstIndividualTimeslotInfo)
    {
    ...
    public UL_TS_ChannelisationCodeList_VHCR getUl_TS_ChannelisationCodeList()
    {
	return (UL_TS_ChannelisationCodeList_VHCR)mComponents[2];
    }
    
    public void setUl_TS_ChannelisationCodeList(UL_TS_ChannelisationCodeList_VHCR ul_TS_ChannelisationCodeList)
    {
	...
	public static class AdditionalTimeslots extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"UplinkTimeslotsCodes_VHCR$MoreTimeslots$AdditionalTimeslots$Consecutive"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		 ...
		 */
		public TimeslotList(UplinkAdditionalTimeslots_VHCR[] elements)
		{
		    super(elements);
		}
		 ...
		 */
		public synchronized void add(UplinkAdditionalTimeslots_VHCR element)
		{
		 ...
		 */
		public synchronized void set(UplinkAdditionalTimeslots_VHCR element, int atIndex)
		{
		 ...
		 */
		public synchronized UplinkAdditionalTimeslots_VHCR get(int atIndex)
		{
		    return (UplinkAdditionalTimeslots_VHCR)super.getElement(atIndex);
		}
		
		/**
		 * Insert an Element into the SEQUENCE OF/SET OF.
		 */
		public synchronized void insert(UplinkAdditionalTimeslots_VHCR element, int atIndex)
		{
		 ...
		 */
		public synchronized void remove(UplinkAdditionalTimeslots_VHCR element)
		{
		...
		{
		    return (AbstractData)new UplinkAdditionalTimeslots_VHCR();
		}
		...
		private static final ContainerInfo c_typeinfo = new ContainerInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UplinkTimeslotsCodes_VHCR$MoreTimeslots$AdditionalTimeslots$TimeslotList"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE OF"
			...
			new QName (
			    "rrc.informationelements",
			    "UplinkAdditionalTimeslots_VHCR"
			)
		    )
		);
		...
		new QName (
		    "rrc.informationelements",
		    "UplinkTimeslotsCodes_VHCR$MoreTimeslots$AdditionalTimeslots"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UplinkTimeslotsCodes_VHCR$MoreTimeslots"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UplinkTimeslotsCodes_VHCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UplinkTimeslotsCodes_VHCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UplinkTimeslotsCodes_VHCR
