...
/**
 * Define the ASN1 Type UL_LogicalChannelMappingList from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_LogicalChannelMappingList extends Sequence {
    
    /**
     * The default constructor.
     */
    public UL_LogicalChannelMappingList()
    {
    }
     ...
     */
    public UL_LogicalChannelMappingList(BOOLEAN rlc_LogicalChannelMappingIndicator, 
	 ...
	 */
	public Ul_LogicalChannelMapping(UL_LogicalChannelMapping[] elements)
	{
	    super(elements);
	}
	 ...
	 */
	public synchronized void add(UL_LogicalChannelMapping element)
	{
	 ...
	 */
	public synchronized void set(UL_LogicalChannelMapping element, int atIndex)
	{
	 ...
	 */
	public synchronized UL_LogicalChannelMapping get(int atIndex)
	{
	    return (UL_LogicalChannelMapping)super.getElement(atIndex);
	}
	
	/**
	 * Insert an Element into the SEQUENCE OF/SET OF.
	 */
	public synchronized void insert(UL_LogicalChannelMapping element, int atIndex)
	{
	 ...
	 */
	public synchronized void remove(UL_LogicalChannelMapping element)
	{
	...
	{
	    return (AbstractData)new UL_LogicalChannelMapping();
	}
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
		...
		"UL_LogicalChannelMappingList$Ul_LogicalChannelMapping"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_LogicalChannelMappingList object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_LogicalChannelMappingList object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_LogicalChannelMappingList
