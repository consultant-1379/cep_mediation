...
/**
 * Define the ASN1 Type UE_Positioning_Measurement_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_Measurement_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_Measurement_r9()
    {
    }
     ...
     */
    public UE_Positioning_Measurement_r9(UE_Positioning_ReportingQuantity_r8 ue_positioning_ReportingQuantity, 
		    ...
		    UE_Positioning_GPS_AssistanceData_r9 ue_positioning_GPS_AssistanceData, 
		    UE_Positioning_GANSS_AssistanceData_r9 ue_positioning_GANSS_AssistanceData)
    {
	...
	mComponents[4] = new UE_Positioning_GPS_AssistanceData_r9();
	mComponents[5] = new UE_Positioning_GANSS_AssistanceData_r9();
    }
	...
	switch (index) {
	    ...
	    case 4:
		return new UE_Positioning_GPS_AssistanceData_r9();
	    case 5:
		return new UE_Positioning_GANSS_AssistanceData_r9();
	    default:
    ...
    public UE_Positioning_GPS_AssistanceData_r9 getUe_positioning_GPS_AssistanceData()
    {
	return (UE_Positioning_GPS_AssistanceData_r9)mComponents[4];
    }
    
    public void setUe_positioning_GPS_AssistanceData(UE_Positioning_GPS_AssistanceData_r9 ue_positioning_GPS_AssistanceData)
    {
    ...
    public UE_Positioning_GANSS_AssistanceData_r9 getUe_positioning_GANSS_AssistanceData()
    {
	return (UE_Positioning_GANSS_AssistanceData_r9)mComponents[5];
    }
    
    public void setUe_positioning_GANSS_AssistanceData(UE_Positioning_GANSS_AssistanceData_r9 ue_positioning_GANSS_AssistanceData)
    {
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"UE_Positioning_GPS_AssistanceData_r9"
			    ),
			    new QName (
				"InformationElements",
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"UE_Positioning_GANSS_AssistanceData_r9"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r9 object.
     */
...
} // End class definition for UE_Positioning_Measurement_r9
