...
/**
 * Define the ASN1 Type IntraFreqCellInfoList_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqCellInfoList_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqCellInfoList_r9()
    {
    }
     ...
     */
    public IntraFreqCellInfoList_r9(RemovedIntraFreqCellList removedIntraFreqCellList, 
		    NewIntraFreqCellList_r9 newIntraFreqCellList, 
	...
	mComponents[1] = new NewIntraFreqCellList_r9();
	...
	switch (index) {
	    ...
	    case 1:
		return new NewIntraFreqCellList_r9();
	    case 2:
    ...
    public NewIntraFreqCellList_r9 getNewIntraFreqCellList()
    {
	return (NewIntraFreqCellList_r9)mComponents[1];
    }
    
    public void setNewIntraFreqCellList(NewIntraFreqCellList_r9 newIntraFreqCellList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqCellInfoList_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqCellInfoList_r9 object.
     */
...
} // End class definition for IntraFreqCellInfoList_r9
