...
/**
 * Define the ASN1 Type PUSCH_PowerControlInfo_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PUSCH_PowerControlInfo_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PUSCH_PowerControlInfo_r7()
    {
    }
     ...
     */
    public PUSCH_PowerControlInfo_r7(UL_TargetSIR ul_TargetSIR, 
		    TddOption tddOption)
    {
	...
	public static class Tdd128 extends Sequence {
		...
		new QName (
		    ...
		    "PUSCH_PowerControlInfo_r7$TddOption$Tdd128"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"PUSCH_PowerControlInfo_r7$TddOption"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_PowerControlInfo_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_PowerControlInfo_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PUSCH_PowerControlInfo_r7
