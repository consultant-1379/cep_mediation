...
/**
 * Define the ASN1 Type UE_Positioning_GPS_AssistanceData_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GPS_AssistanceData_r10 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GPS_AssistanceData_r10()
    {
    }
     ...
     */
    public UE_Positioning_GPS_AssistanceData_r10(UE_Positioning_GPS_ReferenceTime_r10 ue_positioning_GPS_ReferenceTime, 
		    ReferenceLocation ue_positioning_GPS_ReferenceLocation, 
		    UE_Positioning_GPS_DGPS_Corrections_r9 ue_positioning_GPS_DGPS_Corrections, 
		    ...
		    UE_Positioning_GPS_Almanac_r10 ue_positioning_GPS_Almanac, 
		    UE_Positioning_GPS_AcquisitionAssistance_r10 ue_positioning_GPS_AcquisitionAssistance, 
    ...
    {
	mComponents[0] = new UE_Positioning_GPS_ReferenceTime_r10();
	mComponents[1] = new ReferenceLocation();
	mComponents[2] = new UE_Positioning_GPS_DGPS_Corrections_r9();
	...
	mComponents[6] = new UE_Positioning_GPS_Almanac_r10();
	mComponents[7] = new UE_Positioning_GPS_AcquisitionAssistance_r10();
	...
	switch (index) {
	    case 0:
		return new UE_Positioning_GPS_ReferenceTime_r10();
	    case 1:
		return new ReferenceLocation();
	    case 2:
		return new UE_Positioning_GPS_DGPS_Corrections_r9();
	    case 3:
	    ...
	    case 6:
		return new UE_Positioning_GPS_Almanac_r10();
	    case 7:
		return new UE_Positioning_GPS_AcquisitionAssistance_r10();
	    case 8:
    ...
    public UE_Positioning_GPS_ReferenceTime_r10 getUe_positioning_GPS_ReferenceTime()
    {
	return (UE_Positioning_GPS_ReferenceTime_r10)mComponents[0];
    }
    
    public void setUe_positioning_GPS_ReferenceTime(UE_Positioning_GPS_ReferenceTime_r10 ue_positioning_GPS_ReferenceTime)
    {
    ...
    public UE_Positioning_GPS_DGPS_Corrections_r9 getUe_positioning_GPS_DGPS_Corrections()
    {
	return (UE_Positioning_GPS_DGPS_Corrections_r9)mComponents[2];
    }
    
    public void setUe_positioning_GPS_DGPS_Corrections(UE_Positioning_GPS_DGPS_Corrections_r9 ue_positioning_GPS_DGPS_Corrections)
    {
    ...
    public UE_Positioning_GPS_Almanac_r10 getUe_positioning_GPS_Almanac()
    {
	return (UE_Positioning_GPS_Almanac_r10)mComponents[6];
    }
    
    public void setUe_positioning_GPS_Almanac(UE_Positioning_GPS_Almanac_r10 ue_positioning_GPS_Almanac)
    {
    ...
    public UE_Positioning_GPS_AcquisitionAssistance_r10 getUe_positioning_GPS_AcquisitionAssistance()
    {
	return (UE_Positioning_GPS_AcquisitionAssistance_r10)mComponents[7];
    }
    
    public void setUe_positioning_GPS_AcquisitionAssistance(UE_Positioning_GPS_AcquisitionAssistance_r10 ue_positioning_GPS_AcquisitionAssistance)
    {
	...
	new QName (
	    ...
	    "UE_Positioning_GPS_AssistanceData_r10"
	),
	new QName (
	    "InformationElements",
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"UE_Positioning_GPS_AcquisitionAssistance_r10"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_AssistanceData_r10 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_AssistanceData_r10 object.
     */
...
} // End class definition for UE_Positioning_GPS_AssistanceData_r10
