...
/**
 * Define the ASN1 Type DL_AddReconfTransChInformation_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_AddReconfTransChInformation_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_AddReconfTransChInformation_r4()
    {
    }
     ...
     */
    public DL_AddReconfTransChInformation_r4(DL_TrCH_Type dl_TransportChannelType, 
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"DL_AddReconfTransChInformation_r4$Tfs_SignallingMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_AddReconfTransChInformation_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_AddReconfTransChInformation_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_AddReconfTransChInformation_r4
