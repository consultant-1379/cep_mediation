...
/**
 * Define the ASN1 Type UplinkTimeslotsCodes_LCR_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UplinkTimeslotsCodes_LCR_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UplinkTimeslotsCodes_LCR_r7()
    {
    }
     ...
     */
    public UplinkTimeslotsCodes_LCR_r7(BOOLEAN dynamicSFusage, 
		    IndividualTimeslotInfo_LCR_r4 firstIndividualTimeslotInfo, 
		    UL_TS_ChannelisationCodeList_r7 ul_TS_ChannelisationCodeList, 
	...
	mComponents[1] = new IndividualTimeslotInfo_LCR_r4();
	mComponents[2] = new UL_TS_ChannelisationCodeList_r7();
	...
	switch (index) {
	    ...
	    case 2:
		return new UL_TS_ChannelisationCodeList_r7();
	    case 3:
    ...
    public IndividualTimeslotInfo_LCR_r4 getFirstIndividualTimeslotInfo()
    {
	return (IndividualTimeslotInfo_LCR_r4)mComponents[1];
    }
    
    public void setFirstIndividualTimeslotInfo(IndividualTimeslotInfo_LCR_r4 firstIndividualTimeslotInfo)
    {
    ...
    public UL_TS_ChannelisationCodeList_r7 getUl_TS_ChannelisationCodeList()
    {
	return (UL_TS_ChannelisationCodeList_r7)mComponents[2];
    }
    
    public void setUl_TS_ChannelisationCodeList(UL_TS_ChannelisationCodeList_r7 ul_TS_ChannelisationCodeList)
    {
	...
	public static class AdditionalTimeslots extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"UplinkTimeslotsCodes_LCR_r7$MoreTimeslots$AdditionalTimeslots$Consecutive"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		 ...
		 */
		public TimeslotList(UplinkAdditionalTimeslots_LCR_r7[] elements)
		{
		    super(elements);
		}
		 ...
		 */
		public synchronized void add(UplinkAdditionalTimeslots_LCR_r7 element)
		{
		 ...
		 */
		public synchronized void set(UplinkAdditionalTimeslots_LCR_r7 element, int atIndex)
		{
		 ...
		 */
		public synchronized UplinkAdditionalTimeslots_LCR_r7 get(int atIndex)
		{
		    return (UplinkAdditionalTimeslots_LCR_r7)super.getElement(atIndex);
		}
		
		/**
		 * Insert an Element into the SEQUENCE OF/SET OF.
		 */
		public synchronized void insert(UplinkAdditionalTimeslots_LCR_r7 element, int atIndex)
		{
		 ...
		 */
		public synchronized void remove(UplinkAdditionalTimeslots_LCR_r7 element)
		{
		...
		{
		    return (AbstractData)new UplinkAdditionalTimeslots_LCR_r7();
		}
		...
		private static final ContainerInfo c_typeinfo = new ContainerInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UplinkTimeslotsCodes_LCR_r7$MoreTimeslots$AdditionalTimeslots$TimeslotList"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE OF"
			...
			new QName (
			    "rrc.informationelements",
			    "UplinkAdditionalTimeslots_LCR_r7"
			)
		    )
		);
		...
		new QName (
		    "rrc.informationelements",
		    "UplinkTimeslotsCodes_LCR_r7$MoreTimeslots$AdditionalTimeslots"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UplinkTimeslotsCodes_LCR_r7$MoreTimeslots"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UplinkTimeslotsCodes_LCR_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UplinkTimeslotsCodes_LCR_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UplinkTimeslotsCodes_LCR_r7
