...
/**
 * Define the ASN1 Type DL_DPCH_InfoPerRL_r4 from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_DPCH_InfoPerRL_r4 extends Choice {
    
    /**
     * The default constructor.
     */
    public DL_DPCH_InfoPerRL_r4()
    {
    }
    ...
    public static DL_DPCH_InfoPerRL_r4 createDL_DPCH_InfoPerRL_r4WithFdd(Fdd fdd)
    {
	DL_DPCH_InfoPerRL_r4 __object = new DL_DPCH_InfoPerRL_r4();
	...
	public void initComponents()
	{
	    ...
	    mComponents[5] = SSDT_CellIdentity.ssdt_id_a;
	...
	{
	    return (SSDT_CellIdentity)mComponents[5];
	}
    ...
    public static DL_DPCH_InfoPerRL_r4 createDL_DPCH_InfoPerRL_r4WithTdd(Tdd tdd)
    {
	DL_DPCH_InfoPerRL_r4 __object = new DL_DPCH_InfoPerRL_r4();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_DPCH_InfoPerRL_r4
