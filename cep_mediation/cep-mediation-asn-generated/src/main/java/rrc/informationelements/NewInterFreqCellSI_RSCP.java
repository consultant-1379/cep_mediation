...
/**
 * Define the ASN1 Type NewInterFreqCellSI_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterFreqCellSI_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterFreqCellSI_RSCP()
    {
    }
     ...
     */
    public NewInterFreqCellSI_RSCP(InterFreqCellID interFreqCellID, 
		    FrequencyInfo frequencyInfo, CellInfoSI_RSCP cellInfo)
    {
     ...
     */
    public NewInterFreqCellSI_RSCP(CellInfoSI_RSCP cellInfo)
    {
	setCellInfo(cellInfo);
    }
	...
	mComponents[2] = new CellInfoSI_RSCP();
    }
    ...
    public CellInfoSI_RSCP getCellInfo()
    {
	return (CellInfoSI_RSCP)mComponents[2];
    }
    
    public void setCellInfo(CellInfoSI_RSCP cellInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_RSCP object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_RSCP object.
     */
...
} // End class definition for NewInterFreqCellSI_RSCP
