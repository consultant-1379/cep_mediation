...
/**
 * Define the ASN1 Type Neighbour_v390ext from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Neighbour_v390ext extends Sequence {
    
    /**
     * The default constructor.
     */
    public Neighbour_v390ext()
    {
    }
     ...
     */
    public Neighbour_v390ext(ModeSpecificInfo modeSpecificInfo)
    {
	...
	public static class Fdd extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Fdd(FrequencyInfo frequencyInfo)
	    {
		...
		new QName (
		    ...
		    "Neighbour_v390ext$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"Neighbour_v390ext$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Neighbour_v390ext object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Neighbour_v390ext object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for Neighbour_v390ext
