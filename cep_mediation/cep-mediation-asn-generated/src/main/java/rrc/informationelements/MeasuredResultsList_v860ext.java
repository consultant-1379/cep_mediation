...
/**
 * Define the ASN1 Type MeasuredResultsList_v860ext from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class MeasuredResultsList_v860ext extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public MeasuredResultsList_v860ext()
    {
    }
     ...
     */
    public MeasuredResultsList_v860ext(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(MeasuredResults_v860ext measuredResults)
	{
	...
	{
	    mComponents[0] = new MeasuredResults_v860ext();
	}
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new MeasuredResults_v860ext();
		default:
	...
	public MeasuredResults_v860ext getMeasuredResults()
	{
	    return (MeasuredResults_v860ext)mComponents[0];
	}
	
	public void setMeasuredResults(MeasuredResults_v860ext measuredResults)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasuredResultsList_v860ext object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasuredResultsList_v860ext object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MeasuredResultsList_v860ext
