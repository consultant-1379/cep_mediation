...
/**
 * Define the ASN1 Type Common_MAC_ehs_ReorderingQueue from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Common_MAC_ehs_ReorderingQueue extends Sequence {
    
    /**
     * The default constructor.
     */
    public Common_MAC_ehs_ReorderingQueue()
    {
    }
     ...
     */
    public Common_MAC_ehs_ReorderingQueue(MAC_ehs_QueueId mac_ehs_QueueId, 
		    T1_ReleaseTimer t1_ReleaseTimer, 
		    Treset_ResetTimer reorderingResetTimer, 
		    MAC_hs_WindowSize mac_ehsWindowSize)
    {
	setMac_ehs_QueueId(mac_ehs_QueueId);
	setT1_ReleaseTimer(t1_ReleaseTimer);
    ...
    // Methods for field "t1_ReleaseTimer"
    public T1_ReleaseTimer getT1_ReleaseTimer()
    {
	return (T1_ReleaseTimer)mComponents[1];
    }
    
    public void setT1_ReleaseTimer(T1_ReleaseTimer t1_ReleaseTimer)
    {
	mComponents[1] = t1_ReleaseTimer;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Common_MAC_ehs_ReorderingQueue object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Common_MAC_ehs_ReorderingQueue object.
     */
...
} // End class definition for Common_MAC_ehs_ReorderingQueue
