...
/**
 * Define the ASN1 Type PUSCH_SysInfoList_SFN_HCR_r5 from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PUSCH_SysInfoList_SFN_HCR_r5 extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PUSCH_SysInfoList_SFN_HCR_r5()
    {
    }
     ...
     */
    public PUSCH_SysInfoList_SFN_HCR_r5(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(PUSCH_SysInfo_HCR_r5 pusch_SysInfo, 
	...
	{
	    mComponents[0] = new PUSCH_SysInfo_HCR_r5();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new PUSCH_SysInfo_HCR_r5();
		case 1:
	...
	public PUSCH_SysInfo_HCR_r5 getPusch_SysInfo()
	{
	    return (PUSCH_SysInfo_HCR_r5)mComponents[0];
	}
	
	public void setPusch_SysInfo(PUSCH_SysInfo_HCR_r5 pusch_SysInfo)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN_HCR_r5 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN_HCR_r5 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PUSCH_SysInfoList_SFN_HCR_r5
