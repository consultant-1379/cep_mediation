...
/**
 * Define the ASN1 Type HS_SCCH_TDD128 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class HS_SCCH_TDD128 extends Sequence {
    
    /**
     * The default constructor.
     */
    public HS_SCCH_TDD128()
    {
    }
     ...
     */
    public HS_SCCH_TDD128(TimeslotNumber_LCR_r4 timeslotNumber, 
	...
	mComponents[5] = new Bler_Target();
	mComponents[6] = new HS_SICH_Configuration_TDD128();
    }
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"HS_SCCH_TDD128$MidambleAllocationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (Bler_Target)mComponents[5];
    }
    
    public void setBler_target(Bler_Target bler_target)
    {
	mComponents[5] = bler_target;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HS_SCCH_TDD128 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HS_SCCH_TDD128 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HS_SCCH_TDD128
