...
/**
 * Define the ASN1 Type DSCH_Mapping from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DSCH_Mapping extends Sequence {
     ...
     */
    public DSCH_Mapping(MaxTFCI_Field2Value maxTFCI_Field2Value, 
		    SF_PDSCH spreadingFactor, CodeNumberDSCH codeNumber, 
		    MultiCodeInfo multiCodeInfo)
    {
	setMaxTFCI_Field2Value(maxTFCI_Field2Value);
    ...
    // Methods for field "maxTFCI_Field2Value"
    public MaxTFCI_Field2Value getMaxTFCI_Field2Value()
    {
	return (MaxTFCI_Field2Value)mComponents[0];
    }
    
    public void setMaxTFCI_Field2Value(MaxTFCI_Field2Value maxTFCI_Field2Value)
    {
	mComponents[0] = maxTFCI_Field2Value;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DSCH_Mapping object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DSCH_Mapping object.
     */
...
} // End class definition for DSCH_Mapping
