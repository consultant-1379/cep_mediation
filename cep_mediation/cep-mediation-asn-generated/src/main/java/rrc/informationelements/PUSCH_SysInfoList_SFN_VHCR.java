...
/**
 * Define the ASN1 Type PUSCH_SysInfoList_SFN_VHCR from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PUSCH_SysInfoList_SFN_VHCR extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PUSCH_SysInfoList_SFN_VHCR()
    {
    }
     ...
     */
    public PUSCH_SysInfoList_SFN_VHCR(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(PUSCH_SysInfo_VHCR pusch_SysInfo_VHCR, 
			SFN_TimeInfo sfn_TimeInfo)
	{
	    setPusch_SysInfo_VHCR(pusch_SysInfo_VHCR);
	...
	{
	    mComponents[0] = new PUSCH_SysInfo_VHCR();
	...
	// Methods for field "pusch_SysInfo_VHCR"
	public PUSCH_SysInfo_VHCR getPusch_SysInfo_VHCR()
	{
	    return (PUSCH_SysInfo_VHCR)mComponents[0];
	}
	
	public void setPusch_SysInfo_VHCR(PUSCH_SysInfo_VHCR pusch_SysInfo_VHCR)
	{
	    mComponents[0] = pusch_SysInfo_VHCR;
	}
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN_VHCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN_VHCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PUSCH_SysInfoList_SFN_VHCR
