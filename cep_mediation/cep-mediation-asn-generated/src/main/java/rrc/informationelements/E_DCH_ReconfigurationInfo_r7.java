...
/**
 * Define the ASN1 Type E_DCH_ReconfigurationInfo_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class E_DCH_ReconfigurationInfo_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public E_DCH_ReconfigurationInfo_r7()
    {
    }
     ...
     */
    public E_DCH_ReconfigurationInfo_r7(E_DCH_RL_InfoNewServingCell_r7 e_DCH_RL_InfoNewServingCell, 
    ...
    {
	mComponents[0] = new E_DCH_RL_InfoNewServingCell_r7();
	...
	switch (index) {
	    case 0:
		return new E_DCH_RL_InfoNewServingCell_r7();
	    case 1:
    ...
    public E_DCH_RL_InfoNewServingCell_r7 getE_DCH_RL_InfoNewServingCell()
    {
	return (E_DCH_RL_InfoNewServingCell_r7)mComponents[0];
    }
    
    public void setE_DCH_RL_InfoNewServingCell(E_DCH_RL_InfoNewServingCell_r7 e_DCH_RL_InfoNewServingCell)
    {
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
		...
		"E_DCH_ReconfigurationInfo_r7$E_DCH_RL_InfoOtherCellList"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"E_DCH_RL_InfoNewServingCell_r7"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' E_DCH_ReconfigurationInfo_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' E_DCH_ReconfigurationInfo_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for E_DCH_ReconfigurationInfo_r7
