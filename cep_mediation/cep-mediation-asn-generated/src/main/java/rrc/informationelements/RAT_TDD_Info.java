...
/**
 * Define the ASN1 Type RAT_TDD_Info from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RAT_TDD_Info extends Sequence {
     ...
     */
    public RAT_TDD_Info(RAT_Identifier rat_Identifier, 
		    S_SearchRXLEV s_SearchRAT, S_SearchRXLEV s_HCS_RAT, 
		    S_SearchRXLEV s_Limit_SearchRAT)
    {
	...
	mComponents[3] = new S_SearchRXLEV();
    }
    ...
    public S_SearchRXLEV getS_SearchRAT()
    {
	return (S_SearchRXLEV)mComponents[1];
    }
    
    public void setS_SearchRAT(S_SearchRXLEV s_SearchRAT)
    {
    ...
    public S_SearchRXLEV getS_Limit_SearchRAT()
    {
	return (S_SearchRXLEV)mComponents[3];
    }
    
    public void setS_Limit_SearchRAT(S_SearchRXLEV s_Limit_SearchRAT)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RAT_TDD_Info object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RAT_TDD_Info object.
     */
...
} // End class definition for RAT_TDD_Info
