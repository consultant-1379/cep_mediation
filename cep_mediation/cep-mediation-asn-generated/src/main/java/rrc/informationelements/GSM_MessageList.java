...
/**
 * Define the ASN1 Type GSM_MessageList from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class GSM_MessageList extends SequenceOf {
     ...
     */
    public GSM_MessageList(BitString[] elements)
    {
	super(elements);
    }
