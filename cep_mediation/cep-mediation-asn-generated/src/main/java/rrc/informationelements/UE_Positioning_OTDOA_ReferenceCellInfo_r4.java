...
/**
 * Define the ASN1 Type UE_Positioning_OTDOA_ReferenceCellInfo_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_OTDOA_ReferenceCellInfo_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r4()
    {
    }
     ...
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r4(INTEGER sfn, 
     ...
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r4(long sfn, 
		    ModeSpecificInfo modeSpecificInfo, 
		    FrequencyInfo frequencyInfo, 
		    PositioningMode positioningMode, 
		    UE_Positioning_IPDL_Parameters_r4 ue_positioning_IPDL_Paremeters)
     ...
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r4(ModeSpecificInfo modeSpecificInfo, 
		    PositioningMode positioningMode)
    {
	setModeSpecificInfo(modeSpecificInfo);
	setPositioningMode(positioningMode);
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r4$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r4$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UE_Positioning_OTDOA_ReferenceCellInfo_r4$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	public static class UeBased extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r4$PositioningMode$UeBased"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class UeAssisted extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r4$PositioningMode$UeAssisted"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UE_Positioning_OTDOA_ReferenceCellInfo_r4$PositioningMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_OTDOA_ReferenceCellInfo_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_OTDOA_ReferenceCellInfo_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_OTDOA_ReferenceCellInfo_r4
