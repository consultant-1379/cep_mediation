...
/**
 * Define the ASN1 Type UL_CCTrCH_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_CCTrCH_r4 extends Sequence {
     ...
     */
    public UL_CCTrCH_r4(TFCS_IdentityPlain tfcs_ID, UL_TargetSIR ul_TargetSIR, 
     ...
     */
    public UL_CCTrCH_r4(UL_TargetSIR ul_TargetSIR, TimeInfo timeInfo, 
		    TddOption tddOption)
    {
	setUl_TargetSIR(ul_TargetSIR);
	setTimeInfo(timeInfo);
	...
	public static class Tdd128 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd128(UplinkTimeslotsCodes_LCR_r4 ul_CCTrCH_TimeslotsCodes)
	    {
		setUl_CCTrCH_TimeslotsCodes(ul_CCTrCH_TimeslotsCodes);
	    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_CCTrCH_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_CCTrCH_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_CCTrCH_r4
