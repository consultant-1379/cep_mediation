...
/**
 * Define the ASN1 Type IntraFreqReportCriteria_r7 from ASN1 Module InformationElements.
 * @see Choice
 */

public class IntraFreqReportCriteria_r7 extends Choice {
    
    /**
     * The default constructor.
     */
    public IntraFreqReportCriteria_r7()
    {
    }
    ...
    public static IntraFreqReportCriteria_r7 createIntraFreqReportCriteria_r7WithIntraFreqReportingCriteria(IntraFreqReportingCriteria_r7 intraFreqReportingCriteria)
    {
	IntraFreqReportCriteria_r7 __object = new IntraFreqReportCriteria_r7();
    ...
    public static IntraFreqReportCriteria_r7 createIntraFreqReportCriteria_r7WithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	IntraFreqReportCriteria_r7 __object = new IntraFreqReportCriteria_r7();
    ...
    public static IntraFreqReportCriteria_r7 createIntraFreqReportCriteria_r7WithNoReporting(ReportingCellStatusOpt noReporting)
    {
	IntraFreqReportCriteria_r7 __object = new IntraFreqReportCriteria_r7();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria_r7 object.
     */
...
} // End class definition for IntraFreqReportCriteria_r7
