...
/**
 * Define the ASN1 Type GANSSGenericData_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class GANSSGenericData_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public GANSSGenericData_r8()
    {
    }
     ...
     */
    public GANSSGenericData_r8(INTEGER ganssId, 
		    ...
		    UE_Positioning_GANSS_Almanac_r8 uePositioningGANSSAlmanac, 
     ...
     */
    public GANSSGenericData_r8(long ganssId, 
		    UE_Positioning_GANSS_SBAS_ID uePositiningGANSSsbasID, 
		    GANSSTimeModelsList ganssTimeModelsList, 
		    UE_Positioning_DGANSSCorrections uePositioningDGANSSCorrections, 
		    UE_Positioning_GANSS_NavigationModel uePositioningGANSSNavigationModel, 
	...
	mComponents[2] = new GANSSTimeModelsList();
	mComponents[3] = new UE_Positioning_DGANSSCorrections();
	...
	mComponents[8] = new UE_Positioning_GANSS_ReferenceMeasurementInfo();
	mComponents[9] = new UE_Positioning_GANSS_Almanac_r8();
	...
	switch (index) {
	    ...
	    case 9:
		return new UE_Positioning_GANSS_Almanac_r8();
	    case 10:
    ...
    {
	return (GANSSTimeModelsList)mComponents[2];
    }
    ...
    {
	return (UE_Positioning_DGANSSCorrections)mComponents[3];
    }
    ...
    {
	return (UE_Positioning_GANSS_ReferenceMeasurementInfo)mComponents[8];
    }
    ...
    public UE_Positioning_GANSS_Almanac_r8 getUePositioningGANSSAlmanac()
    {
	return (UE_Positioning_GANSS_Almanac_r8)mComponents[9];
    }
    
    public void setUePositioningGANSSAlmanac(UE_Positioning_GANSS_Almanac_r8 uePositioningGANSSAlmanac)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' GANSSGenericData_r8 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' GANSSGenericData_r8 object.
     */
...
} // End class definition for GANSSGenericData_r8
