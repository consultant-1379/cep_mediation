...
/**
 * Define the ASN1 Type UL_LogicalChannelMappingList_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_LogicalChannelMappingList_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UL_LogicalChannelMappingList_r6()
    {
    }
     ...
     */
    public UL_LogicalChannelMappingList_r6(BOOLEAN rlc_LogicalChannelMappingIndicator, 
	 ...
	 */
	public Ul_LogicalChannelMapping(UL_LogicalChannelMapping_r6[] elements)
	{
	    super(elements);
	}
	 ...
	 */
	public synchronized void add(UL_LogicalChannelMapping_r6 element)
	{
	 ...
	 */
	public synchronized void set(UL_LogicalChannelMapping_r6 element, int atIndex)
	{
	 ...
	 */
	public synchronized UL_LogicalChannelMapping_r6 get(int atIndex)
	{
	    return (UL_LogicalChannelMapping_r6)super.getElement(atIndex);
	}
	
	/**
	 * Insert an Element into the SEQUENCE OF/SET OF.
	 */
	public synchronized void insert(UL_LogicalChannelMapping_r6 element, int atIndex)
	{
	 ...
	 */
	public synchronized void remove(UL_LogicalChannelMapping_r6 element)
	{
	...
	{
	    return (AbstractData)new UL_LogicalChannelMapping_r6();
	}
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
		...
		"UL_LogicalChannelMappingList_r6$Ul_LogicalChannelMapping"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_LogicalChannelMappingList_r6 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_LogicalChannelMappingList_r6 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_LogicalChannelMappingList_r6
