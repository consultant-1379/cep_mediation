...
/**
 * Define the ASN1 Type PDSCH_SysInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDSCH_SysInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDSCH_SysInfo()
    {
    }
     ...
     */
    public PDSCH_SysInfo(PDSCH_Identity pdsch_Identity, PDSCH_Info pdsch_Info, 
		    TransportFormatSet dsch_TFS, TFCS dsch_TFCS)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_SysInfo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_SysInfo object.
     */
...
} // End class definition for PDSCH_SysInfo
