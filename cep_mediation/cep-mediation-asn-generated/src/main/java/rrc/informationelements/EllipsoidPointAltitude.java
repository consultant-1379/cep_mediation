...
/**
 * Define the ASN1 Type EllipsoidPointAltitude from ASN1 Module InformationElements.
 * @see Sequence
 */

public class EllipsoidPointAltitude extends Sequence {
    
    /**
     * The default constructor.
     */
    public EllipsoidPointAltitude()
    {
    }
     ...
     */
    public EllipsoidPointAltitude(LatitudeSign latitudeSign, INTEGER latitude, 
		    INTEGER longitude, AltitudeDirection altitudeDirection, 
		    INTEGER altitude)
    {
     ...
     */
    public EllipsoidPointAltitude(LatitudeSign latitudeSign, long latitude, 
		    long longitude, AltitudeDirection altitudeDirection, 
		    long altitude)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"EllipsoidPointAltitude$LatitudeSign"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"EllipsoidPointAltitude$AltitudeDirection"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' EllipsoidPointAltitude object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' EllipsoidPointAltitude object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for EllipsoidPointAltitude
