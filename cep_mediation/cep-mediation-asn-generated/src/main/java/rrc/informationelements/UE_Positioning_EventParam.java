...
/**
 * Define the ASN1 Type UE_Positioning_EventParam from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_EventParam extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_EventParam()
    {
    }
     ...
     */
    public UE_Positioning_EventParam(ReportingAmount reportingAmount, 
		    BOOLEAN reportFirstFix, 
		    UE_Positioning_MeasurementInterval measurementInterval, 
		    UE_Positioning_EventSpecificInfo eventSpecificInfo)
    {
	...
	mComponents[3] = new UE_Positioning_EventSpecificInfo();
    }
	...
	switch (index) {
	    ...
	    case 3:
		return new UE_Positioning_EventSpecificInfo();
	    default:
    ...
    public UE_Positioning_EventSpecificInfo getEventSpecificInfo()
    {
	return (UE_Positioning_EventSpecificInfo)mComponents[3];
    }
    
    public void setEventSpecificInfo(UE_Positioning_EventSpecificInfo eventSpecificInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_EventParam object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_EventParam object.
     */
...
} // End class definition for UE_Positioning_EventParam
