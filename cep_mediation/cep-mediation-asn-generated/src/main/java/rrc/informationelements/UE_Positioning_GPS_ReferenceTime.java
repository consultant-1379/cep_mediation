...
/**
 * Define the ASN1 Type UE_Positioning_GPS_ReferenceTime from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GPS_ReferenceTime extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GPS_ReferenceTime()
    {
    }
     ...
     */
    public UE_Positioning_GPS_ReferenceTime(INTEGER gps_Week, 
     ...
     */
    public UE_Positioning_GPS_ReferenceTime(long gps_Week, 
		    GPS_TOW_1msec gps_tow_1msec, 
		    UTRAN_GPSReferenceTime utran_GPSReferenceTime, 
		    SFN_TOW_Uncertainty sfn_tow_Uncertainty, 
		    UTRAN_GPS_DriftRate utran_GPS_DriftRate, 
	...
	mComponents[3] = SFN_TOW_Uncertainty.lessThan10;
	mComponents[4] = UTRAN_GPS_DriftRate.utran_GPSDrift0;
	mComponents[5] = new GPS_TOW_AssistList();
    }
    ...
    {
	return (GPS_TOW_AssistList)mComponents[5];
    }
    
    public void setGps_TOW_AssistList(GPS_TOW_AssistList gps_TOW_AssistList)
    {
	mComponents[5] = gps_TOW_AssistList;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_ReferenceTime object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_ReferenceTime object.
     */
...
} // End class definition for UE_Positioning_GPS_ReferenceTime
