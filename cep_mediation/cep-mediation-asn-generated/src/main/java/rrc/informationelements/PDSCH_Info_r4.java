...
/**
 * Define the ASN1 Type PDSCH_Info_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDSCH_Info_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDSCH_Info_r4()
    {
    }
     ...
     */
    public PDSCH_Info_r4(TFCS_IdentityPlain tfcs_ID, 
     ...
     */
    public PDSCH_Info_r4(TddOption tddOption)
    {
	setTddOption(tddOption);
    }
	...
	public static class Tdd384 extends Sequence {
		...
		new QName (
		    ...
		    "PDSCH_Info_r4$TddOption$Tdd384"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd128 extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "PDSCH_Info_r4$TddOption$Tdd128"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_Info_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_Info_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDSCH_Info_r4
