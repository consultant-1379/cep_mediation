...
/**
 * Define the ASN1 Type InterFrequencyMeasurement_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterFrequencyMeasurement_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterFrequencyMeasurement_r4()
    {
    }
     ...
     */
    public InterFrequencyMeasurement_r4(InterFreqCellInfoList_r4 interFreqCellInfoList, 
		    ...
		    InterFreqReportCriteria_r4 reportCriteria)
    {
	...
	mComponents[5] = new InterFreqReportCriteria_r4();
    }
	...
	switch (index) {
	    ...
	    case 5:
		return new InterFreqReportCriteria_r4();
	    default:
    ...
    public InterFreqReportCriteria_r4 getReportCriteria()
    {
	return (InterFreqReportCriteria_r4)mComponents[5];
    }
    
    public void setReportCriteria(InterFreqReportCriteria_r4 reportCriteria)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement_r4 object.
     */
...
} // End class definition for InterFrequencyMeasurement_r4
