...
/**
 * Define the ASN1 Type MBSFNInterFrequencyNeighbour_v860ext from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MBSFNInterFrequencyNeighbour_v860ext extends Sequence {
    
    /**
     * The default constructor.
     */
    public MBSFNInterFrequencyNeighbour_v860ext()
    {
    }
     ...
     */
    public MBSFNInterFrequencyNeighbour_v860ext(Imb_Indication imb_Indication)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"MBSFNInterFrequencyNeighbour_v860ext$Imb_Indication"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MBSFNInterFrequencyNeighbour_v860ext object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MBSFNInterFrequencyNeighbour_v860ext object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MBSFNInterFrequencyNeighbour_v860ext
