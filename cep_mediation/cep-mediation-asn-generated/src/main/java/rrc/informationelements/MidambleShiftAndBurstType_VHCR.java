...
/**
 * Define the ASN1 Type MidambleShiftAndBurstType_VHCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MidambleShiftAndBurstType_VHCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public MidambleShiftAndBurstType_VHCR()
    {
    }
     ...
     */
    public MidambleShiftAndBurstType_VHCR(BurstType burstType)
    {
	...
	public static final  int  type3_chosen = 3;
	public static final  int  mbsfnBurstType4_chosen = 4;
	...
	public static class Type1 extends Sequence {
		...
		public static class UeSpecificMidamble extends Sequence {
			...
			new QName (
			    ...
			    "MidambleShiftAndBurstType_VHCR$BurstType$Type1$MidambleAllocationMode$UeSpecificMidamble"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MidambleShiftAndBurstType_VHCR$BurstType$Type1$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MidambleShiftAndBurstType_VHCR$BurstType$Type1"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Type2 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Type2(MidambleConfigurationBurstType2_VHCR midambleConfigurationBurstType2, 
			    MidambleAllocationMode midambleAllocationMode)
	    {
	    ...
	    public void initComponents()
	    {
		mComponents[0] = MidambleConfigurationBurstType2_VHCR.ms4;
		mComponents[1] = new MidambleAllocationMode();
	    }
		...
		switch (index) {
		    case 0:
			return MidambleConfigurationBurstType2_VHCR.ms4;
		    case 1:
			return new MidambleAllocationMode();
		    default:
			throw new InternalError("AbstractCollection.createInstance()");
	    ...
	    public MidambleConfigurationBurstType2_VHCR getMidambleConfigurationBurstType2()
	    {
		return (MidambleConfigurationBurstType2_VHCR)mComponents[0];
	    }
	    
	    public void setMidambleConfigurationBurstType2(MidambleConfigurationBurstType2_VHCR midambleConfigurationBurstType2)
	    {
		...
		public static class UeSpecificMidamble extends Sequence {
		     ...
		     * Construct with AbstractData components.
		     */
		    public UeSpecificMidamble(MidambleShiftShort_VHCR midambleShift)
		    {
			setMidambleShift(midambleShift);
		    }
		    ...
		    public void initComponents()
		    {
			mComponents[0] = new MidambleShiftShort_VHCR();
		    }
			...
			switch (index) {
			    case 0:
				return new MidambleShiftShort_VHCR();
			    default:
				throw new InternalError("AbstractCollection.createInstance()");
			}
		    ...
		    // Methods for field "midambleShift"
		    public MidambleShiftShort_VHCR getMidambleShift()
		    {
			return (MidambleShiftShort_VHCR)mComponents[0];
		    }
		    
		    public void setMidambleShift(MidambleShiftShort_VHCR midambleShift)
		    {
			mComponents[0] = midambleShift;
		    }
			...
			new QName (
			    "rrc.informationelements",
			    "MidambleShiftAndBurstType_VHCR$BurstType$Type2$MidambleAllocationMode$UeSpecificMidamble"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
			...
			new Fields (
				...
				new SequenceFieldInfo (
					...
					new IntegerInfo (
					    ...
					    new ValueRangeConstraint (
						new AbstractBounds(
						    new MidambleShiftShort_VHCR(0), 
						    new MidambleShiftShort_VHCR(7),
						    0
						)
					    ),
					    new Bounds (
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MidambleShiftAndBurstType_VHCR$BurstType$Type2$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MidambleShiftAndBurstType_VHCR$BurstType$Type2"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new Fields (
			...
			new SequenceFieldInfo (
				...
				new EnumeratedInfo (
				    ...
				    new QName (
					"rrc.informationelements",
					"MidambleConfigurationBurstType2_VHCR"
				    ),
				    new QName (
					"InformationElements",
				    ...
				    0,
				    MidambleConfigurationBurstType2_VHCR.ms4
				)
			    ),
	...
	// Methods for field "type3"
	public static BurstType createBurstTypeWithType3(Type3 type3)
	{
	    BurstType __object = new BurstType();

	    __object.setType3(type3);
	    return __object;
	}
	
	public boolean hasType3()
	{
	    return getChosenFlag() == type3_chosen;
	}
	
	public void setType3(Type3 type3)
	{
	    setChosenValue(type3);
	    setChosenFlag(type3_chosen);
	}
	
	
	
	/**
	 * Define the ASN1 Type Type3 from ASN1 Module InformationElements.
	 * @see Sequence
	 */
	public static class Type3 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Type3(MidambleConfigurationBurstType1and3 midambleConfigurationBurstType1and3, 
			    MidambleAllocationMode midambleAllocationMode)
	    {
		setMidambleConfigurationBurstType1and3(midambleConfigurationBurstType1and3);
		setMidambleAllocationMode(midambleAllocationMode);
		...
		public static class UeSpecificMidamble extends Sequence {
			...
			new QName (
			    "rrc.informationelements",
			    "MidambleShiftAndBurstType_VHCR$BurstType$Type3$MidambleAllocationMode$UeSpecificMidamble"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MidambleShiftAndBurstType_VHCR$BurstType$Type3$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MidambleShiftAndBurstType_VHCR$BurstType$Type3"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	    ...
	    /**
	     * Get the type descriptor (TypeInfo) of 'this' Type3 object.
	     */
	    public TypeInfo getTypeInfo()
	    {
		return c_typeinfo;
	    ...
	    /**
	     * Get the static type descriptor (TypeInfo) of 'this' Type3 object.
	     */
	    public static TypeInfo getStaticTypeInfo()
	    {
		return c_typeinfo;
	...
	} // End class definition for Type3

	// Methods for field "mbsfnBurstType4"
	public static BurstType createBurstTypeWithMbsfnBurstType4(Null mbsfnBurstType4)
	{
	    BurstType __object = new BurstType();

	    __object.setMbsfnBurstType4(mbsfnBurstType4);
	    return __object;
	}
	
	public boolean hasMbsfnBurstType4()
	{
	    return getChosenFlag() == mbsfnBurstType4_chosen;
	}
	
	public void setMbsfnBurstType4(Null mbsfnBurstType4)
	{
	    setChosenValue(mbsfnBurstType4);
	    setChosenFlag(mbsfnBurstType4_chosen);
	}
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"MidambleShiftAndBurstType_VHCR$BurstType"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MidambleShiftAndBurstType_VHCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MidambleShiftAndBurstType_VHCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MidambleShiftAndBurstType_VHCR
