...
/**
 * Define the ASN1 Type CellSelectReselectInfoSIB_11_12_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellSelectReselectInfoSIB_11_12_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellSelectReselectInfoSIB_11_12_RSCP()
    {
    }
     ...
     */
    public CellSelectReselectInfoSIB_11_12_RSCP(Q_OffsetS_N q_OffsetS_N, 
     ...
     */
    public CellSelectReselectInfoSIB_11_12_RSCP(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellSelectReselectInfoSIB_11_12_RSCP$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellSelectReselectInfoSIB_11_12_RSCP$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Gsm extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellSelectReselectInfoSIB_11_12_RSCP$ModeSpecificInfo$Gsm"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CellSelectReselectInfoSIB_11_12_RSCP$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	new QName (
	    "rrc.informationelements",
	    "CellSelectReselectInfoSIB_11_12_RSCP"
	),
	new QName (
	    "InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellSelectReselectInfoSIB_11_12_RSCP object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellSelectReselectInfoSIB_11_12_RSCP object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellSelectReselectInfoSIB_11_12_RSCP
