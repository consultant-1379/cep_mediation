...
/**
 * Define the ASN1 Type NewInterFreqCellSI_ECN0_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterFreqCellSI_ECN0_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterFreqCellSI_ECN0_LCR_r4()
    {
    }
     ...
     */
    public NewInterFreqCellSI_ECN0_LCR_r4(InterFreqCellID interFreqCellID, 
     ...
     */
    public NewInterFreqCellSI_ECN0_LCR_r4(CellInfoSI_ECN0_LCR_r4 cellInfo)
    {
	setCellInfo(cellInfo);
    }
	...
	mComponents[2] = new CellInfoSI_ECN0_LCR_r4();
    }
    ...
    {
	return (CellInfoSI_ECN0_LCR_r4)mComponents[2];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_ECN0_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_ECN0_LCR_r4 object.
     */
...
} // End class definition for NewInterFreqCellSI_ECN0_LCR_r4
