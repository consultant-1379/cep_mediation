...
/**
 * Define the ASN1 Type RL_AdditionInformation_SecULFreq from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RL_AdditionInformation_SecULFreq extends Sequence {
    
    /**
     * The default constructor.
     */
    public RL_AdditionInformation_SecULFreq()
    {
    }
     ...
     */
    public RL_AdditionInformation_SecULFreq(PrimaryCPICH_Info primaryCPICH_Info, 
		    CellIdentity cell_id, 
		    DL_FDPCH_InfoPerRL_r7 dl_FDPCH_InfoPerRL, 
		    E_HICH_Information e_HICH_Information, 
		    E_RGCH_Information e_RGCH_Information)
    {
	setPrimaryCPICH_Info(primaryCPICH_Info);
	setCell_id(cell_id);
	setDl_FDPCH_InfoPerRL(dl_FDPCH_InfoPerRL);
    ...
    public DL_FDPCH_InfoPerRL_r7 getDl_FDPCH_InfoPerRL()
    {
    ...
    {
	mComponents[2] = dl_FDPCH_InfoPerRL;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RL_AdditionInformation_SecULFreq object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RL_AdditionInformation_SecULFreq object.
     */
...
} // End class definition for RL_AdditionInformation_SecULFreq
