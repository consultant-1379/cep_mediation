...
/**
 * Define the ASN1 Type DL_RLC_Mode_r5 from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_RLC_Mode_r5 extends Choice {
    
    /**
     * The default constructor.
     */
    public DL_RLC_Mode_r5()
    {
    }
    ...
    public static DL_RLC_Mode_r5 createDL_RLC_Mode_r5WithDl_AM_RLC_Mode(DL_AM_RLC_Mode_r5 dl_AM_RLC_Mode)
    {
	DL_RLC_Mode_r5 __object = new DL_RLC_Mode_r5();
    ...
    public void setDl_AM_RLC_Mode(DL_AM_RLC_Mode_r5 dl_AM_RLC_Mode)
    {
    ...
    public static DL_RLC_Mode_r5 createDL_RLC_Mode_r5WithDl_UM_RLC_Mode(DL_UM_RLC_Mode_r5 dl_UM_RLC_Mode)
    {
	DL_RLC_Mode_r5 __object = new DL_RLC_Mode_r5();
    ...
    public void setDl_UM_RLC_Mode(DL_UM_RLC_Mode_r5 dl_UM_RLC_Mode)
    {
    ...
    public static DL_RLC_Mode_r5 createDL_RLC_Mode_r5WithDl_TM_RLC_Mode(DL_TM_RLC_Mode dl_TM_RLC_Mode)
    {
	DL_RLC_Mode_r5 __object = new DL_RLC_Mode_r5();
	...
	switch (chosen) {
		...
		return new DL_AM_RLC_Mode_r5();
	    case dl_UM_RLC_Mode_chosen:
		return new DL_UM_RLC_Mode_r5();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_RLC_Mode_r5 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_RLC_Mode_r5 object.
     */
...
} // End class definition for DL_RLC_Mode_r5
