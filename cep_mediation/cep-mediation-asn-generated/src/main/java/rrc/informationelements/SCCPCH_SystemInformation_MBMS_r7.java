...
/**
 * Define the ASN1 Type SCCPCH_SystemInformation_MBMS_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class SCCPCH_SystemInformation_MBMS_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public SCCPCH_SystemInformation_MBMS_r7()
    {
    }
     ...
     */
    public SCCPCH_SystemInformation_MBMS_r7(SecondaryCCPCHInfo_MBMS_r7 secondaryCCPCHInfo_MBMS, 
    ...
    {
	mComponents[0] = new SecondaryCCPCHInfo_MBMS_r7();
	...
	switch (index) {
	    case 0:
		return new SecondaryCCPCHInfo_MBMS_r7();
	    case 1:
		return new TFCS();
	    case 2:
    ...
    public SecondaryCCPCHInfo_MBMS_r7 getSecondaryCCPCHInfo_MBMS()
    {
	return (SecondaryCCPCHInfo_MBMS_r7)mComponents[0];
    }
    
    public void setSecondaryCCPCHInfo_MBMS(SecondaryCCPCHInfo_MBMS_r7 secondaryCCPCHInfo_MBMS)
    {
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
		...
		"SCCPCH_SystemInformation_MBMS_r7$FachCarryingMCCH"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"SCCPCH_SystemInformation_MBMS_r7$FachCarryingMSCH"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SCCPCH_SystemInformation_MBMS_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SCCPCH_SystemInformation_MBMS_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SCCPCH_SystemInformation_MBMS_r7
