...
/**
 * Define the ASN1 Type MAC_ehs_AddReconfReordQ_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MAC_ehs_AddReconfReordQ_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public MAC_ehs_AddReconfReordQ_r9()
    {
    }
     ...
     */
    public MAC_ehs_AddReconfReordQ_r9(MAC_ehs_QueueId mac_ehs_QueueId, 
		    T1_ReleaseTimer reorderingReleaseTimer, 
		    Treset_ResetTimer reorderingResetTimer, 
		    MAC_hs_WindowSize_r9 mac_ehsWindowSize)
    {
	...
	mComponents[3] = MAC_hs_WindowSize_r9.mws4;
    }
    ...
    {
	return (MAC_hs_WindowSize_r9)mComponents[3];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MAC_ehs_AddReconfReordQ_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MAC_ehs_AddReconfReordQ_r9 object.
     */
...
} // End class definition for MAC_ehs_AddReconfReordQ_r9
