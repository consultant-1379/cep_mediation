...
/**
 * Define the ASN1 Type IntraFreqReportCriteria_r9 from ASN1 Module InformationElements.
 * @see Choice
 */

public class IntraFreqReportCriteria_r9 extends Choice {
    
    /**
     * The default constructor.
     */
    public IntraFreqReportCriteria_r9()
    {
    }
    ...
    public static IntraFreqReportCriteria_r9 createIntraFreqReportCriteria_r9WithIntraFreqReportingCriteria(IntraFreqReportingCriteria_r9 intraFreqReportingCriteria)
    {
	IntraFreqReportCriteria_r9 __object = new IntraFreqReportCriteria_r9();
    ...
    public static IntraFreqReportCriteria_r9 createIntraFreqReportCriteria_r9WithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	IntraFreqReportCriteria_r9 __object = new IntraFreqReportCriteria_r9();
    ...
    public static IntraFreqReportCriteria_r9 createIntraFreqReportCriteria_r9WithNoReporting(ReportingCellStatusOpt noReporting)
    {
	IntraFreqReportCriteria_r9 __object = new IntraFreqReportCriteria_r9();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqReportCriteria_r9 object.
     */
...
} // End class definition for IntraFreqReportCriteria_r9
