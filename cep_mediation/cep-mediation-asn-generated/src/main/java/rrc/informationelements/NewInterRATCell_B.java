...
/**
 * Define the ASN1 Type NewInterRATCell_B from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterRATCell_B extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterRATCell_B()
    {
    }
     ...
     */
    public NewInterRATCell_B(InterRATCellID interRATCellID, 
     ...
     */
    public NewInterRATCell_B(TechnologySpecificInfo technologySpecificInfo)
    {
	setTechnologySpecificInfo(technologySpecificInfo);
    }
	...
	public static class Gsm extends Sequence {
		...
		new QName (
		    ...
		    "NewInterRATCell_B$TechnologySpecificInfo$Gsm"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Is_2000 extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "NewInterRATCell_B$TechnologySpecificInfo$Is_2000"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"NewInterRATCell_B$TechnologySpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterRATCell_B object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterRATCell_B object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for NewInterRATCell_B
