...
/**
 * Define the ASN1 Type MeasurementControlSysInfoExtension from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MeasurementControlSysInfoExtension extends Sequence {
    
    /**
     * The default constructor.
     */
    public MeasurementControlSysInfoExtension()
    {
    }
     ...
     */
    public MeasurementControlSysInfoExtension(Use_of_HCS use_of_HCS)
    {
	...
	public static class Hcs_not_used extends Sequence {
		...
		public static class Cpich_RSCP extends Sequence {
		     ...
		     * Construct with AbstractData components.
		     */
		    public Cpich_RSCP(NewIntraFreqCellSI_List_RSCP newIntraFreqCellList, 
				    NewInterFreqCellSI_List_RSCP newInterFreqCellList)
		    {
		    ...
		    public void initComponents()
		    {
			mComponents[0] = new NewIntraFreqCellSI_List_RSCP();
			mComponents[1] = new NewInterFreqCellSI_List_RSCP();
		    }
			...
			switch (index) {
			    ...
			    case 1:
				return new NewInterFreqCellSI_List_RSCP();
			    default:
				throw new InternalError("AbstractCollection.createInstance()");
			}
		    ...
		    {
			return (NewIntraFreqCellSI_List_RSCP)mComponents[0];
		    }
		    ...
		    public NewInterFreqCellSI_List_RSCP getNewInterFreqCellList()
		    {
			return (NewInterFreqCellSI_List_RSCP)mComponents[1];
		    }
		    
		    public void setNewInterFreqCellList(NewInterFreqCellSI_List_RSCP newInterFreqCellList)
		    {
			...
			new QName (
			    ...
			    "MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_not_used$CellSelectQualityMeasure$Cpich_RSCP"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class Cpich_Ec_N0 extends Sequence {
		     ...
		     * Construct with AbstractData components.
		     */
		    public Cpich_Ec_N0(NewIntraFreqCellSI_List_ECN0 newIntraFreqCellList, 
				    NewInterFreqCellSI_List_ECN0 newInterFreqCellList)
		    {
			setNewIntraFreqCellList(newIntraFreqCellList);
			setNewInterFreqCellList(newInterFreqCellList);
		    }
		    ...
		    public void initComponents()
		    {
			mComponents[0] = new NewIntraFreqCellSI_List_ECN0();
			mComponents[1] = new NewInterFreqCellSI_List_ECN0();
		    }
			...
			switch (index) {
			    case 0:
				return new NewIntraFreqCellSI_List_ECN0();
			    case 1:
				return new NewInterFreqCellSI_List_ECN0();
			    default:
				throw new InternalError("AbstractCollection.createInstance()");
			}
		    ...
		    // Methods for field "newIntraFreqCellList"
		    public NewIntraFreqCellSI_List_ECN0 getNewIntraFreqCellList()
		    {
			return (NewIntraFreqCellSI_List_ECN0)mComponents[0];
		    }
		    
		    public void setNewIntraFreqCellList(NewIntraFreqCellSI_List_ECN0 newIntraFreqCellList)
		    {
			mComponents[0] = newIntraFreqCellList;
		    }
		    ...
		    // Methods for field "newInterFreqCellList"
		    public NewInterFreqCellSI_List_ECN0 getNewInterFreqCellList()
		    {
			return (NewInterFreqCellSI_List_ECN0)mComponents[1];
		    }
		    
		    public void setNewInterFreqCellList(NewInterFreqCellSI_List_ECN0 newInterFreqCellList)
		    {
			mComponents[1] = newInterFreqCellList;
		    }
			...
			new QName (
			    "rrc.informationelements",
			    "MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_not_used$CellSelectQualityMeasure$Cpich_Ec_N0"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_not_used$CellSelectQualityMeasure"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_not_used"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Hcs_used extends Sequence {
		...
		public static class Cpich_RSCP extends Sequence {
		     ...
		     * Construct with AbstractData components.
		     */
		    public Cpich_RSCP(NewIntraFreqCellSI_List_HCS_RSCP newIntraFreqCellList, 
		    ...
		    public void initComponents()
		    {
			mComponents[0] = new NewIntraFreqCellSI_List_HCS_RSCP();
			...
			switch (index) {
			    case 0:
				return new NewIntraFreqCellSI_List_HCS_RSCP();
			    case 1:
		    ...
		    // Methods for field "newIntraFreqCellList"
		    public NewIntraFreqCellSI_List_HCS_RSCP getNewIntraFreqCellList()
		    {
			return (NewIntraFreqCellSI_List_HCS_RSCP)mComponents[0];
		    }
		    
		    public void setNewIntraFreqCellList(NewIntraFreqCellSI_List_HCS_RSCP newIntraFreqCellList)
		    {
			mComponents[0] = newIntraFreqCellList;
		    }
			...
			new QName (
			    "rrc.informationelements",
			    "MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_used$CellSelectQualityMeasure$Cpich_RSCP"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class Cpich_Ec_N0 extends Sequence {
		     ...
		     * Construct with AbstractData components.
		     */
		    public Cpich_Ec_N0(NewIntraFreqCellSI_List_HCS_ECN0 newIntraFreqCellList, 
				    NewInterFreqCellSI_List_HCS_ECN0 newInterFreqCellList)
		    {
			setNewIntraFreqCellList(newIntraFreqCellList);
			setNewInterFreqCellList(newInterFreqCellList);
		    }
		    ...
		    public void initComponents()
		    {
			mComponents[0] = new NewIntraFreqCellSI_List_HCS_ECN0();
			mComponents[1] = new NewInterFreqCellSI_List_HCS_ECN0();
		    }
			...
			switch (index) {
			    case 0:
				return new NewIntraFreqCellSI_List_HCS_ECN0();
			    case 1:
				return new NewInterFreqCellSI_List_HCS_ECN0();
			    default:
				throw new InternalError("AbstractCollection.createInstance()");
			}
		    ...
		    // Methods for field "newIntraFreqCellList"
		    public NewIntraFreqCellSI_List_HCS_ECN0 getNewIntraFreqCellList()
		    {
			return (NewIntraFreqCellSI_List_HCS_ECN0)mComponents[0];
		    }
		    
		    public void setNewIntraFreqCellList(NewIntraFreqCellSI_List_HCS_ECN0 newIntraFreqCellList)
		    {
			mComponents[0] = newIntraFreqCellList;
		    }
		    ...
		    // Methods for field "newInterFreqCellList"
		    public NewInterFreqCellSI_List_HCS_ECN0 getNewInterFreqCellList()
		    {
			return (NewInterFreqCellSI_List_HCS_ECN0)mComponents[1];
		    }
		    
		    public void setNewInterFreqCellList(NewInterFreqCellSI_List_HCS_ECN0 newInterFreqCellList)
		    {
			mComponents[1] = newInterFreqCellList;
		    }
			...
			new QName (
			    "rrc.informationelements",
			    "MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_used$CellSelectQualityMeasure$Cpich_Ec_N0"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
			...
			new Fields (
				...
				new SequenceFieldInfo (
					...
					new ContainerInfo (
					    ...
					    new QName (
						"rrc.informationelements",
						"NewInterFreqCellSI_List_HCS_ECN0"
					    ),
					    new QName (
						"InformationElements",
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_used$CellSelectQualityMeasure"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MeasurementControlSysInfoExtension$Use_of_HCS$Hcs_used"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"MeasurementControlSysInfoExtension$Use_of_HCS"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementControlSysInfoExtension object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementControlSysInfoExtension object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MeasurementControlSysInfoExtension
