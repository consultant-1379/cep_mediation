...
/**
 * Define the ASN1 Type PUSCH_SysInfo_VHCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PUSCH_SysInfo_VHCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public PUSCH_SysInfo_VHCR()
    {
    }
     ...
     */
    public PUSCH_SysInfo_VHCR(PUSCH_Identity pusch_Identity, 
		    PUSCH_Info_VHCR pusch_Info_VHCR, 
		    USCH_TransportChannelsInfo usch_TransportChannelsInfo, 
		    TFCS usch_TFCS)
    {
	setPusch_Identity(pusch_Identity);
	setPusch_Info_VHCR(pusch_Info_VHCR);
	...
	mComponents[1] = new PUSCH_Info_VHCR();
    ...
    // Methods for field "pusch_Info_VHCR"
    public PUSCH_Info_VHCR getPusch_Info_VHCR()
    {
	return (PUSCH_Info_VHCR)mComponents[1];
    }
    
    public void setPusch_Info_VHCR(PUSCH_Info_VHCR pusch_Info_VHCR)
    {
	mComponents[1] = pusch_Info_VHCR;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_SysInfo_VHCR object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_SysInfo_VHCR object.
     */
...
} // End class definition for PUSCH_SysInfo_VHCR
