...
/**
 * Define the ASN1 Type PUSCH_Info_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PUSCH_Info_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PUSCH_Info_LCR_r4()
    {
    }
     ...
     */
    public PUSCH_Info_LCR_r4(TFCS_IdentityPlain tfcs_ID, 
		    CommonTimeslotInfo commonTimeslotInfo, 
		    UplinkTimeslotsCodes_LCR_r4 pusch_TimeslotsCodes)
    {
	setTfcs_ID(tfcs_ID);
    ...
    {
	mComponents[2] = pusch_TimeslotsCodes;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_Info_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_Info_LCR_r4 object.
     */
...
} // End class definition for PUSCH_Info_LCR_r4
