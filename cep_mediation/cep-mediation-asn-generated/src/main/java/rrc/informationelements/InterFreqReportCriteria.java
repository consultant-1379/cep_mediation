...
/**
 * Define the ASN1 Type InterFreqReportCriteria from ASN1 Module InformationElements.
 * @see Choice
 */

public class InterFreqReportCriteria extends Choice {
    
    /**
     * The default constructor.
     */
    public InterFreqReportCriteria()
    {
    }
    ...
    public static InterFreqReportCriteria createInterFreqReportCriteriaWithIntraFreqReportingCriteria(IntraFreqReportingCriteria intraFreqReportingCriteria)
    {
	InterFreqReportCriteria __object = new InterFreqReportCriteria();
    ...
    public static InterFreqReportCriteria createInterFreqReportCriteriaWithInterFreqReportingCriteria(InterFreqReportingCriteria interFreqReportingCriteria)
    {
	InterFreqReportCriteria __object = new InterFreqReportCriteria();
    ...
    public static InterFreqReportCriteria createInterFreqReportCriteriaWithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	InterFreqReportCriteria __object = new InterFreqReportCriteria();
    ...
    public static InterFreqReportCriteria createInterFreqReportCriteriaWithNoReporting(ReportingCellStatusOpt noReporting)
    {
	InterFreqReportCriteria __object = new InterFreqReportCriteria();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFreqReportCriteria object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFreqReportCriteria object.
     */
...
} // End class definition for InterFreqReportCriteria
