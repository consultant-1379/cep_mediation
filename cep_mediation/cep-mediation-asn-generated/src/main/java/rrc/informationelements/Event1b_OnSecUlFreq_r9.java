...
/**
 * Define the ASN1 Type Event1b_OnSecUlFreq_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event1b_OnSecUlFreq_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public Event1b_OnSecUlFreq_r9()
    {
    }
     ...
     */
    public Event1b_OnSecUlFreq_r9(TriggeringCondition1 triggeringCondition, 
		    ReportingRange reportingRange, 
		    ForbiddenAffectCellListOnSecULFreq forbiddenAffectCellListOnSecULFreq, 
		    W w, PeriodicReportingInfo_1b periodicReportingInfo_1b)
    {
	...
	mComponents[3] = new W();
	mComponents[4] = new PeriodicReportingInfo_1b();
    }
    ...
    {
	return (PeriodicReportingInfo_1b)mComponents[4];
    }
    
    public void setPeriodicReportingInfo_1b(PeriodicReportingInfo_1b periodicReportingInfo_1b)
    {
	mComponents[4] = periodicReportingInfo_1b;
    }
    
    public boolean hasPeriodicReportingInfo_1b()
    {
	return componentIsPresent(4);
    }
    
    public void deletePeriodicReportingInfo_1b()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event1b_OnSecUlFreq_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event1b_OnSecUlFreq_r9 object.
     */
...
} // End class definition for Event1b_OnSecUlFreq_r9
