...
/**
 * Define the ASN1 Type CommonTimeslotInfoSCCPCH from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CommonTimeslotInfoSCCPCH extends Sequence {
    
    /**
     * The default constructor.
     */
    public CommonTimeslotInfoSCCPCH()
    {
    }
     ...
     */
    public CommonTimeslotInfoSCCPCH(SecondInterleavingMode secondInterleavingMode, 
		    TFCI_Coding tfci_Coding, PuncturingLimit puncturingLimit, 
		    RepetitionPeriodLengthAndOffset repetitionPeriodLengthAndOffset)
    {
	setSecondInterleavingMode(secondInterleavingMode);
	setTfci_Coding(tfci_Coding);
	setPuncturingLimit(puncturingLimit);
	setRepetitionPeriodLengthAndOffset(repetitionPeriodLengthAndOffset);
    }
	...
	mComponents[3] = new RepetitionPeriodLengthAndOffset();
    }
	...
	switch (index) {
	    ...
	    case 3:
		return new RepetitionPeriodLengthAndOffset();
	    default:
    ...
    // Methods for field "repetitionPeriodLengthAndOffset"
    public RepetitionPeriodLengthAndOffset getRepetitionPeriodLengthAndOffset()
    {
	return (RepetitionPeriodLengthAndOffset)mComponents[3];
    }
    
    public void setRepetitionPeriodLengthAndOffset(RepetitionPeriodLengthAndOffset repetitionPeriodLengthAndOffset)
    {
	mComponents[3] = repetitionPeriodLengthAndOffset;
    }
    
    public boolean hasRepetitionPeriodLengthAndOffset()
    {
	return componentIsPresent(3);
    }
    
    public void deleteRepetitionPeriodLengthAndOffset()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CommonTimeslotInfoSCCPCH object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CommonTimeslotInfoSCCPCH object.
     */
...
} // End class definition for CommonTimeslotInfoSCCPCH
