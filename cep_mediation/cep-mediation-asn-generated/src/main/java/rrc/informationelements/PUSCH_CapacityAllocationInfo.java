...
/**
 * Define the ASN1 Type PUSCH_CapacityAllocationInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PUSCH_CapacityAllocationInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public PUSCH_CapacityAllocationInfo()
    {
    }
     ...
     */
    public PUSCH_CapacityAllocationInfo(Pusch_Allocation pusch_Allocation)
    {
	...
	public static class Pusch_AllocationAssignment extends Sequence {
	    ...
	    public Pusch_AllocationAssignment(AllocationPeriodInfo pusch_AllocationPeriodInfo, 
			    UL_TargetSIR pusch_PowerControlInfo, 
	    ...
	    public UL_TargetSIR getPusch_PowerControlInfo()
	    {
		return (UL_TargetSIR)mComponents[1];
	    }
	    
	    public void setPusch_PowerControlInfo(UL_TargetSIR pusch_PowerControlInfo)
	    {
		...
		public static class Old_Configuration extends Sequence {
			...
			new QName (
			    ...
			    "PUSCH_CapacityAllocationInfo$Pusch_Allocation$Pusch_AllocationAssignment$Configuration$Old_Configuration"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class New_Configuration extends Sequence {
		     ...
		     * Construct with AbstractData components.
		     */
		    public New_Configuration(PUSCH_Info pusch_Info, 
				    PUSCH_Identity pusch_Identity)
		    {
		    ...
		    {
			return (PUSCH_Info)mComponents[0];
		    }
			...
			new QName (
			    "rrc.informationelements",
			    "PUSCH_CapacityAllocationInfo$Pusch_Allocation$Pusch_AllocationAssignment$Configuration$New_Configuration"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"PUSCH_CapacityAllocationInfo$Pusch_Allocation$Pusch_AllocationAssignment$Configuration"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "PUSCH_CapacityAllocationInfo$Pusch_Allocation$Pusch_AllocationAssignment"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"PUSCH_CapacityAllocationInfo$Pusch_Allocation"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_CapacityAllocationInfo object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_CapacityAllocationInfo object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PUSCH_CapacityAllocationInfo
