...
/**
 * Define the ASN1 Type DownlinkTimeslotsCodes from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DownlinkTimeslotsCodes extends Sequence {
    
    /**
     * The default constructor.
     */
    public DownlinkTimeslotsCodes()
    {
    }
     ...
     */
    public DownlinkTimeslotsCodes(IndividualTimeslotInfo firstIndividualTimeslotInfo, 
	...
	public static class AdditionalTimeslots extends Choice {
		 ...
		 */
		public TimeslotList(DownlinkAdditionalTimeslots[] elements)
		{
		    super(elements);
		}
		 ...
		 */
		public synchronized void add(DownlinkAdditionalTimeslots element)
		{
		 ...
		 */
		public synchronized void set(DownlinkAdditionalTimeslots element, int atIndex)
		{
		 ...
		 */
		public synchronized DownlinkAdditionalTimeslots get(int atIndex)
		{
		    return (DownlinkAdditionalTimeslots)super.getElement(atIndex);
		}
		
		/**
		 * Insert an Element into the SEQUENCE OF/SET OF.
		 */
		public synchronized void insert(DownlinkAdditionalTimeslots element, int atIndex)
		{
		 ...
		 */
		public synchronized void remove(DownlinkAdditionalTimeslots element)
		{
		...
		{
		    return (AbstractData)new DownlinkAdditionalTimeslots();
		}
		...
		private static final ContainerInfo c_typeinfo = new ContainerInfo (
			...
			"DownlinkTimeslotsCodes$MoreTimeslots$AdditionalTimeslots$TimeslotList"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE OF"
		...
		new QName (
		    "rrc.informationelements",
		    "DownlinkTimeslotsCodes$MoreTimeslots$AdditionalTimeslots"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DownlinkTimeslotsCodes$MoreTimeslots"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DownlinkTimeslotsCodes object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DownlinkTimeslotsCodes object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DownlinkTimeslotsCodes
