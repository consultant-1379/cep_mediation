...
/**
 * Define the ASN1 Type InterRATMeasurement_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterRATMeasurement_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterRATMeasurement_r9()
    {
    }
     ...
     */
    public InterRATMeasurement_r9(InterRATMeasurementObjects interRATMeasurementObjects, 
     ...
     */
    public InterRATMeasurement_r9(InterRATReportCriteria reportCriteria)
    {
	setReportCriteria(reportCriteria);
    }
	...
	public static InterRATMeasurementObjects createInterRATMeasurementObjectsWithEutra_FrequencyList(EUTRA_FrequencyList_r9 eutra_FrequencyList)
	{
	    InterRATMeasurementObjects __object = new InterRATMeasurementObjects();
	...
	public void setEutra_FrequencyList(EUTRA_FrequencyList_r9 eutra_FrequencyList)
	{
	...
	public AbstractData createInstance(int chosen)
	{
		...
		case eutra_FrequencyList_chosen:
		    return new EUTRA_FrequencyList_r9();
		default:
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"InterRATMeasurement_r9$InterRATMeasurementObjects"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterRATMeasurement_r9 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterRATMeasurement_r9 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for InterRATMeasurement_r9
