...
/**
 * Define the ASN1 Type IntraFrequencyMeasurement_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFrequencyMeasurement_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFrequencyMeasurement_r4()
    {
    }
     ...
     */
    public IntraFrequencyMeasurement_r4(IntraFreqCellInfoList_r4 intraFreqCellInfoList, 
	...
	mComponents[4] = new IntraFreqReportCriteria_r4();
    }
	...
	switch (index) {
	    ...
	    case 4:
		return new IntraFreqReportCriteria_r4();
	    default:
    ...
    public IntraFreqReportCriteria_r4 getReportCriteria()
    {
	return (IntraFreqReportCriteria_r4)mComponents[4];
    }
    
    public void setReportCriteria(IntraFreqReportCriteria_r4 reportCriteria)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r4 object.
     */
...
} // End class definition for IntraFrequencyMeasurement_r4
