...
/**
 * Define the ASN1 Type UE_Positioning_Error from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_Error extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_Error()
    {
    }
     ...
     */
    public UE_Positioning_Error(UE_Positioning_ErrorCause errorReason, 
    ...
    {
	mComponents[0] = UE_Positioning_ErrorCause.notEnoughOTDOA_Cells;
	...
	switch (index) {
	    case 0:
		return UE_Positioning_ErrorCause.notEnoughOTDOA_Cells;
	    case 1:
    ...
    {
	return (UE_Positioning_ErrorCause)mComponents[0];
    }
    
    public void setErrorReason(UE_Positioning_ErrorCause errorReason)
    {
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new EnumeratedInfo (
			    ...
			    0,
			    UE_Positioning_ErrorCause.notEnoughOTDOA_Cells
			)
		    ),
		    "errorReason",
		    0,
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_Error object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_Error object.
     */
...
} // End class definition for UE_Positioning_Error
