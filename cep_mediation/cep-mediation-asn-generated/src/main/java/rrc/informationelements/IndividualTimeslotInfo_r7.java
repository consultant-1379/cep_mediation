...
/**
 * Define the ASN1 Type IndividualTimeslotInfo_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IndividualTimeslotInfo_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IndividualTimeslotInfo_r7()
    {
    }
     ...
     */
    public IndividualTimeslotInfo_r7(TimeslotNumber timeslotNumber, 
		    BOOLEAN tfci_Existence, 
		    MidambleShiftAndBurstType_r7 midambleShiftAndBurstType)
    {
	...
	mComponents[2] = new MidambleShiftAndBurstType_r7();
    }
    ...
    {
	return (MidambleShiftAndBurstType_r7)mComponents[2];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IndividualTimeslotInfo_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IndividualTimeslotInfo_r7 object.
     */
...
} // End class definition for IndividualTimeslotInfo_r7
