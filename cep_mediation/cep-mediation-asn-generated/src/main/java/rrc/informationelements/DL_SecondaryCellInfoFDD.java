...
/**
 * Define the ASN1 Type DL_SecondaryCellInfoFDD from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_SecondaryCellInfoFDD extends Choice {
    
    /**
     * The default constructor.
     */
    public DL_SecondaryCellInfoFDD()
    {
    }
    ...
    public static DL_SecondaryCellInfoFDD createDL_SecondaryCellInfoFDDWith_continue(Null _continue)
    {
	DL_SecondaryCellInfoFDD __object = new DL_SecondaryCellInfoFDD();
    ...
    public static DL_SecondaryCellInfoFDD createDL_SecondaryCellInfoFDDWithNewConfiguration(NewConfiguration newConfiguration)
    {
	DL_SecondaryCellInfoFDD __object = new DL_SecondaryCellInfoFDD();
	...
	public static final class Dl_64QAM_Configured extends Enumerated {
		...
		new QName (
		    ...
		    "DL_SecondaryCellInfoFDD$NewConfiguration$Dl_64QAM_Configured"
		),
		new QName (
		    "builtin",
		    "ENUMERATED"
	...
	public static class HS_SCCHChannelisationCodeInfo extends SequenceOf {
		...
		new QName (
		    "rrc.informationelements",
		    "DL_SecondaryCellInfoFDD$NewConfiguration$HS_SCCHChannelisationCodeInfo"
		),
		new QName (
		    "builtin",
		    "SEQUENCE OF"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_SecondaryCellInfoFDD$NewConfiguration"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_SecondaryCellInfoFDD object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_SecondaryCellInfoFDD object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_SecondaryCellInfoFDD
