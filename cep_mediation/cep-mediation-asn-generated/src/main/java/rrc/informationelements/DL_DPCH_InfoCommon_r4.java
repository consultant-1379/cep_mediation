...
/**
 * Define the ASN1 Type DL_DPCH_InfoCommon_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_DPCH_InfoCommon_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_DPCH_InfoCommon_r4()
    {
    }
     ...
     */
    public DL_DPCH_InfoCommon_r4(CfnHandling cfnHandling, 
		    ModeSpecificInfo modeSpecificInfo, 
		    MAC_d_HFN_initial_value mac_d_HFN_initial_value)
    {
	setCfnHandling(cfnHandling);
	setModeSpecificInfo(modeSpecificInfo);
	setMac_d_HFN_initial_value(mac_d_HFN_initial_value);
    }
	...
	mComponents[2] = new MAC_d_HFN_initial_value();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new MAC_d_HFN_initial_value();
	    default:
	...
	public static class Initialise extends Sequence {
		...
		new QName (
		    ...
		    "DL_DPCH_InfoCommon_r4$CfnHandling$Initialise"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_DPCH_InfoCommon_r4$CfnHandling"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "DL_DPCH_InfoCommon_r4$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "DL_DPCH_InfoCommon_r4$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_DPCH_InfoCommon_r4$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    // Methods for field "mac_d_HFN_initial_value"
    public MAC_d_HFN_initial_value getMac_d_HFN_initial_value()
    {
	return (MAC_d_HFN_initial_value)mComponents[2];
    }
    
    public void setMac_d_HFN_initial_value(MAC_d_HFN_initial_value mac_d_HFN_initial_value)
    {
	mComponents[2] = mac_d_HFN_initial_value;
    }
    
    public boolean hasMac_d_HFN_initial_value()
    {
	return componentIsPresent(2);
    }
    
    public void deleteMac_d_HFN_initial_value()
    {
	setComponentAbsent(2);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_DPCH_InfoCommon_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_DPCH_InfoCommon_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_DPCH_InfoCommon_r4
