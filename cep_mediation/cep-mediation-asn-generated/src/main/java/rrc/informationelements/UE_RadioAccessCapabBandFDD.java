...
/**
 * Define the ASN1 Type UE_RadioAccessCapabBandFDD from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_RadioAccessCapabBandFDD extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_RadioAccessCapabBandFDD()
    {
    }
     ...
     */
    public UE_RadioAccessCapabBandFDD(RadioFrequencyBandFDD radioFrequencyBandFDD, 
		    FddRF_Capability fddRF_Capability, 
		    MeasurementCapabilityExt measurementCapability)
    {
	...
	mComponents[2] = new MeasurementCapabilityExt();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new MeasurementCapabilityExt();
	    default:
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
		...
		"UE_RadioAccessCapabBandFDD$FddRF_Capability"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    {
	return (MeasurementCapabilityExt)mComponents[2];
    }
    
    public void setMeasurementCapability(MeasurementCapabilityExt measurementCapability)
    {
	mComponents[2] = measurementCapability;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_RadioAccessCapabBandFDD object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_RadioAccessCapabBandFDD object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_RadioAccessCapabBandFDD
