...
/**
 * Define the ASN1 Type UE_Positioning_OTDOA_NeighbourCellInfo_UEB from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_OTDOA_NeighbourCellInfo_UEB extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_OTDOA_NeighbourCellInfo_UEB()
    {
    }
     ...
     */
    public UE_Positioning_OTDOA_NeighbourCellInfo_UEB(ModeSpecificInfo modeSpecificInfo, 
		    ...
		    INTEGER relativeNorth, INTEGER relativeEast, 
    ...
    public UE_Positioning_OTDOA_NeighbourCellInfo_UEB(ModeSpecificInfo modeSpecificInfo, 
		    ...
		    SFN_SFN_Drift sfn_SFN_Drift, 
		    OTDOA_SearchWindowSize searchWindowSize, 
		    long relativeNorth, long relativeEast, 
		    long relativeAltitude, FineSFN_SFN fineSFN_SFN, 
		    long roundTripTime)
    {
	this(modeSpecificInfo, frequencyInfo, 
	     ue_positioning_IPDL_Paremeters, sfn_SFN_RelTimeDifference, 
	     sfn_SFN_Drift, searchWindowSize, new INTEGER(relativeNorth), 
	     new INTEGER(relativeEast), new INTEGER(relativeAltitude), 
	     fineSFN_SFN, new INTEGER(roundTripTime));
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "UE_Positioning_OTDOA_NeighbourCellInfo_UEB$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_OTDOA_NeighbourCellInfo_UEB$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UE_Positioning_OTDOA_NeighbourCellInfo_UEB$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	mComponents[8] = relativeAltitude;
    }
    ...
    {
	return (FineSFN_SFN)mComponents[9];
    }
    
    public void setFineSFN_SFN(FineSFN_SFN fineSFN_SFN)
    {
	mComponents[9] = fineSFN_SFN;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_OTDOA_NeighbourCellInfo_UEB object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_OTDOA_NeighbourCellInfo_UEB object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_OTDOA_NeighbourCellInfo_UEB
