...
/**
 * Define the ASN1 Type Serving_HSDSCH_CellInformation_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Serving_HSDSCH_CellInformation_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public Serving_HSDSCH_CellInformation_r9()
    {
    }
     ...
     */
    public Serving_HSDSCH_CellInformation_r9(DeltaACK deltaACK, 
		    DeltaNACK deltaNACK, 
     ...
     */
    public Serving_HSDSCH_CellInformation_r9(HARQ_Preamble_Mode harq_Preamble_Mode)
    {
	setHarq_Preamble_Mode(harq_Preamble_Mode);
    }
	...
	mComponents[4] = new DL_HSPDSCH_Information_r9();
    ...
    {
	return (DL_HSPDSCH_Information_r9)mComponents[4];
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"Serving_HSDSCH_CellInformation_r9$Mac_hsResetIndicator"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Serving_HSDSCH_CellInformation_r9 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Serving_HSDSCH_CellInformation_r9 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for Serving_HSDSCH_CellInformation_r9
