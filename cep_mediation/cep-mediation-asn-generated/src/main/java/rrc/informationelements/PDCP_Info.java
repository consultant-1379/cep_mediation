...
/**
 * Define the ASN1 Type PDCP_Info from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDCP_Info extends Sequence {
     ...
     */
    public PDCP_Info(LosslessSRNS_RelocSupport losslessSRNS_RelocSupport, 
		    PDCP_PDU_Header pdcp_PDU_Header, 
		    HeaderCompressionInfoList headerCompressionInfoList)
    {
     ...
     */
    public PDCP_Info(PDCP_PDU_Header pdcp_PDU_Header)
    {
	setPdcp_PDU_Header(pdcp_PDU_Header);
    }
	...
	mComponents[2] = new HeaderCompressionInfoList();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new HeaderCompressionInfoList();
	    default:
    ...
    public HeaderCompressionInfoList getHeaderCompressionInfoList()
    {
	return (HeaderCompressionInfoList)mComponents[2];
    }
    
    public void setHeaderCompressionInfoList(HeaderCompressionInfoList headerCompressionInfoList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDCP_Info object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDCP_Info object.
     */
...
} // End class definition for PDCP_Info
