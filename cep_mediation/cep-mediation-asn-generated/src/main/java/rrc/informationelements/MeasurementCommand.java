...
/**
 * Define the ASN1 Type MeasurementCommand from ASN1 Module InformationElements.
 * @see Choice
 */

public class MeasurementCommand extends Choice {
    ...
    public static MeasurementCommand createMeasurementCommandWithSetup(MeasurementType setup)
    {
	MeasurementCommand __object = new MeasurementCommand();
    ...
    public void setSetup(MeasurementType setup)
    {
    ...
    public static MeasurementCommand createMeasurementCommandWithModify(Modify modify)
    {
	MeasurementCommand __object = new MeasurementCommand();
	 ...
	 */
	public Modify(MeasurementType measurementType)
	{
	...
	{
	    mComponents[0] = new MeasurementType();
	}
	...
	{
	    return (MeasurementType)mComponents[0];
	}
    ...
    public static MeasurementCommand createMeasurementCommandWithRelease(Null release)
    {
	MeasurementCommand __object = new MeasurementCommand();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementCommand object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementCommand object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MeasurementCommand
