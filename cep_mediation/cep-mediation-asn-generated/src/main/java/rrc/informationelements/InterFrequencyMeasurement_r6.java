...
/**
 * Define the ASN1 Type InterFrequencyMeasurement_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterFrequencyMeasurement_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterFrequencyMeasurement_r6()
    {
    }
     ...
     */
    public InterFrequencyMeasurement_r6(InterFreqCellInfoList_r4 interFreqCellInfoList, 
		    ...
		    InterFreqReportCriteria_r6 reportCriteria)
    {
	...
	mComponents[5] = new InterFreqReportCriteria_r6();
    }
	...
	switch (index) {
	    ...
	    case 5:
		return new InterFreqReportCriteria_r6();
	    default:
    ...
    public InterFreqReportCriteria_r6 getReportCriteria()
    {
	return (InterFreqReportCriteria_r6)mComponents[5];
    }
    
    public void setReportCriteria(InterFreqReportCriteria_r6 reportCriteria)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFrequencyMeasurement_r6 object.
     */
...
} // End class definition for InterFrequencyMeasurement_r6
