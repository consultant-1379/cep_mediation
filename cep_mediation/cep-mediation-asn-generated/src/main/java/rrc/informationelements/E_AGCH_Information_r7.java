...
/**
 * Define the ASN1 Type E_AGCH_Information_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class E_AGCH_Information_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public E_AGCH_Information_r7()
    {
    }
     ...
     */
    public E_AGCH_Information_r7(ModeSpecific modeSpecific)
    {
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "E_AGCH_Information_r7$ModeSpecific$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"E_AGCH_Information_r7$ModeSpecific$Tdd$Tdd384"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"E_AGCH_Information_r7$ModeSpecific$Tdd$Tdd768"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"E_AGCH_Information_r7$ModeSpecific$Tdd$Tdd128"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "E_AGCH_Information_r7$ModeSpecific$Tdd"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"E_AGCH_Information_r7$ModeSpecific"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' E_AGCH_Information_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' E_AGCH_Information_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for E_AGCH_Information_r7
