...
/**
 * Define the ASN1 Type MIMO_PilotConfiguration_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MIMO_PilotConfiguration_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public MIMO_PilotConfiguration_r9()
    {
    }
     ...
     */
    public MIMO_PilotConfiguration_r9(SecondCPICH_Pattern secondCPICH_Pattern)
    {
	...
	public static class DiversityPattern extends Sequence {
	    ...
	    public DiversityPattern(ChannelisationCode256 channelisationCode, 
			    S_CPICH_PowerOffset_MIMO s_cpich_PowerOffset_Mimo)
	    {
		...
		mComponents[1] = new S_CPICH_PowerOffset_MIMO();
	    }
		...
		new QName (
		    ...
		    "MIMO_PilotConfiguration_r9$SecondCPICH_Pattern$DiversityPattern"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"MIMO_PilotConfiguration_r9$SecondCPICH_Pattern"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MIMO_PilotConfiguration_r9 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MIMO_PilotConfiguration_r9 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MIMO_PilotConfiguration_r9
