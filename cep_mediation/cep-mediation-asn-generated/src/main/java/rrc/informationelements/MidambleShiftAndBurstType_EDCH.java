...
/**
 * Define the ASN1 Type MidambleShiftAndBurstType_EDCH from ASN1 Module InformationElements.
 * @see Sequence
 */

public class MidambleShiftAndBurstType_EDCH extends Sequence {
    
    /**
     * The default constructor.
     */
    public MidambleShiftAndBurstType_EDCH()
    {
    }
     ...
     */
    public MidambleShiftAndBurstType_EDCH(BurstType burstType)
    {
	...
	public static class Type1 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Type1(MidambleConfigurationBurstType1 midambleConfigurationBurstType1, 
	    ...
	    public void initComponents()
	    {
		mComponents[0] = MidambleConfigurationBurstType1.ms4;
		...
		switch (index) {
		    case 0:
			return MidambleConfigurationBurstType1.ms4;
		    case 1:
	    ...
	    // Methods for field "midambleConfigurationBurstType1"
	    public MidambleConfigurationBurstType1 getMidambleConfigurationBurstType1()
	    {
		return (MidambleConfigurationBurstType1)mComponents[0];
	    }
	    
	    public void setMidambleConfigurationBurstType1(MidambleConfigurationBurstType1 midambleConfigurationBurstType1)
	    {
		mComponents[0] = midambleConfigurationBurstType1;
	    }
		...
		public static class UeSpecificMidamble extends Sequence {
			...
			new QName (
			    ...
			    "MidambleShiftAndBurstType_EDCH$BurstType$Type1$MidambleAllocationMode$UeSpecificMidamble"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MidambleShiftAndBurstType_EDCH$BurstType$Type1$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MidambleShiftAndBurstType_EDCH$BurstType$Type1"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new Fields (
			...
			new SequenceFieldInfo (
				...
				new EnumeratedInfo (
				    ...
				    0,
				    MidambleConfigurationBurstType1.ms4
				)
			    ),
			    "midambleConfigurationBurstType1",
			    0,
	...
	public static class Type2 extends Sequence {
		...
		public static class UeSpecificMidamble extends Sequence {
			...
			new QName (
			    "rrc.informationelements",
			    "MidambleShiftAndBurstType_EDCH$BurstType$Type2$MidambleAllocationMode$UeSpecificMidamble"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"MidambleShiftAndBurstType_EDCH$BurstType$Type2$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "MidambleShiftAndBurstType_EDCH$BurstType$Type2"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"MidambleShiftAndBurstType_EDCH$BurstType"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MidambleShiftAndBurstType_EDCH object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MidambleShiftAndBurstType_EDCH object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MidambleShiftAndBurstType_EDCH
