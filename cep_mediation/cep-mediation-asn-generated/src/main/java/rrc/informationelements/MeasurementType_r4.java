...
/**
 * Define the ASN1 Type MeasurementType_r4 from ASN1 Module InformationElements.
 * @see Choice
 */

public class MeasurementType_r4 extends Choice {
    
    /**
     * The default constructor.
     */
    public MeasurementType_r4()
    {
    }
    ...
    public static MeasurementType_r4 createMeasurementType_r4WithIntraFrequencyMeasurement(IntraFrequencyMeasurement_r4 intraFrequencyMeasurement)
    {
	MeasurementType_r4 __object = new MeasurementType_r4();
    ...
    public void setIntraFrequencyMeasurement(IntraFrequencyMeasurement_r4 intraFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r4 createMeasurementType_r4WithInterFrequencyMeasurement(InterFrequencyMeasurement_r4 interFrequencyMeasurement)
    {
	MeasurementType_r4 __object = new MeasurementType_r4();
    ...
    public void setInterFrequencyMeasurement(InterFrequencyMeasurement_r4 interFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r4 createMeasurementType_r4WithInterRATMeasurement(InterRATMeasurement_r4 interRATMeasurement)
    {
	MeasurementType_r4 __object = new MeasurementType_r4();
    ...
    public void setInterRATMeasurement(InterRATMeasurement_r4 interRATMeasurement)
    {
    ...
    public static MeasurementType_r4 createMeasurementType_r4WithUp_Measurement(UE_Positioning_Measurement_r4 up_Measurement)
    {
	MeasurementType_r4 __object = new MeasurementType_r4();
    ...
    public static MeasurementType_r4 createMeasurementType_r4WithTrafficVolumeMeasurement(TrafficVolumeMeasurement trafficVolumeMeasurement)
    {
	MeasurementType_r4 __object = new MeasurementType_r4();
    ...
    public static MeasurementType_r4 createMeasurementType_r4WithQualityMeasurement(QualityMeasurement qualityMeasurement)
    {
	MeasurementType_r4 __object = new MeasurementType_r4();
    ...
    public static MeasurementType_r4 createMeasurementType_r4WithUe_InternalMeasurement(UE_InternalMeasurement_r4 ue_InternalMeasurement)
    {
	MeasurementType_r4 __object = new MeasurementType_r4();
	...
	switch (chosen) {
		...
		return new IntraFrequencyMeasurement_r4();
	    case interFrequencyMeasurement_chosen:
		return new InterFrequencyMeasurement_r4();
	    case interRATMeasurement_chosen:
		return new InterRATMeasurement_r4();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementType_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementType_r4 object.
     */
...
} // End class definition for MeasurementType_r4
