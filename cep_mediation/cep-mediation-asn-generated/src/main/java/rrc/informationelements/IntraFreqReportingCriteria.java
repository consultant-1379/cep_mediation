...
public class IntraFreqReportingCriteria extends Sequence {
     ...
     */
    public IntraFreqReportingCriteria(IntraFreqEventCriteriaList eventCriteriaList)
    {
    ...
    {
	mComponents[0] = new IntraFreqEventCriteriaList();
    }
	...
	switch (index) {
	    case 0:
		return new IntraFreqEventCriteriaList();
	    default:
    ...
    public IntraFreqEventCriteriaList getEventCriteriaList()
    {
	return (IntraFreqEventCriteriaList)mComponents[0];
    }
    
    public void setEventCriteriaList(IntraFreqEventCriteriaList eventCriteriaList)
    {
