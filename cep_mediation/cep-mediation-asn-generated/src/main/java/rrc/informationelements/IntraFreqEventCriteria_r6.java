...
/**
 * Define the ASN1 Type IntraFreqEventCriteria_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqEventCriteria_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqEventCriteria_r6()
    {
    }
     ...
     */
    public IntraFreqEventCriteria_r6(IntraFreqEvent_r6 event, 
    ...
    {
	mComponents[0] = new IntraFreqEvent_r6();
    ...
    public IntraFreqEvent_r6 getEvent()
    {
	return (IntraFreqEvent_r6)mComponents[0];
    }
    
    public void setEvent(IntraFreqEvent_r6 event)
    {
	mComponents[0] = event;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_r6 object.
     */
...
} // End class definition for IntraFreqEventCriteria_r6
