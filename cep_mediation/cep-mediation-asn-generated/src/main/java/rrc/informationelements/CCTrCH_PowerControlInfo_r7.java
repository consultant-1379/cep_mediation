...
/**
 * Define the ASN1 Type CCTrCH_PowerControlInfo_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CCTrCH_PowerControlInfo_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public CCTrCH_PowerControlInfo_r7()
    {
    }
     ...
     */
    public CCTrCH_PowerControlInfo_r7(TFCS_Identity tfcs_Identity, 
		    UL_DPCH_PowerControlInfo_r7 ul_DPCH_PowerControlInfo)
    {
     ...
     */
    public CCTrCH_PowerControlInfo_r7(UL_DPCH_PowerControlInfo_r7 ul_DPCH_PowerControlInfo)
    {
	setUl_DPCH_PowerControlInfo(ul_DPCH_PowerControlInfo);
    }
	...
	mComponents[1] = new UL_DPCH_PowerControlInfo_r7();
    }
    ...
    {
	return (UL_DPCH_PowerControlInfo_r7)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CCTrCH_PowerControlInfo_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CCTrCH_PowerControlInfo_r7 object.
     */
...
} // End class definition for CCTrCH_PowerControlInfo_r7
