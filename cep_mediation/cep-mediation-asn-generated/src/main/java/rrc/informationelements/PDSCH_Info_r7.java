...
/**
 * Define the ASN1 Type PDSCH_Info_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDSCH_Info_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDSCH_Info_r7()
    {
    }
     ...
     */
    public PDSCH_Info_r7(TFCS_IdentityPlain tfcs_ID, 
     ...
     */
    public PDSCH_Info_r7(TddOption tddOption)
    {
	setTddOption(tddOption);
    }
	...
	public static class Tdd384 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd384(DownlinkTimeslotsCodes pdsch_TimeslotsCodes)
	    {
	    ...
	    {
		mComponents[0] = pdsch_TimeslotsCodes;
	    }
		...
		new QName (
		    ...
		    "PDSCH_Info_r7$TddOption$Tdd384"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd768 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd768(DownlinkTimeslotsCodes_VHCR pdsch_TimeslotsCodes)
	    {
		setPdsch_TimeslotsCodes(pdsch_TimeslotsCodes);
	    }
	    ...
	    // Methods for field "pdsch_TimeslotsCodes"
	    public DownlinkTimeslotsCodes_VHCR getPdsch_TimeslotsCodes()
	    {
		return (DownlinkTimeslotsCodes_VHCR)mComponents[0];
	    }
	    
	    public void setPdsch_TimeslotsCodes(DownlinkTimeslotsCodes_VHCR pdsch_TimeslotsCodes)
	    {
		mComponents[0] = pdsch_TimeslotsCodes;
	    }
		...
		new QName (
		    "rrc.informationelements",
		    "PDSCH_Info_r7$TddOption$Tdd768"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd128 extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public Tdd128(DownlinkTimeslotsCodes_LCR_r4 pdsch_TimeslotsCodes)
	    {
		setPdsch_TimeslotsCodes(pdsch_TimeslotsCodes);
	    }
	    ...
	    // Methods for field "pdsch_TimeslotsCodes"
	    public DownlinkTimeslotsCodes_LCR_r4 getPdsch_TimeslotsCodes()
	    {
		return (DownlinkTimeslotsCodes_LCR_r4)mComponents[0];
	    }
	    
	    public void setPdsch_TimeslotsCodes(DownlinkTimeslotsCodes_LCR_r4 pdsch_TimeslotsCodes)
	    {
		mComponents[0] = pdsch_TimeslotsCodes;
	    }
		...
		new QName (
		    "rrc.informationelements",
		    "PDSCH_Info_r7$TddOption$Tdd128"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_Info_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_Info_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDSCH_Info_r7
