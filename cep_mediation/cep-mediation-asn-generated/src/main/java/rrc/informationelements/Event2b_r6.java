...
/**
 * Define the ASN1 Type Event2b_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2b_r6 extends Sequence {
     ...
     */
    public Event2b_r6(Threshold_r6 usedFreqThreshold, W usedFreqW, 
		    HysteresisInterFreq hysteresis, 
		    TimeToTrigger timeToTrigger, 
		    ReportingCellStatus reportingCellStatus, 
		    NonUsedFreqParameterList_r6 nonUsedFreqParameterList)
    {
	...
	mComponents[5] = new NonUsedFreqParameterList_r6();
    }
	...
	switch (index) {
	    ...
	    case 5:
		return new NonUsedFreqParameterList_r6();
	    default:
    ...
    public NonUsedFreqParameterList_r6 getNonUsedFreqParameterList()
    {
	return (NonUsedFreqParameterList_r6)mComponents[5];
    }
    
    public void setNonUsedFreqParameterList(NonUsedFreqParameterList_r6 nonUsedFreqParameterList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2b_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2b_r6 object.
     */
...
} // End class definition for Event2b_r6
