...
/**
 * Define the ASN1 Type Event2b from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2b extends Sequence {
     ...
     */
    public Event2b(Threshold usedFreqThreshold, W usedFreqW, 
    ...
    public Threshold getUsedFreqThreshold()
    {
	return (Threshold)mComponents[0];
    }
    
    public void setUsedFreqThreshold(Threshold usedFreqThreshold)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2b object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2b object.
     */
...
} // End class definition for Event2b
