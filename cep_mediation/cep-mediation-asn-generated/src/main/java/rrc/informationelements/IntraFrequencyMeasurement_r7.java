...
/**
 * Define the ASN1 Type IntraFrequencyMeasurement_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFrequencyMeasurement_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFrequencyMeasurement_r7()
    {
    }
     ...
     */
    public IntraFrequencyMeasurement_r7(IntraFreqCellInfoList_r4 intraFreqCellInfoList, 
		    ...
		    IntraFreqReportCriteria_r7 reportCriteria)
    {
	...
	mComponents[4] = new IntraFreqReportCriteria_r7();
    }
	...
	switch (index) {
	    ...
	    case 4:
		return new IntraFreqReportCriteria_r7();
	    default:
    ...
    public IntraFreqReportCriteria_r7 getReportCriteria()
    {
	return (IntraFreqReportCriteria_r7)mComponents[4];
    }
    
    public void setReportCriteria(IntraFreqReportCriteria_r7 reportCriteria)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r7 object.
     */
...
} // End class definition for IntraFrequencyMeasurement_r7
