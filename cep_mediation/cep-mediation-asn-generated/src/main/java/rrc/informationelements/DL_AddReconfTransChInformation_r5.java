...
/**
 * Define the ASN1 Type DL_AddReconfTransChInformation_r5 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_AddReconfTransChInformation_r5 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_AddReconfTransChInformation_r5()
    {
    }
     ...
     */
    public DL_AddReconfTransChInformation_r5(DL_TrCH_TypeId1_r5 dl_TransportChannelType, 
	...
	public static Tfs_SignallingMode createTfs_SignallingModeWithHsdsch(HSDSCH_Info hsdsch)
	{
	    Tfs_SignallingMode __object = new Tfs_SignallingMode();
	...
	public void setHsdsch(HSDSCH_Info hsdsch)
	{
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"DL_AddReconfTransChInformation_r5$Tfs_SignallingMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_AddReconfTransChInformation_r5 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_AddReconfTransChInformation_r5 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_AddReconfTransChInformation_r5
