...
/**
 * Define the ASN1 Type DL_InformationPerRL_r5bis from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_InformationPerRL_r5bis extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_InformationPerRL_r5bis()
    {
    }
     ...
     */
    public DL_InformationPerRL_r5bis(ModeSpecificInfo modeSpecificInfo, 
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "DL_InformationPerRL_r5bis$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_InformationPerRL_r5bis$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_InformationPerRL_r5bis object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_InformationPerRL_r5bis object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_InformationPerRL_r5bis
