...
/**
 * Define the ASN1 Type E_AGCH_Individual_LCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class E_AGCH_Individual_LCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public E_AGCH_Individual_LCR()
    {
    }
     ...
     */
    public E_AGCH_Individual_LCR(TimeslotNumber_LCR_r4 timeslotNumber, 
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"E_AGCH_Individual_LCR$MidambleAllocationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' E_AGCH_Individual_LCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' E_AGCH_Individual_LCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for E_AGCH_Individual_LCR
