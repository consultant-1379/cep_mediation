...
/**
 * Define the ASN1 Type UL_CounterSynchronisationInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_CounterSynchronisationInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public UL_CounterSynchronisationInfo()
    {
    }
     ...
     */
    public UL_CounterSynchronisationInfo(RB_WithPDCP_InfoList rB_WithPDCP_InfoList, 
		    STARTList startList)
    {
     ...
     */
    public UL_CounterSynchronisationInfo(STARTList startList)
    {
	setStartList(startList);
    }
    ...
    {
	return (STARTList)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_CounterSynchronisationInfo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_CounterSynchronisationInfo object.
     */
...
} // End class definition for UL_CounterSynchronisationInfo
