...
/**
 * Define the ASN1 Type TimeslotInfoList from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class TimeslotInfoList extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public TimeslotInfoList()
    {
    }
     ...
     */
    public TimeslotInfoList(TimeslotInfo[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TimeslotInfoList object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TimeslotInfoList object.
     */
...
} // End class definition for TimeslotInfoList
