...
/**
 * Define the ASN1 Type HS_SICH_Configuration_TDD768 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class HS_SICH_Configuration_TDD768 extends Sequence {
    
    /**
     * The default constructor.
     */
    public HS_SICH_Configuration_TDD768()
    {
    }
     ...
     */
    public HS_SICH_Configuration_TDD768(TimeslotNumber timeslotNumber, 
	...
	public static class UeSpecificMidamble extends Sequence {
		...
		new QName (
		    ...
		    "HS_SICH_Configuration_TDD768$MidambleAllocationMode$UeSpecificMidamble"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"HS_SICH_Configuration_TDD768$MidambleAllocationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HS_SICH_Configuration_TDD768 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HS_SICH_Configuration_TDD768 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HS_SICH_Configuration_TDD768
