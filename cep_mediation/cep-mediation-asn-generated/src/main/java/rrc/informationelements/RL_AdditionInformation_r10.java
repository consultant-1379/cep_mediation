...
/**
 * Define the ASN1 Type RL_AdditionInformation_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RL_AdditionInformation_r10 extends Sequence {
    
    /**
     * The default constructor.
     */
    public RL_AdditionInformation_r10()
    {
    }
     ...
     */
    public RL_AdditionInformation_r10(PrimaryCPICH_Info primaryCPICH_Info, 
		    CellIdentity cell_Id, Dl_dpchInfo dl_dpchInfo, 
		    E_HICH_Information e_HICH_Information, 
		    E_RGCH_Information e_RGCH_Information, 
		    TargetCellPreconfigInfo_r10 targetCellPreconfigInfo)
    {
	...
	mComponents[5] = new TargetCellPreconfigInfo_r10();
    }
	...
	switch (index) {
	    ...
	    case 5:
		return new TargetCellPreconfigInfo_r10();
	    default:
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"RL_AdditionInformation_r10$Dl_dpchInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public TargetCellPreconfigInfo_r10 getTargetCellPreconfigInfo()
    {
	return (TargetCellPreconfigInfo_r10)mComponents[5];
    }
    
    public void setTargetCellPreconfigInfo(TargetCellPreconfigInfo_r10 targetCellPreconfigInfo)
    {
	mComponents[5] = targetCellPreconfigInfo;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RL_AdditionInformation_r10 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RL_AdditionInformation_r10 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RL_AdditionInformation_r10
