...
/**
 * Define the ASN1 Type CommonTransChTFS from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CommonTransChTFS extends Sequence {
    
    /**
     * The default constructor.
     */
    public CommonTransChTFS()
    {
    }
     ...
     */
    public CommonTransChTFS(Tti tti, 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CommonTransChTFS object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CommonTransChTFS object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CommonTransChTFS
