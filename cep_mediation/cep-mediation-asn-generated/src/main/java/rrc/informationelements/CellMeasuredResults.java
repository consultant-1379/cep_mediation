...
/**
 * Define the ASN1 Type CellMeasuredResults from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellMeasuredResults extends Sequence {
     ...
     */
    public CellMeasuredResults(CellIdentity cellIdentity, 
		    SFN_SFN_ObsTimeDifference dummy, 
     ...
     */
    public CellMeasuredResults(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	mComponents[1] = new SFN_SFN_ObsTimeDifference();
	mComponents[2] = new CellSynchronisationInfo();
    ...
    {
	return (SFN_SFN_ObsTimeDifference)mComponents[1];
    }
    
    public void setDummy(SFN_SFN_ObsTimeDifference dummy)
    {
	mComponents[1] = dummy;
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellMeasuredResults$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellMeasuredResults$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CellMeasuredResults$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellMeasuredResults object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellMeasuredResults object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellMeasuredResults
