...
/**
 * Define the ASN1 Type NewInterFreqCellSI_RSCP_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterFreqCellSI_RSCP_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterFreqCellSI_RSCP_LCR_r4()
    {
    }
     ...
     */
    public NewInterFreqCellSI_RSCP_LCR_r4(InterFreqCellID interFreqCellID, 
		    FrequencyInfo frequencyInfo, 
		    CellInfoSI_RSCP_LCR_r4 cellInfo)
    {
     ...
     */
    public NewInterFreqCellSI_RSCP_LCR_r4(CellInfoSI_RSCP_LCR_r4 cellInfo)
    {
	setCellInfo(cellInfo);
    }
	...
	mComponents[2] = new CellInfoSI_RSCP_LCR_r4();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new CellInfoSI_RSCP_LCR_r4();
	    default:
    ...
    public CellInfoSI_RSCP_LCR_r4 getCellInfo()
    {
	return (CellInfoSI_RSCP_LCR_r4)mComponents[2];
    }
    
    public void setCellInfo(CellInfoSI_RSCP_LCR_r4 cellInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_RSCP_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_RSCP_LCR_r4 object.
     */
...
} // End class definition for NewInterFreqCellSI_RSCP_LCR_r4
