...
/**
 * Define the ASN1 Type UE_Positioning_Measurement_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_Measurement_r10 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_Measurement_r10()
    {
    }
     ...
     */
    public UE_Positioning_Measurement_r10(UE_Positioning_ReportingQuantity_r8 ue_positioning_ReportingQuantity, 
		    ...
		    UE_Positioning_GPS_AssistanceData_r10 ue_positioning_GPS_AssistanceData, 
		    UE_Positioning_GANSS_AssistanceData_r10 ue_positioning_GANSS_AssistanceData)
    {
	...
	mComponents[4] = new UE_Positioning_GPS_AssistanceData_r10();
	mComponents[5] = new UE_Positioning_GANSS_AssistanceData_r10();
    }
	...
	switch (index) {
	    ...
	    case 4:
		return new UE_Positioning_GPS_AssistanceData_r10();
	    case 5:
		return new UE_Positioning_GANSS_AssistanceData_r10();
	    default:
    ...
    public UE_Positioning_GPS_AssistanceData_r10 getUe_positioning_GPS_AssistanceData()
    {
	return (UE_Positioning_GPS_AssistanceData_r10)mComponents[4];
    }
    
    public void setUe_positioning_GPS_AssistanceData(UE_Positioning_GPS_AssistanceData_r10 ue_positioning_GPS_AssistanceData)
    {
    ...
    public UE_Positioning_GANSS_AssistanceData_r10 getUe_positioning_GANSS_AssistanceData()
    {
	return (UE_Positioning_GANSS_AssistanceData_r10)mComponents[5];
    }
    
    public void setUe_positioning_GANSS_AssistanceData(UE_Positioning_GANSS_AssistanceData_r10 ue_positioning_GANSS_AssistanceData)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r10 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r10 object.
     */
...
} // End class definition for UE_Positioning_Measurement_r10
