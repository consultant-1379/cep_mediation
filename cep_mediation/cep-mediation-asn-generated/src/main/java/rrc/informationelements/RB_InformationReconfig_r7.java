...
/**
 * Define the ASN1 Type RB_InformationReconfig_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RB_InformationReconfig_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public RB_InformationReconfig_r7()
    {
    }
     ...
     */
    public RB_InformationReconfig_r7(RB_Identity rb_Identity, 
		    PDCP_InfoReconfig_r4 pdcp_Info, PDCP_SN_Info pdcp_SN_Info, 
		    RLC_Info_r7 rlc_Info, RB_MappingInfo_r7 rb_MappingInfo, 
	...
	mComponents[3] = new RLC_Info_r7();
	mComponents[4] = new RB_MappingInfo_r7();
    ...
    public RLC_Info_r7 getRlc_Info()
    {
	return (RLC_Info_r7)mComponents[3];
    }
    
    public void setRlc_Info(RLC_Info_r7 rlc_Info)
    {
    ...
    {
	return (RB_MappingInfo_r7)mComponents[4];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RB_InformationReconfig_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RB_InformationReconfig_r7 object.
     */
...
} // End class definition for RB_InformationReconfig_r7
