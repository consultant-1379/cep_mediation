...
/**
 * Define the ASN1 Type E_DCH_RL_InfoNewServingCell_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class E_DCH_RL_InfoNewServingCell_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public E_DCH_RL_InfoNewServingCell_r7()
    {
    }
     ...
     */
    public E_DCH_RL_InfoNewServingCell_r7(PrimaryCPICH_Info primaryCPICH_Info, 
	...
	mComponents[4] = new E_DPDCH_Reference_E_TFCIList_r7();
	...
	public static final class Primary_Secondary_GrantSelector extends Enumerated {
		...
		new QName (
		    ...
		    "E_DCH_RL_InfoNewServingCell_r7$ServingGrant$Primary_Secondary_GrantSelector"
		),
		new QName (
		    "builtin",
		    "ENUMERATED"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"E_DCH_RL_InfoNewServingCell_r7$ServingGrant"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    {
	return (E_DPDCH_Reference_E_TFCIList_r7)mComponents[4];
    }
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"E_DCH_RL_InfoNewServingCell_r7$E_RGCH_Info"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' E_DCH_RL_InfoNewServingCell_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' E_DCH_RL_InfoNewServingCell_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for E_DCH_RL_InfoNewServingCell_r7
