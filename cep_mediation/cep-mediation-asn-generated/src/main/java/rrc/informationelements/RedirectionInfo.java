...
/**
 * Define the ASN1 Type RedirectionInfo from ASN1 Module InformationElements.
 * @see Choice
 */

public class RedirectionInfo extends Choice {
    ...
    public static RedirectionInfo createRedirectionInfoWithFrequencyInfo(FrequencyInfo frequencyInfo)
    {
	RedirectionInfo __object = new RedirectionInfo();
    ...
    public static RedirectionInfo createRedirectionInfoWithInterRATInfo(InterRATInfo interRATInfo)
    {
	RedirectionInfo __object = new RedirectionInfo();
    ...
    public void setInterRATInfo(InterRATInfo interRATInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RedirectionInfo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RedirectionInfo object.
     */
...
} // End class definition for RedirectionInfo
