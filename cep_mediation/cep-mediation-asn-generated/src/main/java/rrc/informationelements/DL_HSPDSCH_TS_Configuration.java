...
/**
 * Define the ASN1 Type DL_HSPDSCH_TS_Configuration from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class DL_HSPDSCH_TS_Configuration extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public DL_HSPDSCH_TS_Configuration()
    {
    }
     ...
     */
    public DL_HSPDSCH_TS_Configuration(Sequence_[] elements)
    {
	super(elements);
    }
	...
	public Sequence_(TimeslotNumber timeslot, 
			MidambleShiftAndBurstType_DL midambleShiftAndBurstType)
	{
	...
	public void initComponents()
	{
	    ...
	    mComponents[1] = new MidambleShiftAndBurstType_DL();
	}
	...
	public AbstractData createInstance(int index)
	{
		...
		case 1:
		    return new MidambleShiftAndBurstType_DL();
		default:
	...
	public MidambleShiftAndBurstType_DL getMidambleShiftAndBurstType()
	{
	    return (MidambleShiftAndBurstType_DL)mComponents[1];
	}
	
	public void setMidambleShiftAndBurstType(MidambleShiftAndBurstType_DL midambleShiftAndBurstType)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_HSPDSCH_TS_Configuration object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_HSPDSCH_TS_Configuration object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_HSPDSCH_TS_Configuration
