...
/**
 * Define the ASN1 Type CellInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellInfo extends Sequence {
     ...
     */
    public CellInfo(CellIndividualOffset cellIndividualOffset, 
     ...
     */
    public CellInfo(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellInfo object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellInfo object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellInfo
