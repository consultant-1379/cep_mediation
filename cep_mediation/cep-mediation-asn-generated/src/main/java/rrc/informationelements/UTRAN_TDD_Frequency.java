...
/**
 * Define the ASN1 Type UTRAN_TDD_Frequency from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UTRAN_TDD_Frequency extends Sequence {
    
    /**
     * The default constructor.
     */
    public UTRAN_TDD_Frequency()
    {
    }
     ...
     */
    public UTRAN_TDD_Frequency(UARFCN uarfcn, INTEGER priority, 
		    INTEGER threshXhigh, INTEGER threshXlow, 
		    INTEGER qRxLevMinTDD)
    {
	setUarfcn(uarfcn);
	setPriority(priority);
	setThreshXhigh(threshXhigh);
	setThreshXlow(threshXlow);
	setQRxLevMinTDD(qRxLevMinTDD);
    }
    
    /**
     * Construct with components.
     */
    public UTRAN_TDD_Frequency(UARFCN uarfcn, long priority, long threshXhigh, 
		    long threshXlow, long qRxLevMinTDD)
    {
	this(uarfcn, new INTEGER(priority), new INTEGER(threshXhigh), 
	     new INTEGER(threshXlow), new INTEGER(qRxLevMinTDD));
    }
    ...
    // Methods for field "qRxLevMinTDD"
    public long getQRxLevMinTDD()
    {
	return ((INTEGER)mComponents[4]).longValue();
    }
    
    public void setQRxLevMinTDD(long qRxLevMinTDD)
    {
	setQRxLevMinTDD(new INTEGER(qRxLevMinTDD));
    }
    
    public void setQRxLevMinTDD(INTEGER qRxLevMinTDD)
    {
	mComponents[4] = qRxLevMinTDD;
    }
    
    public boolean hasQRxLevMinTDD()
    {
	return componentIsPresent(4);
    }
    
    public void deleteQRxLevMinTDD()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UTRAN_TDD_Frequency object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UTRAN_TDD_Frequency object.
     */
...
} // End class definition for UTRAN_TDD_Frequency
