...
/**
 * Define the ASN1 Type DL_CommonInformation_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_CommonInformation_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_CommonInformation_r8()
    {
    }
     ...
     */
    public DL_CommonInformation_r8(Dl_dpchInfoCommon dl_dpchInfoCommon, 
     ...
     */
    public DL_CommonInformation_r8(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"DL_CommonInformation_r8$Dl_dpchInfoCommon"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	public static class Fdd extends Sequence {
	    ...
	    public Fdd(DefaultDPCH_OffsetValueFDD defaultDPCH_OffsetValue, 
			    DPCH_CompressedModeInfo_r8 dpch_CompressedModeInfo, 
		...
		mComponents[1] = new DPCH_CompressedModeInfo_r8();
		...
		switch (index) {
		    ...
		    case 1:
			return new DPCH_CompressedModeInfo_r8();
		    case 2:
	    ...
	    public DPCH_CompressedModeInfo_r8 getDpch_CompressedModeInfo()
	    {
		return (DPCH_CompressedModeInfo_r8)mComponents[1];
	    }
	    
	    public void setDpch_CompressedModeInfo(DPCH_CompressedModeInfo_r8 dpch_CompressedModeInfo)
	    {
		...
		new QName (
		    "rrc.informationelements",
		    "DL_CommonInformation_r8$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		public static class Tdd128 extends Sequence {
			...
			new QName (
			    "rrc.informationelements",
			    "DL_CommonInformation_r8$ModeSpecificInfo$Tdd$TddOption$Tdd128"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_CommonInformation_r8$ModeSpecificInfo$Tdd$TddOption"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_CommonInformation_r8$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_CommonInformation_r8$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_CommonInformation_r8$Mac_hsResetIndicator"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_CommonInformation_r8$PostVerificationPeriod"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_CommonInformation_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_CommonInformation_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_CommonInformation_r8
