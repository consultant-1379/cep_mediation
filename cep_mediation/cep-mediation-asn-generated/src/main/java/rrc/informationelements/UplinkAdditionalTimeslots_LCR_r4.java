...
/**
 * Define the ASN1 Type UplinkAdditionalTimeslots_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UplinkAdditionalTimeslots_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UplinkAdditionalTimeslots_LCR_r4()
    {
    }
     ...
     */
    public UplinkAdditionalTimeslots_LCR_r4(Parameters parameters)
    {
	...
	public static class SameAsLast extends Sequence {
		...
		new QName (
		    ...
		    "UplinkAdditionalTimeslots_LCR_r4$Parameters$SameAsLast"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class NewParameters extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UplinkAdditionalTimeslots_LCR_r4$Parameters$NewParameters"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UplinkAdditionalTimeslots_LCR_r4$Parameters"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UplinkAdditionalTimeslots_LCR_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UplinkAdditionalTimeslots_LCR_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UplinkAdditionalTimeslots_LCR_r4
