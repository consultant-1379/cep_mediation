...
/**
 * Define the ASN1 Type Event3a from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event3a extends Sequence {
     ...
     */
    public Event3a(Threshold thresholdOwnSystem, W w, 
		    Threshold thresholdOtherSystem, Hysteresis hysteresis, 
	...
	mComponents[1] = new W();
	mComponents[2] = new Threshold();
	mComponents[3] = new Hysteresis();
	mComponents[4] = TimeToTrigger.ttt0;
	mComponents[5] = new ReportingCellStatus();
    }
    ...
    // Methods for field "thresholdOwnSystem"
    public Threshold getThresholdOwnSystem()
    {
	return (Threshold)mComponents[0];
    }
    
    public void setThresholdOwnSystem(Threshold thresholdOwnSystem)
    {
	mComponents[0] = thresholdOwnSystem;
    }
    ...
    {
	return (Hysteresis)mComponents[3];
    }
    
    public void setHysteresis(Hysteresis hysteresis)
    {
	mComponents[3] = hysteresis;
    }
    ...
    {
	return (TimeToTrigger)mComponents[4];
    }
    
    public void setTimeToTrigger(TimeToTrigger timeToTrigger)
    {
	mComponents[4] = timeToTrigger;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event3a object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event3a object.
     */
...
} // End class definition for Event3a
