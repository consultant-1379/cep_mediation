...
/**
 * Define the ASN1 Type DownlinkTimeslotsCodes_VHCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DownlinkTimeslotsCodes_VHCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public DownlinkTimeslotsCodes_VHCR()
    {
    }
     ...
     */
    public DownlinkTimeslotsCodes_VHCR(IndividualTimeslotInfo_VHCR firstIndividualTimeslotInfo, 
		    DL_TS_ChannelisationCodesShort_VHCR dl_TS_ChannelisationCodesShort, 
	...
	mComponents[1] = new DL_TS_ChannelisationCodesShort_VHCR();
	...
	switch (index) {
	    ...
	    case 1:
		return new DL_TS_ChannelisationCodesShort_VHCR();
	    case 2:
    ...
    public DL_TS_ChannelisationCodesShort_VHCR getDl_TS_ChannelisationCodesShort()
    {
	return (DL_TS_ChannelisationCodesShort_VHCR)mComponents[1];
    }
    
    public void setDl_TS_ChannelisationCodesShort(DL_TS_ChannelisationCodesShort_VHCR dl_TS_ChannelisationCodesShort)
    {
	...
	public static class AdditionalTimeslots extends Choice {
		 ...
		 */
		public TimeslotList(DownlinkAdditionalTimeslots_VHCR[] elements)
		{
		    super(elements);
		}
		 ...
		 */
		public synchronized void add(DownlinkAdditionalTimeslots_VHCR element)
		{
		 ...
		 */
		public synchronized void set(DownlinkAdditionalTimeslots_VHCR element, int atIndex)
		{
		 ...
		 */
		public synchronized DownlinkAdditionalTimeslots_VHCR get(int atIndex)
		{
		    return (DownlinkAdditionalTimeslots_VHCR)super.getElement(atIndex);
		}
		
		/**
		 * Insert an Element into the SEQUENCE OF/SET OF.
		 */
		public synchronized void insert(DownlinkAdditionalTimeslots_VHCR element, int atIndex)
		{
		 ...
		 */
		public synchronized void remove(DownlinkAdditionalTimeslots_VHCR element)
		{
		...
		{
		    return (AbstractData)new DownlinkAdditionalTimeslots_VHCR();
		}
		...
		private static final ContainerInfo c_typeinfo = new ContainerInfo (
			...
			"DownlinkTimeslotsCodes_VHCR$MoreTimeslots$AdditionalTimeslots$TimeslotList"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE OF"
			...
			new QName (
			    "rrc.informationelements",
			    "DownlinkAdditionalTimeslots_VHCR"
			)
		    )
		);
		...
		new QName (
		    "rrc.informationelements",
		    "DownlinkTimeslotsCodes_VHCR$MoreTimeslots$AdditionalTimeslots"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DownlinkTimeslotsCodes_VHCR$MoreTimeslots"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DownlinkTimeslotsCodes_VHCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DownlinkTimeslotsCodes_VHCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DownlinkTimeslotsCodes_VHCR
