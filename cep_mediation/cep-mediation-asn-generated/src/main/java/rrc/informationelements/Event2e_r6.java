...
/**
 * Define the ASN1 Type Event2e_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2e_r6 extends Sequence {
     ...
     */
    public Event2e_r6(HysteresisInterFreq hysteresis, 
	...
	mComponents[3] = new NonUsedFreqParameterList_r6();
    }
    ...
    {
	return (NonUsedFreqParameterList_r6)mComponents[3];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2e_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2e_r6 object.
     */
...
} // End class definition for Event2e_r6
