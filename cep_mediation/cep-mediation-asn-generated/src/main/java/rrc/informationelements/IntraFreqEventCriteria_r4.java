...
/**
 * Define the ASN1 Type IntraFreqEventCriteria_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqEventCriteria_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqEventCriteria_r4()
    {
    }
     ...
     */
    public IntraFreqEventCriteria_r4(IntraFreqEvent_r4 event, 
    ...
    {
	mComponents[0] = new IntraFreqEvent_r4();
    ...
    public IntraFreqEvent_r4 getEvent()
    {
	return (IntraFreqEvent_r4)mComponents[0];
    }
    
    public void setEvent(IntraFreqEvent_r4 event)
    {
	mComponents[0] = event;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_r4 object.
     */
...
} // End class definition for IntraFreqEventCriteria_r4
