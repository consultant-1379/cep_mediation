...
/**
 * Define the ASN1 Type CellDCH_ReportCriteria from ASN1 Module InformationElements.
 * @see Choice
 */

public class CellDCH_ReportCriteria extends Choice {
    
    /**
     * The default constructor.
     */
    public CellDCH_ReportCriteria()
    {
    }
    ...
    public static CellDCH_ReportCriteria createCellDCH_ReportCriteriaWithIntraFreqReportingCriteria(IntraFreqReportingCriteria intraFreqReportingCriteria)
    {
	CellDCH_ReportCriteria __object = new CellDCH_ReportCriteria();
    ...
    public static CellDCH_ReportCriteria createCellDCH_ReportCriteriaWithPeriodicalReportingCriteria(PeriodicalReportingCriteria periodicalReportingCriteria)
    {
	CellDCH_ReportCriteria __object = new CellDCH_ReportCriteria();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellDCH_ReportCriteria object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellDCH_ReportCriteria object.
     */
...
} // End class definition for CellDCH_ReportCriteria
