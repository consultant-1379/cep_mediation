...
/**
 * Define the ASN1 Type IntraFreqEventCriteria_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqEventCriteria_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqEventCriteria_r7()
    {
    }
     ...
     */
    public IntraFreqEventCriteria_r7(IntraFreqEvent_r7 event, 
    ...
    {
	mComponents[0] = new IntraFreqEvent_r7();
    ...
    public IntraFreqEvent_r7 getEvent()
    {
	return (IntraFreqEvent_r7)mComponents[0];
    }
    
    public void setEvent(IntraFreqEvent_r7 event)
    {
	mComponents[0] = event;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_r7 object.
     */
...
} // End class definition for IntraFreqEventCriteria_r7
