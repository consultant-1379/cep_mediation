...
/**
 * Define the ASN1 Type Event3b from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event3b extends Sequence {
     ...
     */
    public Event3b(Threshold thresholdOtherSystem, Hysteresis hysteresis, 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event3b object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event3b object.
     */
...
} // End class definition for Event3b
