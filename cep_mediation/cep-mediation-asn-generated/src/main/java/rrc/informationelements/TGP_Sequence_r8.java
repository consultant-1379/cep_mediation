...
/**
 * Define the ASN1 Type TGP_Sequence_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class TGP_Sequence_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public TGP_Sequence_r8()
    {
    }
     ...
     */
    public TGP_Sequence_r8(TGPSI tgpsi, Tgps_Status tgps_Status, 
		    TGPS_ConfigurationParams_r8 tgps_ConfigurationParams)
    {
	setTgpsi(tgpsi);
	...
	mComponents[2] = new TGPS_ConfigurationParams_r8();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new TGPS_ConfigurationParams_r8();
	    default:
	...
	public static class Activate extends Sequence {
		...
		new QName (
		    ...
		    "TGP_Sequence_r8$Tgps_Status$Activate"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    public TGPS_ConfigurationParams_r8 getTgps_ConfigurationParams()
    {
	return (TGPS_ConfigurationParams_r8)mComponents[2];
    }
    
    public void setTgps_ConfigurationParams(TGPS_ConfigurationParams_r8 tgps_ConfigurationParams)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TGP_Sequence_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TGP_Sequence_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TGP_Sequence_r8
