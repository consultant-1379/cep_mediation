...
/**
 * Define the ASN1 Type Event3d from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event3d extends Sequence {
     ...
     */
    public Event3d(Hysteresis hysteresis, TimeToTrigger timeToTrigger, 
    ...
    {
	return (Hysteresis)mComponents[0];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event3d object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event3d object.
     */
...
} // End class definition for Event3d
