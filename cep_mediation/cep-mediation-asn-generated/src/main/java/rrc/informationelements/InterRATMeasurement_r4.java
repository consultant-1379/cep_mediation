...
/**
 * Define the ASN1 Type InterRATMeasurement_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterRATMeasurement_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterRATMeasurement_r4()
    {
    }
     ...
     */
    public InterRATMeasurement_r4(InterRATCellInfoList_r4 interRATCellInfoList, 
     ...
     */
    public InterRATMeasurement_r4(InterRATReportCriteria reportCriteria)
    {
	setReportCriteria(reportCriteria);
    }
    ...
    {
	mComponents[0] = new InterRATCellInfoList_r4();
	...
	switch (index) {
	    case 0:
		return new InterRATCellInfoList_r4();
	    case 1:
    ...
    public InterRATCellInfoList_r4 getInterRATCellInfoList()
    {
	return (InterRATCellInfoList_r4)mComponents[0];
    }
    
    public void setInterRATCellInfoList(InterRATCellInfoList_r4 interRATCellInfoList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterRATMeasurement_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterRATMeasurement_r4 object.
     */
...
} // End class definition for InterRATMeasurement_r4
