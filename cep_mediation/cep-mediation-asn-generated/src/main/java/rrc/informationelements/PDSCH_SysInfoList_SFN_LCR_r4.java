...
/**
 * Define the ASN1 Type PDSCH_SysInfoList_SFN_LCR_r4 from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PDSCH_SysInfoList_SFN_LCR_r4 extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PDSCH_SysInfoList_SFN_LCR_r4()
    {
    }
     ...
     */
    public PDSCH_SysInfoList_SFN_LCR_r4(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(PDSCH_SysInfo_LCR_r4 pdsch_SysInfo, 
	...
	{
	    mComponents[0] = new PDSCH_SysInfo_LCR_r4();
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return new PDSCH_SysInfo_LCR_r4();
		case 1:
	...
	public PDSCH_SysInfo_LCR_r4 getPdsch_SysInfo()
	{
	    return (PDSCH_SysInfo_LCR_r4)mComponents[0];
	}
	
	public void setPdsch_SysInfo(PDSCH_SysInfo_LCR_r4 pdsch_SysInfo)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_SysInfoList_SFN_LCR_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_SysInfoList_SFN_LCR_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDSCH_SysInfoList_SFN_LCR_r4
