...
/**
 * Define the ASN1 Type DLUL_HSPA_Information_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DLUL_HSPA_Information_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DLUL_HSPA_Information_r8()
    {
    }
     ...
     */
    public DLUL_HSPA_Information_r8(UL_EDCH_Information_r8 ul_EDCH_Information, 
		    DL_CommonInformation_r8 dl_CommonInformation, 
    ...
    {
	mComponents[0] = new UL_EDCH_Information_r8();
	mComponents[1] = new DL_CommonInformation_r8();
	mComponents[2] = new DL_InformationPerRL_List_r7();
	mComponents[3] = new DL_HSPDSCH_Information_r8();
    }
	...
	switch (index) {
	    case 0:
		return new UL_EDCH_Information_r8();
	    case 1:
		return new DL_CommonInformation_r8();
	    case 2:
    ...
    public UL_EDCH_Information_r8 getUl_EDCH_Information()
    {
	return (UL_EDCH_Information_r8)mComponents[0];
    }
    
    public void setUl_EDCH_Information(UL_EDCH_Information_r8 ul_EDCH_Information)
    {
    ...
    public DL_CommonInformation_r8 getDl_CommonInformation()
    {
	return (DL_CommonInformation_r8)mComponents[1];
    }
    
    public void setDl_CommonInformation(DL_CommonInformation_r8 dl_CommonInformation)
    {
    ...
    {
	return (DL_HSPDSCH_Information_r8)mComponents[3];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DLUL_HSPA_Information_r8 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DLUL_HSPA_Information_r8 object.
     */
...
} // End class definition for DLUL_HSPA_Information_r8
