...
/**
 * Define the ASN1 Type RepetitionPeriodAndLength from ASN1 Module InformationElements.
 * @see Choice
 */

public class RepetitionPeriodAndLength extends Choice {
    
    /**
     * The default constructor.
     */
    public RepetitionPeriodAndLength()
    {
    }
    ...
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod1(Null repetitionPeriod1)
    {
	RepetitionPeriodAndLength __object = new RepetitionPeriodAndLength();
    ...
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod2(long repetitionPeriod2)
    {
	return createRepetitionPeriodAndLengthWithRepetitionPeriod2(new INTEGER(repetitionPeriod2));
    }
    
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod2(INTEGER repetitionPeriod2)
    {
	RepetitionPeriodAndLength __object = new RepetitionPeriodAndLength();
    ...
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod4(long repetitionPeriod4)
    {
	return createRepetitionPeriodAndLengthWithRepetitionPeriod4(new INTEGER(repetitionPeriod4));
    }
    
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod4(INTEGER repetitionPeriod4)
    {
	RepetitionPeriodAndLength __object = new RepetitionPeriodAndLength();
    ...
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod8(long repetitionPeriod8)
    {
	return createRepetitionPeriodAndLengthWithRepetitionPeriod8(new INTEGER(repetitionPeriod8));
    }
    
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod8(INTEGER repetitionPeriod8)
    {
	RepetitionPeriodAndLength __object = new RepetitionPeriodAndLength();
    ...
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod16(long repetitionPeriod16)
    {
	return createRepetitionPeriodAndLengthWithRepetitionPeriod16(new INTEGER(repetitionPeriod16));
    }
    
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod16(INTEGER repetitionPeriod16)
    {
	RepetitionPeriodAndLength __object = new RepetitionPeriodAndLength();
    ...
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod32(long repetitionPeriod32)
    {
	return createRepetitionPeriodAndLengthWithRepetitionPeriod32(new INTEGER(repetitionPeriod32));
    }
    
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod32(INTEGER repetitionPeriod32)
    {
	RepetitionPeriodAndLength __object = new RepetitionPeriodAndLength();
    ...
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod64(long repetitionPeriod64)
    {
	return createRepetitionPeriodAndLengthWithRepetitionPeriod64(new INTEGER(repetitionPeriod64));
    }
    
    public static RepetitionPeriodAndLength createRepetitionPeriodAndLengthWithRepetitionPeriod64(INTEGER repetitionPeriod64)
    {
	RepetitionPeriodAndLength __object = new RepetitionPeriodAndLength();
    ...
    public void setRepetitionPeriod64(long repetitionPeriod64)
    {
	setRepetitionPeriod64(new INTEGER(repetitionPeriod64));
    }
    
    public void setRepetitionPeriod64(INTEGER repetitionPeriod64)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RepetitionPeriodAndLength object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RepetitionPeriodAndLength object.
     */
...
} // End class definition for RepetitionPeriodAndLength
