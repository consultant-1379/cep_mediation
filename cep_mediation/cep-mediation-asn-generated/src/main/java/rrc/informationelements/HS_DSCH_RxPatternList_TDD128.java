...
/**
 * Define the ASN1 Type HS_DSCH_RxPatternList_TDD128 from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class HS_DSCH_RxPatternList_TDD128 extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public HS_DSCH_RxPatternList_TDD128()
    {
    }
     ...
     */
    public HS_DSCH_RxPatternList_TDD128(Sequence_[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HS_DSCH_RxPatternList_TDD128 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HS_DSCH_RxPatternList_TDD128 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HS_DSCH_RxPatternList_TDD128
