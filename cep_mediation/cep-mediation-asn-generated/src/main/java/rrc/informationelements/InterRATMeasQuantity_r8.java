...
/**
 * Define the ASN1 Type InterRATMeasQuantity_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterRATMeasQuantity_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterRATMeasQuantity_r8()
    {
    }
     ...
     */
    public InterRATMeasQuantity_r8(IntraFreqMeasQuantity measQuantityUTRAN_QualityEstimate, 
     ...
     */
    public InterRATMeasQuantity_r8(RatSpecificInfo ratSpecificInfo)
    {
	setRatSpecificInfo(ratSpecificInfo);
    }
	...
	public static final  int  e_UTRA_chosen = 3;
	...
	public static class Gsm extends Sequence {
		...
		new QName (
		    ...
		    "InterRATMeasQuantity_r8$RatSpecificInfo$Gsm"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Is_2000 extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "InterRATMeasQuantity_r8$RatSpecificInfo$Is_2000"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static RatSpecificInfo createRatSpecificInfoWithE_UTRA(E_UTRA e_UTRA)
	{
	    RatSpecificInfo __object = new RatSpecificInfo();
	...
	public static class E_UTRA extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public E_UTRA(MeasurementQuantityEUTRA measurementQuantity, 
			    FilterCoefficient filterCoefficient)
	    {
		setMeasurementQuantity(measurementQuantity);
		setFilterCoefficient(filterCoefficient);
	    ...
	    public void initComponents()
	    {
		mComponents[0] = MeasurementQuantityEUTRA.rrsp;
		mComponents[1] = FilterCoefficient.fc0;
	    }
		...
		switch (index) {
		    case 0:
			return MeasurementQuantityEUTRA.rrsp;
		    case 1:
			return FilterCoefficient.fc0;
		    default:
			throw new InternalError("AbstractCollection.createInstance()");
	    ...
	    // Methods for field "measurementQuantity"
	    public MeasurementQuantityEUTRA getMeasurementQuantity()
	    {
		return (MeasurementQuantityEUTRA)mComponents[0];
	    }
	    
	    public void setMeasurementQuantity(MeasurementQuantityEUTRA measurementQuantity)
	    {
		mComponents[0] = measurementQuantity;
	    }
		...
		new QName (
		    "rrc.informationelements",
		    "InterRATMeasQuantity_r8$RatSpecificInfo$E_UTRA"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"InterRATMeasQuantity_r8$RatSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterRATMeasQuantity_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterRATMeasQuantity_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for InterRATMeasQuantity_r8
