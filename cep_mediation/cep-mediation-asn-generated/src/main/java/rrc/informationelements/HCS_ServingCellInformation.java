...
/**
 * Define the ASN1 Type HCS_ServingCellInformation from ASN1 Module InformationElements.
 * @see Sequence
 */

public class HCS_ServingCellInformation extends Sequence {
    
    /**
     * The default constructor.
     */
    public HCS_ServingCellInformation()
    {
    }
     ...
     */
    public HCS_ServingCellInformation(HCS_PRIO hcs_PRIO, Q_HCS q_HCS, 
		    T_CRMax t_CR_Max)
    {
	setHcs_PRIO(hcs_PRIO);
	setQ_HCS(q_HCS);
	setT_CR_Max(t_CR_Max);
    }
    ...
    // Methods for field "t_CR_Max"
    public T_CRMax getT_CR_Max()
    {
	return (T_CRMax)mComponents[2];
    }
    
    public void setT_CR_Max(T_CRMax t_CR_Max)
    {
	mComponents[2] = t_CR_Max;
    }
    
    public boolean hasT_CR_Max()
    {
	return componentIsPresent(2);
    }
    
    public void deleteT_CR_Max()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HCS_ServingCellInformation object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HCS_ServingCellInformation object.
     */
...
} // End class definition for HCS_ServingCellInformation
