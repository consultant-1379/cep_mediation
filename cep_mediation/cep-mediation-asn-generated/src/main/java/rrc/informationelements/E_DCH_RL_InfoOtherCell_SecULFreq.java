...
/**
 * Define the ASN1 Type E_DCH_RL_InfoOtherCell_SecULFreq from ASN1 Module InformationElements.
 * @see Sequence
 */

public class E_DCH_RL_InfoOtherCell_SecULFreq extends Sequence {
    
    /**
     * The default constructor.
     */
    public E_DCH_RL_InfoOtherCell_SecULFreq()
    {
    }
     ...
     */
    public E_DCH_RL_InfoOtherCell_SecULFreq(PrimaryCPICH_Info primaryCPICH_Info, 
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		...
		"E_DCH_RL_InfoOtherCell_SecULFreq$E_RGCH_Info"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' E_DCH_RL_InfoOtherCell_SecULFreq object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' E_DCH_RL_InfoOtherCell_SecULFreq object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for E_DCH_RL_InfoOtherCell_SecULFreq
