...
/**
 * Define the ASN1 Type NewInterFreqCellSI_HCS_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterFreqCellSI_HCS_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterFreqCellSI_HCS_RSCP()
    {
    }
     ...
     */
    public NewInterFreqCellSI_HCS_RSCP(InterFreqCellID interFreqCellID, 
		    FrequencyInfo frequencyInfo, CellInfoSI_HCS_RSCP cellInfo)
    {
     ...
     */
    public NewInterFreqCellSI_HCS_RSCP(CellInfoSI_HCS_RSCP cellInfo)
    {
	setCellInfo(cellInfo);
    }
	...
	mComponents[2] = new CellInfoSI_HCS_RSCP();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new CellInfoSI_HCS_RSCP();
	    default:
    ...
    public CellInfoSI_HCS_RSCP getCellInfo()
    {
	return (CellInfoSI_HCS_RSCP)mComponents[2];
    }
    
    public void setCellInfo(CellInfoSI_HCS_RSCP cellInfo)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_HCS_RSCP object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterFreqCellSI_HCS_RSCP object.
     */
...
} // End class definition for NewInterFreqCellSI_HCS_RSCP
