...
/**
 * Define the ASN1 Type DL_InformationPerRL_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_InformationPerRL_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_InformationPerRL_r4()
    {
    }
     ...
     */
    public DL_InformationPerRL_r4(ModeSpecificInfo modeSpecificInfo, 
		    DL_DPCH_InfoPerRL_r4 dl_DPCH_InfoPerRL, 
	...
	mComponents[1] = new DL_DPCH_InfoPerRL_r4();
	...
	switch (index) {
	    ...
	    case 1:
		return new DL_DPCH_InfoPerRL_r4();
	    case 2:
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "DL_InformationPerRL_r4$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_InformationPerRL_r4$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public DL_DPCH_InfoPerRL_r4 getDl_DPCH_InfoPerRL()
    {
	return (DL_DPCH_InfoPerRL_r4)mComponents[1];
    }
    
    public void setDl_DPCH_InfoPerRL(DL_DPCH_InfoPerRL_r4 dl_DPCH_InfoPerRL)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_InformationPerRL_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_InformationPerRL_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_InformationPerRL_r4
