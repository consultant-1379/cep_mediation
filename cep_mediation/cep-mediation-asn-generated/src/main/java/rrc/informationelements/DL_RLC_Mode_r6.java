...
/**
 * Define the ASN1 Type DL_RLC_Mode_r6 from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_RLC_Mode_r6 extends Choice {
    
    /**
     * The default constructor.
     */
    public DL_RLC_Mode_r6()
    {
    }
    ...
    public static DL_RLC_Mode_r6 createDL_RLC_Mode_r6WithDl_AM_RLC_Mode(DL_AM_RLC_Mode_r5 dl_AM_RLC_Mode)
    {
	DL_RLC_Mode_r6 __object = new DL_RLC_Mode_r6();
    ...
    public static DL_RLC_Mode_r6 createDL_RLC_Mode_r6WithDl_UM_RLC_Mode(DL_UM_RLC_Mode_r6 dl_UM_RLC_Mode)
    {
	DL_RLC_Mode_r6 __object = new DL_RLC_Mode_r6();
    ...
    public static DL_RLC_Mode_r6 createDL_RLC_Mode_r6WithDl_TM_RLC_Mode(DL_TM_RLC_Mode dl_TM_RLC_Mode)
    {
	DL_RLC_Mode_r6 __object = new DL_RLC_Mode_r6();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_RLC_Mode_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_RLC_Mode_r6 object.
     */
...
} // End class definition for DL_RLC_Mode_r6
