...
/**
 * Define the ASN1 Type AccessServiceClass_TDD_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class AccessServiceClass_TDD_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public AccessServiceClass_TDD_LCR_r4()
    {
    }
     ...
     */
    public AccessServiceClass_TDD_LCR_r4(AvailableSYNC_UlCodesIndics availableSYNC_UlCodesIndics, 
		    SubchannelSize subchannelSize)
    {
	setAvailableSYNC_UlCodesIndics(availableSYNC_UlCodesIndics);
     ...
     */
    public AccessServiceClass_TDD_LCR_r4(SubchannelSize subchannelSize)
    {
	setSubchannelSize(subchannelSize);
    }
    ...
    {
	mComponents[0] = new AvailableSYNC_UlCodesIndics();
	...
	switch (index) {
	    case 0:
		return new AvailableSYNC_UlCodesIndics();
	    case 1:
    ...
    // Methods for field "availableSYNC_UlCodesIndics"
    public AvailableSYNC_UlCodesIndics getAvailableSYNC_UlCodesIndics()
    {
	return (AvailableSYNC_UlCodesIndics)mComponents[0];
    }
    
    public void setAvailableSYNC_UlCodesIndics(AvailableSYNC_UlCodesIndics availableSYNC_UlCodesIndics)
    {
	mComponents[0] = availableSYNC_UlCodesIndics;
    }
    
    public boolean hasAvailableSYNC_UlCodesIndics()
    {
	return componentIsPresent(0);
    }
    
    public void deleteAvailableSYNC_UlCodesIndics()
    {
    ...
    /**
     * Define the ASN1 Type AvailableSYNC_UlCodesIndics from ASN1 Module InformationElements.
     * @see BitString
     */
    public static class AvailableSYNC_UlCodesIndics extends BitString {
	
	/**
	 * The default constructor.
	 */
	public AvailableSYNC_UlCodesIndics()
	{
	}
	 ...
	 */
	public AvailableSYNC_UlCodesIndics(byte[] value)
	{
	    super(value);
	}
	 ...
	 */
	public AvailableSYNC_UlCodesIndics(byte[] value, int sigBits)
	{
	    super(value, sigBits);
	}
	
	// Named list definitions.
	public static final int sulCodeIndex7 = 0;
	public static final int sulCodeIndex6 = 1;
	public static final int sulCodeIndex5 = 2;
	public static final int sulCodeIndex4 = 3;
	public static final int sulCodeIndex3 = 4;
	public static final int sulCodeIndex2 = 5;
	public static final int sulCodeIndex1 = 6;
	public static final int sulCodeIndex0 = 7;
	...
	private static final BitStringInfo c_typeinfo = new BitStringInfo (
		...
		"AccessServiceClass_TDD_LCR_r4$AvailableSYNC_UlCodesIndics"
	    ),
	    new QName (
		"builtin",
		"BIT STRING"
	...
	/**
	 * Get the type descriptor (TypeInfo) of 'this' AvailableSYNC_UlCodesIndics object.
	 */
	...
	/**
	 * Get the static type descriptor (TypeInfo) of 'this' AvailableSYNC_UlCodesIndics object.
	 */
    ...
    } // End class definition for AvailableSYNC_UlCodesIndics
	...
	public static class Size2 extends Sequence {
		...
		private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"AccessServiceClass_TDD_LCR_r4$SubchannelSize$Size2$Subchannels"
		    ),
		    new QName (
			"builtin",
			"ENUMERATED"
		...
		new QName (
		    "rrc.informationelements",
		    "AccessServiceClass_TDD_LCR_r4$SubchannelSize$Size2"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Size4 extends Sequence {
		...
		private static final BitStringInfo c_typeinfo = new BitStringInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"AccessServiceClass_TDD_LCR_r4$SubchannelSize$Size4$Subchannels"
		    ),
		    new QName (
			"builtin",
			"BIT STRING"
		...
		new QName (
		    "rrc.informationelements",
		    "AccessServiceClass_TDD_LCR_r4$SubchannelSize$Size4"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Size8 extends Sequence {
		...
		private static final BitStringInfo c_typeinfo = new BitStringInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"AccessServiceClass_TDD_LCR_r4$SubchannelSize$Size8$Subchannels"
		    ),
		    new QName (
			"builtin",
			"BIT STRING"
		...
		new QName (
		    "rrc.informationelements",
		    "AccessServiceClass_TDD_LCR_r4$SubchannelSize$Size8"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"AccessServiceClass_TDD_LCR_r4$SubchannelSize"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' AccessServiceClass_TDD_LCR_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' AccessServiceClass_TDD_LCR_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for AccessServiceClass_TDD_LCR_r4
