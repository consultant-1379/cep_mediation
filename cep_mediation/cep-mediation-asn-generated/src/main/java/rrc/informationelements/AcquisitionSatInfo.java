...
/**
 * Define the ASN1 Type AcquisitionSatInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class AcquisitionSatInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public AcquisitionSatInfo()
    {
    }
     ...
     */
    public AcquisitionSatInfo(SatID satID, INTEGER doppler0thOrder, 
     ...
     */
    public AcquisitionSatInfo(SatID satID, long doppler0thOrder, 
	...
	mComponents[7] = new AzimuthAndElevation();
    }
    ...
    {
	return (AzimuthAndElevation)mComponents[7];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' AcquisitionSatInfo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' AcquisitionSatInfo object.
     */
...
} // End class definition for AcquisitionSatInfo
