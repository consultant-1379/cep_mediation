...
/**
 * Define the ASN1 Type DL_DPCH_InfoPerRL_r6 from ASN1 Module InformationElements.
 * @see Choice
 */

public class DL_DPCH_InfoPerRL_r6 extends Choice {
    
    /**
     * The default constructor.
     */
    public DL_DPCH_InfoPerRL_r6()
    {
    }
    ...
    public static DL_DPCH_InfoPerRL_r6 createDL_DPCH_InfoPerRL_r6WithFdd(Fdd fdd)
    {
	DL_DPCH_InfoPerRL_r6 __object = new DL_DPCH_InfoPerRL_r6();
    ...
    public static DL_DPCH_InfoPerRL_r6 createDL_DPCH_InfoPerRL_r6WithTdd(Tdd tdd)
    {
	DL_DPCH_InfoPerRL_r6 __object = new DL_DPCH_InfoPerRL_r6();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL_r6 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_DPCH_InfoPerRL_r6 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_DPCH_InfoPerRL_r6
