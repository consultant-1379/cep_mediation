...
/**
 * Define the ASN1 Type UE_ConnTimersAndConstants_r5 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_ConnTimersAndConstants_r5 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_ConnTimersAndConstants_r5()
    {
    }
     ...
     */
    public UE_ConnTimersAndConstants_r5(T_301 t_301, N_301 n_301, T_302 t_302, 
		    N_302 n_302, T_304 t_304, N_304 n_304, T_305 t_305, 
		    T_307 t_307, T_308 t_308, T_309 t_309, T_310 t_310, 
		    N_310 n_310, T_311 t_311, T_312 t_312, N_312_r5 n_312, 
		    T_313 t_313, N_313 n_313, T_314 t_314, T_315 t_315, 
		    N_315_r5 n_315, T_316 t_316, T_317 t_317)
    {
	setT_301(t_301);
	setN_301(n_301);
	setT_302(t_302);
	...
	new T_312(1);
    public static final N_312_r5 n_312__default = 
	N_312_r5.s1;
	...
	T_315.s180;
    public static final N_315_r5 n_315__default = 
	N_315_r5.s1;
    ...
    public N_312_r5 getN_312()
    {
	if (hasN_312())
	    return (N_312_r5)mComponents[14];
	else
	    return (N_312_r5)n_312__default.clone();
    }
    
    public void setN_312(N_312_r5 n_312)
    {
    ...
    public N_315_r5 getN_315()
    {
	if (hasN_315())
	    return (N_315_r5)mComponents[19];
	else
	    return (N_315_r5)n_315__default.clone();
    }
    
    public void setN_315(N_315_r5 n_315)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_ConnTimersAndConstants_r5 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_ConnTimersAndConstants_r5 object.
     */
...
} // End class definition for UE_ConnTimersAndConstants_r5
