...
/**
 * Define the ASN1 Type UplinkAdditionalTimeslots_VHCR from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UplinkAdditionalTimeslots_VHCR extends Sequence {
    
    /**
     * The default constructor.
     */
    public UplinkAdditionalTimeslots_VHCR()
    {
    }
     ...
     */
    public UplinkAdditionalTimeslots_VHCR(Parameters parameters)
    {
	...
	public static class SameAsLast extends Sequence {
		...
		new QName (
		    ...
		    "UplinkAdditionalTimeslots_VHCR$Parameters$SameAsLast"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class NewParameters extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UplinkAdditionalTimeslots_VHCR$Parameters$NewParameters"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UplinkAdditionalTimeslots_VHCR$Parameters"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UplinkAdditionalTimeslots_VHCR object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UplinkAdditionalTimeslots_VHCR object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UplinkAdditionalTimeslots_VHCR
