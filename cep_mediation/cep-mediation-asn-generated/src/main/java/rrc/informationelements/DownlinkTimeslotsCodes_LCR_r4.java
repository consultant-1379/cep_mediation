...
/**
 * Define the ASN1 Type DownlinkTimeslotsCodes_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DownlinkTimeslotsCodes_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DownlinkTimeslotsCodes_LCR_r4()
    {
    }
     ...
     */
    public DownlinkTimeslotsCodes_LCR_r4(IndividualTimeslotInfo_LCR_r4 firstIndividualTimeslotInfo, 
	...
	public static class AdditionalTimeslots extends Choice {
		 ...
		 */
		public TimeslotList(DownlinkAdditionalTimeslots_LCR_r4[] elements)
		{
		    super(elements);
		}
		 ...
		 */
		public synchronized void add(DownlinkAdditionalTimeslots_LCR_r4 element)
		{
		 ...
		 */
		public synchronized void set(DownlinkAdditionalTimeslots_LCR_r4 element, int atIndex)
		{
		 ...
		 */
		public synchronized DownlinkAdditionalTimeslots_LCR_r4 get(int atIndex)
		{
		    return (DownlinkAdditionalTimeslots_LCR_r4)super.getElement(atIndex);
		}
		
		/**
		 * Insert an Element into the SEQUENCE OF/SET OF.
		 */
		public synchronized void insert(DownlinkAdditionalTimeslots_LCR_r4 element, int atIndex)
		{
		 ...
		 */
		public synchronized void remove(DownlinkAdditionalTimeslots_LCR_r4 element)
		{
		...
		{
		    return (AbstractData)new DownlinkAdditionalTimeslots_LCR_r4();
		}
		...
		private static final ContainerInfo c_typeinfo = new ContainerInfo (
			...
			"DownlinkTimeslotsCodes_LCR_r4$MoreTimeslots$AdditionalTimeslots$TimeslotList"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE OF"
			...
			new QName (
			    "rrc.informationelements",
			    "DownlinkAdditionalTimeslots_LCR_r4"
			)
		    )
		);
		...
		new QName (
		    "rrc.informationelements",
		    "DownlinkTimeslotsCodes_LCR_r4$MoreTimeslots$AdditionalTimeslots"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DownlinkTimeslotsCodes_LCR_r4$MoreTimeslots"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DownlinkTimeslotsCodes_LCR_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DownlinkTimeslotsCodes_LCR_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DownlinkTimeslotsCodes_LCR_r4
