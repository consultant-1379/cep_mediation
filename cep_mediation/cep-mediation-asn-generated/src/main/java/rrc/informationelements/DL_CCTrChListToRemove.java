...
/**
 * Define the ASN1 Type DL_CCTrChListToRemove from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class DL_CCTrChListToRemove extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public DL_CCTrChListToRemove()
    {
    }
     ...
     */
    public DL_CCTrChListToRemove(TFCS_IdentityPlain[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_CCTrChListToRemove object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_CCTrChListToRemove object.
     */
...
} // End class definition for DL_CCTrChListToRemove
