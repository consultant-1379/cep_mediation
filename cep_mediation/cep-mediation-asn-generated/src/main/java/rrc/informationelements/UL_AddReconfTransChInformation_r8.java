...
/**
 * Define the ASN1 Type UL_AddReconfTransChInformation_r8 from ASN1 Module InformationElements.
 * @see Choice
 */

public class UL_AddReconfTransChInformation_r8 extends Choice {
    
    /**
     * The default constructor.
     */
    public UL_AddReconfTransChInformation_r8()
    {
    }
    ...
    public static UL_AddReconfTransChInformation_r8 createUL_AddReconfTransChInformation_r8WithDch_usch(Dch_usch dch_usch)
    {
	UL_AddReconfTransChInformation_r8 __object = new UL_AddReconfTransChInformation_r8();
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
		...
		"UL_AddReconfTransChInformation_r8$Dch_usch"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    public static UL_AddReconfTransChInformation_r8 createUL_AddReconfTransChInformation_r8WithE_dch(E_dch e_dch)
    {
	UL_AddReconfTransChInformation_r8 __object = new UL_AddReconfTransChInformation_r8();
	 ...
	 * Construct with AbstractData components.
	 */
	public E_dch(Ul_MAC_HeaderType ul_MAC_HeaderType, 
			ModeSpecific modeSpecific, Harq_Info harq_Info, 
			E_DCH_AddReconf_MAC_d_FlowList_r7 addReconf_MAC_d_FlowList)
	{
	    setUl_MAC_HeaderType(ul_MAC_HeaderType);
	...
	public void initComponents()
	{
	    mComponents[0] = Ul_MAC_HeaderType.mac_iis;
	    mComponents[1] = new ModeSpecific();
	    mComponents[2] = Harq_Info.rv0;
	    mComponents[3] = new E_DCH_AddReconf_MAC_d_FlowList_r7();
	}
	...
	public AbstractData createInstance(int index)
	{
	    switch (index) {
		case 0:
		    return Ul_MAC_HeaderType.mac_iis;
		case 1:
	...
	// Methods for field "ul_MAC_HeaderType"
	public Ul_MAC_HeaderType getUl_MAC_HeaderType()
	{
	    return (Ul_MAC_HeaderType)mComponents[0];
	}
	
	public void setUl_MAC_HeaderType(Ul_MAC_HeaderType ul_MAC_HeaderType)
	{
	    mComponents[0] = ul_MAC_HeaderType;
	}
	
	public boolean hasUl_MAC_HeaderType()
	{
	    return componentIsPresent(0);
	}
	
	public void deleteUl_MAC_HeaderType()
	{
	...
	/**
	 * Define the ASN1 Type Ul_MAC_HeaderType from ASN1 Module InformationElements.
	 * @see Enumerated
	 */
	public static final class Ul_MAC_HeaderType extends Enumerated {
	    
	    /**
	     * The default constructor.
	     */
	    private Ul_MAC_HeaderType()
	    {
		super(cFirstNumber);
	    }
	    
	    protected Ul_MAC_HeaderType(long value)
	    {
		super(value);
	    }
	    
	    // Named list definitions.
	    public static final Ul_MAC_HeaderType mac_iis =
		new Ul_MAC_HeaderType(0);
	    private final static Ul_MAC_HeaderType cNamedNumbers[] = {
		 mac_iis
	    };
	    ...
	    public static Ul_MAC_HeaderType valueOf(long value)
	    {
		return (Ul_MAC_HeaderType)mac_iis.lookupValue(value);
	    }
		...
		new QName (
		    "rrc.informationelements",
		    "UL_AddReconfTransChInformation_r8$E_dch$Ul_MAC_HeaderType"
		),
		new QName (
		    "builtin",
		    "ENUMERATED"
	    ...
	    /**
	     * Get the type descriptor (TypeInfo) of 'this' Ul_MAC_HeaderType object.
	     */
	    public TypeInfo getTypeInfo()
	    {
		return c_typeinfo;
	    ...
	    /**
	     * Get the static type descriptor (TypeInfo) of 'this' Ul_MAC_HeaderType object.
	     */
	    public static TypeInfo getStaticTypeInfo()
	    {
		return c_typeinfo;
	...
	public static class ModeSpecific extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"UL_AddReconfTransChInformation_r8$E_dch$ModeSpecific$Fdd"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "UL_AddReconfTransChInformation_r8$E_dch$ModeSpecific"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	{
	    return (Harq_Info)mComponents[2];
	}
	
	public void setHarq_Info(Harq_Info harq_Info)
	{
	    mComponents[2] = harq_Info;
	}
	...
	public static final class Harq_Info extends Enumerated {
		...
		new QName (
		    "rrc.informationelements",
		    "UL_AddReconfTransChInformation_r8$E_dch$Harq_Info"
		),
		new QName (
		    "builtin",
		    "ENUMERATED"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UL_AddReconfTransChInformation_r8$E_dch"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_AddReconfTransChInformation_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_AddReconfTransChInformation_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_AddReconfTransChInformation_r8
