...
/**
 * Define the ASN1 Type CellSelectReselectInfoMC_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellSelectReselectInfoMC_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellSelectReselectInfoMC_RSCP()
    {
    }
     ...
     */
    public CellSelectReselectInfoMC_RSCP(Q_OffsetS_N q_OffsetS_N, 
     ...
     */
    public CellSelectReselectInfoMC_RSCP(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellSelectReselectInfoMC_RSCP$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellSelectReselectInfoMC_RSCP$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Gsm extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellSelectReselectInfoMC_RSCP$ModeSpecificInfo$Gsm"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CellSelectReselectInfoMC_RSCP$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellSelectReselectInfoMC_RSCP object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellSelectReselectInfoMC_RSCP object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellSelectReselectInfoMC_RSCP
