...
/**
 * Define the ASN1 Type PDSCH_SysInfoList_SFN from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PDSCH_SysInfoList_SFN extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PDSCH_SysInfoList_SFN()
    {
    }
     ...
     */
    public PDSCH_SysInfoList_SFN(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(PDSCH_SysInfo pdsch_SysInfo, 
	...
	{
	    mComponents[0] = new PDSCH_SysInfo();
	...
	public PDSCH_SysInfo getPdsch_SysInfo()
	{
	    return (PDSCH_SysInfo)mComponents[0];
	}
	
	public void setPdsch_SysInfo(PDSCH_SysInfo pdsch_SysInfo)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_SysInfoList_SFN object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_SysInfoList_SFN object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDSCH_SysInfoList_SFN
