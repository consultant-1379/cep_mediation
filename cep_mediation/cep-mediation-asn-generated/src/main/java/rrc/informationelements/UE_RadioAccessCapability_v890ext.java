...
/**
 * Define the ASN1 Type UE_RadioAccessCapability_v890ext from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_RadioAccessCapability_v890ext extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_RadioAccessCapability_v890ext()
    {
    }
     ...
     */
    public UE_RadioAccessCapability_v890ext(SupportCellSpecificTxDiversityinDC_Operation supportCellSpecificTxDiversityinDC_Operation)
    {
	...
	new QName (
	    "rrc.informationelements",
	    "UE_RadioAccessCapability_v890ext"
	),
	new QName (
	    "InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_RadioAccessCapability_v890ext object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_RadioAccessCapability_v890ext object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_RadioAccessCapability_v890ext
