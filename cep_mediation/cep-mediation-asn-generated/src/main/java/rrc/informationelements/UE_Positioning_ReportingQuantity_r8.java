...
/**
 * Define the ASN1 Type UE_Positioning_ReportingQuantity_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_ReportingQuantity_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_ReportingQuantity_r8()
    {
    }
     ...
     */
    public UE_Positioning_ReportingQuantity_r8(UE_Positioning_MethodType methodType, 
		    ...
		    BitString gANSSPositioningMethods, 
		    BitString gANSSTimingOfCellWanted, 
		    BitString gANSSCarrierPhaseMeasurementRequested, 
		    BitString gANSSMultiFreqMeasurementRequested)
    {
	...
	setVelocityRequested(velocityRequested);
	setGANSSPositioningMethods(gANSSPositioningMethods);
	setGANSSTimingOfCellWanted(gANSSTimingOfCellWanted);
	setGANSSCarrierPhaseMeasurementRequested(gANSSCarrierPhaseMeasurementRequested);
	setGANSSMultiFreqMeasurementRequested(gANSSMultiFreqMeasurementRequested);
    }
	...
	this(methodType, positioningMethod, horizontalAccuracy, 
	     ...
	     environmentCharacterisation, velocityRequested, 
	     gANSSPositioningMethods, gANSSTimingOfCellWanted, 
	...
	mComponents[7] = VelocityRequested._true;
	...
	switch (index) {
	    ...
	    case 7:
		return VelocityRequested._true;
	    case 8:
    ...
    public void deleteVelocityRequested()
    {
    ...
    /**
     * Define the ASN1 Type VelocityRequested from ASN1 Module InformationElements.
     * @see Enumerated
     */
    public static final class VelocityRequested extends Enumerated {
	
	/**
	 * The default constructor.
	 */
	private VelocityRequested()
	{
	    super(cFirstNumber);
	}
	
	protected VelocityRequested(long value)
	{
	    super(value);
	}
	
	// Named list definitions.
	public static final VelocityRequested _true =
	    new VelocityRequested(0);
	private final static VelocityRequested cNamedNumbers[] = {
	     _true
	};
	...
	public static VelocityRequested valueOf(long value)
	{
	    return (VelocityRequested)_true.lookupValue(value);
	}
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"UE_Positioning_ReportingQuantity_r8$VelocityRequested"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	/**
	 * Get the type descriptor (TypeInfo) of 'this' VelocityRequested object.
	 */
	...
	/**
	 * Get the static type descriptor (TypeInfo) of 'this' VelocityRequested object.
	 */
    ...
    } // End class definition for VelocityRequested

    // Methods for field "gANSSPositioningMethods"
    public BitString getGANSSPositioningMethods()
    {
	return (BitString)mComponents[8];
    }
    
    public void setGANSSPositioningMethods(BitString gANSSPositioningMethods)
    {
	mComponents[8] = gANSSPositioningMethods;
    }
    
    public boolean hasGANSSPositioningMethods()
    {
	return componentIsPresent(8);
    }
    
    public void deleteGANSSPositioningMethods()
    {
	setComponentAbsent(8);
    }
    
    
    // Methods for field "gANSSTimingOfCellWanted"
    public BitString getGANSSTimingOfCellWanted()
    {
	return (BitString)mComponents[9];
    }
    
    public void setGANSSTimingOfCellWanted(BitString gANSSTimingOfCellWanted)
    {
	mComponents[9] = gANSSTimingOfCellWanted;
    }
    
    public boolean hasGANSSTimingOfCellWanted()
    {
	return componentIsPresent(9);
    }
    
    public void deleteGANSSTimingOfCellWanted()
    {
	setComponentAbsent(9);
    }
    
    
    // Methods for field "gANSSCarrierPhaseMeasurementRequested"
    public BitString getGANSSCarrierPhaseMeasurementRequested()
    {
	return (BitString)mComponents[10];
    }
    
    public void setGANSSCarrierPhaseMeasurementRequested(BitString gANSSCarrierPhaseMeasurementRequested)
    {
	mComponents[10] = gANSSCarrierPhaseMeasurementRequested;
    }
    
    public boolean hasGANSSCarrierPhaseMeasurementRequested()
    {
	return componentIsPresent(10);
    }
    
    public void deleteGANSSCarrierPhaseMeasurementRequested()
    {
	setComponentAbsent(10);
    }
    
    
    // Methods for field "gANSSMultiFreqMeasurementRequested"
    public BitString getGANSSMultiFreqMeasurementRequested()
    {
	return (BitString)mComponents[11];
    }
    
    public void setGANSSMultiFreqMeasurementRequested(BitString gANSSMultiFreqMeasurementRequested)
    {
	mComponents[11] = gANSSMultiFreqMeasurementRequested;
    }
    
    public boolean hasGANSSMultiFreqMeasurementRequested()
    {
	return componentIsPresent(11);
    }
    
    public void deleteGANSSMultiFreqMeasurementRequested()
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_ReportingQuantity_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_ReportingQuantity_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_ReportingQuantity_r8
