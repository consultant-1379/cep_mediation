...
/**
 * Define the ASN1 Type IntraFrequencyMeasurement_r6 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFrequencyMeasurement_r6 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFrequencyMeasurement_r6()
    {
    }
     ...
     */
    public IntraFrequencyMeasurement_r6(IntraFreqCellInfoList_r4 intraFreqCellInfoList, 
		    ...
		    IntraFreqReportCriteria_r6 reportCriteria)
    {
     ...
     */
    public IntraFrequencyMeasurement_r6(IntraFreqReportCriteria_r6 reportCriteria)
    {
	setReportCriteria(reportCriteria);
    }
	...
	switch (index) {
	    case 0:
		return new IntraFreqCellInfoList_r4();
	    case 1:
	    ...
	    case 4:
		return new IntraFreqReportCriteria_r6();
	    default:
    ...
    public IntraFreqCellInfoList_r4 getIntraFreqCellInfoList()
    {
	return (IntraFreqCellInfoList_r4)mComponents[0];
    }
    
    public void setIntraFreqCellInfoList(IntraFreqCellInfoList_r4 intraFreqCellInfoList)
    {
    ...
    public IntraFreqReportCriteria_r6 getReportCriteria()
    {
	return (IntraFreqReportCriteria_r6)mComponents[4];
    }
    
    public void setReportCriteria(IntraFreqReportCriteria_r6 reportCriteria)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r6 object.
     */
...
} // End class definition for IntraFrequencyMeasurement_r6
