...
/**
 * Define the ASN1 Type PLMNsOfInterRATCellsList from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PLMNsOfInterRATCellsList extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PLMNsOfInterRATCellsList()
    {
    }
     ...
     */
    public PLMNsOfInterRATCellsList(Sequence_[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PLMNsOfInterRATCellsList object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PLMNsOfInterRATCellsList object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PLMNsOfInterRATCellsList
