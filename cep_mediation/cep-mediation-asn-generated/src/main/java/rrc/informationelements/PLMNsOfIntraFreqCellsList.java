...
/**
 * Define the ASN1 Type PLMNsOfIntraFreqCellsList from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PLMNsOfIntraFreqCellsList extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PLMNsOfIntraFreqCellsList()
    {
    }
     ...
     */
    public PLMNsOfIntraFreqCellsList(Sequence_[] elements)
    {
	super(elements);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PLMNsOfIntraFreqCellsList object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PLMNsOfIntraFreqCellsList object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PLMNsOfIntraFreqCellsList
