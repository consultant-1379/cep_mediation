...
/**
 * Define the ASN1 Type PRACH_Definition_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PRACH_Definition_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PRACH_Definition_LCR_r4()
    {
    }
     ...
     */
    public PRACH_Definition_LCR_r4(TimeslotNumber_PRACH_LCR_r4 timeslot, 
		    PRACH_ChanCodes_LCR_r4 prach_ChanCodes_LCR, 
		    MidambleShiftAndBurstType_LCR_r4 midambleShiftAndBurstType, 
		    FPACH_Info_r4 fpach_Info)
    {
	setTimeslot(timeslot);
	setPrach_ChanCodes_LCR(prach_ChanCodes_LCR);
	...
	mComponents[1] = new PRACH_ChanCodes_LCR_r4();
	...
	switch (index) {
	    ...
	    case 1:
		return new PRACH_ChanCodes_LCR_r4();
	    case 2:
    ...
    // Methods for field "prach_ChanCodes_LCR"
    public PRACH_ChanCodes_LCR_r4 getPrach_ChanCodes_LCR()
    {
	return (PRACH_ChanCodes_LCR_r4)mComponents[1];
    }
    
    public void setPrach_ChanCodes_LCR(PRACH_ChanCodes_LCR_r4 prach_ChanCodes_LCR)
    {
	mComponents[1] = prach_ChanCodes_LCR;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PRACH_Definition_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PRACH_Definition_LCR_r4 object.
     */
...
} // End class definition for PRACH_Definition_LCR_r4
