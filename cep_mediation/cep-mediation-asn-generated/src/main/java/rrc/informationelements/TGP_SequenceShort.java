...
/**
 * Define the ASN1 Type TGP_SequenceShort from ASN1 Module InformationElements.
 * @see Sequence
 */

public class TGP_SequenceShort extends Sequence {
    
    /**
     * The default constructor.
     */
    public TGP_SequenceShort()
    {
    }
     ...
     */
    public TGP_SequenceShort(TGPSI tgpsi, Tgps_Status tgps_Status)
    {
	setTgpsi(tgpsi);
	...
	public static class Activate extends Sequence {
		...
		new QName (
		    ...
		    "TGP_SequenceShort$Tgps_Status$Activate"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TGP_SequenceShort object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TGP_SequenceShort object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TGP_SequenceShort
