...
/**
 * Define the ASN1 Type CellInfoSI_HCS_RSCP from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellInfoSI_HCS_RSCP extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellInfoSI_HCS_RSCP()
    {
    }
     ...
     */
    public CellInfoSI_HCS_RSCP(CellIndividualOffset cellIndividualOffset, 
     ...
     */
    public CellInfoSI_HCS_RSCP(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	mComponents[3] = new CellSelectReselectInfoSIB_11_12_HCS_RSCP();
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellInfoSI_HCS_RSCP$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellInfoSI_HCS_RSCP$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CellInfoSI_HCS_RSCP$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (CellSelectReselectInfoSIB_11_12_HCS_RSCP)mComponents[3];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellInfoSI_HCS_RSCP object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellInfoSI_HCS_RSCP object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellInfoSI_HCS_RSCP
