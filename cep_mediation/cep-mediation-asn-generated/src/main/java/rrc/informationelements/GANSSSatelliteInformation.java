...
/**
 * Define the ASN1 Type GANSSSatelliteInformation from ASN1 Module InformationElements.
 * @see Sequence
 */

public class GANSSSatelliteInformation extends Sequence {
    
    /**
     * The default constructor.
     */
    public GANSSSatelliteInformation()
    {
    }
     ...
     */
    public GANSSSatelliteInformation(INTEGER ganssSatId, 
		    ...
		    AzimuthAndElevation azimuthandElevation)
    {
     ...
     */
    public GANSSSatelliteInformation(long ganssSatId, long dopplerZeroOrder, 
		    ExtraDoppler extraDoppler, long codePhase, 
	...
	mComponents[6] = new AzimuthAndElevation();
    }
    ...
    public AzimuthAndElevation getAzimuthandElevation()
    {
	return (AzimuthAndElevation)mComponents[6];
    }
    
    public void setAzimuthandElevation(AzimuthAndElevation azimuthandElevation)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' GANSSSatelliteInformation object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' GANSSSatelliteInformation object.
     */
...
} // End class definition for GANSSSatelliteInformation
