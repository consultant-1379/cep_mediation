...
/**
 * Define the ASN1 Type Event1d from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event1d extends Sequence {
     ...
     */
    public Event1d(TriggeringCondition2 triggeringCondition, BOOLEAN useCIO)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event1d object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event1d object.
     */
...
} // End class definition for Event1d
