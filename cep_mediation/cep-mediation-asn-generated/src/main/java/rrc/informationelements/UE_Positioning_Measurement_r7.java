...
/**
 * Define the ASN1 Type UE_Positioning_Measurement_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_Measurement_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_Measurement_r7()
    {
    }
     ...
     */
    public UE_Positioning_Measurement_r7(UE_Positioning_ReportingQuantity_r7 ue_positioning_ReportingQuantity, 
		    ...
		    UE_Positioning_GANSS_AssistanceData ue_positioning_GANSS_AssistanceData)
    {
    ...
    {
	mComponents[0] = new UE_Positioning_ReportingQuantity_r7();
	...
	mComponents[5] = new UE_Positioning_GANSS_AssistanceData();
    }
	...
	switch (index) {
	    case 0:
		return new UE_Positioning_ReportingQuantity_r7();
	    case 1:
	    ...
	    case 5:
		return new UE_Positioning_GANSS_AssistanceData();
	    default:
    ...
    public UE_Positioning_ReportingQuantity_r7 getUe_positioning_ReportingQuantity()
    {
	return (UE_Positioning_ReportingQuantity_r7)mComponents[0];
    }
    
    public void setUe_positioning_ReportingQuantity(UE_Positioning_ReportingQuantity_r7 ue_positioning_ReportingQuantity)
    {
    ...
    public UE_Positioning_GANSS_AssistanceData getUe_positioning_GANSS_AssistanceData()
    {
	return (UE_Positioning_GANSS_AssistanceData)mComponents[5];
    }
    
    public void setUe_positioning_GANSS_AssistanceData(UE_Positioning_GANSS_AssistanceData ue_positioning_GANSS_AssistanceData)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_Measurement_r7 object.
     */
...
} // End class definition for UE_Positioning_Measurement_r7
