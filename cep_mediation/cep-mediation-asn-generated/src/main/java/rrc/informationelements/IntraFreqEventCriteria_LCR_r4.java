...
/**
 * Define the ASN1 Type IntraFreqEventCriteria_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqEventCriteria_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqEventCriteria_LCR_r4()
    {
    }
     ...
     */
    public IntraFreqEventCriteria_LCR_r4(IntraFreqEvent_LCR_r4 event, 
    ...
    {
	mComponents[0] = new IntraFreqEvent_LCR_r4();
	...
	switch (index) {
	    case 0:
		return new IntraFreqEvent_LCR_r4();
	    case 1:
    ...
    public IntraFreqEvent_LCR_r4 getEvent()
    {
	return (IntraFreqEvent_LCR_r4)mComponents[0];
    }
    
    public void setEvent(IntraFreqEvent_LCR_r4 event)
    {
	mComponents[0] = event;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqEventCriteria_LCR_r4 object.
     */
...
} // End class definition for IntraFreqEventCriteria_LCR_r4
