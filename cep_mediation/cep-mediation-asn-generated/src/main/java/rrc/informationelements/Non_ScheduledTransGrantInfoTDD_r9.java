...
/**
 * Define the ASN1 Type Non_ScheduledTransGrantInfoTDD_r9 from ASN1 Module InformationElements.
 * @see Choice
 */

public class Non_ScheduledTransGrantInfoTDD_r9 extends Choice {
    
    /**
     * The default constructor.
     */
    public Non_ScheduledTransGrantInfoTDD_r9()
    {
    }
    ...
    public static Non_ScheduledTransGrantInfoTDD_r9 createNon_ScheduledTransGrantInfoTDD_r9WithTdd384_768(Tdd384_768 tdd384_768)
    {
	Non_ScheduledTransGrantInfoTDD_r9 __object = new Non_ScheduledTransGrantInfoTDD_r9();
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
		...
		"Non_ScheduledTransGrantInfoTDD_r9$Tdd384_768"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    public static Non_ScheduledTransGrantInfoTDD_r9 createNon_ScheduledTransGrantInfoTDD_r9WithTdd128(Tdd128 tdd128)
    {
	Non_ScheduledTransGrantInfoTDD_r9 __object = new Non_ScheduledTransGrantInfoTDD_r9();
	...
	public Tdd128(INTEGER n_E_UCCH, INTEGER n_E_HICH, 
			...
			RepetitionPeriodAndLength repetitionPeriodAndLength, 
			UL_TS_ChannelisationCode codeResourceInfo, 
			E_HICH_Info e_HICH_Info, T_SI_nst t_SI_nst)
	{
			...
			E_HICH_Info e_HICH_Info, T_SI_nst t_SI_nst)
	{
	    this(new INTEGER(n_E_UCCH), new INTEGER(n_E_HICH), 
		 ...
		 codeResourceInfo, e_HICH_Info, t_SI_nst);
	}
	...
	public void initComponents()
	{
	    ...
	    mComponents[9] = T_SI_nst.everyEDCHTTI;
	}
	...
	public static class E_HICH_Info extends Sequence {
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"Non_ScheduledTransGrantInfoTDD_r9$Tdd128$E_HICH_Info$MidambleAllocationMode"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "Non_ScheduledTransGrantInfoTDD_r9$Tdd128$E_HICH_Info"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	{
	    return (T_SI_nst)mComponents[9];
	}
	
	public void setT_SI_nst(T_SI_nst t_SI_nst)
	{
	    mComponents[9] = t_SI_nst;
	}
	...
	public static final class T_SI_nst extends Enumerated {
		...
		new QName (
		    "rrc.informationelements",
		    "Non_ScheduledTransGrantInfoTDD_r9$Tdd128$T_SI_nst"
		),
		new QName (
		    "builtin",
		    "ENUMERATED"
	...
	private static final SequenceInfo c_typeinfo = new SequenceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"Non_ScheduledTransGrantInfoTDD_r9$Tdd128"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Non_ScheduledTransGrantInfoTDD_r9 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Non_ScheduledTransGrantInfoTDD_r9 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for Non_ScheduledTransGrantInfoTDD_r9
