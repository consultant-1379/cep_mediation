...
/**
 * Define the ASN1 Type DGANSSInfo_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DGANSSInfo_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DGANSSInfo_r9()
    {
    }
     ...
     */
    public DGANSSInfo_r9(GANSS_Signal_Id ganssSignalId, 
		    GANSS_Status_Health ganssStatusHealth, 
		    DGANSSSignalInformationList_r9 dgansssignalInformationList)
    {
     ...
     */
    public DGANSSInfo_r9(GANSS_Status_Health ganssStatusHealth)
    {
	setGanssStatusHealth(ganssStatusHealth);
    }
	...
	mComponents[2] = new DGANSSSignalInformationList_r9();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new DGANSSSignalInformationList_r9();
	    default:
    ...
    public DGANSSSignalInformationList_r9 getDgansssignalInformationList()
    {
	return (DGANSSSignalInformationList_r9)mComponents[2];
    }
    
    public void setDgansssignalInformationList(DGANSSSignalInformationList_r9 dgansssignalInformationList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DGANSSInfo_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DGANSSInfo_r9 object.
     */
...
} // End class definition for DGANSSInfo_r9
