...
/**
 * Define the ASN1 Type CellInfoSI_ECN0 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class CellInfoSI_ECN0 extends Sequence {
    
    /**
     * The default constructor.
     */
    public CellInfoSI_ECN0()
    {
    }
     ...
     */
    public CellInfoSI_ECN0(CellIndividualOffset cellIndividualOffset, 
		    ReferenceTimeDifferenceToCell referenceTimeDifferenceToCell, 
		    ModeSpecificInfo modeSpecificInfo, 
		    CellSelectReselectInfoSIB_11_12_ECN0 cellSelectionReselectionInfo)
    {
     ...
     */
    public CellInfoSI_ECN0(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	mComponents[3] = new CellSelectReselectInfoSIB_11_12_ECN0();
    }
	...
	switch (index) {
	    ...
	    case 3:
		return new CellSelectReselectInfoSIB_11_12_ECN0();
	    default:
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "CellInfoSI_ECN0$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "CellInfoSI_ECN0$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"CellInfoSI_ECN0$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    public CellSelectReselectInfoSIB_11_12_ECN0 getCellSelectionReselectionInfo()
    {
	return (CellSelectReselectInfoSIB_11_12_ECN0)mComponents[3];
    }
    
    public void setCellSelectionReselectionInfo(CellSelectReselectInfoSIB_11_12_ECN0 cellSelectionReselectionInfo)
    {
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"CellSelectReselectInfoSIB_11_12_ECN0"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' CellInfoSI_ECN0 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' CellInfoSI_ECN0 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for CellInfoSI_ECN0
