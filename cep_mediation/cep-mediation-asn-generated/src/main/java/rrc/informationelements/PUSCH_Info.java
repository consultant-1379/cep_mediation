...
/**
 * Define the ASN1 Type PUSCH_Info from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PUSCH_Info extends Sequence {
     ...
     */
    public PUSCH_Info(TFCS_IdentityPlain tfcs_ID, 
		    CommonTimeslotInfo commonTimeslotInfo, 
		    UplinkTimeslotsCodes pusch_TimeslotsCodes)
    {
	setTfcs_ID(tfcs_ID);
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_Info object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_Info object.
     */
...
} // End class definition for PUSCH_Info
