...
/**
 * Define the ASN1 Type Event2f from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event2f extends Sequence {
     ...
     */
    public Event2f(Threshold usedFreqThreshold, W usedFreqW, 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event2f object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event2f object.
     */
...
} // End class definition for Event2f
