...
/**
 * Define the ASN1 Type Serving_HSDSCH_CellInformation_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Serving_HSDSCH_CellInformation_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public Serving_HSDSCH_CellInformation_r7()
    {
    }
     ...
     */
    public Serving_HSDSCH_CellInformation_r7(DeltaACK deltaACK, 
		    DeltaNACK deltaNACK, 
		    HARQ_Preamble_Mode harq_Preamble_Mode, 
		    PrimaryCPICH_Info primaryCPICH_Info, 
		    DL_HSPDSCH_Information_r7 dl_hspdsch_Information, 
     ...
     */
    public Serving_HSDSCH_CellInformation_r7(HARQ_Preamble_Mode harq_Preamble_Mode)
    {
	setHarq_Preamble_Mode(harq_Preamble_Mode);
    }
	...
	mComponents[4] = new DL_HSPDSCH_Information_r7();
	...
	switch (index) {
	    ...
	    case 4:
		return new DL_HSPDSCH_Information_r7();
	    case 5:
    ...
    public DL_HSPDSCH_Information_r7 getDl_hspdsch_Information()
    {
	return (DL_HSPDSCH_Information_r7)mComponents[4];
    }
    
    public void setDl_hspdsch_Information(DL_HSPDSCH_Information_r7 dl_hspdsch_Information)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"Serving_HSDSCH_CellInformation_r7$Mac_hsResetIndicator"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Serving_HSDSCH_CellInformation_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Serving_HSDSCH_CellInformation_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for Serving_HSDSCH_CellInformation_r7
