...
/**
 * Define the ASN1 Type NewInterFreqCell from ASN1 Module InformationElements.
 * @see Sequence
 */

public class NewInterFreqCell extends Sequence {
    
    /**
     * The default constructor.
     */
    public NewInterFreqCell()
    {
    }
     ...
     */
    public NewInterFreqCell(InterFreqCellID interFreqCellID, 
		    FrequencyInfo frequencyInfo, CellInfo cellInfo)
    {
     ...
     */
    public NewInterFreqCell(CellInfo cellInfo)
    {
	setCellInfo(cellInfo);
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NewInterFreqCell object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NewInterFreqCell object.
     */
...
} // End class definition for NewInterFreqCell
