...
/**
 * Define the ASN1 Type MultiplePLMNsOfInterFreqCellsList from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class MultiplePLMNsOfInterFreqCellsList extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public MultiplePLMNsOfInterFreqCellsList()
    {
    }
     ...
     */
    public MultiplePLMNsOfInterFreqCellsList(Sequence_[] elements)
    {
	super(elements);
    }
	...
	public static class MultiplePLMN_list extends SequenceOf {
		...
		new QName (
		    ...
		    "MultiplePLMNsOfInterFreqCellsList$Sequence_$MultiplePLMN_list"
		),
		new QName (
		    "builtin",
		    "SEQUENCE OF"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MultiplePLMNsOfInterFreqCellsList object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MultiplePLMNsOfInterFreqCellsList object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for MultiplePLMNsOfInterFreqCellsList
