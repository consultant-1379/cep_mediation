...
/**
 * Define the ASN1 Type UL_DPCH_Info_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_DPCH_Info_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UL_DPCH_Info_r4()
    {
    }
     ...
     */
    public UL_DPCH_Info_r4(UL_DPCH_PowerControlInfo_r4 ul_DPCH_PowerControlInfo, 
     ...
     */
    public UL_DPCH_Info_r4(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
    ...
    {
	mComponents[0] = new UL_DPCH_PowerControlInfo_r4();
	...
	switch (index) {
	    case 0:
		return new UL_DPCH_PowerControlInfo_r4();
	    case 1:
    ...
    public UL_DPCH_PowerControlInfo_r4 getUl_DPCH_PowerControlInfo()
    {
	return (UL_DPCH_PowerControlInfo_r4)mComponents[0];
    }
    
    public void setUl_DPCH_PowerControlInfo(UL_DPCH_PowerControlInfo_r4 ul_DPCH_PowerControlInfo)
    {
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "UL_DPCH_Info_r4$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UL_DPCH_Info_r4$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UL_DPCH_Info_r4$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_DPCH_Info_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_DPCH_Info_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_DPCH_Info_r4
