...
/**
 * Define the ASN1 Type IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4()
    {
    }
     ...
     */
    public IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4(MeasurementIdentity intraFreqMeasurementID, 
		    IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4 intraFreqCellInfoSI_List, 
	...
	mComponents[1] = new IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4();
	...
	switch (index) {
	    ...
	    case 1:
		return new IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4();
	    case 2:
    ...
    public IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4 getIntraFreqCellInfoSI_List()
    {
	return (IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4)mComponents[1];
    }
    
    public void setIntraFreqCellInfoSI_List(IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4 intraFreqCellInfoSI_List)
    {
	...
	new Fields (
		...
		new SequenceFieldInfo (
			...
			new SequenceInfo (
			    ...
			    new QName (
				"rrc.informationelements",
				"IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4"
			    ),
			    new QName (
				"InformationElements",
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4 object.
     */
...
} // End class definition for IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4
