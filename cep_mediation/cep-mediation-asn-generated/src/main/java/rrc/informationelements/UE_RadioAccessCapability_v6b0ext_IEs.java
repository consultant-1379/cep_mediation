...
/**
 * Define the ASN1 Type UE_RadioAccessCapability_v6b0ext_IEs from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_RadioAccessCapability_v6b0ext_IEs extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_RadioAccessCapability_v6b0ext_IEs()
    {
    }
     ...
     */
    public UE_RadioAccessCapability_v6b0ext_IEs(SupportForSIB11bis supportForSIB11bis)
    {
    ...
    /**
     * Define the ASN1 Type SupportForSIB11bis from ASN1 Module InformationElements.
     * @see Enumerated
     */
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"UE_RadioAccessCapability_v6b0ext_IEs$SupportForSIB11bis"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_RadioAccessCapability_v6b0ext_IEs object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_RadioAccessCapability_v6b0ext_IEs object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_RadioAccessCapability_v6b0ext_IEs
