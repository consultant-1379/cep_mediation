...
/**
 * Define the ASN1 Type InterRATMeasurement from ASN1 Module InformationElements.
 * @see Sequence
 */

public class InterRATMeasurement extends Sequence {
    
    /**
     * The default constructor.
     */
    public InterRATMeasurement()
    {
    }
     ...
     */
    public InterRATMeasurement(InterRATCellInfoList interRATCellInfoList, 
     ...
     */
    public InterRATMeasurement(InterRATReportCriteria reportCriteria)
    {
	setReportCriteria(reportCriteria);
    }
    ...
    {
	mComponents[0] = new InterRATCellInfoList();
	...
	switch (index) {
	    case 0:
		return new InterRATCellInfoList();
	    case 1:
    ...
    public InterRATCellInfoList getInterRATCellInfoList()
    {
	return (InterRATCellInfoList)mComponents[0];
    }
    
    public void setInterRATCellInfoList(InterRATCellInfoList interRATCellInfoList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterRATMeasurement object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterRATMeasurement object.
     */
...
} // End class definition for InterRATMeasurement
