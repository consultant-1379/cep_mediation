...
/**
 * Define the ASN1 Type PeriodicalWithReportingCellStatus from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PeriodicalWithReportingCellStatus extends Sequence {
    
    /**
     * The default constructor.
     */
    public PeriodicalWithReportingCellStatus()
    {
    }
     ...
     */
    public PeriodicalWithReportingCellStatus(PeriodicalReportingCriteria periodicalReportingCriteria, 
	...
	mComponents[1] = new ReportingCellStatus();
    }
    ...
    {
	return (ReportingCellStatus)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PeriodicalWithReportingCellStatus object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PeriodicalWithReportingCellStatus object.
     */
...
} // End class definition for PeriodicalWithReportingCellStatus
