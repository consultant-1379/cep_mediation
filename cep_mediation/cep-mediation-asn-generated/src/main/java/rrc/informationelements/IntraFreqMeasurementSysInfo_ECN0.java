...
/**
 * Define the ASN1 Type IntraFreqMeasurementSysInfo_ECN0 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFreqMeasurementSysInfo_ECN0 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFreqMeasurementSysInfo_ECN0()
    {
    }
     ...
     */
    public IntraFreqMeasurementSysInfo_ECN0(MeasurementIdentity intraFreqMeasurementID, 
		    IntraFreqCellInfoSI_List_ECN0 intraFreqCellInfoSI_List, 
	...
	mComponents[1] = new IntraFreqCellInfoSI_List_ECN0();
	...
	switch (index) {
	    ...
	    case 1:
		return new IntraFreqCellInfoSI_List_ECN0();
	    case 2:
    ...
    public IntraFreqCellInfoSI_List_ECN0 getIntraFreqCellInfoSI_List()
    {
	return (IntraFreqCellInfoSI_List_ECN0)mComponents[1];
    }
    
    public void setIntraFreqCellInfoSI_List(IntraFreqCellInfoSI_List_ECN0 intraFreqCellInfoSI_List)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_ECN0 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFreqMeasurementSysInfo_ECN0 object.
     */
...
} // End class definition for IntraFreqMeasurementSysInfo_ECN0
