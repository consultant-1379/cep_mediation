...
/**
 * Define the ASN1 Type Event1b from ASN1 Module InformationElements.
 * @see Sequence
 */

public class Event1b extends Sequence {
     ...
     */
    public Event1b(TriggeringCondition1 triggeringCondition, 
		    ReportingRange reportingRange, 
		    ForbiddenAffectCellList forbiddenAffectCellList, W w)
    {
	...
	mComponents[2] = new ForbiddenAffectCellList();
	mComponents[3] = new W();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new ForbiddenAffectCellList();
	    case 3:
		return new W();
	    default:
    ...
    public ForbiddenAffectCellList getForbiddenAffectCellList()
    {
	return (ForbiddenAffectCellList)mComponents[2];
    }
    
    public void setForbiddenAffectCellList(ForbiddenAffectCellList forbiddenAffectCellList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Event1b object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Event1b object.
     */
...
} // End class definition for Event1b
