...
/**
 * Define the ASN1 Type TargetCellPreconfigInfo_r10 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class TargetCellPreconfigInfo_r10 extends Sequence {
    
    /**
     * The default constructor.
     */
    public TargetCellPreconfigInfo_r10()
    {
    }
     ...
     */
    public TargetCellPreconfigInfo_r10(ActivationTimeOffset activationTimeOffset, 
		    ...
		    DL_SecondaryCellInfoFDD_r10 dl_SecondaryCellInfoFDD, 
		    AdditionalDLSecCellInfoListFDD additionalDLSecCellInfoListFDD, 
     ...
     */
    public TargetCellPreconfigInfo_r10(H_RNTI new_H_RNTI, 
		    Serving_HSDSCH_CellInformation_r9 serving_HSDSCH_CellInformation, 
		    E_DCH_ReconfigurationInfo_r7 e_dch_ReconfigurationInfo)
    {
	setNew_H_RNTI(new_H_RNTI);
	...
	mComponents[10] = new DL_SecondaryCellInfoFDD_r10();
	mComponents[11] = new AdditionalDLSecCellInfoListFDD();
	mComponents[12] = new UL_SecondaryCellInfoFDD();
	mComponents[13] = new E_DCH_ReconfigurationInfo_SecULFrequency();
    }
	...
	switch (index) {
	    ...
	    case 10:
		return new DL_SecondaryCellInfoFDD_r10();
	    case 11:
		return new AdditionalDLSecCellInfoListFDD();
	    case 12:
    ...
    public DL_SecondaryCellInfoFDD_r10 getDl_SecondaryCellInfoFDD()
    {
	return (DL_SecondaryCellInfoFDD_r10)mComponents[10];
    }
    
    public void setDl_SecondaryCellInfoFDD(DL_SecondaryCellInfoFDD_r10 dl_SecondaryCellInfoFDD)
    {
    ...
    public AdditionalDLSecCellInfoListFDD getAdditionalDLSecCellInfoListFDD()
    {
	return (AdditionalDLSecCellInfoListFDD)mComponents[11];
    }
    
    public void setAdditionalDLSecCellInfoListFDD(AdditionalDLSecCellInfoListFDD additionalDLSecCellInfoListFDD)
    {
	mComponents[11] = additionalDLSecCellInfoListFDD;
    }
    ...
    {
	return (E_DCH_ReconfigurationInfo_SecULFrequency)mComponents[13];
    }
    ...
    {
	mComponents[13] = e_dch_ReconfigurationInfo_SecULFrequency;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TargetCellPreconfigInfo_r10 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TargetCellPreconfigInfo_r10 object.
     */
...
} // End class definition for TargetCellPreconfigInfo_r10
