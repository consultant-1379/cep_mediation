...
/**
 * Define the ASN1 Type PUSCH_SysInfoList_SFN from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class PUSCH_SysInfoList_SFN extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public PUSCH_SysInfoList_SFN()
    {
    }
     ...
     */
    public PUSCH_SysInfoList_SFN(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(PUSCH_SysInfo pusch_SysInfo, 
	...
	{
	    mComponents[0] = new PUSCH_SysInfo();
	...
	public PUSCH_SysInfo getPusch_SysInfo()
	{
	    return (PUSCH_SysInfo)mComponents[0];
	}
	
	public void setPusch_SysInfo(PUSCH_SysInfo pusch_SysInfo)
	{
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_SysInfoList_SFN object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PUSCH_SysInfoList_SFN
