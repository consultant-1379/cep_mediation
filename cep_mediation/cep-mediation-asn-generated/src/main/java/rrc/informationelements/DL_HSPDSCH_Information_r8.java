...
/**
 * Define the ASN1 Type DL_HSPDSCH_Information_r8 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class DL_HSPDSCH_Information_r8 extends Sequence {
    
    /**
     * The default constructor.
     */
    public DL_HSPDSCH_Information_r8()
    {
    }
     ...
     */
    public DL_HSPDSCH_Information_r8(HS_SCCH_Info_r7 hs_scch_Info, 
     ...
     */
    public DL_HSPDSCH_Information_r8(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
    ...
    {
	mComponents[0] = new HS_SCCH_Info_r7();
    ...
    public HS_SCCH_Info_r7 getHs_scch_Info()
    {
	return (HS_SCCH_Info_r7)mComponents[0];
    }
    
    public void setHs_scch_Info(HS_SCCH_Info_r7 hs_scch_Info)
    {
	...
	public static class Tdd extends Choice {
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
			...
			"DL_HSPDSCH_Information_r8$ModeSpecificInfo$Tdd$Tdd384"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_HSPDSCH_Information_r8$ModeSpecificInfo$Tdd$Tdd768"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		private static final SequenceInfo c_typeinfo = new SequenceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_HSPDSCH_Information_r8$ModeSpecificInfo$Tdd$Tdd128"
		    ),
		    new QName (
			"builtin",
			"SEQUENCE"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_HSPDSCH_Information_r8$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "CHOICE"
	...
	public static class Fdd extends Sequence {
		...
		private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"DL_HSPDSCH_Information_r8$ModeSpecificInfo$Fdd$Dl_64QAM_Configured"
		    ),
		    new QName (
			"builtin",
			"ENUMERATED"
		...
		new QName (
		    "rrc.informationelements",
		    "DL_HSPDSCH_Information_r8$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"DL_HSPDSCH_Information_r8$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DL_HSPDSCH_Information_r8 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DL_HSPDSCH_Information_r8 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for DL_HSPDSCH_Information_r8
