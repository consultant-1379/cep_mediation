...
/**
 * Define the ASN1 Type RemovedIntraFreqCellListOnSecULFreq from ASN1 Module InformationElements.
 * @see Choice
 */

public class RemovedIntraFreqCellListOnSecULFreq extends Choice {
    
    /**
     * The default constructor.
     */
    public RemovedIntraFreqCellListOnSecULFreq()
    {
    }
    ...
    public static RemovedIntraFreqCellListOnSecULFreq createRemovedIntraFreqCellListOnSecULFreqWithRemoveAllIntraFreqCells(Null removeAllIntraFreqCells)
    {
	RemovedIntraFreqCellListOnSecULFreq __object = new RemovedIntraFreqCellListOnSecULFreq();
    ...
    public static RemovedIntraFreqCellListOnSecULFreq createRemovedIntraFreqCellListOnSecULFreqWithRemoveSomeIntraFreqCells(RemoveSomeIntraFreqCells removeSomeIntraFreqCells)
    {
	RemovedIntraFreqCellListOnSecULFreq __object = new RemovedIntraFreqCellListOnSecULFreq();
	 ...
	 */
	public RemoveSomeIntraFreqCells(IntraFreqCellIDOnSecULFreq[] elements)
	{
	    super(elements);
	}
	 ...
	 */
	public synchronized void add(IntraFreqCellIDOnSecULFreq element)
	{
	 ...
	 */
	public synchronized void set(IntraFreqCellIDOnSecULFreq element, int atIndex)
	{
	 ...
	 */
	public synchronized IntraFreqCellIDOnSecULFreq get(int atIndex)
	{
	    return (IntraFreqCellIDOnSecULFreq)super.getElement(atIndex);
	}
	
	/**
	 * Insert an Element into the SEQUENCE OF/SET OF.
	 */
	public synchronized void insert(IntraFreqCellIDOnSecULFreq element, int atIndex)
	{
	 ...
	 */
	public synchronized void remove(IntraFreqCellIDOnSecULFreq element)
	{
	...
	{
	    return (AbstractData)new IntraFreqCellIDOnSecULFreq();
	}
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
		...
		"RemovedIntraFreqCellListOnSecULFreq$RemoveSomeIntraFreqCells"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
    ...
    public static RemovedIntraFreqCellListOnSecULFreq createRemovedIntraFreqCellListOnSecULFreqWithRemoveNoIntraFreqCells(Null removeNoIntraFreqCells)
    {
	RemovedIntraFreqCellListOnSecULFreq __object = new RemovedIntraFreqCellListOnSecULFreq();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RemovedIntraFreqCellListOnSecULFreq object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RemovedIntraFreqCellListOnSecULFreq object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RemovedIntraFreqCellListOnSecULFreq
