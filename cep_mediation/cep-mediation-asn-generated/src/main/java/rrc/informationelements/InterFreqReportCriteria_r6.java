...
/**
 * Define the ASN1 Type InterFreqReportCriteria_r6 from ASN1 Module InformationElements.
 * @see Choice
 */

public class InterFreqReportCriteria_r6 extends Choice {
    
    /**
     * The default constructor.
     */
    public InterFreqReportCriteria_r6()
    {
    }
    ...
    public static InterFreqReportCriteria_r6 createInterFreqReportCriteria_r6WithIntraFreqReportingCriteria(IntraFreqReportingCriteria_r6 intraFreqReportingCriteria)
    {
	InterFreqReportCriteria_r6 __object = new InterFreqReportCriteria_r6();
    ...
    public static InterFreqReportCriteria_r6 createInterFreqReportCriteria_r6WithInterFreqReportingCriteria(InterFreqReportingCriteria_r6 interFreqReportingCriteria)
    {
	InterFreqReportCriteria_r6 __object = new InterFreqReportCriteria_r6();
    ...
    public static InterFreqReportCriteria_r6 createInterFreqReportCriteria_r6WithPeriodicalReportingCriteria(PeriodicalWithReportingCellStatus periodicalReportingCriteria)
    {
	InterFreqReportCriteria_r6 __object = new InterFreqReportCriteria_r6();
    ...
    public static InterFreqReportCriteria_r6 createInterFreqReportCriteria_r6WithNoReporting(ReportingCellStatusOpt noReporting)
    {
	InterFreqReportCriteria_r6 __object = new InterFreqReportCriteria_r6();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' InterFreqReportCriteria_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' InterFreqReportCriteria_r6 object.
     */
...
} // End class definition for InterFreqReportCriteria_r6
