...
/**
 * Define the ASN1 Type RAB_Info_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class RAB_Info_r7 extends Sequence {
     ...
     */
    public RAB_Info_r7(RAB_Identity rab_Identity, 
	...
	mComponents[3] = CN_DomainIdentity.cs_domain;
	mComponents[4] = new NAS_Synchronisation_Indicator();
	mComponents[5] = Re_EstablishmentTimer.useT314;
    }
    ...
    {
	mComponents[2] = mbms_ServiceIdentity;
    }
    
    public boolean hasMbms_ServiceIdentity()
    {
	return componentIsPresent(2);
    }
    
    public void deleteMbms_ServiceIdentity()
    {
    ...
    {
	return (CN_DomainIdentity)mComponents[3];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RAB_Info_r7 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RAB_Info_r7 object.
     */
...
} // End class definition for RAB_Info_r7
