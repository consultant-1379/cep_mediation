...
/**
 * Define the ASN1 Type UL_EDCH_Information_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UL_EDCH_Information_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UL_EDCH_Information_r7()
    {
    }
     ...
     */
    public UL_EDCH_Information_r7(Mac_es_e_resetIndicator mac_es_e_resetIndicator, 
     ...
     */
    public UL_EDCH_Information_r7(ModeSpecificInfo modeSpecificInfo)
    {
	setModeSpecificInfo(modeSpecificInfo);
    }
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"UL_EDCH_Information_r7$Mac_es_e_resetIndicator"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
	...
	public static class Fdd extends Sequence {
		...
		mComponents[1] = new E_DPDCH_Info_r7();
	    ...
	    public E_DPDCH_Info_r7 getE_DPDCH_Info()
	    {
		return (E_DPDCH_Info_r7)mComponents[1];
	    }
	    
	    public void setE_DPDCH_Info(E_DPDCH_Info_r7 e_DPDCH_Info)
	    {
		...
		new QName (
		    "rrc.informationelements",
		    "UL_EDCH_Information_r7$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
	    ...
	    public Tdd(E_RUCCH_Info e_RUCCH_Info, E_PUCH_Info e_PUCH_Info, 
			    Non_ScheduledTransGrantInfoTDD non_ScheduledTransGrantInfo)
	    {
		...
		mComponents[2] = new Non_ScheduledTransGrantInfoTDD();
	    }
		...
		switch (index) {
		    ...
		    case 2:
			return new Non_ScheduledTransGrantInfoTDD();
		    default:
			throw new InternalError("AbstractCollection.createInstance()");
		}
	    ...
	    public Non_ScheduledTransGrantInfoTDD getNon_ScheduledTransGrantInfo()
	    {
		return (Non_ScheduledTransGrantInfoTDD)mComponents[2];
	    }
	    
	    public void setNon_ScheduledTransGrantInfo(Non_ScheduledTransGrantInfoTDD non_ScheduledTransGrantInfo)
	    {
		...
		new QName (
		    "rrc.informationelements",
		    "UL_EDCH_Information_r7$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UL_EDCH_Information_r7$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UL_EDCH_Information_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UL_EDCH_Information_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UL_EDCH_Information_r7
