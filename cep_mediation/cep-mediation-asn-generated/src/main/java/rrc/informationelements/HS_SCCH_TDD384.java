...
/**
 * Define the ASN1 Type HS_SCCH_TDD384 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class HS_SCCH_TDD384 extends Sequence {
    
    /**
     * The default constructor.
     */
    public HS_SCCH_TDD384()
    {
    }
     ...
     */
    public HS_SCCH_TDD384(TimeslotNumber timeslotNumber, 
	...
	mComponents[5] = new HS_SICH_Configuration_TDD384();
    }
	...
	public static class UeSpecificMidamble extends Sequence {
		...
		new QName (
		    ...
		    "HS_SCCH_TDD384$MidambleAllocationMode$UeSpecificMidamble"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"HS_SCCH_TDD384$MidambleAllocationMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (HS_SICH_Configuration_TDD384)mComponents[5];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HS_SCCH_TDD384 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HS_SCCH_TDD384 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for HS_SCCH_TDD384
