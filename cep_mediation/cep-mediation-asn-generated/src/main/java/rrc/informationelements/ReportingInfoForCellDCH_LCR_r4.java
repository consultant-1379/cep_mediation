...
/**
 * Define the ASN1 Type ReportingInfoForCellDCH_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class ReportingInfoForCellDCH_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public ReportingInfoForCellDCH_LCR_r4()
    {
    }
     ...
     */
    public ReportingInfoForCellDCH_LCR_r4(IntraFreqReportingQuantity intraFreqReportingQuantity, 
		    MeasurementReportingMode measurementReportingMode, 
		    CellDCH_ReportCriteria_LCR_r4 reportCriteria)
    {
	...
	mComponents[2] = new CellDCH_ReportCriteria_LCR_r4();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new CellDCH_ReportCriteria_LCR_r4();
	    default:
    ...
    public CellDCH_ReportCriteria_LCR_r4 getReportCriteria()
    {
	return (CellDCH_ReportCriteria_LCR_r4)mComponents[2];
    }
    
    public void setReportCriteria(CellDCH_ReportCriteria_LCR_r4 reportCriteria)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' ReportingInfoForCellDCH_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' ReportingInfoForCellDCH_LCR_r4 object.
     */
...
} // End class definition for ReportingInfoForCellDCH_LCR_r4
