...
/**
 * Define the ASN1 Type PDCP_Capability_v770ext from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDCP_Capability_v770ext extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDCP_Capability_v770ext()
    {
    }
     ...
     */
    public PDCP_Capability_v770ext(SupportForCSVoiceoverHSPA supportForCSVoiceoverHSPA)
    {
	...
	private static final EnumeratedInfo c_typeinfo = new EnumeratedInfo (
		...
		"PDCP_Capability_v770ext$SupportForCSVoiceoverHSPA"
	    ),
	    new QName (
		"builtin",
		"ENUMERATED"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDCP_Capability_v770ext object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDCP_Capability_v770ext object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDCP_Capability_v770ext
