...
/**
 * Define the ASN1 Type UE_InternalMeasurement from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_InternalMeasurement extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_InternalMeasurement()
    {
    }
     ...
     */
    public UE_InternalMeasurement(UE_InternalMeasQuantity ue_InternalMeasQuantity, 
		    UE_InternalReportingQuantity ue_InternalReportingQuantity, 
     ...
     */
    public UE_InternalMeasurement(UE_InternalReportCriteria reportCriteria)
    {
	setReportCriteria(reportCriteria);
    }
	...
	mComponents[1] = new UE_InternalReportingQuantity();
	...
	switch (index) {
	    ...
	    case 1:
		return new UE_InternalReportingQuantity();
	    case 2:
    ...
    public UE_InternalReportingQuantity getUe_InternalReportingQuantity()
    {
	return (UE_InternalReportingQuantity)mComponents[1];
    }
    
    public void setUe_InternalReportingQuantity(UE_InternalReportingQuantity ue_InternalReportingQuantity)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_InternalMeasurement object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_InternalMeasurement object.
     */
...
} // End class definition for UE_InternalMeasurement
