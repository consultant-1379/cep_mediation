...
/**
 * Define the ASN1 Type PowerOffsetInfoShort from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PowerOffsetInfoShort extends Sequence {
    
    /**
     * The default constructor.
     */
    public PowerOffsetInfoShort()
    {
    }
     ...
     */
    public PowerOffsetInfoShort(TFC_Value referenceTFC, 
    ...
    {
	mComponents[0] = new TFC_Value();
	mComponents[1] = new ModeSpecificInfo();
	mComponents[2] = new GainFactor();
    }
    ...
    // Methods for field "referenceTFC"
    public TFC_Value getReferenceTFC()
    {
	return (TFC_Value)mComponents[0];
    }
    
    public void setReferenceTFC(TFC_Value referenceTFC)
    {
	mComponents[0] = referenceTFC;
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "PowerOffsetInfoShort$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"PowerOffsetInfoShort$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (GainFactor)mComponents[2];
    }
    
    public void setGainFactorBetaD(GainFactor gainFactorBetaD)
    {
	mComponents[2] = gainFactorBetaD;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PowerOffsetInfoShort object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PowerOffsetInfoShort object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PowerOffsetInfoShort
