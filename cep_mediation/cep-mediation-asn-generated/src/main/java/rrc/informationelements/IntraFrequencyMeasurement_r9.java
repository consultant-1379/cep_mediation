...
/**
 * Define the ASN1 Type IntraFrequencyMeasurement_r9 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class IntraFrequencyMeasurement_r9 extends Sequence {
    
    /**
     * The default constructor.
     */
    public IntraFrequencyMeasurement_r9()
    {
    }
     ...
     */
    public IntraFrequencyMeasurement_r9(IntraFreqCellInfoList_r9 intraFreqCellInfoList, 
    ...
    {
	mComponents[0] = new IntraFreqCellInfoList_r9();
	...
	switch (index) {
	    case 0:
		return new IntraFreqCellInfoList_r9();
	    case 1:
    ...
    public IntraFreqCellInfoList_r9 getIntraFreqCellInfoList()
    {
	return (IntraFreqCellInfoList_r9)mComponents[0];
    }
    
    public void setIntraFreqCellInfoList(IntraFreqCellInfoList_r9 intraFreqCellInfoList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntraFrequencyMeasurement_r9 object.
     */
...
} // End class definition for IntraFrequencyMeasurement_r9
