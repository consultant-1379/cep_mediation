...
/**
 * Define the ASN1 Type UE_Positioning_GPS_DGPS_Corrections from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_GPS_DGPS_Corrections extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_GPS_DGPS_Corrections()
    {
    }
     ...
     */
    public UE_Positioning_GPS_DGPS_Corrections(GPS_TOW_1sec gps_TOW, 
		    DiffCorrectionStatus statusHealth, 
		    DGPS_CorrectionSatInfoList dgps_CorrectionSatInfoList)
    {
	setGps_TOW(gps_TOW);
	...
	mComponents[2] = new DGPS_CorrectionSatInfoList();
    }
	...
	switch (index) {
	    ...
	    case 2:
		return new DGPS_CorrectionSatInfoList();
	    default:
    ...
    public DGPS_CorrectionSatInfoList getDgps_CorrectionSatInfoList()
    {
	return (DGPS_CorrectionSatInfoList)mComponents[2];
    }
    
    public void setDgps_CorrectionSatInfoList(DGPS_CorrectionSatInfoList dgps_CorrectionSatInfoList)
    {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_DGPS_Corrections object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_GPS_DGPS_Corrections object.
     */
...
} // End class definition for UE_Positioning_GPS_DGPS_Corrections
