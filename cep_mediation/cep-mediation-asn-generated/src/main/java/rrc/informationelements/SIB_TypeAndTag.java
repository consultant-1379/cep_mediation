...
/**
 * Define the ASN1 Type SIB_TypeAndTag from ASN1 Module InformationElements.
 * @see Choice
 */

public class SIB_TypeAndTag extends Choice {
    
    /**
     * The default constructor.
     */
    public SIB_TypeAndTag()
    {
    }
    ...
    public static final  int  sysInfoType15_1_chosen = 22;
    public static final  int  sysInfoType15_2_chosen = 23;
    public static final  int  sysInfoType15_3_chosen = 24;
    public static final  int  sysInfoType15_4_chosen = 25;
    public static final  int  sysInfoType18_chosen = 26;
    public static final  int  sysInfoType15_5_chosen = 27;
    public static final  int  sysInfoType5bis_chosen = 28;
    public static final  int  spare4_chosen = 29;
    public static final  int  spare3_chosen = 30;
    public static final  int  spare2_chosen = 31;
    public static final  int  spare1_chosen = 32;
    
    // Methods for field "sysInfoType1"
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType1(long sysInfoType1)
    {
	return createSIB_TypeAndTagWithSysInfoType1(new PLMN_ValueTag(sysInfoType1));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType1(PLMN_ValueTag sysInfoType1)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType2(long sysInfoType2)
    {
	return createSIB_TypeAndTagWithSysInfoType2(new CellValueTag(sysInfoType2));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType2(CellValueTag sysInfoType2)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType3(long sysInfoType3)
    {
	return createSIB_TypeAndTagWithSysInfoType3(new CellValueTag(sysInfoType3));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType3(CellValueTag sysInfoType3)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType4(long sysInfoType4)
    {
	return createSIB_TypeAndTagWithSysInfoType4(new CellValueTag(sysInfoType4));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType4(CellValueTag sysInfoType4)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType5(long sysInfoType5)
    {
	return createSIB_TypeAndTagWithSysInfoType5(new CellValueTag(sysInfoType5));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType5(CellValueTag sysInfoType5)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType6(long sysInfoType6)
    {
	return createSIB_TypeAndTagWithSysInfoType6(new CellValueTag(sysInfoType6));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType6(CellValueTag sysInfoType6)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType7(Null sysInfoType7)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithDummy(long dummy)
    {
	return createSIB_TypeAndTagWithDummy(new CellValueTag(dummy));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithDummy(CellValueTag dummy)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithDummy2(Null dummy2)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithDummy3(Null dummy3)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType11(long sysInfoType11)
    {
	return createSIB_TypeAndTagWithSysInfoType11(new CellValueTag(sysInfoType11));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType11(CellValueTag sysInfoType11)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType12(long sysInfoType12)
    {
	return createSIB_TypeAndTagWithSysInfoType12(new CellValueTag(sysInfoType12));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType12(CellValueTag sysInfoType12)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13(long sysInfoType13)
    {
	return createSIB_TypeAndTagWithSysInfoType13(new CellValueTag(sysInfoType13));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13(CellValueTag sysInfoType13)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_1(long sysInfoType13_1)
    {
	return createSIB_TypeAndTagWithSysInfoType13_1(new CellValueTag(sysInfoType13_1));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_1(CellValueTag sysInfoType13_1)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_2(long sysInfoType13_2)
    {
	return createSIB_TypeAndTagWithSysInfoType13_2(new CellValueTag(sysInfoType13_2));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_2(CellValueTag sysInfoType13_2)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_3(long sysInfoType13_3)
    {
	return createSIB_TypeAndTagWithSysInfoType13_3(new CellValueTag(sysInfoType13_3));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_3(CellValueTag sysInfoType13_3)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_4(long sysInfoType13_4)
    {
	return createSIB_TypeAndTagWithSysInfoType13_4(new CellValueTag(sysInfoType13_4));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType13_4(CellValueTag sysInfoType13_4)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType14(Null sysInfoType14)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15(long sysInfoType15)
    {
	return createSIB_TypeAndTagWithSysInfoType15(new CellValueTag(sysInfoType15));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15(CellValueTag sysInfoType15)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType16(PredefinedConfigIdentityAndValueTag sysInfoType16)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType17(Null sysInfoType17)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_1(long sysInfoType15_1)
    {
	return createSIB_TypeAndTagWithSysInfoType15_1(new CellValueTag(sysInfoType15_1));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_1(CellValueTag sysInfoType15_1)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_2(SIBOccurrenceIdentityAndValueTag sysInfoType15_2)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_3(SIBOccurrenceIdentityAndValueTag sysInfoType15_3)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_4(long sysInfoType15_4)
    {
	return createSIB_TypeAndTagWithSysInfoType15_4(new CellValueTag(sysInfoType15_4));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_4(CellValueTag sysInfoType15_4)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType18(long sysInfoType18)
    {
	return createSIB_TypeAndTagWithSysInfoType18(new CellValueTag(sysInfoType18));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType18(CellValueTag sysInfoType18)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_5(long sysInfoType15_5)
    {
	return createSIB_TypeAndTagWithSysInfoType15_5(new CellValueTag(sysInfoType15_5));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType15_5(CellValueTag sysInfoType15_5)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType5bis(long sysInfoType5bis)
    {
	return createSIB_TypeAndTagWithSysInfoType5bis(new CellValueTag(sysInfoType5bis));
    }
    
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSysInfoType5bis(CellValueTag sysInfoType5bis)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSpare4(Null spare4)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSpare3(Null spare3)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSpare2(Null spare2)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    public static SIB_TypeAndTag createSIB_TypeAndTagWithSpare1(Null spare1)
    {
	SIB_TypeAndTag __object = new SIB_TypeAndTag();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SIB_TypeAndTag object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SIB_TypeAndTag object.
     */
...
} // End class definition for SIB_TypeAndTag
