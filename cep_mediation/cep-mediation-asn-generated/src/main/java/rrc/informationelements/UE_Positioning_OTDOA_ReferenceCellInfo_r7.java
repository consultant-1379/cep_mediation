...
/**
 * Define the ASN1 Type UE_Positioning_OTDOA_ReferenceCellInfo_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class UE_Positioning_OTDOA_ReferenceCellInfo_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r7()
    {
    }
     ...
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r7(INTEGER sfn, 
     ...
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r7(long sfn, 
		    ModeSpecificInfo modeSpecificInfo, 
		    FrequencyInfo frequencyInfo, 
		    PositioningMode positioningMode, 
		    UE_Positioning_IPDL_Parameters_r4 ue_positioning_IPDL_Paremeters)
     ...
     */
    public UE_Positioning_OTDOA_ReferenceCellInfo_r7(ModeSpecificInfo modeSpecificInfo, 
		    PositioningMode positioningMode)
    {
	setModeSpecificInfo(modeSpecificInfo);
	setPositioningMode(positioningMode);
	...
	mComponents[4] = new UE_Positioning_IPDL_Parameters_r4();
    }
	...
	public static class Fdd extends Sequence {
		...
		new QName (
		    ...
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r7$ModeSpecificInfo$Fdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class Tdd extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r7$ModeSpecificInfo$Tdd"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UE_Positioning_OTDOA_ReferenceCellInfo_r7$ModeSpecificInfo"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
	...
	public static class UeBased extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public UeBased(ReferenceCellPosition cellPosition, 
			    INTEGER roundTripTime, 
			    INTEGER roundTripTimeExtension)
	    {
	     ...
	     */
	    public UeBased(ReferenceCellPosition cellPosition, 
			    long roundTripTime, long roundTripTimeExtension)
	    {
		this(cellPosition, new INTEGER(roundTripTime), 
		     new INTEGER(roundTripTimeExtension));
	    }
	    
	    public void initComponents()
	    {
		mComponents[0] = new ReferenceCellPosition();
	    ...
	    {
		return (ReferenceCellPosition)mComponents[0];
	    }
	    
	    public void setCellPosition(ReferenceCellPosition cellPosition)
	    {
		mComponents[0] = cellPosition;
	    }
	    ...
	    {
		mComponents[2] = roundTripTimeExtension;
	    }
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r7$PositioningMode$UeBased"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class UeAssisted extends Sequence {
		...
		new QName (
		    "rrc.informationelements",
		    "UE_Positioning_OTDOA_ReferenceCellInfo_r7$PositioningMode$UeAssisted"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"UE_Positioning_OTDOA_ReferenceCellInfo_r7$PositioningMode"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    {
	return (UE_Positioning_IPDL_Parameters_r4)mComponents[4];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' UE_Positioning_OTDOA_ReferenceCellInfo_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' UE_Positioning_OTDOA_ReferenceCellInfo_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for UE_Positioning_OTDOA_ReferenceCellInfo_r7
