...
/**
 * Define the ASN1 Type MeasurementType_r6 from ASN1 Module InformationElements.
 * @see Choice
 */

public class MeasurementType_r6 extends Choice {
    
    /**
     * The default constructor.
     */
    public MeasurementType_r6()
    {
    }
    ...
    public static MeasurementType_r6 createMeasurementType_r6WithIntraFrequencyMeasurement(IntraFrequencyMeasurement_r6 intraFrequencyMeasurement)
    {
	MeasurementType_r6 __object = new MeasurementType_r6();
    ...
    public void setIntraFrequencyMeasurement(IntraFrequencyMeasurement_r6 intraFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r6 createMeasurementType_r6WithInterFrequencyMeasurement(InterFrequencyMeasurement_r6 interFrequencyMeasurement)
    {
	MeasurementType_r6 __object = new MeasurementType_r6();
    ...
    public void setInterFrequencyMeasurement(InterFrequencyMeasurement_r6 interFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r6 createMeasurementType_r6WithInterRATMeasurement(InterRATMeasurement_r6 interRATMeasurement)
    {
	MeasurementType_r6 __object = new MeasurementType_r6();
    ...
    public static MeasurementType_r6 createMeasurementType_r6WithUp_Measurement(UE_Positioning_Measurement_r4 up_Measurement)
    {
	MeasurementType_r6 __object = new MeasurementType_r6();
    ...
    public void setUp_Measurement(UE_Positioning_Measurement_r4 up_Measurement)
    {
    ...
    public static MeasurementType_r6 createMeasurementType_r6WithTrafficVolumeMeasurement(TrafficVolumeMeasurement trafficVolumeMeasurement)
    {
	MeasurementType_r6 __object = new MeasurementType_r6();
    ...
    public static MeasurementType_r6 createMeasurementType_r6WithQualityMeasurement(QualityMeasurement qualityMeasurement)
    {
	MeasurementType_r6 __object = new MeasurementType_r6();
    ...
    public static MeasurementType_r6 createMeasurementType_r6WithUe_InternalMeasurement(UE_InternalMeasurement_r4 ue_InternalMeasurement)
    {
	MeasurementType_r6 __object = new MeasurementType_r6();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementType_r6 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementType_r6 object.
     */
...
} // End class definition for MeasurementType_r6
