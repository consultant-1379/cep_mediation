...
/**
 * Define the ASN1 Type PDSCH_Info_LCR_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDSCH_Info_LCR_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDSCH_Info_LCR_r4()
    {
    }
     ...
     */
    public PDSCH_Info_LCR_r4(TFCS_IdentityPlain tfcs_ID, 
		    CommonTimeslotInfo commonTimeslotInfo, 
		    DownlinkTimeslotsCodes_LCR_r4 pdsch_TimeslotsCodes)
    {
	setTfcs_ID(tfcs_ID);
	...
	mComponents[2] = new DownlinkTimeslotsCodes_LCR_r4();
    }
    ...
    {
	return (DownlinkTimeslotsCodes_LCR_r4)mComponents[2];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_Info_LCR_r4 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_Info_LCR_r4 object.
     */
...
} // End class definition for PDSCH_Info_LCR_r4
