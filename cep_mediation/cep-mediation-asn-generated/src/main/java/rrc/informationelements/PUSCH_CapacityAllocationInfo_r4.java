...
/**
 * Define the ASN1 Type PUSCH_CapacityAllocationInfo_r4 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PUSCH_CapacityAllocationInfo_r4 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PUSCH_CapacityAllocationInfo_r4()
    {
    }
     ...
     */
    public PUSCH_CapacityAllocationInfo_r4(Pusch_Allocation pusch_Allocation)
    {
	...
	public static class Pusch_AllocationAssignment extends Sequence {
	    ...
	    public Pusch_AllocationAssignment(AllocationPeriodInfo pusch_AllocationPeriodInfo, 
			    PUSCH_PowerControlInfo_r4 pusch_PowerControlInfo, 
		...
		mComponents[1] = new PUSCH_PowerControlInfo_r4();
		...
		switch (index) {
		    ...
		    case 1:
			return new PUSCH_PowerControlInfo_r4();
		    case 2:
	    ...
	    public PUSCH_PowerControlInfo_r4 getPusch_PowerControlInfo()
	    {
		return (PUSCH_PowerControlInfo_r4)mComponents[1];
	    }
	    
	    public void setPusch_PowerControlInfo(PUSCH_PowerControlInfo_r4 pusch_PowerControlInfo)
	    {
		...
		public static class Old_Configuration extends Sequence {
			...
			new QName (
			    ...
			    "PUSCH_CapacityAllocationInfo_r4$Pusch_Allocation$Pusch_AllocationAssignment$Configuration$Old_Configuration"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		public static class New_Configuration extends Sequence {
		     ...
		     * Construct with AbstractData components.
		     */
		    public New_Configuration(PUSCH_Info_r4 pusch_Info, 
				    PUSCH_Identity pusch_Identity)
		    {
		    ...
		    public void initComponents()
		    {
			mComponents[0] = new PUSCH_Info_r4();
			mComponents[1] = new PUSCH_Identity();
		    }
		    ...
		    public PUSCH_Info_r4 getPusch_Info()
		    {
			return (PUSCH_Info_r4)mComponents[0];
		    }
		    
		    public void setPusch_Info(PUSCH_Info_r4 pusch_Info)
		    {
			...
			new QName (
			    "rrc.informationelements",
			    "PUSCH_CapacityAllocationInfo_r4$Pusch_Allocation$Pusch_AllocationAssignment$Configuration$New_Configuration"
			),
			new QName (
			    "builtin",
			    "SEQUENCE"
		...
		private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
		    ...
		    new QName (
			"rrc.informationelements",
			"PUSCH_CapacityAllocationInfo_r4$Pusch_Allocation$Pusch_AllocationAssignment$Configuration"
		    ),
		    new QName (
			"builtin",
			"CHOICE"
		...
		new QName (
		    "rrc.informationelements",
		    "PUSCH_CapacityAllocationInfo_r4$Pusch_Allocation$Pusch_AllocationAssignment"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"PUSCH_CapacityAllocationInfo_r4$Pusch_Allocation"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PUSCH_CapacityAllocationInfo_r4 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PUSCH_CapacityAllocationInfo_r4 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PUSCH_CapacityAllocationInfo_r4
