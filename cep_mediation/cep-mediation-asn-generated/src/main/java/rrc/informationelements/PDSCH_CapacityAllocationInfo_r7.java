...
/**
 * Define the ASN1 Type PDSCH_CapacityAllocationInfo_r7 from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDSCH_CapacityAllocationInfo_r7 extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDSCH_CapacityAllocationInfo_r7()
    {
    }
     ...
     */
    public PDSCH_CapacityAllocationInfo_r7(AllocationPeriodInfo pdsch_AllocationPeriodInfo, 
	...
	public static class Old_Configuration extends Sequence {
		...
		new QName (
		    ...
		    "PDSCH_CapacityAllocationInfo_r7$Configuration$Old_Configuration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class New_Configuration extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public New_Configuration(PDSCH_Info_r7 pdsch_Info, 
			    PDSCH_Identity pdsch_Identity, 
	    ...
	    public void initComponents()
	    {
		mComponents[0] = new PDSCH_Info_r7();
		mComponents[1] = new PDSCH_Identity();
	    ...
	    public PDSCH_Info_r7 getPdsch_Info()
	    {
		return (PDSCH_Info_r7)mComponents[0];
	    }
	    
	    public void setPdsch_Info(PDSCH_Info_r7 pdsch_Info)
	    {
		...
		new QName (
		    "rrc.informationelements",
		    "PDSCH_CapacityAllocationInfo_r7$Configuration$New_Configuration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"PDSCH_CapacityAllocationInfo_r7$Configuration"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_CapacityAllocationInfo_r7 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_CapacityAllocationInfo_r7 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDSCH_CapacityAllocationInfo_r7
