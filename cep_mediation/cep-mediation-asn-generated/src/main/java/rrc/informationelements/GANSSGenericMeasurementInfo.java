...
/**
 * Define the ASN1 Type GANSSGenericMeasurementInfo from ASN1 Module InformationElements.
 * @see SequenceOf
 */

public class GANSSGenericMeasurementInfo extends SequenceOf {
    
    /**
     * The default constructor.
     */
    public GANSSGenericMeasurementInfo()
    {
    }
     ...
     */
    public GANSSGenericMeasurementInfo(Sequence_[] elements)
    {
	super(elements);
    }
	 ...
	 */
	public Sequence_(INTEGER ganssId, 
	 ...
	 */
	public Sequence_(long ganssId, 
			GANSSMeasurementSignalList ganssMeasurementSignalList)
	{
	    this(new INTEGER(ganssId), ganssMeasurementSignalList);
	}
	
	/**
	 * Construct with required components.
	 */
	public Sequence_(GANSSMeasurementSignalList ganssMeasurementSignalList)
	{
	    setGanssMeasurementSignalList(ganssMeasurementSignalList);
	}
	...
	public void initComponents()
	{
	    ...
	    mComponents[1] = new GANSSMeasurementSignalList();
	}
	...
	public AbstractData createInstance(int index)
	{
		...
		case 0:
		    return new INTEGER();
		case 1:
		    return new GANSSMeasurementSignalList();
		default:
	...
	public GANSSMeasurementSignalList getGanssMeasurementSignalList()
	{
	    return (GANSSMeasurementSignalList)mComponents[1];
	}
	
	public void setGanssMeasurementSignalList(GANSSMeasurementSignalList ganssMeasurementSignalList)
	{
	    mComponents[1] = ganssMeasurementSignalList;
	}
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' GANSSGenericMeasurementInfo object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' GANSSGenericMeasurementInfo object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for GANSSGenericMeasurementInfo
