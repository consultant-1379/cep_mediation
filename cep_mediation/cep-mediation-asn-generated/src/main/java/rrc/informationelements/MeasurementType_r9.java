...
/**
 * Define the ASN1 Type MeasurementType_r9 from ASN1 Module InformationElements.
 * @see Choice
 */

public class MeasurementType_r9 extends Choice {
    
    /**
     * The default constructor.
     */
    public MeasurementType_r9()
    {
    }
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithIntraFrequencyMeasurement(IntraFrequencyMeasurement_r9 intraFrequencyMeasurement)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    public void setIntraFrequencyMeasurement(IntraFrequencyMeasurement_r9 intraFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithInterFrequencyMeasurement(InterFrequencyMeasurement_r9 interFrequencyMeasurement)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    public void setInterFrequencyMeasurement(InterFrequencyMeasurement_r9 interFrequencyMeasurement)
    {
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithInterRATMeasurement(InterRATMeasurement_r9 interRATMeasurement)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithUp_Measurement(UE_Positioning_Measurement_r9 up_Measurement)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    public void setUp_Measurement(UE_Positioning_Measurement_r9 up_Measurement)
    {
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithTrafficVolumeMeasurement(TrafficVolumeMeasurement trafficVolumeMeasurement)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithQualityMeasurement(QualityMeasurement qualityMeasurement)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithUe_InternalMeasurement(UE_InternalMeasurement_r4 ue_InternalMeasurement)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    public static MeasurementType_r9 createMeasurementType_r9WithCsgProximityDetection(CSGProximityDetection csgProximityDetection)
    {
	MeasurementType_r9 __object = new MeasurementType_r9();
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MeasurementType_r9 object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MeasurementType_r9 object.
     */
...
} // End class definition for MeasurementType_r9
