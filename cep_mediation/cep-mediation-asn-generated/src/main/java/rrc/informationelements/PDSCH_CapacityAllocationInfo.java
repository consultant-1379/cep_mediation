...
/**
 * Define the ASN1 Type PDSCH_CapacityAllocationInfo from ASN1 Module InformationElements.
 * @see Sequence
 */

public class PDSCH_CapacityAllocationInfo extends Sequence {
    
    /**
     * The default constructor.
     */
    public PDSCH_CapacityAllocationInfo()
    {
    }
     ...
     */
    public PDSCH_CapacityAllocationInfo(PDSCH_PowerControlInfo pdsch_PowerControlInfo, 
		    AllocationPeriodInfo pdsch_AllocationPeriodInfo, 
     ...
     */
    public PDSCH_CapacityAllocationInfo(AllocationPeriodInfo pdsch_AllocationPeriodInfo, 
		    Configuration configuration)
    {
	setPdsch_AllocationPeriodInfo(pdsch_AllocationPeriodInfo);
	setConfiguration(configuration);
    ...
    {
	mComponents[0] = new PDSCH_PowerControlInfo();
	mComponents[1] = new AllocationPeriodInfo();
	...
	public static class Old_Configuration extends Sequence {
		...
		new QName (
		    ...
		    "PDSCH_CapacityAllocationInfo$Configuration$Old_Configuration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	public static class New_Configuration extends Sequence {
	     ...
	     * Construct with AbstractData components.
	     */
	    public New_Configuration(PDSCH_Info pdsch_Info, 
			    PDSCH_Identity pdsch_Identity)
	    {
	    ...
	    {
		return (PDSCH_Info)mComponents[0];
	    }
		...
		new QName (
		    "rrc.informationelements",
		    "PDSCH_CapacityAllocationInfo$Configuration$New_Configuration"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
	...
	private static final ChoiceInfo c_typeinfo = new ChoiceInfo (
	    ...
	    new QName (
		"rrc.informationelements",
		"PDSCH_CapacityAllocationInfo$Configuration"
	    ),
	    new QName (
		"builtin",
		"CHOICE"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PDSCH_CapacityAllocationInfo object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PDSCH_CapacityAllocationInfo object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for PDSCH_CapacityAllocationInfo
