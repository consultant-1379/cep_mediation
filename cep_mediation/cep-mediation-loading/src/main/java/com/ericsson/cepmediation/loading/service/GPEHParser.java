...
public class GPEHParser extends Parser implements ParserService, StatisticsAware {
    // Get a reference to the logger
    private static final Logger logger = LoggerFactory.getLogger(GPEHParser.class);
    ...
    public LoadingMetrics execute(final Collection<File> fileList) throws ParsingFailedException {
        try {
            ...
            final LoadingMetrics loadingMetrics = new LoadGPEH().load(schemaTypeHandler, fileList, publishers);
