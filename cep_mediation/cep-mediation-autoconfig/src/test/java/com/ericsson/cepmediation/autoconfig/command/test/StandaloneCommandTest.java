...
public class StandaloneCommandTest {
    ...
    public void init() {
        ...
        String standaloneXML = getClass().getClassLoader().getResource("standalone.xml").getFile();
        config.setStandaloneXML(standaloneXML);
    }

    @Test
    public void testProcess() {
        assertTrue(new StandaloneCommand().process(config));
    }
