...
public class EnhancedInternalSystemReleaseEnriched extends INTERNAL_SYSTEM_RELEASE_ENRICHED {

	public static final String ABSOLUTE_NAME = "correlation.ENHANCED_INTERNAL_SYSTEM_RELEASE_ENRICHED";
